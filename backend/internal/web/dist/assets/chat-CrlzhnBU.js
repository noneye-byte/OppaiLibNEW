import{a as Ge,V as Ke,W as be,X as W,T as fe,B as Xe,Y as ye,Z as Ve,e as m,$ as Je,a0 as M,a1 as Qe,l as ve,n as N,a2 as Ze,g as te,a3 as xe,a4 as et,a5 as tt,a6 as at,Q as ae,a7 as st,a8 as it,a9 as ot,aa as nt,ab as we,ac as rt,b as n,h as X,ad as lt,f as dt,A as d,j as se,k as ie,ae as oe,af as ke,ag as V,ah as ct,ai as ce,R as pt,aj as B,ak as ht,al as ut,am as gt,an as $e,M as mt,q as bt,ao as ft,ap as yt,aq as vt,r as xt,i as wt,N as kt,u as g,t as $t}from"./index-CsG9DGtL.js";import{e as Ne}from"./query-__j_ZMY6.js";import{l as Ct,a as Ce,b as St,s as Se}from"./libby-backgrounds-n1qcLQ-w.js";function Tt(e){var a;return(((a=/(?:https?:\/\/|www\.)[^\s<>"'`]{2,}/i.exec(e))==null?void 0:a[0])??"").replace(/[.,;:!?)\]}'"]+$/,"")}const J=5,It=160,Lt=200;function Te(e){var s;const t=e.trim();if(!t)return[t];let a=t.split(/\n{2,}/).map(o=>o.trim()).filter(Boolean);if(a.length<2){if(t.length<It)return[t];const o=(s=t.match(/[^.!?…]+[.!?…]+["')\]]*\s*|[^.!?…]+$/g))==null?void 0:s.map(r=>r.trim()).filter(Boolean);if(!o||o.length<2)return[t];a=[];let i="";for(const r of o)i&&i.length+r.length>Lt&&a.length<J-1?(a.push(i.trim()),i=r):i=i?`${i} ${r}`:r;i.trim()&&a.push(i.trim())}return a.length<=J?a:[...a.slice(0,J-1),a.slice(J-1).join(`

`)]}function Dt(e,t,a=Math.random){const s=i=>i*(.7+a()*.6);let o=s(700+e*28);return t>10*6e4&&(o+=s(1500)),Math.min(6500,o)}function Ie(e){return e.replace(/\*\*|~~|`|\*/g,"").replace(/\s+/g," ").trim()}function Pt(e){return e.replace(/\[[^\]\n]{0,200}\]/g," ").replace(/\*\*|__|~~|\*|`/g,"").replace(/\s+/g," ").trim()}function Le(e,t=Date.now()){const a=Math.max(0,(t-e)/1e3);return a<90?"just now":a<5400?`${Math.round(a/60)} minutes ago`:a<172800?`${Math.round(a/3600)} hours ago`:`${Math.round(a/86400)} days ago`}function At(e){return e<.15?"Still getting to know each other":e<.5?"Comfortable with each other by now":e<.85?"Close — you know each other well":"Deeply close after all this time"}function ne(e,t=140){let a=e.trim();const s=a.indexOf(`
`);if(s>=0&&a.slice(0,s).trim()&&(a=a.slice(0,s).trim()),a.length<=t)return a;let o=a.slice(0,t);const i=o.lastIndexOf(" ");return i>t/2&&(o=o.slice(0,i)),o.trim()+"…"}function I(e,...t){for(const a of t){const s=e[a];if(typeof s=="string"&&s.trim()!=="")return s}return""}function De(e,...t){for(const a of t){const s=e[a];if(Array.isArray(s)){const o=s.filter(i=>typeof i=="string"&&i.trim()!=="");if(o.length)return o}}return[]}function Be(e,t){if(!e||typeof e!="object"||Array.isArray(e))throw new Error("that file isn't a character card (expected a JSON object)");const a=e,s=typeof a.spec=="string"?a.spec.toLowerCase():"",o=a.data&&typeof a.data=="object"&&!Array.isArray(a.data)?a.data:null,i=o??a,r=s.includes("v3")?"v3":s.includes("v2")||o?"v2":"v1",l=I(i,"name","char_name","charName")||t,u=I(i,"description","char_persona","persona"),c=I(i,"personality","personalitySummary"),v=I(i,"scenario","world_scenario"),b=I(i,"first_mes","firstMessage","char_greeting","greeting"),$=I(i,"mes_example","exampleDialogue","example_dialogue"),f=I(i,"creator_notes","creatorNotes","creatorcomment","creator_comment"),k=[I(i,"system_prompt","systemPrompt"),I(i,"post_history_instructions","postHistoryInstructions")].filter(Boolean).join(`

`),w=De(i,"alternate_greetings","alternateGreetings"),S=De(i,"tags"),y=i.extensions&&typeof i.extensions=="object"?i.extensions:{},T=y.oppailib&&typeof y.oppailib=="object"?y.oppailib:{},O={name:l,description:u,personality:c,scenario:v,firstMessage:b,exampleDialogue:$,systemPrompt:k,creatorNotes:f,appearance:I(T,"appearance"),kinks:I(T,"kinks"),promptWeight:typeof T.promptWeight=="number"&&Number.isFinite(T.promptWeight)?T.promptWeight:1,defaultMode:I(T,"defaultMode")||"roleplay"};return w.length&&(O.altGreetings=w),{character:O,spec:r,leftovers:{alternateGreetings:w.length,characterBook:!!i.character_book||!!i.characterBook,tags:S,creator:I(i,"creator"),characterVersion:I(i,"character_version","characterVersion")}}}function Ot(e){const t=atob(e.replace(/\s+/g,"")),a=Uint8Array.from(t,s=>s.charCodeAt(0));return new TextDecoder("utf-8").decode(a)}async function Pe(e){const t=new Blob([e]).stream().pipeThrough(new DecompressionStream("deflate"));return new Uint8Array(await new Response(t).arrayBuffer())}async function _t(e){const t=[137,80,78,71,13,10,26,10];if(e.length<8||t.some((l,u)=>e[u]!==l))return[];const a=new DataView(e.buffer,e.byteOffset,e.byteLength),s=new TextDecoder("latin1"),o=new TextDecoder("utf-8"),i=[];let r=8;for(;r+12<=e.length;){const l=a.getUint32(r),u=s.decode(e.subarray(r+4,r+8));if(u==="IEND")break;const c=r+8,v=c+l;if(v+4>e.length)break;const b=e.subarray(c,v);if(u==="tEXt"||u==="zTXt"||u==="iTXt"){const $=b.indexOf(0);if($>0){const f=s.decode(b.subarray(0,$));try{if(u==="tEXt")i.push({keyword:f,text:s.decode(b.subarray($+1))});else if(u==="zTXt")i.push({keyword:f,text:s.decode(await Pe(b.subarray($+2)))});else{let k=$+1;const w=b[k]===1;k+=2;const S=b.indexOf(0,k);if(S<0)throw new Error("bad iTXt");const y=b.indexOf(0,S+1);if(y<0)throw new Error("bad iTXt");const T=b.subarray(y+1);i.push({keyword:f,text:w?o.decode(await Pe(T)):o.decode(T)})}}catch{}}}r=v+4}return i}async function zt(e,t){const a=await _t(e),s=l=>a.find(u=>u.keyword.toLowerCase()===l),o=s("ccv3")??s("chara");if(!o)return null;let i;try{i=Ot(o.text)}catch{throw new Error("the card data inside that PNG is not valid base64")}let r;try{r=JSON.parse(i)}catch{throw new Error("the card data inside that PNG is not valid JSON")}return Be(r,t)}async function Mt(e){const t=e.name.replace(/\.[^.]+$/,"")||"New friend";if(e.name.toLowerCase().endsWith(".png")||e.type==="image/png")return zt(new Uint8Array(await e.arrayBuffer()),t);if(e.type.startsWith("image/"))return null;let s;try{s=JSON.parse(await e.text())}catch{throw new Error("that file is neither a PNG card nor valid JSON")}return Be(s,t)}function Et(e){const t={name:e.name,description:e.description??"",personality:e.personality??"",scenario:e.scenario??"",first_mes:e.firstMessage??"",mes_example:e.exampleDialogue??"",system_prompt:e.systemPrompt??"",post_history_instructions:"",creator_notes:e.creatorNotes??"",alternate_greetings:e.altGreetings??[],tags:[],creator:"",character_version:"",extensions:{oppailib:{appearance:e.appearance??"",kinks:e.kinks??"",defaultMode:e.defaultMode,promptWeight:e.promptWeight}}};return{spec:"chara_card_v2",spec_version:"2.0",data:t,...t}}var Rt=Object.defineProperty,Wt=Object.getOwnPropertyDescriptor,h=(e,t,a,s)=>{for(var o=s>1?void 0:s?Wt(t,a):t,i=e.length-1,r;i>=0;i--)(r=e[i])&&(o=(s?r(t,a,o):r(o))||o);return s&&o&&Rt(t,a,o),o};const E=[{id:"sweet",label:"sweet",emotion:"happy",topic:"Soft, warm, and unhurried."},{id:"playful",label:"playful",emotion:"mischievous",topic:"Teasing and quick on their feet."},{id:"bold",label:"bold",emotion:"surprised",topic:"Blunt, uninhibited, and direct."},{id:"roleplay",label:"roleplay",emotion:"thinking",topic:"In character, in scene, in detail."},{id:"horny",label:"horny",emotion:"mischievous",topic:"Explicit, leading, and sending pictures."}],Nt=[{id:"character",label:"Character card",icon:"badge",group:"Friend"},{id:"images",label:"Images",icon:"image",group:"Friend"},{id:"model",label:"Model & generation",icon:"memory",group:"Chat"},{id:"profile",label:"Your profile",icon:"person",group:"Chat"}],Bt=[{id:"character",label:"Libby",icon:"badge",group:"Libby"},{id:"world",label:"Her world",icon:"public",group:"Libby"},{id:"mind",label:"Her mind",icon:"psychology",group:"Libby"},{id:"images",label:"Her pictures",icon:"image",group:"Libby"},{id:"model",label:"Model & generation",icon:"memory",group:"Chat"},{id:"profile",label:"Your profile",icon:"person",group:"Chat"}],jt=14e3,Q=8,Ut=40,Ae="oppai_chat_autopilot",re=21e4,qt=4e4,Ft=["❤️","😂","😮","😢","🔥","👍","👀","😘"],Oe=56,Yt=72,_e=e=>`avatar:${e}`,_=()=>typeof crypto.randomUUID=="function"?crypto.randomUUID().replaceAll("-",""):[...crypto.getRandomValues(new Uint8Array(16))].map(e=>e.toString(16).padStart(2,"0")).join(""),pe=e=>new Date(e).toLocaleTimeString([],{hour:"numeric",minute:"2-digit"});function Ht(e){return e?e<0?-1:ce.map(a=>a.value).filter(a=>a>0).reduce((a,s)=>Math.abs(s-e)<Math.abs(a-e)?s:a,1):1}function ee(e){const t=new Date(e),a=new Date,s=i=>new Date(i.getFullYear(),i.getMonth(),i.getDate()).getTime(),o=Math.round((s(a)-s(t))/864e5);return o===0?"Today":o===1?"Yesterday":o<7?t.toLocaleDateString([],{weekday:"long"}):t.toLocaleDateString([],{month:"short",day:"numeric",year:t.getFullYear()===a.getFullYear()?void 0:"numeric"})}function Gt(e){const t=ee(e);return t==="Today"?pe(e):t==="Yesterday"?t:new Date(e).toLocaleDateString([],{month:"short",day:"numeric"})}const le=()=>({}),ze="oppai_stage_width",Kt={label:"Loader",keys:["loader"],kind:"select"},A=["llama.cpp"],j=["ExLlamav3_HF","ExLlamav3","ExLlamav2_HF","ExLlamav2"],z=["Transformers","HQQ"],de=[{label:"Context length",keys:["ctx_size","n_ctx","max_seq_len"],kind:"number",placeholder:"model default"},{label:"GPU layers",keys:["gpu_layers","n_gpu_layers"],kind:"number",hint:"0 = CPU only",loaders:A},{label:"Batch size",keys:["batch_size","n_batch"],kind:"number",loaders:A},{label:"Threads",keys:["threads"],kind:"number",loaders:A},{label:"Batch threads",keys:["threads_batch"],kind:"number",loaders:A},{label:"KV cache type",keys:["cache_type"],kind:"select",options:["fp16","q8_0","q4_0","q8","q6","q4"],hint:"q8_0/q4_0 for llama.cpp; q8/q6/q4 for ExLlama"},{label:"Tensor split",keys:["tensor_split"],kind:"text",placeholder:"e.g. 20,10",loaders:A},{label:"GPU split (GB)",keys:["gpu_split"],kind:"text",placeholder:"e.g. 20,7",loaders:j},{label:"RoPE base",keys:["rope_freq_base"],kind:"number",placeholder:"model default"},{label:"Positional compression",keys:["compress_pos_emb"],kind:"number",placeholder:"1"},{label:"Experts per token",keys:["num_experts_per_token"],kind:"number",placeholder:"model default",loaders:j},{label:"Compute dtype",keys:["compute_dtype"],kind:"select",options:["float16","bfloat16","float32"],loaders:z},{label:"Quant type",keys:["quant_type"],kind:"select",options:["nf4","fp4"],loaders:z},{label:"Flash attention",keys:["flash_attn"],kind:"check"},{label:"mlock",keys:["mlock"],kind:"check",hint:"keep in RAM",loaders:A},{label:"No mmap",keys:["no_mmap"],kind:"check",loaders:A},{label:"NUMA",keys:["numa"],kind:"check",loaders:A},{label:"CPU only",keys:["cpu"],kind:"check"},{label:"Load in 4-bit",keys:["load_in_4bit"],kind:"check",loaders:z},{label:"Load in 8-bit",keys:["load_in_8bit"],kind:"check",loaders:z},{label:"bf16",keys:["bf16"],kind:"check",loaders:z},{label:"Auto devices",keys:["auto_devices"],kind:"check",loaders:z},{label:"Disk offload",keys:["disk"],kind:"check",loaders:z},{label:"Trust remote code",keys:["trust_remote_code"],kind:"check",loaders:z},{label:"No flash attention",keys:["no_flash_attn"],kind:"check",loaders:j},{label:"CFG cache",keys:["cfg_cache"],kind:"check",loaders:j},{label:"Tensor parallel",keys:["enable_tp"],kind:"check",loaders:j},{label:"Streaming LLM",keys:["streaming_llm"],kind:"check",loaders:A}],Me={boundary:"boundary",relationship:"us",preference:"likes",user:"about you",libby:"about her",emotional:"feelings",shared:"together"},Xt="two";function je(){return{profile:{displayName:"",persona:""},characters:[],conversations:[],images:[]}}function Vt(){return{...je(),characters:[{id:"libby",name:"Libby",builtIn:!0,promptWeight:1,defaultMode:"sweet",description:"OppaiLib's librarian and resident mascot."}]}}function Ee(e){return{...e,profile:e.profile??{displayName:"",persona:""},characters:(e.characters??[]).filter(t=>t&&t.id),images:(e.images??[]).map(t=>({...t,tags:t.tags??[]})),conversations:(e.conversations??[]).map(t=>({...t,messages:(t.messages??[]).filter(a=>a&&typeof a.content=="string")}))}}function Re(e,t,a){const s=e==null?void 0:e[t];return typeof s=="number"&&Number.isFinite(s)?s:a}function We(e,t,a){const s=/(\*\*[^*\n]+\*\*|\*[^*\n]+\*|~~[^~\n]+~~|`[^`\n]+`|"[^"\n]+")/g,o=e.split(s);return n`${o.map(i=>i.startsWith("**")&&i.endsWith("**")?n`<strong class="action">${Z(i.slice(2,-2),t,a)}</strong>`:i.startsWith("*")&&i.endsWith("*")?n`<em>${Z(i.slice(1,-1),t,a)}</em>`:i.startsWith("~~")&&i.endsWith("~~")?n`<s>${i.slice(2,-2)}</s>`:i.startsWith("`")&&i.endsWith("`")?n`<code>${i.slice(1,-1)}</code>`:i.startsWith('"')&&i.endsWith('"')?n`<span class="speech">${Z(i,t,a)}</span>`:Z(i,t,a))}`}const Jt=e=>e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");function Z(e,t,a){if(!(t!=null&&t.length)||!a||!e)return e;const s=t.filter(r=>r.title.trim().length>=3);if(!s.length)return e;const o=new RegExp(`(${s.map(r=>Jt(r.title)).join("|")})`,"i"),i=e.split(o);return i.length===1?e:n`${i.map(r=>{const l=s.find(c=>c.title.toLowerCase()===r.toLowerCase());if(!l)return r;const u=c=>{c.stopPropagation(),a(l.id)};return n`<a class="inline-link" role="link" tabindex="0" title=${`Open ${l.title}`} @click=${u}
      @keydown=${c=>{(c.key==="Enter"||c.key===" ")&&(c.preventDefault(),u(c))}}>${r}</a>`})}`}let p=class extends Ge{constructor(){super(...arguments),this.status=null,this.workspace=je(),this.characterID="libby",this.conversationID="",this.draft="",this.busy=!1,this.loading=!0,this.workspaceLoaded=!0,this.loadError="",this.settingsOpen=!1,this.speakOn=Ct(),this.editorTab="character",this.outfits=null,this.activities=[],this.outfitsLoading=!1,this.notice="",this.noticeError=!1,this.imageTags="",this.memories=null,this.memoryKinds=[],this.memoryLimit=0,this.memoryDraft="",this.editingMemory=null,this.memoryDraftEdit="",this.memoryKindEdit="",this.autoState=null,this.wants=null,this.identity=void 0,this.pendingLink=null,this.pendingLinkURL="",this.discord=void 0,this.discordPlaces=null,this.discordToken="",this.discordUserDraft="",this.bond=null,this.openingBond=null,this.models=null,this.modelChoice="",this.modelBusy=!1,this.backend=null,this.loadArgs={},this.loadExtra="",this.loadSettings="",this.loraPicks=[],this.cardTokens=null,this.deleteTarget=null,this.deleteConfirm="",this.deletePermanent=!1,this.deleteError="",this.mobileNavOpen=!1,this.chatSearch="",this.pickerOpen=!1,this.captureTurns=!1,this.turnLog=new Map,this.cardDrop=!1,this.cardNote=null,this.autopilot=localStorage.getItem(Ae)==="1",this.autoPaused=!1,this.autoTurns=0,this.stageOpen=!0,this.stageWidth=(()=>{try{return Number(localStorage.getItem(ze))||0}catch{return 0}})(),this.stageDragging=!1,this.pendingPhoto=null,this.typingPhase="idle",this.callOpen=!1,this.callSeconds=0,this.incomingCall=!1,this.ringTimer=0,this.backgrounds=[],this.defaultBackground="",this.scenePickerOpen=!1,this.callCaptions=!0,this.replyTarget=null,this.reactionPicker=null,this.snapOpen=null,this.weightTagDraft="",this.readTimer=0,this.turnOptions={},this.pendingReply=!1,this.swipe=null,this.pendingItems=[],this.picker=null,this.pickerSeq=0,this.callTimer=0,this.autoTimer=0,this.facts=null,this.factsAt=0,this.saveTimer=0,this.editSeq=0,this.idleTimer=0,this.idleNudged=!1,this.noticeTimer=0,this.imageSubject="self",this.approvals=new Ke(()=>this.requestUpdate()),this.onShared=()=>{this.claimShare()},this.onGlobalKey=e=>{e.key==="Escape"&&this.callOpen&&(e.stopPropagation(),this.endCall())},this.lastArrivalID="",this.memoriesLoading=!1,this.wantsLoading=!1,this.bondLoading=!1,this.armIdle=()=>{window.clearTimeout(this.idleTimer),this.idleNudged=!1,this.characterID==="libby"&&(this.idleTimer=window.setTimeout(()=>void this.idleNudge(),re))},this.stageDragStart=e=>{var i,r;e.preventDefault();const t=e.clientX,a=this.stageWidth||((r=(i=this.shadowRoot)==null?void 0:i.querySelector(".stage"))==null?void 0:r.offsetWidth)||300;this.stageDragging=!0;const s=l=>{const u=Math.round(Math.max(220,Math.min(window.innerWidth*.5,a+(t-l.clientX))));this.stageWidth=u},o=()=>{window.removeEventListener("pointermove",s),window.removeEventListener("pointerup",o),this.stageDragging=!1;try{localStorage.setItem(ze,String(this.stageWidth))}catch{}};window.addEventListener("pointermove",s),window.addEventListener("pointerup",o)},this.cancelDeleteModel=()=>{this.deleteTarget=null,this.deleteConfirm="",this.deleteError=""},this.autoStateLoading=!1,this.discordLoading=!1,this.identityLoading=!1,this.chatMenu=e=>{if(be(e))return;e.preventDefault();const t=this.activeCharacter,a=this.activeConversation,o=e.composedPath().find(l=>{var u,c;return(c=(u=l==null?void 0:l.classList)==null?void 0:u.contains)==null?void 0:c.call(u,"convo-wrap")}),i=o==null?void 0:o.dataset.id,r=i?[{label:"Open",icon:"forum",run:()=>this.activateConversation(i)},{label:"New conversation",icon:"add_comment",run:()=>this.newConversation()},{label:"Export conversation…",icon:"download",run:()=>this.exportConversation(i)},W,{label:"Delete conversation",icon:"delete",danger:!0,run:()=>this.deleteConversation(i)}]:[{label:"Re-respond",icon:"refresh",disabled:this.busy||!(a!=null&&a.messages.some(l=>l.role==="assistant")),run:()=>void this.regenerate()},{label:"Retry with a note…",icon:"edit_note",disabled:this.busy||!(a!=null&&a.messages.some(l=>l.role==="assistant")),run:()=>void this.regenerateWithNote()},{label:this.callOpen?"End video call":"Video call",icon:this.callOpen?"call_end":"videocam",run:()=>this.callOpen?this.endCall():this.startCall()},{label:"Share a photo",icon:"add_photo_alternate",disabled:this.busy,run:()=>this.pickPhoto()},{label:"Attach from the library",icon:"collections_bookmark",disabled:this.busy,run:()=>this.openPicker()},{label:this.autopilot?"Turn off autopilot":"Let the AI continue on its own",icon:"smart_toy",run:()=>this.toggleAutopilot()},{label:this.stageOpen?"Hide portrait":"Show portrait",icon:"wallpaper",run:()=>this.stageOpen=!this.stageOpen},{label:this.speakOn?"Stop reading aloud":"Read replies aloud",icon:this.speakOn?"volume_off":"volume_up",run:()=>this.toggleSpeak()},W,{label:"New conversation",icon:"add_comment",run:()=>this.newConversation()},{label:"Chat settings",icon:"tune",run:()=>{this.settingsOpen=!0,this.editorTab="character"}},{label:"Refresh model status",icon:"sync",run:()=>void this.refreshModels()},W,{label:this.captureTurns?"Stop capturing turns":"Capture turns (prompt + raw reply)",icon:this.captureTurns?"bug_report":"pest_control",run:()=>{this.captureTurns=!this.captureTurns,this.say(this.captureTurns?"Capturing every turn's prompt and raw reply. Export the conversation to read them.":"Stopped capturing turns.")}},{label:"Export conversation…",icon:"download",run:()=>this.exportConversation()},W,{label:"Clear messages",icon:"delete_sweep",danger:!0,run:()=>this.clearConversation()}];fe({x:e.clientX,y:e.clientY,title:t==null?void 0:t.name,items:r})}}get canManageModels(){var e;return!!((e=this.user)!=null&&e.isAdmin)}connectedCallback(){super.connectedCallback(),Xe(this,"chat"),this.load().then(()=>void this.claimShare()),window.addEventListener("keydown",this.onGlobalKey),window.addEventListener(ye,this.onShared)}disconnectedCallback(){var e;window.clearTimeout(this.ringTimer),super.disconnectedCallback(),window.clearTimeout(this.saveTimer),window.clearTimeout(this.idleTimer),window.clearTimeout(this.noticeTimer),window.clearTimeout(this.autoTimer),window.clearInterval(this.callTimer),window.clearTimeout(this.readTimer),window.removeEventListener("keydown",this.onGlobalKey),window.removeEventListener(ye,this.onShared),(e=this.resize)==null||e.disconnect()}async claimShare(){const e=Ve();if(!e)return;const t=this.workspace.characters.find(a=>a.id===e.characterId);if(!t){this.say("That character no longer exists.",!0);return}this.characterID!==t.id&&this.activateCharacter(t.id);try{this.say(`Scanning ${e.name} locally…`);const a=await m.uploadChatImage({characterId:t.id,name:e.name,imageData:e.imageData,tags:[]});this.workspace.images.push(a),this.pendingPhoto={imageId:a.id,tags:a.tags??[],name:a.name},this.touchWorkspace(),this.say(`Ready to show ${t.name} — add a message and send.`),this.focusComposer()}catch(a){this.say(a.message,!0)}}firstUpdated(){this.resize=new ResizeObserver(()=>void this.scrollToEnd(!1)),this.log&&this.resize.observe(this.log),this.focusComposer()}focusComposer(){this.settingsOpen||this.updateComplete.then(()=>{const e=this.callOpen?this.renderRoot.querySelector(".call-input"):this.composer;!e||e.disabled||(e.focus({preventScroll:!0}),e.setSelectionRange(e.value.length,e.value.length))})}updated(e){e.has("busy")&&!this.busy&&this.focusComposer(),(e.has("conversationID")||e.has("characterID"))&&this.focusComposer(),e.has("settingsOpen")&&!this.settingsOpen&&this.focusComposer(),e.has("callOpen")&&this.focusComposer(),this.animateArrival()}animateArrival(){var s;const e=(s=this.activeConversation)==null?void 0:s.messages,t=e==null?void 0:e[e.length-1];if(!t){this.lastArrivalID="";return}if(t.id===this.lastArrivalID)return;const a=!this.lastArrivalID;this.lastArrivalID=t.id,!a&&Je(this.renderRoot.querySelector(".log article.msg:last-of-type"))}get activeCharacter(){const e=this.visibleCharacters;return e.find(t=>t.id===this.characterID)??e[0]}get visibleCharacters(){return this.workspace.characters}get spoken(){var e;return((e=this.activeConversation)==null?void 0:e.messages.reduce((t,a)=>t+(a.role==="assistant"?1:0),0))??0}get activeConversation(){return this.workspace.conversations.find(e=>e.id===this.conversationID)}conversationsFor(e=this.characterID){return this.workspace.conversations.filter(t=>t.characterId===e).sort((t,a)=>a.updatedAt-t.updatedAt)}async load(){var s,o,i;const[e,t,a]=await Promise.allSettled([m.chatStatus(),m.chatWorkspace(),m.libbyBond(),this.loadBackgrounds()]);try{e.status==="fulfilled"&&(this.status=e.value),t.status==="fulfilled"?(this.workspace=Ee(t.value),this.workspaceLoaded=!0):(this.workspace=Vt(),this.workspaceLoaded=!1,this.loadError=((s=t.reason)==null?void 0:s.message)||"Couldn't load your chat workspace."),a.status==="fulfilled"&&a.value.lastSeenAt&&(this.openingBond=a.value,M(Math.min(Math.max(1,Math.round(a.value.heatNow||1)),Qe))),this.characterID=((o=this.workspace.characters[0])==null?void 0:o.id)??"libby";const r=this.conversationsFor(this.characterID)[0];r?this.activateConversation(r.id):this.newConversation(!1),(i=this.status)!=null&&i.modelBackend&&this.refreshModels(!0)}catch(r){this.loadError=r.message||"Chat failed to start."}finally{this.loading=!1}}async retryLoad(){this.loading||(this.loadError="",this.loading=!0,await this.load())}say(e,t=!1){this.notice=e,this.noticeError=t,window.clearTimeout(this.noticeTimer),this.noticeTimer=window.setTimeout(()=>this.notice="",4200)}async libraryFacts(){if(this.facts&&Date.now()-this.factsAt<6e4)return this.facts;try{this.facts=await m.libbyContext(),this.factsAt=Date.now()}catch{}return this.facts}async loadMemories(e=!1){if(!this.memoriesLoading){this.memoriesLoading=!0;try{const t=await m.libbyMemory();this.memories=t.memories,this.memoryKinds=t.kinds??[],this.memoryLimit=t.limit??0}catch{e||(this.memories=[])}finally{this.memoriesLoading=!1}}}async forgetMemory(e){try{await m.forgetLibbyMemory(e),this.memories=(this.memories??[]).filter(t=>t.id!==e)}catch(t){this.say(t instanceof Error?t.message:"Couldn't forget that.",!0)}}async addMemory(){const e=this.memoryDraft.trim();if(!(e.length<8))try{await m.addLibbyMemory({text:e}),this.memoryDraft="",await this.loadMemories(!0),this.say("She'll remember that.")}catch(t){this.say(t instanceof Error?t.message:"Couldn't save that.",!0)}}async togglePin(e){try{const t=await m.updateLibbyMemory(e.id,{pinned:!e.pinned});this.memories=(this.memories??[]).map(a=>a.id===e.id?t:a)}catch(t){this.say(t instanceof Error?t.message:"Couldn't pin that.",!0)}}async saveMemoryEdit(e){const t=this.memoryDraftEdit.trim();if(t.length<8){this.say("A memory needs to be a sentence, not a fragment.",!0);return}try{const a=await m.updateLibbyMemory(e.id,{text:t,kind:this.memoryKindEdit&&this.memoryKindEdit!==e.kind?this.memoryKindEdit:void 0});this.memories=(this.memories??[]).map(s=>s.id===e.id?a:s),this.editingMemory=null}catch(a){this.say(a instanceof Error?a.message:"Couldn't save that.",!0)}}async clearMemories(){if(confirm("Clear everything Libby remembers about you? This can't be undone."))try{await m.clearLibbyMemory(),this.memories=[]}catch(e){this.say(e instanceof Error?e.message:"Couldn't clear her memory.",!0)}}async loadWants(){if(!this.wantsLoading){this.wantsLoading=!0;try{this.wants=(await m.libbyWants()).wants}catch{this.wants=[]}finally{this.wantsLoading=!1}}}async forgetWant(e){try{await m.forgetLibbyWant(e),this.wants=(this.wants??[]).filter(t=>t.id!==e)}catch(t){this.say(t instanceof Error?t.message:"Couldn't drop that.",!0)}}async clearWants(){if(confirm("Clear everything Libby has been wanting? This can't be undone."))try{await m.clearLibbyWants(),this.wants=[]}catch(e){this.say(e instanceof Error?e.message:"Couldn't clear her wants.",!0)}}async loadBond(){if(!this.bondLoading){this.bondLoading=!0;try{this.bond=await m.libbyBond()}catch{this.bond=null}finally{this.bondLoading=!1}}}async resetBond(){if(confirm("Start fresh with Libby? She'll forget where you left off — the time, the mood, how close you've grown. Your memories and her wants are kept."))try{await m.resetLibbyBond(),this.bond=null,this.openingBond=null,M(1),this.say("Reset. Your next chat with Libby starts fresh.")}catch(e){this.say(e instanceof Error?e.message:"Couldn't reset that.",!0)}}async refreshModels(e=!1){try{const[t,a]=await Promise.all([m.chatModels(),m.chatStatus()]);this.models=t,this.status=a,e||this.say(a.enabled?`Connected to ${a.model||"the loaded model"}.`:a.message||"No model is loaded.",!a.enabled),t.supported?this.refreshBackend():this.backend=null}catch(t){e||this.say(t.message,!0)}}async refreshBackend(){var e,t,a;try{this.backend=await m.chatBackendInfo(),this.loraPicks=[...((e=this.backend.loras)==null?void 0:e.loaded)??[]],this.seedLoadArgs(this.modelChoice||((t=this.models)==null?void 0:t.loaded)||((a=this.models)==null?void 0:a.models[0])||"")}catch{this.backend=null}}seedLoadArgs(e){var i,r;const t=(r=(i=this.backend)==null?void 0:i.loads)==null?void 0:r[e],a={...(t==null?void 0:t.args)??{}},s=new Set(de.flatMap(l=>l.keys)),o={};for(const[l,u]of Object.entries(a))s.has(l)||(o[l]=u);for(const l of Object.keys(o))delete a[l];this.loadArgs=a,this.loadExtra=Object.keys(o).length?JSON.stringify(o,null,2):"",this.loadSettings=t!=null&&t.settings&&Object.keys(t.settings).length?JSON.stringify(t.settings,null,2):""}composeLoadArgs(){const e={};for(const a of de){const s=this.loadArgs[a.keys[0]];if(!(s===void 0||s===""||s===null)&&!(a.kind==="check"&&!s))for(const o of a.keys)e[o]=s}this.loadExtra.trim()&&Object.assign(e,JSON.parse(this.loadExtra));const t=this.loadSettings.trim()?JSON.parse(this.loadSettings):{};return{args:e,settings:t}}setLoadArg(e,t){const a={...this.loadArgs},s=e.keys[0];if(e.kind==="check")t?a[s]=!0:delete a[s];else if(e.kind==="number"){const o=Number(t);t===""||Number.isNaN(o)?delete a[s]:a[s]=o}else t===""?delete a[s]:a[s]=t;this.loadArgs=a}async applyLoras(){if(!this.modelBusy){this.modelBusy=!0;try{const e=await m.setChatLoras(this.loraPicks);this.backend&&(this.backend={...this.backend,loras:e}),this.loraPicks=[...e.loaded],this.say(e.loaded.length?`Applied ${e.loaded.join(", ")}.`:"LoRAs cleared.")}catch(e){this.say(e.message,!0)}finally{this.modelBusy=!1}}}async stopGeneration(){try{await m.stopChat(),this.say("Stopping…")}catch(e){this.say(e.message,!0)}}async measureCard(e){const t=[e.description,e.personality,e.scenario,e.kinks,e.systemPrompt,e.exampleDialogue,e.firstMessage].filter(Boolean).join(`

`);try{this.cardTokens=await m.countChatTokens(t)}catch(a){this.say(a.message,!0)}}touchWorkspace(){this.workspace={...this.workspace,profile:{...this.workspace.profile},characters:[...this.workspace.characters],conversations:[...this.workspace.conversations],images:[...this.workspace.images]},this.editSeq++,window.clearTimeout(this.saveTimer),this.saveTimer=window.setTimeout(()=>void this.saveWorkspace(),450)}async saveWorkspace(){if(window.clearTimeout(this.saveTimer),!this.workspaceLoaded)return;const e=this.editSeq;try{const t=await m.saveChatWorkspace(this.workspace);e===this.editSeq&&(this.workspace=Ee(t))}catch(t){this.say(`Couldn't save chat: ${t.message}`,!0)}}liveConversation(e){return this.workspace.conversations.find(t=>t.id===e)}liveCharacter(e){return this.workspace.characters.find(t=>t.id===e)}async scrollToEnd(e=!0){await this.updateComplete,requestAnimationFrame(()=>{this.log&&this.log.scrollTo({top:this.log.scrollHeight,behavior:e?"smooth":"auto"})})}async idleNudge(){var i;if(this.busy||document.visibilityState!=="visible"||this.autoRunning){window.clearTimeout(this.idleTimer),this.idleTimer=window.setTimeout(()=>void this.idleNudge(),re);return}if(this.idleNudged)return;const e=this.activeConversation;if(!e||e.characterId!=="libby")return;const t=e.messages[e.messages.length-1];if(!t||t.role!=="assistant")return;const a=await this.mayLibbySpeak("idle");if(!(a!=null&&a.allow)){window.clearTimeout(this.idleTimer);const r=a!=null&&a.retryAfterSec?Math.min(a.retryAfterSec*1e3,30*6e4):re;this.idleTimer=window.setTimeout(()=>void this.idleNudge(),r);return}if(this.idleNudged=!0,(i=this.status)!=null&&i.enabled){await this.generateReply(e.id,"",{continuation:!0})&&this.recordLibbySpoke("idle","the conversation went quiet after her message");return}const s=ve("idle",{intensity:e.intensity}),o=this.liveConversation(e.id);o&&(o.emotion=s.emotion,await this.typeAndPushBubbles(o.id,[s.message],0),this.recordLibbySpoke("idle","the conversation went quiet (no model loaded)"))}async mayLibbySpeak(e){try{return await m.libbyAutoCheck({trigger:e})}catch{return}}async recordLibbySpoke(e,t){try{await m.libbyAutoSent({trigger:e,detail:t})}catch{}}activateCharacter(e){this.characterID=e,this.mobileNavOpen=!1;const t=this.conversationsFor(e)[0];t?this.activateConversation(t.id):this.newConversation()}activateConversation(e){const t=this.workspace.conversations.find(a=>a.id===e);t&&(this.conversationID=e,this.characterID=t.characterId,this.mobileNavOpen=!1,this.autoTurns=Q,M(t.intensity),this.armIdle(),this.scheduleAuto(),this.scrollToEnd(!1))}newConversation(e=!0){var r,l,u;const t=this.activeCharacter;if(!t)return;const a=Date.now();let s=((r=t.firstMessage)==null?void 0:r.trim())??"",o=N((l=E.find(c=>c.id===t.defaultMode))==null?void 0:l.emotion);if(t.id==="libby"&&((u=this.openingBond)!=null&&u.mood&&(o=N(this.openingBond.mood)),!s)){const c=Ze(t.defaultMode,te());s=c.message,o=c.emotion}const i={id:_(),characterId:t.id,title:"New conversation",mode:t.defaultMode||"sweet",emotion:o,intensity:t.id==="libby"?te():1,progress:t.id==="libby"?te():1,options:{...this.workspace.defaults??le()},messages:s?[{id:_(),role:"assistant",content:s,at:a}]:[],createdAt:a,updatedAt:a};this.workspace.conversations.push(i),this.conversationID=i.id,this.mobileNavOpen=!1,this.touchWorkspace(),e&&this.say(`Started a new chat with ${t.name}.`),this.armIdle(),this.scrollToEnd(!1)}clearConversation(){const e=this.activeConversation;!e||!confirm("Clear every message in this conversation?")||(e.messages=[],e.title="New conversation",e.updatedAt=Date.now(),this.touchWorkspace(),this.say("Conversation cleared."))}deleteConversation(e){if(!confirm("Delete this conversation?"))return;this.workspace.conversations=this.workspace.conversations.filter(a=>a.id!==e);const t=this.conversationsFor()[0];t?this.conversationID=t.id:this.newConversation(!1),this.touchWorkspace()}updateConversation(e){const t=this.activeConversation;t&&(Object.assign(t,e,{updatedAt:Date.now()}),e.intensity!=null&&(t.progress=e.intensity,M(e.intensity)),this.touchWorkspace())}updateOption(e,t){this.updateOptionValue(e,t)}updateOptionValue(e,t){const a=this.activeConversation;if(!a)return;const s={...a.options??{}};t===void 0?delete s[e]:s[e]=t,a.options=s,a.updatedAt=Date.now(),this.touchWorkspace()}onKey(e){e.key==="Enter"&&!e.shiftKey&&(e.preventDefault(),this.send())}noticeLink(){const e=Tt(this.draft);e!==this.pendingLinkURL&&(this.pendingLinkURL=e,this.pendingLink=null,e&&(async()=>{try{const t=await m.libbyLink(e);this.pendingLinkURL===e&&(this.pendingLink=t)}catch{this.pendingLinkURL===e&&(this.pendingLinkURL="")}})())}dropLink(){this.pendingLink=null,this.pendingLinkURL=""}async send(){const e=this.pendingPhoto,t=this.pendingItems,a=this.activeConversation,s=this.draft.trim()||(e?"*shares a photo with you*":"")||(t.length?`*shares ${t.length===1?t[0].title:`${t.length} things`} from the library*`:"");if(!s||!a)return;const o=a.id,i=this.replyTarget,r={id:_(),role:"user",content:s,at:Date.now(),imageId:e==null?void 0:e.imageId,attachments:t.length?t:void 0,replyTo:i?{id:i.id,role:i.role,excerpt:ne(i.content)}:void 0};a.messages.push(r),a.updatedAt=Date.now(),a.title==="New conversation"&&(a.title=s.slice(0,42));const l=this.pendingLink&&!this.pendingLink.failed&&this.pendingLinkURL?this.pendingLinkURL:"";this.draft="",this.pendingPhoto=null,this.pendingItems=[],this.replyTarget=null,this.dropLink(),this.notice="";const u=this.renderRoot.querySelector("textarea");u&&(u.value=""),this.touchWorkspace(),this.armIdle(),this.scrollToEnd(),this.autoTurns=Q,a.characterId==="libby"&&m.libbyAutoAnswered().catch(()=>{});const c=this.turnOptions;this.turnOptions={photoTags:e?e.tags:c.photoTags,photoImageID:e?e.imageId:c.photoImageID,link:l||c.link,sharedMediaIds:[...c.sharedMediaIds??[],...t.map(v=>v.id)]},this.scheduleReply(o,s.length)}scheduleReply(e,t){window.clearTimeout(this.readTimer);const a=this.liveConversation(e),s=a?[...a.messages].reverse().find(i=>i.role==="assistant"):void 0,o=s?Date.now()-s.at:0;if(this.busy){this.pendingReply=!0;return}this.readTimer=window.setTimeout(()=>void this.runTurn(e),Dt(t,o))}async runTurn(e){if(this.busy){this.pendingReply=!0;return}const t=this.liveConversation(e);if(!t)return;const a=Date.now();let s="";for(const l of t.messages)l.role==="user"&&!l.readAt&&(l.readAt=a,s=l.content);if(!s)return;this.touchWorkspace(),await this.pause(250+Math.random()*500);const o=this.turnOptions;this.turnOptions={},await this.generateReply(e,s,{photoTags:o.photoTags??[],photoImageID:o.photoImageID??"",link:o.link??"",sharedMediaIds:o.sharedMediaIds??[]}),this.scheduleAuto();const i=this.liveConversation(e),r=(i==null?void 0:i.messages.some(l=>l.role==="user"&&!l.readAt))??!1;(this.pendingReply||r)&&(this.pendingReply=!1,r&&this.scheduleReply(e,40))}receiptFor(e,t){if(e.role!=="user")return"";const a=t.messages.filter(o=>o.role==="user");if(a[a.length-1]!==e)return"";if(e.readAt)return`Read ${pe(e.readAt)}`;const s=t.messages.indexOf(e);return t.messages.slice(s+1).some(o=>o.role==="assistant"&&!o.thought)?"Read":"Sent"}react(e,t){const a=this.activeConversation;if(!a)return;const s=(e.reactions??[]).find(i=>i.by==="user"),o=(e.reactions??[]).filter(i=>i.by!=="user");e.reactions=(s==null?void 0:s.emoji)===t?o:[...o,{emoji:t,by:"user"}],e.reactions.length||delete e.reactions,this.reactionPicker=null,a.updatedAt=Date.now(),this.touchWorkspace()}applyReaction(e,t,a){const s=a&&e.messages.find(i=>i.id===a)||[...e.messages].reverse().find(i=>i.role==="user");if(!s)return;const o=(s.reactions??[]).filter(i=>i.by!=="assistant");s.reactions=[...o,{emoji:t,by:"assistant"}]}openSnap(e){e.opened||(this.snapOpen=e)}closeSnap(){const e=this.snapOpen;if(this.snapOpen=null,!e)return;e.opened=!0;const t=this.activeConversation;t&&(t.updatedAt=Date.now(),this.touchWorkspace())}swipeStart(e,t){if(t.pointerType==="mouse"||e.thought)return;const a=t.currentTarget.querySelector(".bubble-wrap");a&&(this.swipe={id:e.id,startX:t.clientX,startY:t.clientY,dx:0,live:!1,el:a})}swipeMove(e){const t=this.swipe;if(!t)return;const a=e.clientX-t.startX,s=e.clientY-t.startY;if(!t.live){if(Math.abs(s)>8&&Math.abs(s)>Math.abs(a)){this.swipe=null;return}if(a<10)return;t.live=!0,t.el.classList.add("swiping");try{e.currentTarget.setPointerCapture(e.pointerId)}catch{}}t.dx=Math.max(0,Math.min(Yt,a)),t.el.style.transform=`translateX(${t.dx}px)`,t.el.classList.toggle("will-reply",t.dx>=Oe),e.preventDefault()}swipeEnd(e){const t=this.swipe;this.swipe=null,t&&(t.el.classList.remove("swiping","will-reply"),t.el.style.transform="",t.live&&t.dx>=Oe&&this.replyTo(e))}replyTo(e){e.thought||(this.replyTarget=e,this.focusComposer())}jumpTo(e){if(!(e!=null&&e.id))return;const t=this.renderRoot.querySelector(`[data-message-id="${e.id}"]`);if(!t){this.say("That message isn't in this conversation any more.");return}t.scrollIntoView({block:"center",behavior:"smooth"}),t.classList.remove("flash"),t.offsetWidth,t.classList.add("flash")}openPicker(){this.picker={query:"",items:[],loading:!0},this.searchLibrary(""),window.setTimeout(()=>{var e;return(e=this.renderRoot.querySelector(".picker-head input"))==null?void 0:e.focus()},30)}closePicker(){this.picker=null,this.focusComposer()}async searchLibrary(e){var s;if(!this.picker)return;const t=++this.pickerSeq;(s=this.pickerAbort)==null||s.abort();const a=new AbortController;this.pickerAbort=a,this.picker={...this.picker,query:e,loading:!0};try{const{items:o}=await m.listMedia({q:e,limit:120,signal:a.signal});if(t!==this.pickerSeq||!this.picker)return;this.picker={query:e,items:o,loading:!1}}catch(o){if(a.signal.aborted||t!==this.pickerSeq||!this.picker)return;this.picker={...this.picker,loading:!1},this.say(o.message,!0)}}toggleItem(e){this.pendingItems.some(a=>a.id===e.id)?this.pendingItems=this.pendingItems.filter(a=>a.id!==e.id):this.pendingItems.length<6?this.pendingItems=[...this.pendingItems,{id:e.id,title:e.title||`Item ${e.id}`,kind:e.kind,hasThumb:e.hasThumb===!0}]:this.say("Six at a time is plenty.")}removeItem(e){this.pendingItems=this.pendingItems.filter(t=>t.id!==e)}async attachPhoto(e){var o,i;const t=e.target,a=(o=t.files)==null?void 0:o[0],s=this.activeCharacter;if(!(!a||!s))try{this.say("Scanning photo locally…");const r=await m.uploadChatImage({characterId:s.id,name:a.name,imageData:await this.readDataURL(a),tags:[]});this.workspace.images.push(r),this.pendingPhoto={imageId:r.id,tags:r.tags??[],name:r.name},this.touchWorkspace(),this.say((i=r.tags)!=null&&i.length?`Photo ready: ${r.tags.slice(0,6).join(", ")}.`:"Photo ready to send."),this.focusComposer()}catch(r){this.say(r.message,!0)}finally{t.value=""}}pickPhoto(){var e;(e=this.renderRoot.querySelector(".attach-btn input"))==null||e.click()}async discardPhoto(){const e=this.pendingPhoto;if(e){this.pendingPhoto=null,this.workspace.images=this.workspace.images.filter(t=>t.id!==e.imageId),this.touchWorkspace(),this.focusComposer();try{await m.deleteChatImage(e.imageId)}catch{}}}pause(e){return new Promise(t=>setTimeout(t,e))}async typeLikeAPerson(e,t){const a=r=>r*(.7+Math.random()*.6),s=Math.min(7e3,a(420+e.length*45));let o=Math.max(0,s-t);if(o<120)return;this.typingPhase="thinking";const i=Math.min(o,a(500));if(await this.pause(i),o-=i,e.length>90&&o>900&&Math.random()<.35){const r=o*(.3+Math.random()*.3);this.typingPhase="typing",await this.pause(r),this.typingPhase="thinking";const l=a(650);await this.pause(l),o-=r+l}o>0&&(this.typingPhase="typing",await this.pause(o)),this.typingPhase="idle"}async typeAndPushBubbles(e,t,a,s={},o={}){for(let i=0;i<t.length;i++){await this.typeLikeAPerson(t[i],i===0?a:0);const r=this.liveConversation(e);if(!r)return!1;const l=i===t.length-1;r.messages.push({id:_(),role:"assistant",content:t[i],at:Date.now(),...i===0?o:{},...l?s:{}}),r.updatedAt=Date.now(),this.touchWorkspace(),this.scrollToEnd(),this.speakOn&&e===this.conversationID&&Ce(t[i])}return!0}toggleSpeak(){this.speakOn=!this.speakOn,St(this.speakOn),this.say(this.speakOn?"She'll read her replies aloud on this device.":"Voice off.")}pushThoughts(e,t){if(!(t!=null&&t.length))return!0;const a=this.liveConversation(e);if(!a)return!1;for(const{kind:s,text:o}of t)o.trim()&&a.messages.push({id:_(),role:"assistant",content:o,at:Date.now(),thought:s});return a.updatedAt=Date.now(),this.touchWorkspace(),this.scrollToEnd(),!0}async generateReply(e,t,a={}){var b,$,f,k,w,S,y,T,O,U,R,q,he,ue,ge,me;const{continuation:s=!1,photoTags:o=[],photoImageID:i="",link:r="",sharedMediaIds:l=[],nudge:u=""}=a,c=this.liveConversation(e),v=c&&this.liveCharacter(c.characterId);if(!c||!v||this.busy)return!1;if(this.busy=!0,!((b=this.status)!=null&&b.enabled)&&(($=this.status)!=null&&$.configured||(f=this.status)!=null&&f.modelBackend))try{this.status=await m.chatStatus()}catch{}if(!((k=this.status)!=null&&k.enabled)){if(v.id!=="libby")return this.busy=!1,this.say(((w=this.status)==null?void 0:w.message)||"Load a model in text-generation-webui, then refresh backend status.",!0),!1;const L=xe(c.progress??c.intensity,s?0:et(t,c.mode)),F=c.mode,x=N(c.emotion);let C;if(s)C=ve("idle",{intensity:L.intensity});else{const H=await this.libraryFacts();C=(H&&tt(t,H,{intensity:L.intensity}))??at(t,F,x,L.intensity,!1)}const D=this.liveConversation(e);if(!D)return this.busy=!1,this.typingPhase="idle",!1;D.emotion=C.emotion,D.progress=L.progress,D.intensity=M(L.intensity),D.updatedAt=Date.now(),this.touchWorkspace();const Y=await this.typeAndPushBubbles(e,Te(C.message),0);return this.busy=!1,this.typingPhase="idle",Y}try{const L=c.messages.filter(P=>!P.thought).map(({id:P,role:Ue,content:qe,replyTo:Fe,imageId:Ye,attachments:G,reactions:K})=>({id:P,role:Ue,content:qe,replyTo:Fe,imageId:Ye||void 0,mediaIds:G!=null&&G.length?G.map(He=>He.id):void 0,reactions:K!=null&&K.length?K:void 0}));s?L.push({role:"user",content:"(Continue the scene on your own. Speak or act again without waiting for a reply, and do not answer for me.)"}):u&&L.push({role:"user",content:`(Try that reply again. ${u} Do not mention this note.)`});const F=Date.now();this.typingPhase="typing";const x=await m.chat({mode:c.mode,messages:L,emotion:c.emotion,intensity:c.intensity,options:c.options,characterId:v.id,conversationId:c.id,photoTags:o,photoImageId:i,recentImageIds:nt(c.messages),recentMediaIds:ot(c.messages),recentMoods:it(c.messages),recentHeat:st(c.messages),activity:c.activity||void 0,background:c.background||void 0,sharedMediaIds:l.length?l:void 0,call:this.callOpen||void 0,outfit:v.id==="libby"?ae():"",link:r||void 0,task:s?"autonomous":void 0,debug:this.captureTurns||void 0});if(x.debug){const P=this.turnLog.get(e)??[];P.push({at:F,request:{photoTags:o,photoImageId:i,task:s?"autonomous":""},debug:x.debug}),this.turnLog.set(e,P.slice(-Ut))}this.lastSampling=x.sampling,this.lastPhoto=x.photo,(S=x.context)!=null&&S.note&&this.say(x.context.note);const C=this.liveConversation(e);if(!C)return!1;C.emotion=N(x.emotion??C.emotion),x.activity!==void 0&&(C.activity=x.activity),x.background!==void 0&&(C.background=x.background);const D=we(x.intensity??C.intensity);if(x.declared)C.progress=D,C.intensity=M(D);else{const P=xe(C.progress??C.intensity,D-C.intensity);C.progress=P.progress,C.intensity=M(P.intensity)}if(C.updatedAt=Date.now(),this.touchWorkspace(),x.callRequest&&!this.callOpen&&this.ring(),x.callEnd&&this.callOpen&&(this.endCall(),this.say(`${v.name} ended the call.`)),!this.pushThoughts(e,x.thoughts))return!1;(y=x.reaction)!=null&&y.emoji&&(this.applyReaction(C,x.reaction.emoji,x.reaction.to),this.touchWorkspace());const Y=!!(x.imageId||(T=x.attachments)!=null&&T.length);if(!x.message.trim()&&!Y)return(((O=x.thoughts)==null?void 0:O.length)??0)>0||!!x.reaction;const H=x.message.trim()||(x.snap?"*sends a snap*":"*sends a picture*");return await this.typeAndPushBubbles(e,Te(H),Date.now()-F,{mood:C.emotion,heat:C.intensity,imageId:x.imageId||void 0,snap:x.snap&&Y?!0:void 0,links:(U=x.links)!=null&&U.length?x.links:void 0,attachments:(R=x.attachments)!=null&&R.length?x.attachments:void 0,actions:(q=x.actions)!=null&&q.length?x.actions:void 0},{replyTo:x.replyTo??void 0})}catch(L){if((he=this.status)!=null&&he.configured||(ue=this.status)!=null&&ue.modelBackend)try{this.status=await m.chatStatus()}catch{}return this.typingPhase="idle",this.say(!((ge=this.status)!=null&&ge.enabled)&&((me=this.status)!=null&&me.message)?this.status.message:L.message,!0),!1}finally{this.busy=!1,this.typingPhase="idle"}}async regenerate(e=""){const t=this.activeConversation;if(!t||this.busy)return;const a=t.messages;let s=a.length;for(;s>0&&a[s-1].role==="assistant";)s--;if(s===a.length){this.say("There is no reply to redo yet.",!0);return}const o=t.id,i=s>0?a[s-1].content:"";t.messages=a.slice(0,s),t.updatedAt=Date.now(),this.touchWorkspace(),this.scrollToEnd();const r=s>0?a[s-1]:void 0;await this.generateReply(o,i,{continuation:s===0,nudge:e,sharedMediaIds:(r==null?void 0:r.role)==="user"?(r.attachments??[]).map(l=>l.id):[]})}async regenerateWithNote(){var t;const e=(t=prompt("Ask her to try again — what should be different?",""))==null?void 0:t.trim();e!==void 0&&await this.regenerate(e?e.endsWith(".")?e:e+".":"")}async retryFrom(e){const t=this.activeConversation;if(!t||this.busy||e.role!=="user")return;const a=t.messages.indexOf(e);if(a<0)return;const s=t.id;t.messages=t.messages.slice(0,a+1),t.updatedAt=Date.now(),this.touchWorkspace(),this.scrollToEnd(),await this.generateReply(s,e.content,{sharedMediaIds:(e.attachments??[]).map(o=>o.id)})}toggleAutopilot(){var e;this.autopilot=!this.autopilot,this.autoPaused=!1,this.autoTurns=Q;try{localStorage.setItem(Ae,this.autopilot?"1":"0")}catch{}this.autopilot&&!((e=this.status)!=null&&e.enabled)&&this.say("Autopilot needs a connected model — it stays off until one is loaded.",!0),this.scheduleAuto()}pauseAutopilot(e){this.autoPaused=e,e?window.clearTimeout(this.autoTimer):(this.autoTurns=Math.max(this.autoTurns,1),this.scheduleAuto())}refillAutopilot(){this.autoTurns=Q,this.pauseAutopilot(!1)}get autoRunning(){var e;return this.autopilot&&!this.autoPaused&&!!((e=this.status)!=null&&e.enabled)&&this.autoTurns>0}scheduleAuto(){window.clearTimeout(this.autoTimer),this.autoRunning&&(this.autoTimer=window.setTimeout(()=>void this.autoTick(),jt))}async autoTick(){if(this.busy||document.visibilityState!=="visible"){this.scheduleAuto();return}const e=this.activeConversation;if(!e||!this.autoRunning)return;this.autoTurns--,await this.generateReply(e.id,"",{continuation:!0})?this.scheduleAuto():this.autoPaused=!0}editMessage(e){var s;const t=(s=prompt("Edit message",e.content))==null?void 0:s.trim();if(!t||t===e.content)return;e.content=t;const a=this.activeConversation;a&&(a.updatedAt=Date.now()),this.touchWorkspace()}deleteMessage(e){const t=this.activeConversation;t&&(t.messages=t.messages.filter(a=>a.id!==e),t.updatedAt=Date.now(),this.touchWorkspace())}updateCharacter(e,t){const a=this.activeCharacter;a&&(a[e]=t,this.touchWorkspace())}addCharacter(){const e={id:_(),name:"New friend",promptWeight:1,defaultMode:"sweet",firstMessage:"Hey! It's nice to meet you."};this.workspace.characters.push(e),this.characterID=e.id,this.touchWorkspace(),this.newConversation(!1),this.settingsOpen=!0,this.editorTab="character"}deleteCharacter(){var a;const e=this.activeCharacter;if(!e||e.builtIn||!confirm(`Remove ${e.name} and all of their conversations?`))return;this.workspace.characters=this.workspace.characters.filter(s=>s.id!==e.id),this.workspace.conversations=this.workspace.conversations.filter(s=>s.characterId!==e.id),this.characterID=((a=this.workspace.characters[0])==null?void 0:a.id)??"libby";const t=this.conversationsFor()[0];t?this.conversationID=t.id:this.newConversation(!1),this.touchWorkspace()}async importCard(e){const t=e.target,a=Array.from(t.files??[]);a.length&&await this.ingestCards(a),t.value=""}async ingestCards(e){const t=[],a=[],s=[];for(const i of e)try{const r=await Mt(i),l=i.name.toLowerCase().endsWith(".png")||i.type==="image/png";if(!r){if(!l&&!i.type.startsWith("image/")){s.push(`${i.name}: no character card inside`);continue}s.push(`${i.name}: no card data in that image — add a friend first, then set their picture`);continue}if(this.workspace.characters.length>=40){s.push(`${i.name}: workspace is full`);break}const u={...r.character,id:_()};if(this.workspace.characters.push(u),this.characterID=u.id,t.push(u.name),r.leftovers.alternateGreetings>0&&a.push(`${u.name}: kept ${r.leftovers.alternateGreetings} alternate greeting${r.leftovers.alternateGreetings===1?"":"s"}`),r.leftovers.characterBook&&a.push(`${u.name}: the card's lorebook was dropped — this app has nowhere to put one`),l){await this.saveWorkspace();try{const c=await m.uploadChatImage({characterId:u.id,name:`${u.name} avatar`,imageData:await this.readDataURL(i),tags:["portrait"]});this.workspace.images.push(c);const v=this.liveCharacter(u.id);v&&(v.avatarImageId=c.id)}catch(c){a.push(`${u.name}: card imported, but the portrait didn't upload (${c.message})`)}}}catch(r){s.push(`${i.name}: ${r.message}`)}t.length&&(this.touchWorkspace(),this.newConversation(!1));const o=[t.length?`Imported ${t.join(", ")}.`:"",...a,...s.map(i=>`Couldn't import ${i}.`)].filter(Boolean).join(" ");this.cardNote=o?{text:o,bad:!t.length}:null,o&&this.say(o,!t.length)}readDataURL(e){return new Promise((t,a)=>{const s=new FileReader;s.onload=()=>t(String(s.result)),s.onerror=()=>a(s.error),s.readAsDataURL(e)})}async uploadImage(e){var s;const t=(s=e.target.files)==null?void 0:s[0],a=this.activeCharacter;if(!(!t||!a))try{this.say("Scanning image locally…");const o=this.imageTags.split(",").map(l=>l.trim()).filter(Boolean),i=await m.uploadChatImage({characterId:a.id,name:t.name,imageData:await this.readDataURL(t),tags:o,subject:this.imageSubject||void 0});this.workspace.images.push(i);const r=this.liveCharacter(a.id);r&&!r.avatarImageId&&(r.avatarImageId=i.id),this.imageTags="",this.touchWorkspace(),this.say(`Image scanned: ${i.tags.join(", ")||"no content tags found"}.`)}catch(o){this.say(o.message,!0)}finally{e.target.value=""}}async uploadProfilePicture(e){var s;const t=(s=e.target.files)==null?void 0:s[0];if(!t)return;const a=this.workspace.profile.avatarImageId;try{this.say("Uploading profile picture…");const o=await m.uploadChatImage({characterId:rt,name:t.name,imageData:await this.readDataURL(t),tags:[]});this.workspace.images.push(o),this.editProfile({avatarImageId:o.id}),await this.saveWorkspace(),a&&await this.discardProfileImage(a),this.say("Profile picture updated.")}catch(o){this.say(o.message,!0)}finally{e.target.value=""}}async removeProfilePicture(){const e=this.workspace.profile.avatarImageId;e&&(this.editProfile({avatarImageId:""}),await this.saveWorkspace(),await this.discardProfileImage(e),this.say("Profile picture removed."))}async uploadCharacterPicture(e){var i;const t=(i=e.target.files)==null?void 0:i[0],a=this.activeCharacter;if(!t||!a)return;const s=a.id,o=a.avatarImageId;try{this.say("Uploading picture…");const r=await m.uploadChatImage({characterId:_e(s),name:`${a.name} avatar`,imageData:await this.readDataURL(t),tags:[]});this.workspace.images.push(r);const l=this.liveCharacter(s);l&&(l.avatarImageId=r.id),this.touchWorkspace(),await this.saveWorkspace(),o&&this.isAvatarUpload(o,s)&&await this.discardProfileImage(o),this.say("Picture updated.")}catch(r){this.say(r.message,!0)}finally{e.target.value=""}}async removeCharacterPicture(){const e=this.activeCharacter,t=e==null?void 0:e.avatarImageId;if(!e||!t)return;const a=e.id;e.avatarImageId="",this.touchWorkspace(),await this.saveWorkspace(),this.isAvatarUpload(t,a)&&await this.discardProfileImage(t),this.say("Picture removed.")}isAvatarUpload(e,t){var a;return((a=this.workspace.images.find(s=>s.id===e))==null?void 0:a.characterId)===_e(t)}async discardProfileImage(e){try{await m.deleteChatImage(e),this.workspace.images=this.workspace.images.filter(t=>t.id!==e),this.touchWorkspace()}catch{}}async deleteImage(e){if(confirm(`Delete ${e.name}?`))try{await m.deleteChatImage(e.id),this.workspace.images=this.workspace.images.filter(a=>a.id!==e.id);const t=this.activeCharacter;(t==null?void 0:t.avatarImageId)===e.id&&(t.avatarImageId=""),this.touchWorkspace()}catch(t){this.say(t.message,!0)}}avatar(e,t){return e.avatarImageId?n`<span class=${t}><img src=${m.chatImageURL(e.avatarImageId)} alt="" /></span>`:e.id==="libby"&&!X()?n`<span class=${t}><img src=${lt} alt="Libby" /></span>`:n`<span class="${t} initial">${e.name.slice(0,2).toUpperCase()}</span>`}profileAvatar(e,t){const a=this.workspace.profile.avatarImageId;return a?n`<span class=${t}><img src=${m.chatImageURL(a)} alt="" /></span>`:n`<span class="${t} initial">${e.slice(0,2).toUpperCase()}</span>`}spriteFor(e,t,a,s){return e.id==="libby"?dt(t,a,ae(),s):[]}startCall(){const e=this.activeCharacter;if(e){if(!this.spriteFor(e,"neutral",1).length){this.say(`${e.name} has no picture to show — set one on their character card first.`,!0);return}this.stopRinging(),this.callOpen=!0,this.callSeconds=0,this.settingsOpen=!1,this.scenePickerOpen=!1,window.clearInterval(this.callTimer),this.callTimer=window.setInterval(()=>this.callSeconds+=1,1e3),this.loadBackgrounds(),this.focusComposer()}}endCall(){Se(),this.callOpen=!1,this.scenePickerOpen=!1,window.clearInterval(this.callTimer),this.focusComposer()}ring(){var e;if(!(this.callOpen||X())){this.incomingCall=!0,window.clearTimeout(this.ringTimer),this.ringTimer=window.setTimeout(()=>this.declineCall(!0),qt);try{(e=navigator.vibrate)==null||e.call(navigator,[220,120,220])}catch{}}}stopRinging(){this.incomingCall=!1,window.clearTimeout(this.ringTimer)}acceptCall(){this.stopRinging(),this.startCall()}declineCall(e=!1){var t;this.incomingCall&&(this.stopRinging(),e&&this.say("Missed a call from "+(((t=this.activeCharacter)==null?void 0:t.name)??"her")+"."))}async loadBackgrounds(){try{const e=await m.libbyBackgrounds();this.backgrounds=e.backgrounds,this.defaultBackground=e.default??""}catch{this.backgrounds=[]}}setBackground(e){const t=this.activeConversation;t&&(t.background=e,t.updatedAt=Date.now(),this.touchWorkspace(),this.scenePickerOpen=!1)}toggleScenePicker(){this.scenePickerOpen=!this.scenePickerOpen,this.scenePickerOpen&&this.loadBackgrounds()}renderCall(e,t){if(!this.callOpen)return d;const a=this.poseOf(e,t);if(!a)return d;const{emotion:s,intensity:o,typing:i,activity:r,assets:l}=a,u=this.backgrounds.find(b=>b.id===(t.background||this.defaultBackground)&&b.hasImage),c=t.messages.filter(b=>!b.thought).slice(-3),v=`${Math.floor(this.callSeconds/60)}:${String(this.callSeconds%60).padStart(2,"0")}`;return n`<div class="call" role="dialog" aria-modal="true" aria-label=${`Video call with ${e.name}`}>
      <div class="call-scene" @click=${()=>{this.scenePickerOpen&&(this.scenePickerOpen=!1)}}>
        <div class="call-bg ${u?"":"plain"}" style=${u?`background-image:url("${m.libbyBackgroundURL(u.id)}")`:""}></div>
        ...
        <div class="call-top">
          <span class="call-who">${this.avatar(e,"avatar")}<span><strong>${e.name}</strong><span><i class="call-live"></i>${i?"typing…":this.busy?"thinking…":v}</span></span></span>
          <span class="call-mood" title=${`Feeling ${s}`}>
            ...
            ${u?n`<span class="call-place" title="Where she is">${u.name}</span>`:d}
          </span>
        </div>
        ${this.callCaptions?n`<div class="call-captions" aria-live="polite">
          ${c.map((b,$)=>n`<p class="call-caption ${b.role==="user"?"mine":""} ${$<c.length-1?"older":""}">${We(b.content,b.links,f=>B(this,f))}</p>`)}
      ...
      <div class="call-scenes">
        ...
        ${t.map(a=>n`<button class="call-scene-btn ${(e.background||this.defaultBackground)===a.id?"on":""}" title=${a.tags.join(", ")||a.name} @click=${()=>this.setBackground(a.id)}>
          <img src=${m.libbyBackgroundURL(a.id)} alt="" loading="lazy"/><span class="scene-name">${a.name}${a.id===this.defaultBackground?" · default":""}</span>
        </button>`)}
      </div>
    ...
    </div>`}poseOf(e,t){if(e.id==="libby"&&X())return null;const a=N(t.emotion),s=we(t.intensity),o=this.busy&&this.typingPhase==="typing",i=t.activity||(o?"typing":""),r=this.spriteFor(e,a,s,i);return r.length?{emotion:a,intensity:s,typing:o,activity:i,assets:r,key:`${a}-${s}-${i}-${this.spoken}`}:null}renderHero(e,t){var c;const a=this.poseOf(e,t);if(!a)return d;const{emotion:s,typing:o,activity:i,assets:r,key:l}=a,u=this.busy?"Typing…":this.autoRunning?"Talking on their own":(c=this.status)!=null&&c.enabled?this.status.model:"Local replies";return n`<div class="hero" role="button" tabindex="0" aria-label=${`${e.name} — open the call`} title="Open the call"
      @click=${()=>this.startCall()} @keydown=${v=>{(v.key==="Enter"||v.key===" ")&&(v.preventDefault(),this.startCall())}}>
    ...
    </div>`}renderStage(e,t){var f,k;const a=this.poseOf(e,t);if(!a)return d;const{emotion:s,intensity:o,typing:i,activity:r,assets:l}=a,u=this.busy?"Typing…":this.autoRunning?"Talking on their own":(f=this.status)!=null&&f.enabled?this.status.model:"Local replies",c=this.backgrounds.find(w=>w.id===(t.background||this.defaultBackground)&&w.hasImage),v=i?void 0:[...t.messages].reverse().find(w=>w.role==="assistant"&&!w.thought&&w.content.trim()),b=v?ne(Pt(v.content),110):"",$=!!((k=this.status)!=null&&k.enabled);return n`<aside class="stage" aria-label="${e.name} portrait">
      ...
      <div class="stage-scene" @click=${()=>{this.scenePickerOpen&&(this.scenePickerOpen=!1)}}>
        <div class="stage-bg ${c?"room":"plain"}" style=${c?`background-image:url("${m.libbyBackgroundURL(c.id)}")`:""}></div>
        ...
        <div class="stage-tools">
          ...
          <button class="icon-btn ${this.scenePickerOpen?"on":""}" title="Change where she is" aria-label="Change the background" @click=${w=>{w.stopPropagation(),this.toggleScenePicker()}}><span class="material-symbols-rounded">wallpaper</span></button>`:d}
        ...
        <div class="stage-glass">
          ...
          <div class="stage-chips">
            <span class="stage-chip" title="How she feels"><span class="material-symbols-rounded">mood</span>${ke[s]??s}</span>
            ...
            ${c?n`<span class="stage-chip" title="Where she is"><span class="material-symbols-rounded">location_on</span>${c.name}</span>`:d}
          </div>
          ${e.id==="libby"?n`<div class="stage-heat h${o}" title=${`Heat ${o} of 5`}>
            <span>Heat</span><span class="segs">${[1,2,3,4,5].map(w=>n`<i class=${w<=o?"on":""}></i>`)}</span>
          </div>`:d}
        </div>
      </div>
      ...
      ${this.pickerOpen?this.renderFriends():n`
        ...
        <button class="chat-row" @click=${()=>this.activateConversation(s.id)} aria-current=${s.id===this.conversationID?"page":"false"}>
          ...
          <span class="chat-time">${Gt(s.updatedAt)}</span>
          <span class="chat-preview">${i?n`${i.role==="user"?"You: ":""}${i.imageId&&!i.content.trim()?n`<span class="material-symbols-rounded">photo_camera</span>Photo`:Ie(i.content)}`:n`<em>${(l=o.firstMessage)!=null&&l.trim()?"Say hello":"No messages yet"}</em>`}</span>
        </button>
    ...
    </section>`}field(e,t,a,s=1){return n`<label>${e}${s>1?n`<textarea class="field" rows=${s} .value=${a} @change=${o=>this.updateCharacter(t,o.target.value)}></textarea>`:n`<input class="field" .value=${a} @change=${o=>this.updateCharacter(t,o.target.value)} />`}</label>`}renderCharacterPanel(e){const t=e.id==="libby"&&!X();return n`<div class="panel">
      <section class="group">
      ...
      <div class="grid">${this.field("Name","name",e.name)}${e.id==="libby"?d:n`<label>Default mode<select .value=${e.defaultMode} @change=${a=>this.updateCharacter("defaultMode",a.target.value)}>${E.map(a=>n`<option value=${a.id}>${a.label}</option>`)}</select></label>`}</div>
    ...
    </div>`}async loadModel(){var a,s;const e=this.modelChoice||((a=this.models)==null?void 0:a.models[0]);if(!e||this.modelBusy)return;let t;try{t=this.composeLoadArgs()}catch{this.say("Extra loader arguments and settings must be valid JSON.",!0);return}this.modelBusy=!0,this.say(`Loading ${e}… this can take a few minutes.`);try{await m.loadChatModel(e,t.args,t.settings,!0),await this.refreshModels(!0),this.say(`Loaded ${((s=this.models)==null?void 0:s.loaded)||e}.`)}catch(o){this.say(o.message,!0)}finally{this.modelBusy=!1}}async unloadModel(){if(!(this.modelBusy||!confirm("Unload the current model? Chat stops working until a model is loaded again."))){this.modelBusy=!0,this.say("Unloading…");try{await m.unloadChatModel(),await this.refreshModels(!0),this.say("Model unloaded.")}catch(e){this.say(e.message,!0)}finally{this.modelBusy=!1}}}renderModelControls(){var a,s,o,i,r;const e=((a=this.models)==null?void 0:a.models)??[],t=((s=this.models)==null?void 0:s.loaded)||((o=this.status)==null?void 0:o.model)||"";return n`<label>Text-generation backend
      <div class="model-row">
    ...
    ${((r=this.models)==null?void 0:r.supported)===!1?n`<div class="empty">This backend serves an OpenAI-compatible API but does not expose model load/unload. Manage the model where it runs.</div>`:n`
      ...
      <div class="grid loader-grid">
        <label>Loader<select class="field" .value=${e} ?disabled=${this.modelBusy}
          @change=${s=>this.setLoadArg(Kt,s.target.value)}>
      ...
      <div class="lora-list">${e.available.map(i=>n`<label class="inline-check"><input type="checkbox" .checked=${a.has(i)} ?disabled=${this.modelBusy}
        @change=${r=>{const l=r.target.checked;this.loraPicks=l?[...new Set([...this.loraPicks,i])]:this.loraPicks.filter(u=>u!==i)}}/>${i}${t.has(i)?n`<span class="hint">applied</span>`:d}</label>`)}</div>
    </label>
    <div class="panel-actions">
    ...
    `}async inspectModel(){var t;const e=this.modelChoice||((t=this.models)==null?void 0:t.models[0]);if(e){this.deleteError="",this.deleteConfirm="",this.deletePermanent=!1;try{this.deleteTarget=await m.inspectChatModel(e)}catch(a){this.deleteError=a.message}}}async confirmDeleteModel(){const e=this.deleteTarget;if(!(!e||this.modelBusy)){this.modelBusy=!0,this.deleteError="";try{const t=await m.deleteChatModel(e.name,this.deleteConfirm.trim(),this.deletePermanent);this.models&&(this.models={...this.models,models:t.models}),this.modelChoice="",this.deleteTarget=null,this.deleteConfirm="",this.say(t.movedTo?`${t.name} moved to the trash — ${V(t.bytes)} recoverable at ${t.movedTo}.`:`${t.name} deleted permanently — ${V(t.bytes)} freed.`)}catch(t){this.deleteError=t.message}finally{this.modelBusy=!1}}}async copySampling(){var t;const e=(t=this.lastSampling)==null?void 0:t.summary;if(e)try{await navigator.clipboard.writeText(e),this.say("Generation settings copied.")}catch{this.say(e,!0)}}saveOptionsGlobally(e){this.workspace.defaults={...e.options??le()},this.touchWorkspace(),this.saveWorkspace(),this.say("Saved as the default for new conversations.")}renderModelPanel(e,t){var i,r,l,u,c,v,b,$;const a=(f,k)=>{var w;return Re((w=this.lastSampling)==null?void 0:w.values,f,k)},s=(f,k,w,S,y,T)=>{var R;const O=Re(e.options,k,a(k,T)),U=((R=e.options)==null?void 0:R[k])!=null;return n`<label>${f}${U?d:n`<span class="hint">auto</span>`}<span class="range"><input type="range" min=${w} max=${S} step=${y} .value=${String(O)} @input=${q=>this.updateOption(k,Number(q.target.value))}/><output>${O}</output></span></label>`},o=!!this.workspace.defaults;return n`<div class="panel">
      <section class="group">
        <h3>Backend</h3>
      ...
      <section class="group">
        ...
        ${(i=this.status)!=null&&i.modelManagement?n`<details class="samplers">
          ...
          <div class="grid">
            ${["dynamic_temperature","temperature_last","do_sample","ban_eos_token","add_bos_token","skip_special_tokens","auto_max_new_tokens"].map(f=>{var k,w,S;return n`<label class="inline-check">
              <input type="checkbox" .checked=${((k=e.options)==null?void 0:k[f])===!0} .indeterminate=${((w=e.options)==null?void 0:w[f])==null}
                @change=${y=>this.updateOptionValue(f,y.target.checked)}/>${f.replace(/_/g," ")}${((S=e.options)==null?void 0:S[f])==null?n`<span class="hint">auto</span>`:d}</label>`})}
          </div>
          <label>Grammar (GBNF)<textarea class="field" rows="2" .value=${String(((r=e.options)==null?void 0:r.grammar_string)??"")} @change=${f=>this.updateOptionValue("grammar_string",f.target.value||void 0)}></textarea></label>
...
`):""} @change=${f=>{const k=f.target.value.split(`
`).map(w=>w.trim()).filter(Boolean);this.updateOptionValue("stop",k.length?k:void 0)}}></textarea></label>
          <div class="panel-actions">
            ...
            ${this.cardTokens?n`<span class="empty">Card: ${this.cardTokens.tokens.toLocaleString()} tokens${this.cardTokens.exact?"":" (estimated)"}${(c=this.status)!=null&&c.contextLimit?` of ${this.status.contextLimit.toLocaleString()}`:""}</span>`:d}
          </div>
        </details>`:d}
        ${this.lastSampling?n`<div class="sampling">
          <span>Last reply sampled as <strong>${this.lastSampling.task}</strong>${(v=this.lastSampling.overridden)!=null&&v.length?n` — you overrode ${this.lastSampling.overridden.join(", ")}`:d}</span>
        ...
        ${(b=this.lastPhoto)!=null&&b.source?n`<div class="sampling">
          <span>Last picture chosen <strong>${Qt(this.lastPhoto.source)}</strong> — fit ${this.lastPhoto.fit} of ${this.lastPhoto.candidates} candidate${this.lastPhoto.candidates===1?"":"s"}${($=this.lastPhoto.tags)!=null&&$.length?n`; it shows ${this.lastPhoto.tags.slice(0,6).join(", ")}`:d}</span>
        </div>`:d}
        <details>
          <summary>Advanced API options</summary>
          <textarea class="field" rows="5" .value=${JSON.stringify(e.options??{},null,2)} @change=${f=>{try{const k=JSON.parse(f.target.value);this.updateConversation({options:k})}catch{this.say("Advanced options must be valid JSON.",!0)}}}></textarea>
        </details>
        <div class="panel-actions">
      ...
      ${t.id==="libby"?n`<section class="group">
        ...
        <div class="grid">
          <label>Conversation mode<select .value=${e.mode} @change=${f=>this.updateConversation({mode:f.target.value})}>${E.map(f=>n`<option value=${f.id}>${f.label}</option>`)}</select></label>
          <label>Displayed emotion<select .value=${e.emotion} @change=${f=>this.updateConversation({emotion:f.target.value})}>${ct.map(f=>n`<option value=${f}>${ke[f]}</option>`)}</select></label>
        </div>
        <label>Intensity <span class="range"><input type="range" min="1" max="5" step="1" .value=${String(e.intensity)} @input=${f=>this.updateConversation({intensity:Number(f.target.value)})}/><output>${e.intensity}/5</output></span></label>
      </section>`}
      ...
      <img src=${m.chatImageURL(t.id)} alt=${t.name}/>
      ...
      ${a.length?n`<div class="weight-rows">${a.map(i=>n`<div class="weight-row">
        ...
        <select aria-label=${`Weight for ${i}`} @change=${r=>this.setTagWeight(i,Number(r.target.value))}>
          ${ce.map(r=>n`<option value=${String(r.value)} ?selected=${Ht(t[i])===r.value}>${r.label}</option>`)}
        </select>
      ...
      <div class="pfp-row">
        <span class="pfp">${e.avatarImageId?n`<img src=${m.chatImageURL(e.avatarImageId)} alt="Your profile picture"/>`:n`<span class="pfp-initial">${t.slice(0,2).toUpperCase()}</span>`}</span>
        <div class="pfp-actions">
      ...
      <p class="empty">She'll start a conversation on her own now and then. These are the limits on that: she stops after ${Xt} unanswered messages, waits out your quiet hours, and never replies to herself.</p>
      ...
      ${e.log.length?n`
        <details>
          ...
          <ul class="mem-list">${[...e.log].reverse().map(s=>n`
            ...
            </span><span class="empty">${Le(s.at)}</span></li>`)}</ul>
        </details>`:d}
      ...
      ${this.bond===null&&this.bondLoading?n`<p class="empty">Loading…</p>`:t?n`<ul class="mem-list">
              <li><span>Last talked ${Le(e.lastSeenAt)}</span></li>
              ${e.mood?n`<li><span>She left off feeling ${e.mood}</span></li>`:d}
              <li><span>${At(e.warmth)}</span></li>
      ...
      ${e.length>0?n`<div class="panel-actions"><button class="danger" @click=${()=>void this.clearMemories()}>Clear all memories</button></div>`:d}
        ...
        <select class="field" .value=${e.kind??"user"}
          ...
          ${(this.memoryKinds.length?this.memoryKinds:[e.kind??"user"]).map(a=>n`<option value=${a} ?selected=${a===(e.kind??"user")}>${Me[a]??a}</option>`)}
        </select>
        <div class="panel-actions">
      ...
      <span>
        ${e.text}
        <span class="mem-tags">
          ${e.kind?n`<em class="mem-kind ${e.kind}">${Me[e.kind]??e.kind}</em>`:d}
    ...
    </div>`}async loadDiscord(){if(!this.discordLoading){this.discordLoading=!0;try{this.discord=await m.discord()}catch{this.discord=void 0}finally{this.discordLoading=!1}}}async connectDiscord(){const e=this.discordToken.trim();if(e)try{this.discord=await m.connectDiscord(e),this.discordToken="",this.say(`Connected to Discord as ${this.discord.botName}.`)}catch(t){this.discordToken="",this.say(t instanceof Error?t.message:"Couldn't connect to Discord.",!0)}}async disconnectDiscord(){try{const e=await m.disconnectDiscord();this.say(e.note),this.discordPlaces=null,await this.loadDiscord()}catch(e){this.say(e instanceof Error?e.message:"Couldn't disconnect.",!0)}}async saveDiscord(e){try{this.discord=await m.saveDiscordSettings(e)}catch(t){this.say(t instanceof Error?t.message:"Couldn't save that.",!0)}}async loadDiscordPlaces(){try{this.discordPlaces=(await m.discordPlaces()).servers}catch(e){this.say(e instanceof Error?e.message:"Couldn't ask Discord which servers it's in.",!0)}}setDiscordChannel(e,t,a,s){var u;const o=((u=this.discord)==null?void 0:u.channels)??[],i=o.find(c=>c.channelId===t),r={guildId:e.guildId,guildName:e.name,channelId:t,name:a,read:!1,write:!1,...i,...s},l=o.filter(c=>c.channelId!==t);this.saveDiscord({channels:r.read||r.write?[...l,r]:l})}addDiscordUser(){var t;const e=this.discordUserDraft.trim();if(!/^\d{5,24}$/.test(e)){this.say("That doesn't look like a Discord user id — turn on Developer Mode in Discord and copy the id.",!0);return}this.discordUserDraft="",this.saveDiscord({users:[...new Set([...((t=this.discord)==null?void 0:t.users)??[],e])]})}renderDiscordPanel(){this.discord===void 0&&!this.discordLoading&&this.loadDiscord();const e=this.discord;return n`<div class="mem-panel">
    ...
    </div>`}async loadIdentity(){if(!this.identityLoading){this.identityLoading=!0;try{this.identity=await m.libbyIdentity()}catch{this.identity=void 0}finally{this.identityLoading=!1}}}async saveIdentity(e){try{this.identity=await m.saveLibbyIdentity(e)}catch(t){this.say(t instanceof Error?t.message:"Couldn't save that.",!0)}}async markIdentity(e,t,a=!1){try{this.identity=await m.markLibbyIdentity({mediaId:e,isLibby:t,reference:a}),this.say(t?"Kept as her, without being a reference.":"Noted — that one isn't her.")}catch(s){this.say(s instanceof Error?s.message:"Couldn't save that.",!0)}}async scanForHerself(){this.say("Looking through the library…");try{const e=await m.scanLibbyIdentity();this.say(e.tagged>0?`Found ${e.tagged} more picture${e.tagged===1?"":"s"} of her in ${e.checked}.`:`Checked ${e.checked} items and found nothing new.`),await this.loadIdentity()}catch(e){this.say(e instanceof Error?e.message:"The sweep failed.",!0)}}renderIdentityPanel(){this.identity===void 0&&!this.identityLoading&&this.loadIdentity();const e=this.identity;return n`<div class="mem-panel">
      ...
      <div>${e.content}</div>
    </div>`}sameRun(e,t){return!!e&&!!t&&!e.thought&&!t.thought&&e.role===t.role&&Math.abs(t.at-e.at)<5*6e4}renderEntry(e,t,a){var k,w,S;const s=this.activeCharacter,o=this.activeConversation;if(!s||!o)return d;const i=!t||ee(t.at)!==ee(e.at)?n`<div class="day">${ee(e.at)}</div>`:d;if(e.thought)return n`${i}${this.renderThought(e,s)}`;const r=!this.sameRun(t,e)||i!==d,l=!this.sameRun(e,a),u=e.role==="assistant",c=u?s.name:this.workspace.profile.displayName||((k=this.user)==null?void 0:k.username)||"You",v=l?this.receiptFor(e,o):"",b=e.reactions??[],$=this.reactionPicker===e.id,f=(w=b.find(y=>y.by==="user"))==null?void 0:w.emoji;return n`${i}<article class="msg ${u?"theirs":"mine"} ${r?"first":""} ${l?"last":""}" data-message-id=${e.id}
      @contextmenu=${y=>this.messageMenu(e,y)}
      @pointerdown=${y=>this.swipeStart(e,y)}
      @pointermove=${y=>this.swipeMove(y)}
      @pointerup=${()=>this.swipeEnd(e)} @pointercancel=${()=>this.swipeEnd(e)}>
      ${u?this.avatar(s,"avatar"):d}
      <div class="bubble-wrap">
        <span class="swipe-hint material-symbols-rounded" aria-hidden="true">reply</span>
        ${$?n`<div class="react-row" role="menu" aria-label="React">${Ft.map(y=>n`<button type="button" class=${f===y?"on":""} @click=${()=>this.react(e,y)}>${y}</button>`)}<button type="button" class="close" title="Close" aria-label="Close" @click=${()=>this.reactionPicker=null}><span class="material-symbols-rounded" style="font-size:16px">close</span></button></div>`:d}
    ...
    </button>`}renderSnapViewer(){var a;const e=this.snapOpen;if(!e)return d;const t=e.imageId?m.chatImageURL(e.imageId):(a=e.attachments)!=null&&a[0]?m.streamURL(e.attachments[0].id):"";return n`<div class="snap-viewer" role="dialog" aria-modal="true" aria-label="Snap" @click=${()=>this.closeSnap()}>
      ...
      </section></div>`}}renderClient(){var u,c,v;const e=this.activeCharacter,t=this.activeConversation;if(this.loading)return n`<div class="client"><section class="main" style="grid-column:1/-1;place-items:center;display:grid"><md-circular-progress indeterminate></md-circular-progress></section></div>`;if(!e||!t)return n`<div class="client"><section class="main" style="grid-column:1/-1;padding:24px">Chat workspace is unavailable.</section></div>`;const a=E.find(b=>b.id===t.mode)??E[0],s=this.stageOpen?this.renderStage(e,t):d,o=!!((u=this.status)!=null&&u.enabled),i=o?this.status.model:e.id==="libby"?"Local replies":"Model offline",r=t.messages,l=this.stageOpen?this.renderHero(e,t):d;return n`<div class="client ${this.mobileNavOpen?"nav-open":""} ${s!==d?"with-stage":""} ${this.callOpen?"in-call":""}" style=${this.stageWidth?`--stage-w:${this.stageWidth}px`:""} @pointerdown=${this.armIdle} @contextmenu=${this.chatMenu}>${this.renderSidebar()}
      <main class="main"><header class="top">
        ...
        ${e.id==="libby"?d:n`<select class="quick-mode" aria-label="Conversation mode" title="Conversation mode" .value=${t.mode} @change=${b=>this.updateConversation({mode:b.target.value})}>${E.map(b=>n`<option value=${b.id}>${b.label}</option>`)}</select>`}
        ...
        ${(c=this.status)!=null&&c.modelBackend&&!this.status.enabled?n`<div class="backend-state" role="status"><strong>Text generation offline.</strong> ${this.status.message||"Load a model in text-generation-webui, then refresh status."}</div>`:d}
        ${l}
        ...
        <form class="composer-form" @submit=${b=>{b.preventDefault(),this.send()}}>
          ${this.pendingPhoto?n`<div class="attachment"><img src=${m.chatImageURL(this.pendingPhoto.imageId)} alt=${`Attached photo: ${this.pendingPhoto.name}`}/>
          ...
          ${this.pendingItems.length?n`<div class="items-preview">${this.pendingItems.map(b=>n`<span class="item-chip">
            ${b.hasThumb?n`<img src=${m.thumbURL(b.id)} alt=""/>`:n`<span class="chip-icon"><span class="material-symbols-rounded">${$e[b.kind]??"folder"}</span></span>`}
          ...
          <div class="composer">
            ...
            ${this.busy&&((v=this.status)!=null&&v.modelManagement)?n`<button class="send stop" type="button" title="Stop the reply" aria-label="Stop the reply" @click=${()=>void this.stopGeneration()}><span class="material-symbols-rounded">stop</span></button>`:d}
      ...
      <div class="picker-card" role="dialog" aria-modal="true" aria-label="Attach from the library" @click=${a=>a.stopPropagation()}>
        ...
        <div class="picker-grid">
          ...
          ${e.items.map(a=>n`<button type="button" class="picker-tile ${t.has(a.id)?"on":""}" title=${a.title} @click=${()=>this.toggleItem(a)}>
            ${a.hasThumb||a.kind==="image"||a.kind==="gif"?n`<img src=${m.thumbURL(a.id)} alt="" loading="lazy"/>`:n`<span class="tile-kind material-symbols-rounded">${$e[a.kind]??"folder"}</span>`}
    ...
    </div>`:d}};p.styles=[mt,bt,ft,yt,vt,xt,wt`
  ...
  `];h([kt({attribute:!1})],p.prototype,"user",2);h([g()],p.prototype,"status",2);h([g()],p.prototype,"workspace",2);h([g()],p.prototype,"characterID",2);h([g()],p.prototype,"conversationID",2);h([g()],p.prototype,"draft",2);h([g()],p.prototype,"busy",2);h([g()],p.prototype,"loading",2);h([g()],p.prototype,"workspaceLoaded",2);h([g()],p.prototype,"loadError",2);h([g()],p.prototype,"settingsOpen",2);h([g()],p.prototype,"speakOn",2);h([g()],p.prototype,"editorTab",2);h([g()],p.prototype,"outfits",2);h([g()],p.prototype,"activities",2);h([g()],p.prototype,"notice",2);h([g()],p.prototype,"noticeError",2);h([g()],p.prototype,"imageTags",2);h([g()],p.prototype,"memories",2);h([g()],p.prototype,"memoryKinds",2);h([g()],p.prototype,"memoryLimit",2);h([g()],p.prototype,"memoryDraft",2);h([g()],p.prototype,"editingMemory",2);h([g()],p.prototype,"memoryDraftEdit",2);h([g()],p.prototype,"memoryKindEdit",2);h([g()],p.prototype,"autoState",2);h([g()],p.prototype,"wants",2);h([g()],p.prototype,"identity",2);h([g()],p.prototype,"pendingLink",2);h([g()],p.prototype,"discord",2);h([g()],p.prototype,"discordPlaces",2);h([g()],p.prototype,"discordToken",2);h([g()],p.prototype,"discordUserDraft",2);h([g()],p.prototype,"bond",2);h([g()],p.prototype,"models",2);h([g()],p.prototype,"modelChoice",2);h([g()],p.prototype,"modelBusy",2);h([g()],p.prototype,"backend",2);h([g()],p.prototype,"loadArgs",2);h([g()],p.prototype,"loadExtra",2);h([g()],p.prototype,"loadSettings",2);h([g()],p.prototype,"loraPicks",2);h([g()],p.prototype,"cardTokens",2);h([g()],p.prototype,"deleteTarget",2);h([g()],p.prototype,"deleteConfirm",2);h([g()],p.prototype,"deletePermanent",2);h([g()],p.prototype,"deleteError",2);h([g()],p.prototype,"mobileNavOpen",2);h([g()],p.prototype,"chatSearch",2);h([g()],p.prototype,"pickerOpen",2);h([g()],p.prototype,"captureTurns",2);h([g()],p.prototype,"cardDrop",2);h([g()],p.prototype,"cardNote",2);h([g()],p.prototype,"autopilot",2);h([g()],p.prototype,"autoPaused",2);h([g()],p.prototype,"autoTurns",2);h([g()],p.prototype,"stageOpen",2);h([g()],p.prototype,"stageWidth",2);h([g()],p.prototype,"stageDragging",2);h([g()],p.prototype,"pendingPhoto",2);h([g()],p.prototype,"typingPhase",2);h([g()],p.prototype,"callOpen",2);h([g()],p.prototype,"callSeconds",2);h([g()],p.prototype,"incomingCall",2);h([g()],p.prototype,"backgrounds",2);h([g()],p.prototype,"defaultBackground",2);h([g()],p.prototype,"scenePickerOpen",2);h([g()],p.prototype,"callCaptions",2);h([g()],p.prototype,"replyTarget",2);h([g()],p.prototype,"reactionPicker",2);h([g()],p.prototype,"snapOpen",2);h([g()],p.prototype,"weightTagDraft",2);h([g()],p.prototype,"pendingItems",2);h([g()],p.prototype,"picker",2);h([Ne(".log")],p.prototype,"log",2);h([Ne(".composer textarea")],p.prototype,"composer",2);h([g()],p.prototype,"lastSampling",2);h([g()],p.prototype,"lastPhoto",2);h([g()],p.prototype,"imageSubject",2);p=h([$t("oppai-chat")],p);function Qt(e){switch(e){case"ready":return"from your words, before she wrote";case"model":return"from the tags she wrote";case"rescue":return"as a rescue: she said she was sending one and nothing fitted";case"inferred":return"unprompted, because her words matched it";default:return e}}export{p as OppaiChat};
