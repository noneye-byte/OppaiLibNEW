import{q as w,i as $,N as k,u as n,a as S,e as h,O as I,A as o,b as a,t as z,B as C,P as F,M as q}from"./index-XPJwO1lq.js";import{e as T}from"./query-__j_ZMY6.js";function A(e,t,i,s){const r=t.cursor??"";if(s)return{items:y(t.items),cursor:r,error:""};if(r&&r===i)return{items:e,cursor:"",error:"This source returned the same page cursor twice, so paging was stopped."};const p=new Set(e.map(g=>g.id)),u=y(t.items).filter(g=>!p.has(g.id));return t.items.length>0&&u.length===0?{items:e,cursor:"",error:"This source repeated an earlier page, so paging was stopped."}:{items:[...e,...u],cursor:r,error:""}}function y(e){const t=new Set;return e.filter(i=>t.has(i.id)?!1:(t.add(i.id),!0))}var U=Object.defineProperty,L=Object.getOwnPropertyDescriptor,f=(e,t,i,s)=>{for(var r=s>1?void 0:s?L(t,i):t,p=e.length-1,u;p>=0;p--)(u=e[p])&&(r=(s?u(t,i,r):u(r))||r);return s&&r&&U(t,i,r),r};let m=class extends S{constructor(){super(...arguments),this.existingNames=[],this.url="",this.busy=!1,this.error="",this.proposal=null,this.yaml="",this.showYaml=!1,this.saving=!1,this.analyze=async e=>{e.preventDefault();const t=this.url.trim();if(t){this.busy=!0,this.error="",this.proposal=null;try{const i=await h.analyzeSource(t);this.proposal=i,this.yaml=i.yaml}catch(i){this.error=i.message}finally{this.busy=!1}}},this.save=async()=>{if(this.proposal){this.saving=!0,this.error="";try{const e=await h.saveSource(this.yaml);this.dispatchEvent(new CustomEvent("added",{detail:e,bubbles:!0,composed:!0}))}catch(e){this.error=e.message}finally{this.saving=!1}}},this.close=async()=>{await I(this.sheet),this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}}render(){return a`
