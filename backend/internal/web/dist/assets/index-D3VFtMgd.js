const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./settings-CLREZSYZ.js","./libby-backgrounds-DD5yG2qS.js","./passkeys-DMEvl7GK.js","./browse-DX3pzrvr.js","./query-__j_ZMY6.js","./imagegen-B_v6ZQPf.js","./chat-DQqnSfaQ.js","./scrape-dialog-DbQWv9vm.js","./shared-styles-CC0l2y1S.js","./login-DOtdzo3K.js"])))=>i.map(i=>d[i]);
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function f(e){return _({...e,state:!0,attribute:!1})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const pe=globalThis,_t=e=>e,Ae=pe.trustedTypes,At=Ae?Ae.createPolicy("lit-html",{createHTML:e=>e}):void 0,ni="$lit$",B=`lit$${Math.random().toFixed(9).slice(2)}$`,li="?"+B,so=`<${li}>`,K=document,he=()=>K.createComment(""),ue=e=>e===null||typeof e!="object"&&typeof e!="function",dt=Array.isArray,ro=e=>dt(e)||typeof(e==null?void 0:e[Symbol.iterator])=="function",Ye=`[ 	
\f\r]`,se=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Lt=/-->/g,Mt=/>/g,Y=RegExp(`>|${Ye}(?:([^\\s"'>=/]+)(${Ye}*=${Ye}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Pt=/'/g,Rt=/"/g,di=/^(?:script|style|textarea|title)$/i,no=e=>(t,...i)=>({_$litType$:e,strings:t,values:i}),l=no(1),V=Symbol.for("lit-noChange"),u=Symbol.for("lit-nothing"),Ut=new WeakMap,G=K.createTreeWalker(K,129);function ci(e,t){if(!dt(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return At!==void 0?At.createHTML(t):t}const lo=(e,t)=>{const i=e.length-1,o=[];let a,s=t===2?"<svg>":t===3?"<math>":"",r=se;for(let d=0;d<i;d++){const c=e[d];let p,h,m=-1,b=0;for(;b<c.length&&(r.lastIndex=b,h=r.exec(c),h!==null);)b=r.lastIndex,r===se?h[1]==="!--"?r=Lt:h[1]!==void 0?r=Mt:h[2]!==void 0?(di.test(h[2])&&(a=RegExp("</"+h[2],"g")),r=Y):h[3]!==void 0&&(r=Y):r===Y?h[0]===">"?(r=a??se,m=-1):h[1]===void 0?m=-2:(m=r.lastIndex-h[2].length,p=h[1],r=h[3]===void 0?Y:h[3]==='"'?Rt:Pt):r===Rt||r===Pt?r=Y:r===Lt||r===Mt?r=se:(r=Y,a=void 0);const x=r===Y&&e[d+1].startsWith("/>")?" ":"";s+=r===se?c+so:m>=0?(o.push(p),c.slice(0,m)+ni+c.slice(m)+B+x):c+B+(m===-2?d:x)}return[ci(e,s+(e[i]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),o]};class me{constructor({strings:t,_$litType$:i},o){let a;this.parts=[];let s=0,r=0;const d=t.length-1,c=this.parts,[p,h]=lo(t,i);if(this.el=me.createElement(p,o),G.currentNode=this.el.content,i===2||i===3){const m=this.el.content.firstChild;m.replaceWith(...m.childNodes)}for(;(a=G.nextNode())!==null&&c.length<d;){if(a.nodeType===1){if(a.hasAttributes())for(const m of a.getAttributeNames())if(m.endsWith(ni)){const b=h[r++],x=a.getAttribute(m).split(B),y=/([.?@])?(.*)/.exec(b);c.push({type:1,index:s,name:y[2],strings:x,ctor:y[1]==="."?po:y[1]==="?"?ho:y[1]==="@"?uo:Ne}),a.removeAttribute(m)}else m.startsWith(B)&&(c.push({type:6,index:s}),a.removeAttribute(m));if(di.test(a.tagName)){const m=a.textContent.split(B),b=m.length-1;if(b>0){a.textContent=Ae?Ae.emptyScript:"";for(let x=0;x<b;x++)a.append(m[x],he()),G.nextNode(),c.push({type:2,index:++s});a.append(m[b],he())}}}else if(a.nodeType===8)if(a.data===li)c.push({type:2,index:s});else{let m=-1;for(;(m=a.data.indexOf(B,m+1))!==-1;)c.push({type:7,index:s}),m+=B.length-1}s++}}static createElement(t,i){const o=K.createElement("template");return o.innerHTML=t,o}}function ie(e,t,i=e,o){var r,d;if(t===V)return t;let a=o!==void 0?(r=i._$Co)==null?void 0:r[o]:i._$Cl;const s=ue(t)?void 0:t._$litDirective$;return(a==null?void 0:a.constructor)!==s&&((d=a==null?void 0:a._$AO)==null||d.call(a,!1),s===void 0?a=void 0:(a=new s(e),a._$AT(e,i,o)),o!==void 0?(i._$Co??(i._$Co=[]))[o]=a:i._$Cl=a),a!==void 0&&(t=ie(e,a._$AS(e,t.values),a,o)),t}class co{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:i},parts:o}=this._$AD,a=((t==null?void 0:t.creationScope)??K).importNode(i,!0);G.currentNode=a;let s=G.nextNode(),r=0,d=0,c=o[0];for(;c!==void 0;){if(r===c.index){let p;c.type===2?p=new ke(s,s.nextSibling,this,t):c.type===1?p=new c.ctor(s,c.name,c.strings,this,t):c.type===6&&(p=new mo(s,this,t)),this._$AV.push(p),c=o[++d]}r!==(c==null?void 0:c.index)&&(s=G.nextNode(),r++)}return G.currentNode=K,a}p(t){let i=0;for(const o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(t,o,i),i+=o.strings.length-2):o._$AI(t[i])),i++}}class ke{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,i,o,a){this.type=2,this._$AH=u,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=o,this.options=a,this._$Cv=(a==null?void 0:a.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=ie(this,t,i),ue(t)?t===u||t==null||t===""?(this._$AH!==u&&this._$AR(),this._$AH=u):t!==this._$AH&&t!==V&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):ro(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==u&&ue(this._$AH)?this._$AA.nextSibling.data=t:this.T(K.createTextNode(t)),this._$AH=t}$(t){var s;const{values:i,_$litType$:o}=t,a=typeof o=="number"?this._$AC(t):(o.el===void 0&&(o.el=me.createElement(ci(o.h,o.h[0]),this.options)),o);if(((s=this._$AH)==null?void 0:s._$AD)===a)this._$AH.p(i);else{const r=new co(a,this),d=r.u(this.options);r.p(i),this.T(d),this._$AH=r}}_$AC(t){let i=Ut.get(t.strings);return i===void 0&&Ut.set(t.strings,i=new me(t)),i}k(t){dt(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let o,a=0;for(const s of t)a===i.length?i.push(o=new ke(this.O(he()),this.O(he()),this,this.options)):o=i[a],o._$AI(s),a++;a<i.length&&(this._$AR(o&&o._$AB.nextSibling,a),i.length=a)}_$AR(t=this._$AA.nextSibling,i){var o;for((o=this._$AP)==null?void 0:o.call(this,!1,!0,i);t!==this._$AB;){const a=_t(t).nextSibling;_t(t).remove(),t=a}}setConnected(t){var i;this._$AM===void 0&&(this._$Cv=t,(i=this._$AP)==null||i.call(this,t))}}class Ne{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,i,o,a,s){this.type=1,this._$AH=u,this._$AN=void 0,this.element=t,this.name=i,this._$AM=a,this.options=s,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=u}_$AI(t,i=this,o,a){const s=this.strings;let r=!1;if(s===void 0)t=ie(this,t,i,0),r=!ue(t)||t!==this._$AH&&t!==V,r&&(this._$AH=t);else{const d=t;let c,p;for(t=s[0],c=0;c<s.length-1;c++)p=ie(this,d[o+c],i,c),p===V&&(p=this._$AH[c]),r||(r=!ue(p)||p!==this._$AH[c]),p===u?t=u:t!==u&&(t+=(p??"")+s[c+1]),this._$AH[c]=p}r&&!a&&this.j(t)}j(t){t===u?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class po extends Ne{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===u?void 0:t}}class ho extends Ne{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==u)}}class uo extends Ne{constructor(t,i,o,a,s){super(t,i,o,a,s),this.type=5}_$AI(t,i=this){if((t=ie(this,t,i,0)??u)===V)return;const o=this._$AH,a=t===u&&o!==u||t.capture!==o.capture||t.once!==o.once||t.passive!==o.passive,s=t!==u&&(o===u||a);a&&this.element.removeEventListener(this.name,this,o),s&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var i;typeof this._$AH=="function"?this._$AH.call(((i=this.options)==null?void 0:i.host)??this.element,t):this._$AH.handleEvent(t)}}class mo{constructor(t,i,o){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(t){ie(this,t)}}const qe=pe.litHtmlPolyfillSupport;qe==null||qe(me,ke),(pe.litHtmlVersions??(pe.litHtmlVersions=[])).push("3.3.3");const fo=(e,t,i)=>{const o=(i==null?void 0:i.renderBefore)??t;let a=o._$litPart$;if(a===void 0){const s=(i==null?void 0:i.renderBefore)??null;o._$litPart$=a=new ke(t.insertBefore(he(),s),s,void 0,i??{})}return a._$AI(e),a};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const J=globalThis;let U=class extends Z{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var i;const t=super.createRenderRoot();return(i=this.renderOptions).renderBefore??(i.renderBefore=t.firstChild),t}update(t){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=fo(i,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),(t=this._$Do)==null||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),(t=this._$Do)==null||t.setConnected(!1)}render(){return V}};var si;U._$litElement$=!0,U.finalized=!0,(si=J.litElementHydrateSupport)==null||si.call(J,{LitElement:U});const Ge=J.litElementPolyfillSupport;Ge==null||Ge({LitElement:U});(J.litElementVersions??(J.litElementVersions=[])).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const go={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},pi=e=>(...t)=>({_$litDirective$:e,values:t});let hi=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,i,o){this._$Ct=t,this._$AM=i,this._$Ci=o}_$AS(t,i){return this.update(t,i)}update(t,i){return this.render(...i)}};/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const bo=pi(class extends hi{constructor(e){var t;if(super(e),e.type!==go.ATTRIBUTE||e.name!=="class"||((t=e.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var o,a;if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in t)t[s]&&!((o=this.nt)!=null&&o.has(s))&&this.st.add(s);return this.render(t)}const i=e.element.classList;for(const s of this.st)s in t||(i.remove(s),this.st.delete(s));for(const s in t){const r=!!t[s];r===this.st.has(s)||(a=this.nt)!=null&&a.has(s)||(r?(i.add(s),this.st.add(s)):(i.remove(s),this.st.delete(s)))}return V}});/**
 * @license
 ...
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const xo=vo(U);class Se extends xo{constructor(){super(...arguments),this.value=0,this.max=1,this.indeterminate=!1,this.fourColor=!1}render(){const{ariaLabel:t}=this;return l`
      <div
...
`,_a={generate:"auto_awesome",import:"download",tag:"sell",favorite:"favorite",rename:"edit"},Aa=T`
...
`;function Fa(e,t,i="your library"){return e!=null&&e.length?l`<div class="attached">${e.map(o=>{const a=o.self?`Photo of ${i}: ${o.title}`:`From your library: ${o.title}`;if(o.kind==="image"||o.kind==="gif")return l`<figure class="attached-picture" role="button" tabindex="0"
      ...
      ${o.hasThumb?l`<img src=${g.thumbURL(o.id)} alt="" loading="lazy"/>`:l`<span class="attached-icon"><span class="material-symbols-rounded" style="font-size:24px">${Ri[o.kind]??"folder"}</span></span>`}
      <span class="attached-copy"><strong>${o.title}</strong><span>Open ${o.kind}${s?` at ${ot(s)}`:""}</span></span>
    </button>`})}</div>`:u}const Ui="oppai.safe",Na="oppai-safe",Wt=new Set(["questionable","explicit","rating:questionable","rating:explicit","q","e"]);function Kt(e){if(!e)return!1;for(const t of e){const i=t.name.toLowerCase();if(t.category==="rating"?Wt.has(i):Wt.has(i)&&i.startsWith("rating:"))return!0}return!1}function za(){try{return localStorage.getItem(Ui)==="1"}catch{return!1}}function Ba(e){try{localStorage.setItem(Ui,e?"1":"0")}catch{}window.dispatchEvent(new CustomEvent(Na,{detail:{safe:e}})),window.dispatchEvent(new CustomEvent("oppai-libby-pref",{detail:{hidden:e}}))}function Ha(e){return e.ctrlKey||e.metaKey||e.altKey?null:e.key==="`"?"toggle":e.key==="~"?"lock":null}const Ya=["image","gif","video","game","comic"],wt=e=>Ya.includes(e),je={kind:"",favorite:!1,minRating:0};function qa(e,t){return t.trim()!==""||e==="favorites"||wt(e)}function Di(e,t){const i=t.trim()!=="";return{kind:!(!i&&wt(e)),favorite:!(!i&&e==="favorites")}}function Ga(e,t,i,o,a){const s=Di(e,t),r={sort:a},d=t.trim();return d?r.q=d:e==="favorites"?r.favorite=!0:wt(e)&&(r.kind=e,i&&i!=="All"&&(r.tag=i)),s.kind&&o.kind&&(r.kind=o.kind),s.favorite&&o.favorite&&(r.favorite=!0),o.minRating>0&&(r.minRating=o.minRating),r}function Ja(e,t){let i=0;return t.kind&&e.kind&&i++,t.favorite&&e.favorite&&i++,e.minRating>0&&i++,i}const ja=l`
...
`,we=[];let Wa=1;function de(){window.dispatchEvent(new CustomEvent("oppai-downloads",{detail:we.map(e=>({...e}))}))}function Ka(){return we.map(e=>({...e}))}function vr(e,t){const i={id:Wa++,label:e,progress:.02,state:"running"};return we.unshift(i),de(),t(a=>{i.state==="running"&&(i.progress=Math.max(i.progress,Math.min(.98,a)),de())}).then(()=>{i.progress=1,i.state="done",de(),window.dispatchEvent(new CustomEvent("oppai-download-complete",{detail:{id:i.id}}))}).catch(a=>{i.state="error",i.error=a instanceof Error?a.message:"Download failed",de()}),i.id}function Va(e){const t=we.findIndex(i=>i.id===e);t>=0&&(we.splice(t,1),de())}const Xa=["completed","failed","cancelled"];function W(e){return Xa.includes(e)}function R(e){return!W(e)}function Za(e){return e.state==="queued"||e.state==="uploading"||e.state==="preparing"}function Qa(e){return e.state==="paused"&&!e.needsFile}function es(e){return e.state==="failed"}function ts(e){return R(e.state)}function is(e){return W(e.state)}function os(e){return`${e.name}:${e.size}:${e.lastModified??0}`}function as(e,t){const i=new Set(t),o=[];for(let a=0;a<e;a++)i.has(a)||o.push(a);return o}function ss(e,t,i){const o=e*t;return{start:o,end:Math.min(o+t,i)}}function rs(e,t){return t<=0?0:Math.ceil(e/t)}class ns{constructor(t=8e3){this.samples=[],this.windowMs=t}sample(t,i){this.samples.push({at:i,bytes:t});const o=i-this.windowMs;for(;this.samples.length>2&&this.samples[0].at<o;)this.samples.shift()}rate(){if(this.samples.length<2)return 0;const t=this.samples[0],i=this.samples[this.samples.length-1],o=(i.at-t.at)/1e3;if(o<=0)return 0;const a=(i.bytes-t.bytes)/o;return a>0?a:0}eta(t){const i=this.rate();if(!(i<=0||t<=0))return t/i}reset(){this.samples=[]}}function Oe(e){if(!Number.isFinite(e)||e<0)return"—";if(e<1024)return`${Math.round(e)} B`;const t=["KB","MB","GB","TB"];let i=e/1024,o=0;for(;i>=1024&&o<t.length-1;)i/=1024,o++;return`${i<10?i.toFixed(1):Math.round(i)} ${t[o]}`}function ls(e){return!Number.isFinite(e)||e<=0?"":`${Oe(e)}/s`}function ds(e){if(e===void 0||!Number.isFinite(e)||e<=0)return"";if(e<60)return`${Math.ceil(e)}s left`;if(e<3600)return`${Math.ceil(e/60)} min left`;const t=e/3600;return`${t<10?t.toFixed(1):Math.round(t)} hr left`}function cs(e){if(e.needsFile)return"Waiting for the file";switch(e.state){case"queued":return"Queued";case"preparing":return"Preparing";case"uploading":return"Uploading";case"paused":return"Paused";case"processing":return"Processing on the server";case"completed":return"Completed";case"failed":return"Failed";case"cancelled":return"Cancelled"}}function ps(e){return e.state==="completed"?1:e.size?Math.max(0,Math.min(1,e.sentBytes/e.size)):0}const hs=["queued","preparing","uploading","paused","processing","completed","failed","cancelled"];function us(e){if(!Array.isArray(e))return[];const t=[];for(const i of e){if(!i||typeof i!="object")continue;const o=i;if(typeof o.id!="string"||!o.id||typeof o.name!="string"||typeof o.size!="number"||!Number.isFinite(o.size)||o.size<0)continue;const a=typeof o.state=="string"&&hs.includes(o.state)?o.state:"paused",s=(r,d)=>typeof r=="number"&&Number.isFinite(r)&&r>=0?r:d;t.push({id:o.id,sessionId:typeof o.sessionId=="string"?o.sessionId:void 0,name:o.name,size:o.size,mime:typeof o.mime=="string"?o.mime:"",destination:typeof o.destination=="string"?o.destination:"Library",state:a,sentBytes:Math.min(s(o.sentBytes,0),o.size),retries:s(o.retries,0),error:typeof o.error=="string"?o.error:void 0,mediaId:typeof o.mediaId=="number"&&o.mediaId>0?o.mediaId:void 0,addedAt:s(o.addedAt,0),position:s(o.position,t.length)})}return t}function ms(e,t){const i=new Map(t.map(s=>[s.id,s])),o=new Set,a=[];for(const s of e){const r=s.sessionId?i.get(s.sessionId):void 0;if(!r){W(s.state)?a.push(s):a.push({...s,state:"failed",error:"the server no longer has this upload"});continue}o.add(r.id),a.push(Vt(s,r))}for(const s of t)o.has(s.id)||a.push(Vt({id:`session:${s.id}`,sessionId:s.id,name:s.filename||"Unnamed upload",size:s.size,mime:"",destination:"Library",state:"paused",sentBytes:s.receivedBytes,retries:0,addedAt:0,position:a.length},s));return a}function Vt(e,t){const i={...e,sessionId:t.id,size:t.size||e.size};switch(t.status){case"completed":return{...i,state:"completed",sentBytes:i.size,mediaId:t.mediaId,error:void 0};case"failed":return{...i,state:"failed",error:t.error||"the server could not finish this upload"};case"cancelled":return{...i,state:"cancelled"};default:return{...i,state:"paused",sentBytes:Math.max(t.receivedBytes,0)}}}function at(e){return e.slice().sort((t,i)=>t.position-i.position).map((t,i)=>({...t,position:i}))}function fs(e,t,i){const o=at(e).filter(c=>c.state==="queued"||c.state==="paused"),a=o.findIndex(c=>c.id===t),s=a+i;if(a<0||s<0||s>=o.length)return e;const r=o[a],d=o[s];return e.map(c=>c.id===r.id?{...c,position:d.position}:c.id===d.id?{...c,position:r.position}:c)}const Xt="oppai_uploads",gs=4*1024*1024,bs=5,ys=e=>Math.min(3e4,500*2**e);class vs{constructor(){this.entries=[],this.files=new Map,this.listeners=new Set,this.meters=new Map,this.aborters=new Map,this.running=!1,this.restored=!1}subscribe(t){return this.listeners.add(t),t(this.snapshot()),()=>this.listeners.delete(t)}snapshot(){return at(this.entries).map(t=>({...t}))}activeCount(){return this.entries.filter(t=>R(t.state)).length}publish(){const t=this.snapshot();for(const i of this.listeners)i(t);this.persist(),typeof window<"u"&&window.dispatchEvent(new CustomEvent("oppai-uploads",{detail:t}))}persist(){try{const t=this.entries.map(i=>({id:i.id,sessionId:i.sessionId,name:i.name,size:i.size,mime:i.mime,destination:i.destination,state:i.state==="uploading"||i.state==="preparing"||i.state==="queued"?"paused":i.state,sentBytes:i.sentBytes,retries:i.retries,error:i.error,mediaId:i.mediaId,addedAt:i.addedAt,position:i.position}));localStorage.setItem(Xt,JSON.stringify(t))}catch{}}async restore(){if(this.restored||!fe())return;this.restored=!0;let t=[];try{t=us(JSON.parse(localStorage.getItem(Xt)??"[]"))}catch{t=[]}let i=[];try{i=(await g.listUploadSessions()).items??[]}catch{this.entries=t.map(o=>this.hydrate(o,!0)),this.publish();return}this.entries=ms(t,i).map(o=>this.hydrate(o,R(o.state))),this.publish()}hydrate(t,i){return{...t,bytesPerSecond:0,etaSeconds:void 0,needsFile:i&&!W(t.state)&&!this.files.has(t.id)}}add(t,i="Library"){let o=0,a=this.entries.length;for(const s of Array.from(t)){const r=os(s),d=this.entries.find(p=>p.id===r);if(d&&R(d.state)){d.needsFile&&(this.files.set(r,s),d.needsFile=!1,d.state="queued",d.error=void 0);continue}this.files.set(r,s);const c={id:r,name:s.name,size:s.size,mime:s.type||"",destination:i,state:"queued",sentBytes:0,bytesPerSecond:0,retries:0,addedAt:Date.now(),position:a++,sessionId:d==null?void 0:d.sessionId};this.entries=this.entries.filter(p=>p.id!==r).concat(c),o++}return o&&this.publish(),this.pump(),o}pause(t){var o,a;const i=this.find(t);!i||W(i.state)||(i.state="paused",i.bytesPerSecond=0,i.etaSeconds=void 0,(o=this.meters.get(t))==null||o.reset(),(a=this.aborters.get(t))==null||a.abort(),this.publish())}resume(t){const i=this.find(t);!i||i.state!=="paused"||i.needsFile||(i.state="queued",i.error=void 0,this.publish(),this.pump())}retry(t){const i=this.find(t);i&&(i.state="queued",i.error=void 0,i.retries=0,this.publish(),this.pump())}async cancel(t){var o;const i=this.find(t);if(i&&((o=this.aborters.get(t))==null||o.abort(),i.state="cancelled",i.bytesPerSecond=0,i.etaSeconds=void 0,this.files.delete(t),this.publish(),i.sessionId))try{await g.cancelUploadSession(i.sessionId)}catch{}}remove(t){const i=this.find(t);!i||R(i.state)||(this.entries=this.entries.filter(o=>o.id!==t),this.files.delete(t),this.meters.delete(t),i.sessionId&&g.cancelUploadSession(i.sessionId).catch(()=>{}),this.publish())}clearFinished(){const t=this.entries.filter(i=>W(i.state));this.entries=this.entries.filter(i=>R(i.state));for(const i of t)this.files.delete(i.id),this.meters.delete(i.id),i.sessionId&&g.cancelUploadSession(i.sessionId).catch(()=>{});this.publish()}move(t,i){this.entries=fs(this.entries,t,i),this.publish()}find(t){return this.entries.find(i=>i.id===t)}async pump(){if(!this.running){this.running=!0;try{for(;;){const t=at(this.entries).find(o=>o.state==="queued"&&!o.needsFile);if(!t)return;const i=this.find(t.id);if(!i)return;await this.run(i)}}finally{this.running=!1}}}async run(t){const i=this.files.get(t.id);if(!i){t.state="paused",t.needsFile=!0,this.publish();return}const o=new AbortController;this.aborters.set(t.id,o);const a=new ns;this.meters.set(t.id,a);try{t.state="preparing",t.error=void 0,this.publish();const s=await g.createUploadSession({filename:i.name,size:i.size,mime:i.type||void 0,fingerprint:t.id,chunkSize:gs});t.sessionId=s.id,t.sentBytes=s.receivedBytes;const r=s.chunkSize,d=s.chunkCount||rs(i.size,r);let c=as(d,s.received??[]);t.state="uploading",a.sample(t.sentBytes,Date.now()),this.publish();for(const h of c){if(ne(t))return;const{start:m,end:b}=ss(h,r,i.size);if(await this.sendChunk(t,s.id,h,i.slice(m,b),o.signal),ne(t))return;t.sentBytes=Math.min(i.size,t.sentBytes+(b-m)),a.sample(t.sentBytes,Date.now()),t.bytesPerSecond=a.rate(),t.etaSeconds=a.eta(i.size-t.sentBytes),this.publish()}if(ne(t))return;t.state="processing",t.bytesPerSecond=0,t.etaSeconds=void 0,this.publish();const p=await g.completeUploadSession(s.id);t.state="completed",t.sentBytes=i.size,t.mediaId=p.id,this.files.delete(t.id),this.publish(),typeof window<"u"&&window.dispatchEvent(new CustomEvent("oppai-upload-complete",{detail:{id:p.id,name:i.name,deduped:p.deduped}}))}catch(s){if(ne(t))return;t.state="failed",t.bytesPerSecond=0,t.etaSeconds=void 0,t.error=xs(s),this.publish()}finally{this.aborters.delete(t.id)}}async sendChunk(t,i,o,a,s){for(let r=0;;r++){if(ne(t))return;try{const d=new Headers({"Content-Type":"application/octet-stream"}),c=fe();c&&d.set("Authorization",`Bearer ${c}`);const p=await fetch(`/api/uploads/${i}/chunk/${o}`,{method:"PUT",headers:d,body:a,signal:s});if(p.ok){r>0&&(t.retries+=1);return}const m=(await p.json().catch(()=>({}))).error||p.statusText||`HTTP ${p.status}`;throw p.status<500?new Zt(m):new Error(m)}catch(d){if(s.aborted)return;if(d instanceof Zt||r>=bs)throw d}t.retries+=1,this.publish(),await ws(ys(r),s)}}}function ne(e){return e.state==="paused"||e.state==="cancelled"}class Zt extends Error{}function ws(e,t){return new Promise(i=>{const o=setTimeout(i,e);t.addEventListener("abort",()=>{clearTimeout(o),i()},{once:!0})})}function xs(e){return e instanceof Error?e.name==="AbortError"?"Upload stopped":e.message||"Upload failed":"Upload failed"}const L=new vs;function xt(){var e;return((e=window.matchMedia)==null?void 0:e.call(window,"(prefers-reduced-motion: reduce)").matches)??!1}const $s=260;function wr(e,t="anim-exit"){return!e||xt()?Promise.resolve():new Promise(i=>{let o=!1;const a=()=>{o||(o=!0,e.removeEventListener("animationend",a),e.classList.remove(t),i())};e.addEventListener("animationend",a,{once:!0}),e.classList.add(t),setTimeout(a,$s)})}function ks(e){const t=document;if(xt()||typeof t.startViewTransition!="function"){e();return}t.startViewTransition(e)}function xr(e,t="anim-arrive"){!e||xt()||(e.classList.add(t),e.addEventListener("animationend",()=>e.classList.remove(t),{once:!0}))}var Ss=Object.defineProperty,Is=Object.getOwnPropertyDescriptor,$t=(e,t,i,o)=>{for(var a=o>1?void 0:o?Is(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(a=(o?r(t,i,a):r(a))||a);return o&&a&&Ss(t,i,a),a};function le(e){window.dispatchEvent(new CustomEvent("oppai-menu",{detail:e}))}function Cs(e){const t=window.getSelection();return t&&!t.isCollapsed?!0:e.composedPath().some(i=>{const o=i;if(!(o!=null&&o.tagName))return!1;const a=o.tagName.toLowerCase();return a==="input"||a==="textarea"||a==="a"||o.isContentEditable===!0})}const N={};let xe=class extends U{constructor(){super(...arguments),this.request=null,this.placed={left:0,top:0},this.onRequest=e=>{const t=e.detail.items.reduce((i,o)=>(o.label?i.push(o):i.length&&i[i.length-1].label&&i.push(N),i),[]);for(;t.length&&!t[t.length-1].label;)t.pop();t.length&&(this.request={...e.detail,items:t},this.placed={left:e.detail.x,top:e.detail.y},this.setAttribute("open",""),this.position())},this.close=()=>{this.request&&(this.request=null,this.removeAttribute("open"))},this.onKey=e=>{var a;if(!this.request)return;if(e.key==="Escape"){e.stopPropagation(),this.close();return}if(e.key!=="ArrowDown"&&e.key!=="ArrowUp")return;const t=[...this.renderRoot.querySelectorAll("button:not(:disabled)")];if(!t.length)return;e.preventDefault();const i=t.indexOf((a=this.shadowRoot)==null?void 0:a.activeElement),o=e.key==="ArrowDown"?1:-1;t[(i+o+t.length)%t.length].focus()}}connectedCallback(){super.connectedCallback(),window.addEventListener("oppai-menu",this.onRequest),window.addEventListener("resize",this.close),window.addEventListener("blur",this.close),window.addEventListener("scroll",this.close,!0),window.addEventListener("keydown",this.onKey,!0)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("oppai-menu",this.onRequest),window.removeEventListener("resize",this.close),window.removeEventListener("blur",this.close),window.removeEventListener("scroll",this.close,!0),window.removeEventListener("keydown",this.onKey,!0)}async position(){var d;await this.updateComplete;const e=this.renderRoot.querySelector(".menu"),t=this.request;if(!e||!t)return;const{width:i,height:o}=e.getBoundingClientRect(),a=8,s=t.x+i+a>window.innerWidth?Math.max(a,t.x-i):t.x,r=t.y+o+a>window.innerHeight?Math.max(a,t.y-o):t.y;this.placed={left:s,top:r},await this.updateComplete,(d=this.renderRoot.querySelector("button:not(:disabled)"))==null||d.focus({preventScroll:!0})}pick(e){var t;this.close(),(t=e.run)==null||t.call(e)}render(){const e=this.request;return e?l`
  ...
  `];$t([f()],xe.prototype,"request",2);$t([f()],xe.prototype,"placed",2);xe=$t([ae("oppai-context-menu")],xe);function Es(e){return e.composedPath().some(t=>t instanceof HTMLElement&&(t.tagName==="INPUT"||t.tagName==="TEXTAREA"||t.isContentEditable))}const E={image:{label:"Photos",typeLabel:"PHOTO",icon:"photo_library",aspect:"4 / 3"},gif:{label:"GIFs",typeLabel:"GIF",icon:"animation",aspect:"1 / 1"},video:{label:"Videos",typeLabel:"VIDEO",icon:"movie",aspect:"16 / 9"},game:{label:"Games",typeLabel:"GAME",icon:"sports_esports",aspect:"3 / 4"},comic:{label:"Comics",typeLabel:"COMIC",icon:"auto_stories",aspect:"2 / 3"}},z=["image","gif","video","game","comic"],Qt=["linear-gradient(135deg, oklch(34% 0.06 60), oklch(22% 0.05 55))","linear-gradient(135deg, oklch(33% 0.07 45), oklch(21% 0.05 40))","linear-gradient(135deg, oklch(32% 0.07 30), oklch(20% 0.05 25))","linear-gradient(135deg, oklch(34% 0.055 75), oklch(22% 0.045 70))","linear-gradient(135deg, oklch(32% 0.06 20), oklch(20% 0.05 15))"];function Ts(e){return Qt[Math.abs(e.id)%Qt.length]}function Os(e){return e.kind==="image"||e.kind==="gif"||!!e.hasThumb}function _s(e){const t=Math.max(0,Math.round(e)),i=Math.floor(t/60),o=t%60;return`${i}:${String(o).padStart(2,"0")}`}function Q(e){if(!e)return"";const t=["B","KB","MB","GB","TB"];let i=e,o=0;for(;i>=1024&&o<t.length-1;)i/=1024,o++;return`${i<10&&o>0?i.toFixed(1):Math.round(i)} ${t[o]}`}function As(e){switch(e.kind){case"video":case"gif":return e.duration?_s(e.duration):Q(e.size);case"image":return e.width&&e.height?`${e.width}×${e.height}`:Q(e.size);case"game":return Q(e.size);case"comic":return e.pageCount?`${e.pageCount} pages`:Q(e.size);default:return Q(e.size)}}function Ls(e){return e.tags&&e.tags.length?e.tags[0].name:E[e.kind].label.replace(/s$/,"")}const Fi="oppai_favorites";function ei(){try{const e=localStorage.getItem(Fi);return e?new Set(JSON.parse(e).filter(t=>typeof t=="number")):new Set}catch{return new Set}}function Ms(e){try{localStorage.setItem(Fi,JSON.stringify([...e]))}catch{}}function Ps(e){return!e||e.kind!=="image"&&e.kind!=="gif"?!1:(e.tags??[]).some(t=>t.name==="ai-generated"||t.name==="character:libby"||t.name==="libby")}const Ni="oppai_comic_fit",zi="oppai_comic_pos";function $r(){return localStorage.getItem(Ni)==="width"?"width":"page"}function kr(e){try{localStorage.setItem(Ni,e)}catch{}}function Bi(){try{const e=localStorage.getItem(zi);return e?JSON.parse(e):{}}catch{return{}}}function Sr(e){const t=Bi()[String(e)];return typeof t=="number"&&t>=1?t:1}function Ir(e,t){try{const i=Bi();i[String(e)]=t,localStorage.setItem(zi,JSON.stringify(i))}catch{}}const Hi="oppai.recents.v1",Yi=24;function kt(){try{const e=localStorage.getItem(Hi);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(i=>!!i&&typeof i=="object"&&typeof i.id=="number"&&Number.isFinite(i.id)&&typeof i.at=="number"&&Number.isFinite(i.at)).sort((i,o)=>o.at-i.at).slice(0,Yi):[]}catch{return[]}}function Rs(e,t=Date.now()){const i=[{id:e,at:t},...kt().filter(o=>o.id!==e)].slice(0,Yi);try{localStorage.setItem(Hi,JSON.stringify(i))}catch{}return i}function Us(e,t=kt()){const i=new Map(e.map(a=>[a.id,a])),o=[];for(const a of t){const s=i.get(a.id);s&&o.push(s)}return o}var Ds=Object.defineProperty,Fs=Object.getOwnPropertyDescriptor,S=(e,t,i,o)=>{for(var a=o>1?void 0:o?Fs(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(a=(o?r(t,i,a):r(a))||a);return o&&a&&Ds(t,i,a),a};const Ns=()=>typeof crypto.randomUUID=="function"?crypto.randomUUID().replaceAll("-",""):[...crypto.getRandomValues(new Uint8Array(16))].map(e=>e.toString(16).padStart(2,"0")).join(""),ti=16,ii="oppai_libby_drawer",oi=[{id:"sweet",label:"sweet"},{id:"playful",label:"playful"},{id:"bold",label:"bold"},{id:"horny",label:"horny"}];let k=class extends U{constructor(){super(...arguments),this.items=[],this.focused=null,this.playback=null,this.externalItems=[],this.externalFocused=null,this.where="their library",this.suppressed=!1,this.open=localStorage.getItem(ii)==="1",this.characters=[],this.profile=null,this.characterID="libby",this.status=null,this.remarks=[],this.draft="",this.busy=!1,this.notice="",this.noticeError=!1,this.mode="playful",this.emotion="happy",this.intensity=X(),this.loaded=!1,this.progress=X(),this.remarkedOn=null,this.approvals=new Ma(()=>this.requestUpdate()),this.onPref=()=>this.requestUpdate()}connectedCallback(){super.connectedCallback(),window.addEventListener("oppai-libby-pref",this.onPref)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("oppai-libby-pref",this.onPref)}updated(e){if(!e.has("focused")&&!e.has("externalFocused"))return;const t=this.externalFocused??this.focused;if(!this.open||this.suppressed||tt()||!t)return;const i=`${this.externalFocused?"external":"library"}:${t.id}`;if(i===this.remarkedOn)return;this.remarkedOn=i;const o=this.externalFocused?"(I have just opened the focused item from Browse. Say what you think of it.)":`(I have just opened "${t.title}". Say what you think of it.)`;this.ask("",o)}async load(){var e;if(!this.loaded){this.loaded=!0;try{const t=await g.chatWorkspace();this.profile=t.profile??null,this.characters=(t.characters??[]).filter(o=>o==null?void 0:o.id),this.characters.some(o=>o.id===this.characterID)||(this.characterID=((e=this.characters[0])==null?void 0:e.id)??"libby");const i=this.character;i!=null&&i.defaultMode&&oi.some(o=>o.id===i.defaultMode)&&(this.mode=i.defaultMode)}catch(t){this.say(t.message||"Couldn't load your characters.",!0)}try{this.status=await g.chatStatus()}catch{}this.remarks.length||this.push({role:"assistant",content:Ht({},{intensity:this.intensity}).message})}}get character(){return this.characters.find(e=>e.id===this.characterID)}toggle(){this.open=!this.open;try{localStorage.setItem(ii,this.open?"1":"0")}catch{}this.open&&this.load()}say(e,t=!1){this.notice=e,this.noticeError=t,t||window.setTimeout(()=>{this.notice===e&&(this.notice="")},4e3)}push(e){const t=e.role==="assistant"?{emotion:e.emotion??this.emotion,intensity:e.intensity??this.intensity}:{};this.remarks=[...this.remarks,{...e,...t,id:Ns(),at:Date.now()}].slice(-60),this.scrollLog()}async scrollLog(){await this.updateComplete;const e=this.renderRoot.querySelector(".log");e&&(e.scrollTop=e.scrollHeight)}viewing(){var o,a,s;const e=this.items.slice(0,ti).map(r=>r.id),t=this.externalItems.filter(r=>{var d;return r.id!==((d=this.externalFocused)==null?void 0:d.id)}).slice(0,ti).map(ai),i=((o=this.focused)==null?void 0:o.kind)==="video"?(a=this.playback)==null?void 0:a.call(this):null;return{focusId:(s=this.focused)==null?void 0:s.id,ids:e,external:t,focusExternal:this.externalFocused?ai(this.externalFocused):void 0,section:this.where,position:(i==null?void 0:i.position)||void 0,duration:(i==null?void 0:i.duration)||void 0,paused:(i==null?void 0:i.paused)||void 0}}async ask(e,t){var a,s,r,d,c;const i=this.character;if(!i||this.busy)return;this.busy=!0;const o=Pe(this.progress,Ai(e||t||"",this.mode));try{if(!((a=this.status)!=null&&a.enabled)&&((s=this.status)!=null&&s.configured||(r=this.status)!=null&&r.modelBackend))try{this.status=await g.chatStatus()}catch{}if(!((d=this.status)!=null&&d.enabled)){const b=this.externalFocused??this.focused,x=b?this.externalFocused?this.externalFocused.tags??[]:(((c=this.focused)==null?void 0:c.tags)??[]).map(O=>O.name):[],y=e?ha(e,this.mode,this.emotion,o.intensity,!1):Ht({kind:b==null?void 0:b.kind,tags:x},{intensity:o.intensity});this.applyMood(y.emotion,o.progress,y.intensity),this.push({role:"assistant",content:y.message});return}const p=this.remarks.map(({role:b,content:x})=>({role:b,content:x}));t&&p.push({role:"user",content:t});const h=await g.chat({mode:this.mode,messages:p,emotion:this.emotion,intensity:this.intensity,characterId:i.id,viewing:this.viewing(),outfit:i.id==="libby"?yi():"",recentMoods:this.remarks.filter(b=>b.role==="assistant"&&b.emotion).slice(-8).map(b=>b.emotion)}),m=A(h.intensity??this.intensity);if(h.declared)this.applyMood(ge(h.emotion),m,m);else{const b=Pe(this.progress,m-this.intensity);this.applyMood(ge(h.emotion),b.progress,b.intensity)}this.push({role:"assistant",content:h.message,links:h.links,attachments:h.attachments,actions:h.actions})}catch(p){this.say(p.message||"She didn't answer.",!0)}finally{this.busy=!1}}applyMood(e,t,i){this.emotion=e,this.progress=t,this.intensity=Wo(i)}send(){const e=this.draft.trim();!e||this.busy||(this.draft="",this.push({role:"user",content:e}),this.ask(e))}onKey(e){e.key==="Enter"&&!e.shiftKey&&(e.preventDefault(),this.send())}render(){return tt()||this.suppressed?u:this.open?this.renderPanel():this.renderHandle()}renderHandle(){var t;const e=((t=this.character)==null?void 0:t.name)??"Libby";return l`<button class="handle" title=${`Browse with ${e}`} aria-label=${`Open ${e}'s drawer`}
      @click=${()=>this.toggle()}>
      ...
      <div class="remark-body">
        ...
        ${Fa(e.attachments,r=>jt(this,r),o)}
        ${Ua(e.links,r=>jt(this,r))}
        ${La(e.actions,this.approvals.stateOf,this.approvals.decide)}
      </div>
    </article>`}renderRemarkAvatar(e,t,i){var o;if(e.role==="user")return(o=this.profile)!=null&&o.avatarImageId?l`<span class="remark-avatar"><img src=${g.chatImageURL(this.profile.avatarImageId)} alt="" /></span>`:l`<span class="remark-avatar">${i.slice(0,2).toUpperCase()}</span>`;if((t==null?void 0:t.id)==="libby"||!t){const a=t!=null&&t.avatarImageId?g.chatImageURL(t.avatarImageId):Uo;return l`<span class="remark-avatar"><img src=${a} alt="Libby"/></span>`}return t.avatarImageId?l`<span class="remark-avatar"><img src=${g.chatImageURL(t.avatarImageId)} alt="" /></span>`:l`<span class="remark-avatar">${i.slice(0,2).toUpperCase()}</span>`}};k.styles=[ct,pt,Oa,Da,Aa,$i,T`
  ...
  `];S([_({attribute:!1})],k.prototype,"items",2);S([_({attribute:!1})],k.prototype,"focused",2);S([_({attribute:!1})],k.prototype,"playback",2);S([_({attribute:!1})],k.prototype,"externalItems",2);S([_({attribute:!1})],k.prototype,"externalFocused",2);S([_()],k.prototype,"where",2);S([_({type:Boolean})],k.prototype,"suppressed",2);S([f()],k.prototype,"open",2);S([f()],k.prototype,"characters",2);S([f()],k.prototype,"profile",2);S([f()],k.prototype,"characterID",2);S([f()],k.prototype,"status",2);S([f()],k.prototype,"remarks",2);S([f()],k.prototype,"draft",2);S([f()],k.prototype,"busy",2);S([f()],k.prototype,"notice",2);S([f()],k.prototype,"noticeError",2);S([f()],k.prototype,"mode",2);S([f()],k.prototype,"emotion",2);S([f()],k.prototype,"intensity",2);k=S([ae("oppai-libby-drawer")],k);function ai(e){return{title:e.title,kind:e.kind,tags:e.tags}}function zs(e){var i;if(e==="home"||e==="search")return"their whole library";if(e==="favorites")return"their favorites";if(e==="browse")return"an outside site they are browsing";if(e==="imagegen")return"the image studio, making pictures";if(e==="studio")return"the outfit studio, dressing me up";if(e==="settings")return"the settings screen";const t=(i=E[e])==null?void 0:i.label;return t?`their ${t.toLowerCase()}`:"their library"}var Bs=Object.defineProperty,Hs=Object.getOwnPropertyDescriptor,w=(e,t,i,o)=>{for(var a=o>1?void 0:o?Hs(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(a=(o?r(t,i,a):r(a))||a);return o&&a&&Bs(t,i,a),a};const qi={settings:()=>q(()=>import("./settings-CLREZSYZ.js"),__vite__mapDeps([0,1,2]),import.meta.url),browse:()=>q(()=>import("./browse-DX3pzrvr.js"),__vite__mapDeps([3,4]),import.meta.url),imagegen:()=>q(()=>import("./imagegen-B_v6ZQPf.js"),__vite__mapDeps([5,4]),import.meta.url),chat:()=>q(()=>import("./chat-DQqnSfaQ.js"),__vite__mapDeps([6,4,1]),import.meta.url),viewer:()=>q(()=>import("./viewer-DVSrbakV.js"),[],import.meta.url),scrape:()=>q(()=>import("./scrape-dialog-DbQWv9vm.js"),__vite__mapDeps([7,8,4]),import.meta.url)};function st(e){return e==="studio"?"imagegen":e in qi?e:null}const We=new Map;function Ys(e){const t=st(e);if(!t)return Promise.resolve();const i=We.get(t);if(i)return i;const o=qi[t],a=o().catch(s=>{throw We.delete(t),s});return We.set(t,a),a}const qs=[{id:"home",label:"Home",icon:"home"},...z.map(e=>({id:e,label:E[e].label,icon:E[e].icon})),{id:"favorites",label:"Favorites",icon:"favorite"},{id:"collections",label:"Collections",icon:"bookmarks"},{id:"browse",label:"Browse",icon:"explore"},{id:"imagegen",label:"Create",icon:"auto_awesome"},{id:"studio",label:"Studio",icon:"checkroom"},{id:"chat",label:"Chat",icon:"chat_bubble"}];let v=class extends U{constructor(){super(...arguments),this.items=[],this.total=0,this.sort="newest",this.stats=null,this.home=null,this.viewerStartAt=0,this.safe=za(),this.chipTags=[],this.collections=[],this.openCollection=null,this.recents=kt(),this.loading=!1,this.loadingMore=!1,this.viewReady=new Set,this.section="home",this.selectedId=null,this.editMediaId=0,this.search="",this.filters={},this.refine=je,this.filtersOpen=!1,this.favorites=ei(),this.uploadOpen=!1,this.dragActive=!1,this.selectMode=!1,this.selected=new Set,this.busy=!1,this.downloads=Ka(),this.browseFrame={items:[],focused:null,where:"Browse"},this.pendingUploads=[],this.viewerList=[],this.onIncognito=()=>{this.requestUpdate()},this.onContextMenu=e=>{var r;if(e.defaultPrevented||Cs(e))return;const t=e.composedPath(),i=d=>t.find(c=>{var p,h;return(h=(p=c==null?void 0:c.classList)==null?void 0:p.contains)==null?void 0:h.call(p,d)}),o=t.some(d=>{var c,p;return((p=(c=d==null?void 0:d.tagName)==null?void 0:c.toLowerCase)==null?void 0:p.call(c))==="oppai-viewer"}),a=Number((r=i("tile"))==null?void 0:r.dataset.id);let s;Number.isFinite(a)&&a>0?s=this.tileMenuItems(a,e):o&&this.selectedId!=null?s=this.tileMenuItems(this.selectedId,e,!0):s=this.shellMenuItems(),s.length&&(e.preventDefault(),le({x:e.clientX,y:e.clientY,items:s}))},this.onDownloads=e=>{this.downloads=e.detail},this.onDownloadComplete=()=>this.refresh(),this.onKey=e=>{var i;if(Es(e))return;switch(Ha(e)){case"toggle":e.preventDefault(),this.toggleSafe();return;case"lock":e.preventDefault(),this.logout();return}if(this.selectedId==null||this.uploadOpen)return;const t=((i=this.items.find(o=>o.id===this.selectedId))==null?void 0:i.kind)==="comic";switch(e.key){case"ArrowRight":if(t)return;e.preventDefault(),this.stepItem(1);break;case"ArrowLeft":if(t)return;e.preventDefault(),this.stepItem(-1);break;case"Escape":this.closeItem();break}},this.stepItem=e=>{if(this.selectedId==null)return;const t=this.viewerList.indexOf(this.selectedId);if(t<0)return;const i=t+e;i<0||i>=this.viewerList.length||(this.selectedId=this.viewerList[i])},this.onOpenMedia=async e=>{const{id:t,at:i}=e.detail;if(this.viewerStartAt=i&&i>0?i:0,!this.items.some(o=>o.id===t))try{const o=await g.getMedia(t);this.items=[o,...this.items],this.noteServerFavorites([o])}catch{$("That one isn't in the library any more.","error");return}this.openItem(t,this.items)},this.closeItem=()=>{this.selectedId=null},this.viewerPushed=!1,this.onPopState=()=>{this.viewerPushed&&(this.viewerPushed=!1,this.selectedId!=null&&(this.selectedId=null))},this.onFiltersOutside=e=>{e.composedPath().some(t=>t instanceof HTMLElement&&t.classList.contains("filters-wrap"))||(this.filtersOpen=!1)},this.toggleSelectMode=()=>{this.selectMode=!this.selectMode,this.selectMode||(this.selected=new Set)},this.viewerPlayback=()=>{var e;return((e=this.renderRoot.querySelector("oppai-viewer"))==null?void 0:e.playback())??null},this.toggleUpload=()=>{this.uploadOpen=!this.uploadOpen,this.dragActive=!1},this.onUploadDone=e=>{const t=e.detail;this.pendingUploads.push(t==null?void 0:t.id),this.uploadSettle&&clearTimeout(this.uploadSettle),this.uploadSettle=window.setTimeout(()=>void this.announceUploads(),900)}}connectedCallback(){super.connectedCallback(),vt(this,"library"),this.migrateLocalFavorites().then(()=>this.refresh()),this.addEventListener("contextmenu",this.onContextMenu),this.detachLongPress=Ta(this),this.addEventListener(Te,this.onOpenMedia),window.addEventListener("keydown",this.onKey),window.addEventListener("oppai-downloads",this.onDownloads),window.addEventListener("oppai-download-complete",this.onDownloadComplete),window.addEventListener("oppai-upload-complete",this.onUploadDone),window.addEventListener("oppai-incognito",this.onIncognito),window.addEventListener("popstate",this.onPopState)}disconnectedCallback(){var e,t,i,o;super.disconnectedCallback(),window.removeEventListener("popstate",this.onPopState),this.removeEventListener("contextmenu",this.onContextMenu),(e=this.detachLongPress)==null||e.call(this),this.removeEventListener(Te,this.onOpenMedia),window.removeEventListener("keydown",this.onKey),window.removeEventListener("oppai-downloads",this.onDownloads),window.removeEventListener("oppai-download-complete",this.onDownloadComplete),window.removeEventListener("oppai-upload-complete",this.onUploadDone),window.removeEventListener("oppai-incognito",this.onIncognito),document.removeEventListener("pointerdown",this.onFiltersOutside,!0),this.uploadSettle&&clearTimeout(this.uploadSettle),this.searchDebounce&&clearTimeout(this.searchDebounce),(t=this.pageAbort)==null||t.abort(),(i=this.homeAbort)==null||i.abort(),(o=this.moreObserver)==null||o.disconnect()}updated(e){var i,o,a;(i=super.updated)==null||i.call(this,e),e.has("filtersOpen")&&(this.filtersOpen?document.addEventListener("pointerdown",this.onFiltersOutside,!0):document.removeEventListener("pointerdown",this.onFiltersOutside,!0));const t=(o=this.renderRoot)==null?void 0:o.querySelector(".more-sentinel");if(!t){(a=this.moreObserver)==null||a.disconnect(),this.moreObserver=void 0;return}this.moreObserver||(this.moreObserver=new IntersectionObserver(s=>{s.some(r=>r.isIntersecting)&&this.loadMore()},{rootMargin:"600px 0px"})),this.moreObserver.disconnect(),this.moreObserver.observe(t)}tileMenuItems(e,t,i=!1){const o=this.items.find(r=>r.id===e);if(!o)return[];const a=this.favorites.has(e),s=xa(o);return[...i?[]:[{label:"Open",icon:"open_in_full",run:()=>this.openItem(e)}],{label:a?"Remove from favorites":"Add to favorites",icon:a?"heart_minus":"favorite",run:()=>this.toggleFavorite(e)},...i?[]:[{label:this.selectMode?"Toggle selection":"Select items",icon:"check_box",run:()=>this.selectMode?this.toggleSelected(e):this.toggleSelectMode()}],{label:"Add to collection…",icon:"playlist_add",run:()=>this.openCollectionMenu([e],t.clientX,t.clientY)},...this.openCollection?[{label:`Take off "${this.openCollection.name}"`,icon:"playlist_remove",run:()=>void this.removeFromOpenCollection(e)}]:[],N,{label:"Show Libby now",icon:"send",disabled:!s,hint:"attach to a message",run:()=>void this.share(o,{id:"libby",name:"Libby"})},{label:"Save for Libby to send later",icon:"add_photo_alternate",disabled:!s,hint:"her gallery",run:()=>void this.saveForLater(o)},{label:"Share with…",icon:"ios_share",disabled:!s,run:()=>void this.openShareMenu(o,t.clientX,t.clientY)},...o.kind==="image"||o.kind==="gif"?[{label:"Is this Libby?",icon:"face_retouching_natural",run:()=>this.openIdentityMenu(o,t.clientX,t.clientY)}]:[],...Ps(o)?[{label:"Edit in the studio",icon:"brush",run:()=>this.editInStudio(o.id)}]:[],{label:"Copy title",icon:"content_copy",run:()=>void navigator.clipboard.writeText(o.title)},{label:"Open the file",icon:"open_in_new",run:()=>window.open(g.streamURL(e),"_blank")},N,{label:"Delete",icon:"delete",danger:!0,run:()=>void this.deleteOne(e)}]}openIdentityMenu(e,t,i){const o=async(a,s=!1)=>{try{await g.markLibbyIdentity({mediaId:e.id,isLibby:a,reference:s}),$(a?s?"Saved as one of the pictures of me.":"Noted — that one's me.":"Noted — that one isn't me."),this.refresh()}catch(r){$(r.message||"Couldn't save that.","error")}};le({x:t,y:i,title:`"${e.title}"`,items:[{label:"Yes, that's Libby",icon:"check",run:()=>void o(!0)},{label:"Yes — and use it as a reference",icon:"star",run:()=>void o(!0,!0)},N,{label:"No, that isn't her",icon:"close",run:()=>void o(!1)}]})}async openShareMenu(e,t,i){let o=[];try{o=(await g.chatWorkspace()).characters??[]}catch(a){$(a.message||"Couldn't load your chat characters.","error");return}if(!o.length){$("No chat characters yet — add one in Chat first.","error");return}le({x:t,y:i,title:`Share "${e.title}" with`,items:o.map(a=>({label:a.name,icon:"person",run:()=>void this.share(e,a)}))})}async share(e,t){try{await ka(e,t.id),this.closeItem(),this.selectSection("chat")}catch(i){$(i.message||`Couldn't share with ${t.name}.`,"error")}}async saveForLater(e){$(`Saving "${e.title}" for me…`);try{const t=await Sa(e,"libby");$(t.subject==="other"?`Kept it. It doesn't look like me, so it's on my "someone else" shelf — tell me otherwise under Chat › Images.`:"Kept it — I can send that one later.")}catch(t){$(t.message||"Couldn't save that for Libby.","error")}}shellMenuItems(){const e=Le()!=="light";return[{label:"Add media",icon:"add",run:()=>this.toggleUpload()},{label:"Import from a URL",icon:"link",run:()=>this.openScrape()},{label:"Refresh library",icon:"refresh",run:()=>void this.refresh()},N,{label:"Home",icon:"home",run:()=>this.selectSection("home")},{label:"Favorites",icon:"favorite",run:()=>this.selectSection("favorites")},{label:"Chat",icon:"chat_bubble",run:()=>this.selectSection("chat")},{label:"Create",icon:"auto_awesome",run:()=>this.selectSection("imagegen")},{label:"Outfit studio",icon:"checkroom",run:()=>this.selectSection("studio")},N,{label:e?"Switch to light theme":"Switch to dark theme",icon:e?"light_mode":"dark_mode",run:()=>this.flipTheme()},{label:"Settings",icon:"settings",run:()=>this.selectSection("settings")}]}flipTheme(){const e=Le()==="light"?"dark":"light";Co(e),ht(e)}async deleteOne(e){const t=this.items.find(i=>i.id===e);if(!(!t||!confirm(`Delete "${t.title}"? This cannot be undone.`))){this.busy=!0;try{await g.deleteMedia(e),this.selectedId===e&&this.closeItem(),await this.refresh()}catch(i){$(`Couldn't delete that: ${i.message}`,"error")}finally{this.busy=!1}}}get query(){return Ga(this.section,this.search,this.filters[this.section],this.refine,this.sort)}queryKey(e){return[e.kind??"",e.q??"",e.tag??"",e.favorite?"fav":"",e.minRating??0,e.sort??"newest"].join("|")}async reload(){var o;const e=this.query,t=this.queryKey(e);(o=this.pageAbort)==null||o.abort();const i=new AbortController;this.pageAbort=i,this.loading=!0;try{const a=await g.listMedia({...e,limit:ee,offset:0,signal:i.signal});if(this.queryKey(this.query)!==t)return;this.items=a.items??[],this.total=a.total??this.items.length,this.noteServerFavorites(this.items)}catch(a){if(i.signal.aborted)return;$(a.message||"Couldn't load the library.","error")}finally{this.pageAbort===i&&(this.loading=!1)}}async loadMore(){if(this.loading||this.loadingMore||this.items.length>=this.total)return;const e=this.query,t=this.queryKey(e);this.loadingMore=!0;try{const i=await g.listMedia({...e,limit:ee,offset:this.items.length});if(this.queryKey(this.query)!==t)return;const o=new Set(this.items.map(a=>a.id));this.items=[...this.items,...(i.items??[]).filter(a=>!o.has(a.id))],this.total=i.total??this.total,this.noteServerFavorites(i.items??[])}catch{}finally{this.loadingMore=!1}}async loadHome(){var i;const e=new AbortController;(i=this.homeAbort)==null||i.abort(),this.homeAbort=e;const t=o=>g.listMedia({...o,limit:12,signal:e.signal}).then(a=>a.items??[]).catch(()=>[]);try{const[o,a,s,r,d,...c]=await Promise.all([g.libraryStats(e.signal).catch(()=>null),g.resumeShelf(e.signal).then(h=>h.items??[]).catch(()=>[]),t({favorite:!0}),t({}),g.recentBookmarks(12,e.signal).then(h=>h.bookmarks??[]).catch(()=>[]),...z.map(h=>t({kind:h}))]);if(e.signal.aborted)return;const p={};z.forEach((h,m)=>p[h]=c[m]??[]),this.stats=o,this.home={resume:a,favorites:s,newest:r,byKind:p,moments:d},this.noteServerFavorites([...s,...r,...a])}catch{}}async loadChips(e){try{const{items:t}=await g.topTags(e,8);this.section===e&&(this.chipTags=t??[])}catch{this.chipTags=[]}}ensureView(e){const t=st(e);!t||this.viewReady.has(t)||Ys(e).then(()=>{this.viewReady=new Set(this.viewReady).add(t)}).catch(()=>{$("That screen failed to load. Try again?","error")})}ready(e){const t=st(e);return!t||this.viewReady.has(t)}refresh(){this.loadHome(),this.reload(),z.includes(this.section)&&this.loadChips(this.section),this.loadCollections()}selectSection(e){e!==this.section&&(e!=="imagegen"&&(this.editMediaId=0),this.ensureView(e),ks(()=>{this.section=e,this.selectedId=null,this.search="",this.items=[],this.total=0,this.openCollection=null,e==="home"?this.loadHome():e==="collections"?this.loadCollections():this.reload(),z.includes(e)&&this.loadChips(e)}))}editInStudio(e){this.editMediaId=e,this.selectedId=null,this.selectSection("imagegen")}openItem(e,t){if(this.ensureView("viewer"),t&&t.length?this.viewerList=t.map(i=>i.id):this.viewerList.includes(e)||(this.viewerList=[e]),!this.viewerPushed)try{history.pushState({oppaiViewer:!0},""),this.viewerPushed=!0}catch{}this.recents=Rs(e),this.selectedId=e}willUpdate(e){if(e.has("selectedId")&&this.selectedId==null&&this.viewerPushed){this.viewerPushed=!1;try{history.back()}catch{}}}onSearchInput(e){this.search=e.target.value,this.selectedId=null,this.searchDebounce&&clearTimeout(this.searchDebounce),this.searchDebounce=window.setTimeout(()=>void this.reload(),250)}clearSearch(){this.searchDebounce&&clearTimeout(this.searchDebounce),this.search="",this.reload()}setFilter(e,t){this.filters={...this.filters,[e]:t},this.reload()}setSort(e){e!==this.sort&&(this.sort=e,this.reload())}setRefine(e){this.refine={...this.refine,...e},this.reload()}clearRefine(){this.refine!==je&&(this.refine=je,this.reload())}toggleFilters(){this.filtersOpen=!this.filtersOpen}async toggleFavorite(e,t){t==null||t.stopPropagation();const i=!this.favorites.has(e);this.setLocalFavorite(e,i);try{await g.updateMedia(e,{favorite:i}),!i&&this.query.favorite&&(this.items=this.items.filter(o=>o.id!==e),this.total=Math.max(0,this.total-1)),this.stats&&(this.stats={...this.stats,favorites:Math.max(0,this.stats.favorites+(i?1:-1))})}catch(o){this.setLocalFavorite(e,!i),$(o.message||"Couldn't save that.","error")}}setLocalFavorite(e,t){const i=new Set(this.favorites);t?i.add(e):i.delete(e),this.favorites=i,this.items=this.items.map(o=>o.id===e?{...o,favorite:t}:o)}noteServerFavorites(e){if(!e.length)return;const t=new Set(this.favorites);let i=!1;for(const o of e){const a=t.has(o.id);o.favorite&&!a?(t.add(o.id),i=!0):!o.favorite&&a&&(t.delete(o.id),i=!0)}i&&(this.favorites=t)}async migrateLocalFavorites(){const e=ei();if(e.size!==0)try{await g.bulkMedia("update",[...e],{favorite:!0}),Ms(new Set)}catch{}}async loadCollections(){try{const{items:e}=await g.listCollections();this.collections=e??[]}catch{this.collections=[]}}async newCollection(e=[]){const t=prompt("Name this collection:");if(!(t==null||!t.trim()))try{const{id:i}=await g.createCollection(t.trim());e.length&&await g.addToCollection(i,e),await this.loadCollections(),$(e.length?`Made "${t.trim()}" with ${e.length} item${e.length===1?"":"s"}.`:`Made "${t.trim()}".`,"success")}catch(i){$(i.message||"Couldn't make that collection.","error")}}openCollectionMenu(e,t,i){const o=async a=>{try{const{added:s}=await g.addToCollection(a.id,e);await this.loadCollections(),$(s===0?`Already on "${a.name}".`:`Added ${s} to "${a.name}".`,"success")}catch(s){$(s.message||"Couldn't add that.","error")}};le({x:t,y:i,title:e.length===1?"Add to collection":`Add ${e.length} items to…`,items:[...this.collections.map(a=>({label:a.name,icon:"playlist_add",hint:`${a.count} item${a.count===1?"":"s"}`,run:()=>void o(a)})),...this.collections.length?[N]:[],{label:"New collection…",icon:"create_new_folder",run:()=>void this.newCollection(e)}]})}async openCollectionItems(e){this.openCollection=e,this.search="",this.section="collections",this.loading=!0;try{const t=await g.collectionItems(e.id,ee,0);this.items=t.items??[],this.total=t.total??this.items.length,this.openCollection=t.collection??e,this.noteServerFavorites(this.items)}catch(t){$(t.message||"Couldn't open that collection.","error")}finally{this.loading=!1}}async removeFromOpenCollection(e){const t=this.openCollection;if(t)try{await g.removeFromCollection(t.id,e),this.items=this.items.filter(i=>i.id!==e),this.total=Math.max(0,this.total-1),await this.loadCollections()}catch(i){$(i.message||"Couldn't take that off.","error")}}async renameOpenCollection(e){const t=prompt("Rename this collection:",e.name);if(!(t==null||!t.trim()||t.trim()===e.name))try{await g.renameCollection(e.id,t.trim()),this.openCollection={...e,name:t.trim()},await this.loadCollections()}catch(i){$(i.message||"Couldn't rename that.","error")}}async deleteCollection(e){var t;if(confirm(`Delete the collection "${e.name}"? The items stay in your library.`))try{await g.deleteCollection(e.id),((t=this.openCollection)==null?void 0:t.id)===e.id&&(this.openCollection=null,this.items=[],this.total=0),await this.loadCollections()}catch(i){$(i.message||"Couldn't delete that.","error")}}exitSelect(){this.selectMode=!1,this.selected=new Set}toggleSelected(e,t){t==null||t.stopPropagation();const i=new Set(this.selected);i.has(e)?i.delete(e):i.add(e),this.selected=i}async bulkDelete(){const e=[...this.selected];if(e.length&&confirm(`Delete ${e.length} item${e.length===1?"":"s"}? This cannot be undone.`)){this.busy=!0;try{await g.bulkMedia("delete",e);const t=Re("libraryDelete",{count:e.length});$(t.message,"success",{emotion:t.emotion,intensity:t.intensity});const i=new Set(this.favorites);e.forEach(o=>i.delete(o)),this.favorites=i,this.exitSelect(),await this.refresh()}catch(t){console.error("bulk delete",t)}finally{this.busy=!1}}}async bulkTags(e){const t=[...this.selected];if(!t.length)return;const i=prompt(e==="add"?"Add tags (comma-separated):":"Remove tags (comma-separated):");if(i==null)return;const o=i.split(",").map(a=>a.trim()).filter(Boolean);if(o.length){this.busy=!0;try{await g.bulkMedia("update",t,e==="add"?{addTags:o}:{removeTags:o}),await this.refresh()}catch(a){console.error("bulk tags",a)}finally{this.busy=!1}}}async bulkChangeKind(){const e=[...this.selected];if(!e.length)return;const t=prompt("Change type to (video, gif, image, comic, game):");if(t==null)return;const i=t.trim().toLowerCase();if(!z.includes(i)){alert(`Unknown type "${i}".`);return}this.busy=!0;try{await g.bulkMedia("update",e,{kind:i}),this.exitSelect(),await this.refresh()}catch(o){console.error("bulk kind",o)}finally{this.busy=!1}}async bulkFavorite(){const e=[...this.selected];if(e.length){e.forEach(t=>this.setLocalFavorite(t,!0));try{await g.bulkMedia("update",e,{favorite:!0}),this.stats&&(this.stats={...this.stats,favorites:this.stats.favorites+e.length})}catch(t){e.forEach(i=>this.setLocalFavorite(i,!1)),$(t.message||"Couldn't star those.","error")}this.exitSelect()}}logout(){this.dispatchEvent(new CustomEvent("logout",{bubbles:!0,composed:!0}))}toggleSafe(){var e,t;if(this.safe=!this.safe,Ba(this.safe),this.safe){for(const i of this.renderRoot.querySelectorAll("video"))i.muted=!0;(t=(e=this.renderRoot.querySelector("oppai-viewer"))==null?void 0:e.renderRoot)==null||t.querySelectorAll("video").forEach(i=>i.muted=!0)}}browse(){var e;(e=this.renderRoot.querySelector("#file"))==null||e.click()}onFiles(e){const t=Array.from(e);t.length&&(this.uploadOpen=!1,L.add(t))}async announceUploads(){var i;const e=this.pendingUploads.filter(o=>typeof o=="number"&&o>0);if(this.pendingUploads=[],!e.length)return;const t=e.length===1?await g.getMedia(e[0]).catch(()=>{}):void 0;this.dispatchEvent(new CustomEvent("imported",{detail:{count:e.length,title:t==null?void 0:t.title,kind:t==null?void 0:t.kind,tags:(i=t==null?void 0:t.tags)==null?void 0:i.map(o=>o.name)},bubbles:!0,composed:!0})),this.refresh()}onFileInput(e){const t=e.target;t.files&&this.onFiles(t.files),t.value=""}onDrop(e){var t,i;e.preventDefault(),this.dragActive=!1,(i=(t=e.dataTransfer)==null?void 0:t.files)!=null&&i.length&&this.onFiles(e.dataTransfer.files)}openScrape(){var e;this.ensureView("scrape"),this.uploadOpen=!1,(e=this.renderRoot.querySelector("oppai-scrape-dialog"))==null||e.open()}itemsForKind(e){var t;return((t=this.home)==null?void 0:t.byKind[e])??[]}onScreenItems(e,t,i){var o;return e||t||i?this.items:((o=this.home)==null?void 0:o.newest)??this.items}get viewerQueue(){return this.viewerList.map(e=>this.items.find(t=>t.id===e)).filter(e=>e!=null)}render(){var O,P,I;const e=this.search.trim().length>0,t=this.selectedId!=null,i=!t&&this.section==="settings"&&!e,o=!t&&this.section==="browse"&&!e,a=!t&&this.section==="imagegen"&&!e,s=!t&&this.section==="studio"&&!e,r=this.section==="chat"&&!e,d=!t&&r,c=!t&&this.section==="favorites"&&!e,p=!t&&this.section==="collections"&&!e,h=!t&&this.section==="home"&&!e&&!c,m=!t&&e,b=!t&&!h&&!c&&!p&&!m&&!i&&!o&&!a&&!s&&!d,x=t?this.items.find(C=>C.id===this.selectedId)??null:null;let y="Library";return t?y=x?x.title:"Library":m?y="Search results":i?y="Settings":o?y="Browse sources":a?y="Create":s?y="Outfit studio":d?y="Chat with Libby":c?y="Favorites":p?y=((O=this.openCollection)==null?void 0:O.name)??"Collections":h?y="Library":y=((P=E[this.section])==null?void 0:P.label)??"Library",l`
      ...
      <div class="main-col">
        ...
        <main class=${d||a?"flush":""}>
          ...
          <!-- Keyed so switching between Create and the studio rebuilds the element
               ...
               instance. -->
          ${s?this.ready("studio")?gi("studio",l`<oppai-imagegen studio @imported=${()=>this.refresh()}
                  @open-chat=${()=>this.selectSection("chat")}></oppai-imagegen>`):this.renderViewLoading():u}
      ...
      <oppai-libby-drawer
        .items=${o?[]:x?[x,...this.onScreenItems(b,c,m)]:this.onScreenItems(b,c,m)}
        .focused=${x}
        .playback=${this.viewerPlayback}
        .externalItems=${o?this.browseFrame.items:[]}
        .externalFocused=${o?this.browseFrame.focused:null}
        .where=${o?this.browseFrame.where:zs(m?"search":this.section)}
        ?suppressed=${d}
      ></oppai-libby-drawer>
      ${this.renderUpload()}
      ${this.renderBulkBar()}
    ...
    `}renderHeader(e,t,i,o=!1){return l`
      <header>
        ...
        ${!i&&qa(this.section,this.search)?this.renderFilters():u}
      </header>
    `}renderFilters(){const e=Di(this.section,this.search),t=Ja(this.refine,e),i=(a,s,r)=>l`<button
      ...
      ${this.filtersOpen?l`<div class="filters-pop" role="dialog" aria-label="Filters"
            ...
            ${e.kind?l`<div class="frow-label">Kind</div>
                  <div class="frow">
                    ...
                    ${z.map(a=>i(this.refine.kind===a,l`<span aria-hidden="true"
    ...
    </div>`}renderHome(){var m,b,x,y,O,P;const e=new Date().getHours(),t=e<12?"Good morning":e<18?"Good afternoon":"Good evening";if(!this.home)return l`<div class="empty">Loading your library…</div>`;if((((m=this.stats)==null?void 0:m.total)??this.home.newest.length)===0)return l`<div>
      ...
      </div>`;const i=this.home.newest,o=this.home.resume,a=Us(i,this.recents).slice(0,12),s=o.length?o:a,r=s[0]??i[0],d=this.home.favorites,c=((b=this.stats)==null?void 0:b.thisWeek)??0,p=z.map(I=>({kind:I,label:E[I].label,icon:E[I].icon,items:this.itemsForKind(I)})).filter(I=>I.items.length>0),h=(I,C,Be,St,Ji,It)=>Be.length===0?u:l`
      ...
      <div>
        ...
        ${r?l`
          <section class="hero anim-rise" style="animation-delay:70ms;">
            <button class="hero-art ${this.safe&&Kt(r.tags)?"veiled":""}" @click=${()=>this.openItem(r.id,i)}
              ...
              ${r.hasThumb?l`<img src=${g.thumbURL(r.id)} alt="" loading="lazy" />`:l`<span aria-hidden="true" class="material-symbols-rounded hero-icon">${E[r.kind].icon}</span>`}
            </button>
            <div class="hero-body">
          ...
          <div class="stats anim-rise" style="animation-delay:90ms;">
            <button class="stat" @click=${()=>this.selectSection("home")}>
              <strong>${(((y=this.stats)==null?void 0:y.total)??0).toLocaleString()}</strong><span>items</span></button>
        ...
        ${h("Jump back in","history",s,null,120,o.length?"Where you left off, on any device":"What you've opened on this device")}
        ${h("Favourites","star",d,()=>this.selectSection("favorites"),170)}
        ${this.renderMoments(this.home.moments)}
        ${h("Recently added","new_releases",i.slice(0,12),null,220)}

        ${p.map((I,C)=>h(I.label,I.icon,I.items,()=>this.selectSection(I.kind),270+C*60))}
      </div>
    `}renderMoments(e){return e.length?l`
      ...
      </section>`:u}renderGrid(e,t,i){var p;const o=e?this.section:null,a=t?"Favorites":i?"Search results":((p=E[o])==null?void 0:p.label)??"",s=this.items,r=this.loading?"Loading…":this.total===s.length?`${this.total.toLocaleString()} ${this.total===1?"item":"items"}`:`${s.length.toLocaleString()} of ${this.total.toLocaleString()}`,d=o?this.filters[o]??"All":"All",c=o?["All",...this.chipTags.map(h=>h.name)].map(h=>({label:h,active:d===h})):[];return l`
      <div>
        <div class="grid-head">
        ...
        ${s.length===0?this.loading?l`<div class="empty" aria-busy="true">Loading…</div>`:l`<div class="empty">
              ...
              >
                ${s.map((h,m)=>this.renderTile(h,"100%",m,s))}
              </div>
              ${this.renderMore()}`}
      </div>
    `}renderViewLoading(){return l`<div class="empty" role="status" aria-live="polite">
      ...
      <div>
        ...
        ${this.collections.length===0?l`<div class="empty">
              ...
              ${this.collections.map(t=>l`<div
                  ...
                  @contextmenu=${i=>{i.preventDefault(),le({x:i.clientX,y:i.clientY,title:t.name,items:[{label:"Open",icon:"open_in_full",run:()=>void this.openCollectionItems(t)},{label:"Rename…",icon:"edit",run:()=>void this.renameOpenCollection(t)},N,{label:"Delete collection",icon:"delete",danger:!0,hint:"the items stay in your library",run:()=>void this.deleteCollection(t)}]})}}
                >
                  <div
                    class="tile-media"
                    style="width:100%; aspect-ratio:1; background:var(--oppai-surface-2); display:grid; place-items:center;"
                  >
                    ${t.cover?l`<img src=${g.thumbURL(t.cover)} alt="" loading="lazy" />`:l`<span aria-hidden="true" class="material-symbols-rounded" style="font-size:34px; color:var(--oppai-text-dim);"
                          >bookmarks</span
                        >`}
                  </div>
                  <div class="tile-meta">
    ...
    `}renderTile(e,t,i,o){const a=E[e.kind],s=this.favorites.has(e.id),r=As(e),d=i!=null?"anim-rise":"",c=i!=null?`animation-delay:${Math.min(i,12)*45}ms;`:"",p=this.selected.has(e.id),h=this.safe&&Kt(e.tags),m=`tile ${d} ${this.selectMode?"selecting":""} ${p?"selected":""} ${h?"veiled":""}`;return l`
      <div
        class=${m}
        data-id=${e.id}
      ...
      >
        ...
        >
          ${Os(e)?l`<img loading="lazy" src=${g.thumbURL(e.id)} alt=${e.title} />`:l`<div class="tile-overlay">
  ...
  `];ze([f()],oe.prototype,"entries",2);ze([f()],oe.prototype,"open",2);ze([f()],oe.prototype,"dismissed",2);oe=ze([ae("oppai-upload-manager")],oe);var js=Object.defineProperty,Ws=Object.getOwnPropertyDescriptor,F=(e,t,i,o)=>{for(var a=o>1?void 0:o?Ws(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(a=(o?r(t,i,a):r(a))||a);return o&&a&&js(t,i,a),a};const Ks=6e4;let M=class extends U{constructor(){super(...arguments),this.user=null,this.ready=!1,this.mascotMessage="",this.mascotTone="success",this.mascotEmotion="",this.mascotIntensity=0,this.typed="",this.beat=0,this.onMascot=e=>{const t=e.detail;this.mascotMessage=t.message,this.mascotTone=t.tone,this.mascotEmotion=t.emotion??"",this.mascotIntensity=t.intensity??0,this.beat++,this.typeLine(t.message),this.mascotTimer&&clearTimeout(this.mascotTimer),this.mascotTimer=window.setTimeout(()=>this.mascotMessage="",5e3+zt(t.message))},this.onImported=e=>{const t=e.detail??{},i=Math.max(1,t.count??1),o=Ko(i>1?2:1),a=Qo({...t,count:i},{intensity:o});$(a.message,"success",{emotion:a.emotion,intensity:a.intensity})},this.onLibbyPref=()=>this.requestUpdate(),this.onLogout=()=>{this.user=null,this.stopProbe()},this.onVisible=()=>{document.visibilityState==="visible"&&this.user&&this.probe()}}connectedCallback(){super.connectedCallback(),vt(this,"app shell"),window.addEventListener("oppai-logout",this.onLogout),window.addEventListener("oppai-mascot",this.onMascot),window.addEventListener("oppai-libby-pref",this.onLibbyPref),window.addEventListener("imported",this.onImported),document.addEventListener("visibilitychange",this.onVisible),this.bootstrap()}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("oppai-logout",this.onLogout),window.removeEventListener("oppai-mascot",this.onMascot),window.removeEventListener("oppai-libby-pref",this.onLibbyPref),window.removeEventListener("imported",this.onImported),document.removeEventListener("visibilitychange",this.onVisible),this.stopProbe(),this.mascotTimer&&clearTimeout(this.mascotTimer),this.typeTimer&&cancelAnimationFrame(this.typeTimer)}typeLine(e){if(this.typeTimer&&cancelAnimationFrame(this.typeTimer),window.matchMedia("(prefers-reduced-motion: reduce)").matches){this.typed=e;return}const t=zt(e),i=performance.now();this.typed="";const o=()=>{const a=Math.min(1,(performance.now()-i)/Math.max(1,t));this.typed=e.slice(0,Math.ceil(e.length*a)),a<1?this.typeTimer=requestAnimationFrame(o):this.typeTimer=void 0};this.typeTimer=requestAnimationFrame(o)}async bootstrap(){if(fe())try{this.user=await g.me(),this.startProbe()}catch{Qe(null)}this.ready=!0}async probe(){if(fe())try{await g.me()}catch{}}startProbe(){this.stopProbe(),this.probeTimer=window.setInterval(()=>void this.probe(),Ks)}stopProbe(){this.probeTimer&&(clearInterval(this.probeTimer),this.probeTimer=void 0)}onLoggedIn(e){this.mascotMessage="",this.user=e.detail,this.startProbe()}async logout(){try{await g.logout()}catch{}Qe(null),this.user=null,this.stopProbe()}renderSnackbar(){return this.mascotMessage?l`<div class="snackbar ${this.mascotTone}"
      ...
      <span>${this.mascotMessage}</span>
          ...
          ${t?null:l`<span class="pixel-sprite libby-breathe">${gi(`${this.beat}-${i.emotion}-${i.intensity}`,l`<img class=${s} src=${o[0]} data-fallback-index="0"
                  alt=${`Libby feeling ${i.emotion}`}
                  @error=${d=>qo(d.target,o)} />`)}</span>`}
        </div>`:null;return this.ready?this.user?l`<oppai-library
      .user=${this.user}
      @logout=${this.logout}
    ></oppai-library><oppai-upload-manager></oppai-upload-manager>${r}`:(q(()=>import("./login-DOtdzo3K.js"),__vite__mapDeps([9,8,4,2]),import.meta.url),l`<oppai-login @logged-in=${this.onLoggedIn}></oppai-login>`):l`<div class="center"><md-circular-progress indeterminate></md-circular-progress></div>${r}`}};M.styles=[$i,T`
  ...
  `];F([f()],M.prototype,"user",2);F([f()],M.prototype,"ready",2);F([f()],M.prototype,"mascotMessage",2);F([f()],M.prototype,"mascotTone",2);F([f()],M.prototype,"mascotEmotion",2);F([f()],M.prototype,"mascotIntensity",2);F([f()],M.prototype,"typed",2);F([f()],M.prototype,"beat",2);M=F([ae("oppai-app")],M);const Gi=document.createElement("style");Gi.textContent=Io;document.head.appendChild(Gi);document.adoptedStyleSheets=[...document.adoptedStyleSheets,So.styleSheet];ht(Le());Eo();export{Cs as $,u as A,vt as B,ks as C,lr as D,Co as E,ht as F,kr as G,ar as H,jo as I,dr as J,E as K,Ci as L,ct as M,_ as N,wr as O,vr as P,yi as Q,sr as R,Ft as S,le as T,$a as U,hi as V,go as W,V as X,pi as Y,Ma as Z,$e as _,U as a,N as a0,gr as a1,wa as a2,mr as a3,xr as a4,Wo as a5,No as a6,pr as a7,Pe as a8,Ai as a9,z as aA,Ts as aB,Ps as aC,As as aD,vo as aE,bo as aF,fo as aG,tr as aH,Ao as aI,cr as aa,ha as ab,yr as ac,br as ad,fr as ae,A as af,or as ag,Uo as ah,nr as ai,rr as aj,Q as ak,vi as al,ir as am,jt as an,Fa as ao,Ua as ap,La as aq,Ri as ar,Oa as as,Da as at,Aa as au,Es as av,Sr as aw,Ir as ax,ot as ay,_s as az,l as b,Yo as c,Me as d,g as e,Ho as f,X as g,tt as h,T as i,gi as j,qo as k,Re as l,$ as m,ge as n,ja as o,zo as p,pt as q,$i as r,Qe as s,ae as t,f as u,Le as v,$r as w,Mo as x,hr as y,ur as z};
