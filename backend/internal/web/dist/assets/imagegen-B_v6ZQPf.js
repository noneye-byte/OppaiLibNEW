import{M as gt,i as ft,u as p,a as mt,Q as he,e as g,m as L,R as At,A as c,b as o,S as ue,l as it,t as bt,q as Et,B as ge,T as Ct,U as fe,V as me,W as be,X as ve,Y as xe,O as ye,N as se}from"./index-D3VFtMgd.js";import{e as ae}from"./query-__j_ZMY6.js";function oe(t){return t.faces*t.tiers}function we(t,e){const i=oe(e);if(t>=i){const a=Math.min(t-i,e.miscIds.length-1);return{tier:0,face:0,misc:e.miscIds[Math.max(0,a)]??""}}const s=Math.max(0,Math.min(t,i-1));return{tier:Math.floor(s/e.faces),face:s%e.faces,misc:""}}function $e(t,e,i,s){const a=i?s.miscIds.indexOf(i):-1;return a>=0?oe(s)+a:e+t*s.faces}function _(t){return`${t.emotion}:${t.tier}`}function q(t,e,i,s){if(t.trim()==="")return s;const a=Number(t);return Number.isFinite(a)?Math.min(i,Math.max(e,Math.round(a))):s}function ot(t,e,i,s){if(t.trim()==="")return s;const a=Number(t);return Number.isFinite(a)?Math.min(i,Math.max(e,a)):s}function ke(t,e){var i,s;return{prompt:t.prompt,negativePrompt:t.negativePrompt??"",model:t.checkpoint??"",modelHash:e.modelHash||void 0,vae:t.vae??"",vaePrecision:t.vaePrecision??"fp32",sampler:t.sampler??"",seed:e.seed,steps:t.steps??0,cfgScale:t.cfgScale??0,cfgRescale:t.cfgRescale??0,clipSkip:t.clipSkip??0,width:t.width??0,height:t.height??0,seamlessX:!!t.seamlessX,seamlessY:!!t.seamlessY,cpuNoise:t.cpuNoise!==!1,loras:(t.loras??[]).map(a=>{var r;return{name:a.name,weight:a.weight,hash:((r=e.loraHashes)==null?void 0:r[a.name])||void 0}}),triggers:e.triggers??[],characters:e.characters??[],poses:(i=e.poses)!=null&&i.length?e.poses:void 0,outfit:e.outfit||void 0,controlImage:e.controlImage||void 0,refiner:(s=t.detailer)!=null&&s.enabled?{model:t.detailer.model??"",prompt:t.detailer.prompt??"",negativePrompt:t.detailer.negativePrompt??"",confidence:t.detailer.confidence??0,denoise:t.detailer.denoise??0,maskBlur:t.detailer.maskBlur??0}:void 0,board:t.board&&t.board!=="none"?t.board:void 0,backend:e.backend,seconds:e.seconds,at:Date.now()}}function V(t){const e=t.loras.filter(n=>!t.prompt.includes(`<lora:${n.name}:`)).map(n=>`<lora:${n.name}:${n.weight}>`).join(" "),s=[[t.prompt,e].filter(Boolean).join(" ")];t.negativePrompt&&s.push(`Negative prompt: ${t.negativePrompt}`);const a=[`Steps: ${t.steps}`,`Sampler: ${t.sampler||"default"}`,`CFG scale: ${t.cfgScale}`,`Seed: ${t.seed}`,`Size: ${t.width}x${t.height}`];t.model&&a.push(`Model: ${t.model}`),t.modelHash&&a.push(`Model hash: ${t.modelHash}`),t.vae&&a.push(`VAE: ${t.vae}`),t.clipSkip>0&&a.push(`Clip skip: ${t.clipSkip}`),t.cfgRescale>0&&a.push(`CFG Rescale: ${t.cfgRescale}`);const r=t.loras.filter(n=>n.hash);return r.length&&a.push(`Lora hashes: "${r.map(n=>`${n.name}: ${n.hash}`).join(", ")}"`),(t.seamlessX||t.seamlessY)&&a.push(`Seamless: ${[t.seamlessX?"x":"",t.seamlessY?"y":""].filter(Boolean).join("+")}`),t.vaePrecision&&a.push(`VAE precision: ${t.vaePrecision}`),t.cpuNoise||a.push("Noise device: gpu"),t.refiner&&(a.push(`ADetailer model: ${t.refiner.model}`),a.push(`ADetailer confidence: ${t.refiner.confidence}`),a.push(`ADetailer denoising strength: ${t.refiner.denoise}`),a.push(`ADetailer mask blur: ${t.refiner.maskBlur}`),t.refiner.prompt&&a.push(`ADetailer prompt: ${t.refiner.prompt}`),t.refiner.negativePrompt&&a.push(`ADetailer negative prompt: ${t.refiner.negativePrompt}`)),t.triggers.length&&a.push(`Trigger phrases: ${t.triggers.join(" ")}`),t.characters.length&&a.push(`Characters: ${t.characters.join(", ")}`),t.controlImage&&a.push(`Control image: ${t.controlImage}`),t.board&&a.push(`Board: ${t.board}`),a.push(`Backend: ${t.backend}`),t.seconds!==void 0&&a.push(`Generation time: ${t.seconds.toFixed(1)}s`),s.push(a.join(", ")),s.join(`
`)}function et(t){return JSON.stringify(t,null,2)}function Se(t){return{prompt:t.prompt,negativePrompt:t.negativePrompt??"",model:t.model??"",modelHash:t.modelHash||void 0,vae:t.vae??"",vaePrecision:"fp32",sampler:t.sampler??"",seed:t.seed,steps:t.steps,cfgScale:t.cfgScale,cfgRescale:t.cfgRescale,clipSkip:t.clipSkip,width:t.width,height:t.height,seamlessX:t.seamlessX,seamlessY:t.seamlessY,cpuNoise:t.cpuNoise,loras:t.loras??[],triggers:[],characters:[],backend:t.backend||"invokeai",at:Date.now()}}function Ce(t){return{prompt:t.prompt,negativePrompt:t.negativePrompt||void 0,checkpoint:t.model||void 0,vae:t.vae||void 0,sampler:t.sampler||void 0,seed:t.seed,steps:t.steps,cfgScale:t.cfgScale,cfgRescale:t.cfgRescale,clipSkip:t.clipSkip,width:t.width,height:t.height,seamlessX:t.seamlessX,seamlessY:t.seamlessY,vaePrecision:t.vaePrecision==="fp16"?"fp16":"fp32",cpuNoise:t.cpuNoise,count:1,loras:t.loras.map(({name:e,weight:i})=>({name:e,weight:i})),detailer:t.refiner?{enabled:!0,...t.refiner}:void 0,board:t.board}}async function re(t){var e;try{if((e=navigator.clipboard)!=null&&e.writeText)return await navigator.clipboard.writeText(t),!0}catch{}try{const i=document.createElement("textarea");i.value=t,i.setAttribute("readonly",""),i.style.position="fixed",i.style.top="-1000px",document.body.appendChild(i),i.select();const s=document.execCommand("copy");return document.body.removeChild(i),s}catch{return!1}}const Rt="oppai_gen_draft",Tt=1,Te=720*60*60*1e3;function ze(t){try{const e={...t,version:Tt,at:Date.now()};localStorage.setItem(Rt,JSON.stringify(e))}catch{}}function Pe(){let t=null;try{t=localStorage.getItem(Rt)}catch{return null}if(!t)return null;let e;try{e=JSON.parse(t)}catch{return pt(),null}if(!e||typeof e!="object")return null;const i=e;if(i.version!==Tt)return pt(),null;const s=typeof i.at=="number"?i.at:0;if(!s||Date.now()-s>Te)return pt(),null;const a={version:Tt,at:s},r=d=>{const h=i[d];typeof h=="string"&&(a[d]=h)},n=d=>{const h=i[d];typeof h=="boolean"&&(a[d]=h)},l=d=>{const h=i[d];typeof h=="number"&&Number.isFinite(h)&&(a[d]=h)};if(["prompt","negative","checkpoint","vae","templateId","scheduler","board","outfitText","outfitMisc","outfitUnderwearColor","outfitPubicHairColor","outfitLoadoutId","outfitWardrobeId","detailerModel","detailerPrompt","detailerNegative"].forEach(r),["width","height","steps","cfg","cfgRescale","clipSkip","count","seed","outfitFace","outfitTier","detailerConfidence","detailerDenoise","detailerMaskBlur","scrollTop"].forEach(l),["seamlessX","seamlessY","cpuNoise","outfitOn","outfitCutout","outfitPubicHair","outfitLockColors","outfitMiscBatch","detailerEnabled","showOptions"].forEach(n),(i.vaePrecision==="fp16"||i.vaePrecision==="fp32")&&(a.vaePrecision=i.vaePrecision),(i.outfitBackground==="black"||i.outfitBackground==="white")&&(a.outfitBackground=i.outfitBackground),i.camera&&typeof i.camera=="object"&&!Array.isArray(i.camera)){const d={};for(const[h,m]of Object.entries(i.camera))(typeof m=="string"||typeof m=="boolean")&&(d[h]=m);Object.keys(d).length&&(a.camera=d)}return De(i.selectedLoras)&&(a.selectedLoras=i.selectedLoras),Be(i.open)&&(a.open=i.open),yt(i.selectedTriggers)&&(a.selectedTriggers=i.selectedTriggers),yt(i.selectedChars)&&(a.selectedChars=i.selectedChars),yt(i.selectedPoses)&&(a.selectedPoses=i.selectedPoses),Le(i.outfitGear)&&(a.outfitGear=i.outfitGear),Array.isArray(i.shots)&&(a.shots=i.shots.filter(d=>!!d&&typeof d=="object"&&typeof d.id=="string"&&typeof d.seed=="number").map(d=>({id:d.id,seed:d.seed,saved:!!d.saved,info:d.info,...typeof d.outfitFilename=="string"?{outfitFilename:d.outfitFilename}:{},...Ie(d.outfitSlot)?{outfitSlot:d.outfitSlot}:{},...typeof d.outfitConfig=="string"?{outfitConfig:d.outfitConfig}:{},...typeof d.cutoutReviewed=="boolean"?{cutoutReviewed:d.cutoutReviewed}:{},...typeof d.wipOutfitId=="string"?{wipOutfitId:d.wipOutfitId}:{},...typeof d.previewVersion=="number"&&Number.isFinite(d.previewVersion)?{previewVersion:d.previewVersion}:{},...typeof d.workspaceX=="number"&&Number.isFinite(d.workspaceX)?{workspaceX:Math.max(0,d.workspaceX)}:{},...typeof d.workspaceY=="number"&&Number.isFinite(d.workspaceY)?{workspaceY:Math.max(0,d.workspaceY)}:{}}))),a}function Le(t){return!!t&&typeof t=="object"&&!Array.isArray(t)}function Ie(t){if(!t||typeof t!="object"||Array.isArray(t))return!1;const e=t;return typeof e.emotion=="string"&&typeof e.emotionLabel=="string"&&typeof e.tier=="number"&&Number.isInteger(e.tier)&&typeof e.tierLabel=="string"&&typeof e.index=="number"&&Number.isInteger(e.index)}function pt(){try{localStorage.removeItem(Rt)}catch{}}function yt(t){return Array.isArray(t)&&t.every(e=>typeof e=="string")}function De(t){return!!t&&typeof t=="object"&&!Array.isArray(t)&&Object.values(t).every(e=>typeof e=="number"&&Number.isFinite(e))}function Be(t){return!!t&&typeof t=="object"&&!Array.isArray(t)&&Object.values(t).every(e=>typeof e=="boolean")}const K=new Uint8Array([137,80,78,71,13,10,26,10]),zt=new TextEncoder;function Me(t,e){return(t[e]<<24|t[e+1]<<16|t[e+2]<<8|t[e+3])>>>0}function Nt(t,e,i){t[e]=i>>>24&255,t[e+1]=i>>>16&255,t[e+2]=i>>>8&255,t[e+3]=i&255}let rt;function Oe(t){if(!rt){rt=new Uint32Array(256);for(let i=0;i<256;i++){let s=i;for(let a=0;a<8;a++)s=s&1?3988292384^s>>>1:s>>>1;rt[i]=s>>>0}}let e=4294967295;for(const i of t)e=rt[(e^i)&255]^e>>>8;return(e^4294967295)>>>0}function Ut(t,e){const i=zt.encode(t),s=new Uint8Array(12+e.length);Nt(s,0,e.length),s.set(i,4),s.set(e,8);const a=new Uint8Array(i.length+e.length);return a.set(i),a.set(e,i.length),Nt(s,s.length-4,Oe(a)),s}function Ft(t,e){const i=[...e].every(n=>(n.codePointAt(0)??256)<=255),s=zt.encode(t);if(i){const n=Uint8Array.from([...e],d=>d.codePointAt(0)??0),l=new Uint8Array(s.length+1+n.length);return l.set(s),l.set(n,s.length+1),Ut("tEXt",l)}const a=zt.encode(e),r=new Uint8Array(s.length+5+a.length);return r.set(s),r.set(a,s.length+5),Ut("iTXt",r)}function Pt(t,e,i){const s=t instanceof Uint8Array?t:new Uint8Array(t);if(s.length<20||!K.every((w,$)=>s[$]===w))throw new Error("The generated image is not a PNG.");let a=K.length,r=-1;const n=[];for(;a+12<=s.length;){const w=Me(s,a),$=a+12+w;if($>s.length)throw new Error("The PNG is truncated.");const z=String.fromCharCode(...s.subarray(a+4,a+8));if(z==="IEND"){r=a;break}const S=s.subarray(a+8,a+8+w),C=S.indexOf(0),P=C<0?"":String.fromCharCode(...S.subarray(0,C));(z==="tEXt"||z==="iTXt")&&(P==="parameters"||P==="oppailib")||n.push(s.subarray(a,$)),a=$}if(r<0)throw new Error("The PNG has no IEND chunk.");const l=[Ft("parameters",e)];i&&l.push(Ft("oppailib",i));const d=n.reduce((w,$)=>w+$.length,0),h=l.reduce((w,$)=>w+$.length,0),m=s.subarray(r),b=new Uint8Array(K.length+d+h+m.length);b.set(K);let y=K.length;for(const w of n)b.set(w,y),y+=w.length;for(const w of l)b.set(w,y),y+=w.length;return b.set(m,y),b}async function ne(t,e,i,s){const a=await fetch(t,{credentials:"same-origin"});if(!a.ok)throw new Error(`Couldn't export image (${a.status}).`);const n=Pt(await a.arrayBuffer(),i,s).slice().buffer,l=URL.createObjectURL(new Blob([n],{type:"image/png"}));try{const d=document.createElement("a");d.href=l,d.download=e.toLowerCase().endsWith(".png")?e:`${e}.png`,d.click()}finally{setTimeout(()=>URL.revokeObjectURL(l),0)}}const jt={shot:"full-body",angle:"eye",view:"front",framing:"portrait",lens:"none",lockIdentity:!0},st={"extreme-closeup":{label:"Extreme close-up",hint:"Eyes and mouth fill the frame",prompt:"extreme close-up, face filling the frame, macro detail on the eyes",not:["full body","wide shot","long shot","cowboy shot","upper body"]},closeup:{label:"Close-up",hint:"The face, little else",prompt:"close-up portrait, face and hair fill the frame",not:["full body","wide shot","long shot","cowboy shot"]},"head-shoulders":{label:"Head and shoulders",hint:"The classic portrait crop",prompt:"head and shoulders portrait, shoulders visible at the frame edge",not:["full body","wide shot","long shot","waist visible"]},bust:{label:"Bust shot",hint:"Head to upper chest",prompt:"bust shot, framed from the chest up",not:["full body","wide shot","long shot","legs","feet"]},"waist-up":{label:"Waist-up",hint:"Head to waist, hands usable",prompt:"waist-up shot, upper body, cropped at the waist",not:["full body","long shot","legs","feet","knees"]},"three-quarter":{label:"Three-quarter body",hint:"Head to mid-thigh",prompt:"three-quarter body shot, cowboy shot, cropped at mid-thigh",not:["extreme close-up","feet","shoes"]},"full-body":{label:"Full body",hint:"Head to feet, whole figure",prompt:"full body shot, entire figure in frame, head to feet visible",not:["close-up","cropped legs","out of frame","cropped head"]}};function Ee(t){return st[t].prompt}const Lt={eye:{label:"Eye level",prompt:"eye level perspective, natural straight-on viewpoint",not:[]},low:{label:"Low angle",prompt:"low angle shot, viewed from below, looking upward",not:["from above","high angle","distorted proportions","giant"]},high:{label:"High angle",prompt:"high angle shot, viewed from above, looking downward",not:["from below","low angle","distorted proportions"]}},It={front:{label:"Front",prompt:"front view, facing viewer",not:["from behind","back view"]},"three-quarter":{label:"Three-quarter",prompt:"three-quarter view, body turned at a slight angle",not:["from behind"]},side:{label:"Side",prompt:"side view, profile, from the side",not:["front view","facing viewer"]},rear:{label:"Rear",prompt:"from behind, back view, facing away from viewer",not:["front view","facing viewer","looking at viewer","face visible"]}},Dt={none:{label:"Unspecified",prompt:""},"wide-24":{label:"24mm wide",prompt:"24mm wide angle lens, deep focus"},"normal-50":{label:"50mm normal",prompt:"50mm lens, natural perspective"},"portrait-85":{label:"85mm portrait",prompt:"85mm portrait lens, shallow depth of field, blurred background"},"tele-135":{label:"135mm telephoto",prompt:"135mm telephoto lens, compressed perspective, bokeh"}},Re="consistent character design, same face, consistent facial features, consistent body proportions, anatomically consistent",_e="inconsistent face, different person, face morphing, deformed proportions, distorted anatomy, extra limbs, malformed hands, changed body type, altered hairstyle",Ae="camera, camera body, camera lens, photography equipment, tripod, photographer, studio equipment, boom microphone",le={portrait:{sd:[512,768],xl:[832,1216]},landscape:{sd:[768,512],xl:[1216,832]},square:{sd:[512,512],xl:[1024,1024]}};function Ne(t,e="sd"){const i=st[t.shot],s=Lt[t.angle],a=It[t.view],r=Dt[t.lens],n=Gt([...t.lockIdentity?[Re]:[],i.prompt,a.prompt,s.prompt,r.prompt]),l=Gt([...t.lockIdentity?[_e]:[],Ae,...i.not,...a.not,...s.not]),[d,h]=le[t.framing][e];return{prompt:n,negative:l,width:d,height:h}}function Gt(t){const e=new Set,i=[];for(const s of t)for(const a of s.split(",")){const r=a.trim();if(!r)continue;const n=r.toLowerCase();e.has(n)||(e.add(n),i.push(r))}return i.join(", ")}function Ue(t,e){return t*e>=800*800?"xl":"sd"}const wt={shots:Object.keys(st).map(t=>({id:t,label:st[t].label,hint:st[t].hint})),angles:Object.keys(Lt).map(t=>({id:t,label:Lt[t].label})),views:Object.keys(It).map(t=>({id:t,label:It[t].label})),lenses:Object.keys(Dt).map(t=>({id:t,label:Dt[t].label})),framings:Object.keys(le).map(t=>({id:t,label:t==="portrait"?"Portrait":t==="landscape"?"Landscape":"Square"}))},Wt={feather:2,spill:.5},W=255,F=0,Fe=20;class je{constructor(e){if(this.undoStack=[],this.redoStack=[],"data"in e)this.width=e.width,this.height=e.height,this.source={data:e.data,width:e.width,height:e.height};else{this.width="naturalWidth"in e?e.naturalWidth:e.width,this.height="naturalHeight"in e?e.naturalHeight:e.height;const i=document.createElement("canvas");i.width=this.width,i.height=this.height;const s=i.getContext("2d",{willReadFrequently:!0});if(!s)throw new Error("This browser wouldn't give us a canvas to work on.");s.drawImage(e,0,0),this.source=s.getImageData(0,0,this.width,this.height)}this.mask=new Uint8Array(this.width*this.height).fill(W),this.key=Ht(this.source.data,this.width,this.height)}get canUndo(){return this.undoStack.length>0}get canRedo(){return this.redoStack.length>0}get cutFraction(){let e=0;for(let i=0;i<this.mask.length;i++)this.mask[i]===F&&e++;return e/this.mask.length}checkpoint(){this.undoStack.push(this.mask.slice()),this.undoStack.length>Fe&&this.undoStack.shift(),this.redoStack=[]}undo(){const e=this.undoStack.pop();return e?(this.redoStack.push(this.mask),this.mask=e,!0):!1}redo(){const e=this.redoStack.pop();return e?(this.undoStack.push(this.mask),this.mask=e,!0):!1}reset(){this.checkpoint(),this.mask.fill(W)}autoRemove(e){this.checkpoint(),this.mask.fill(W),this.key=Ht(this.source.data,this.width,this.height);const i=[];for(let s=0;s<this.width;s++)i.push(s,s+(this.height-1)*this.width);for(let s=0;s<this.height;s++)i.push(s*this.width,this.width-1+s*this.width);this.flood(i,this.key,e),this.removeEnclosedBackdrop(e)}removeEnclosedBackdrop(e){const i=this.source.data,s=new Uint8Array(this.mask.length),[a,r,n]=this.key,l=Math.max(1,e),d=qt(a,r,n),h=Math.max(a,r,n)-Math.min(a,r,n)<28,m=Math.max(16,Math.floor(this.mask.length*.08));for(let b=0;b<this.mask.length;b++){if(s[b]||this.mask[b]===F||Z(i,b*4,a,r,n)>l)continue;const y=[],w=new Set,$=[b];for(s[b]=1;$.length;){const P=$.pop();y.push(P);const k=P%this.width,Y=(P-k)/this.width,at=[k>0?P-1:-1,k<this.width-1?P+1:-1,Y>0?P-this.width:-1,Y<this.height-1?P+this.width:-1];for(const N of at)N<0||this.mask[N]===F||(Z(i,N*4,a,r,n)<=l?s[N]||(s[N]=1,$.push(N)):w.add(N))}if(!w.size||y.length>m)continue;let z=0,S=0;for(const P of w){const k=P*4;z+=qt(i[k],i[k+1],i[k+2]),S+=Z(i,k,a,r,n)}if(z/=w.size,S/=w.size,h&&d>=200?d-z>=110:h&&d<=55?z-d>=110:S>=Math.max(90,l*2.25))for(const P of y)this.mask[P]=F}}removeAt(e,i,s){const a=ct(Math.round(e),0,this.width-1),r=ct(Math.round(i),0,this.height-1),n=(r*this.width+a)*4,l=[this.source.data[n],this.source.data[n+1],this.source.data[n+2]];if(this.checkpoint(),this.key=l,s.contiguous){this.flood([r*this.width+a],l,s.tolerance);return}const d=Math.max(1,s.tolerance);for(let h=0;h<this.mask.length;h++)this.mask[h]!==F&&Z(this.source.data,h*4,l[0],l[1],l[2])<=d&&(this.mask[h]=F)}paint(e,i,s,a){const r=a==="add"?W:F,n=Math.max(1,Math.round(s)),l=Math.round(e),d=Math.round(i),h=n*n,m=Math.max(0,l-n),b=Math.min(this.width-1,l+n),y=Math.max(0,d-n),w=Math.min(this.height-1,d+n);for(let $=y;$<=w;$++){const z=$-d;for(let S=m;S<=b;S++){const C=S-l;C*C+z*z>h||(this.mask[$*this.width+S]=r)}}}beginStroke(){this.checkpoint()}compose(e,i=!1){const s=document.createElement("canvas");s.width=this.width,s.height=this.height;const a=s.getContext("2d");if(!a)return s;const r=this.composePixels(e,i);return a.putImageData(new ImageData(r.data,r.width,r.height),0,0),s}composePixels(e,i=!1){const s={data:new Uint8ClampedArray(this.source.data),width:this.width,height:this.height};if(i)return s;const a=this.featheredAlpha(Math.max(0,Math.round(e.feather))),r=ct(e.spill,0,1),[n,l,d]=this.key;for(let h=0;h<a.length;h++){const m=h*4,b=a[h];if(s.data[m+3]=b,b===0||b===W||r===0)continue;const y=r*(1-b/W);s.data[m]=$t(s.data[m],n,y),s.data[m+1]=$t(s.data[m+1],l,y),s.data[m+2]=$t(s.data[m+2],d,y)}return s}featheredAlpha(e){const i=new Uint8Array(this.mask.length);if(e<=0)return i.set(this.mask),i;const s=1e6,a=new Float32Array(this.mask.length);for(let l=0;l<this.mask.length;l++)a[l]=this.mask[l]===F?0:s;const r=this.width,n=this.height;for(let l=0;l<n;l++)for(let d=0;d<r;d++){const h=l*r+d;let m=a[h];d>0&&(m=Math.min(m,a[h-1]+1)),l>0&&(m=Math.min(m,a[h-r]+1)),d>0&&l>0&&(m=Math.min(m,a[h-r-1]+1.414)),d<r-1&&l>0&&(m=Math.min(m,a[h-r+1]+1.414)),a[h]=m}for(let l=n-1;l>=0;l--)for(let d=r-1;d>=0;d--){const h=l*r+d;let m=a[h];d<r-1&&(m=Math.min(m,a[h+1]+1)),l<n-1&&(m=Math.min(m,a[h+r]+1)),d<r-1&&l<n-1&&(m=Math.min(m,a[h+r+1]+1.414)),d>0&&l<n-1&&(m=Math.min(m,a[h+r-1]+1.414)),a[h]=m}for(let l=0;l<i.length;l++){if(this.mask[l]===F){i[l]=0;continue}const d=a[l];i[l]=d>=e?W:Math.round(d/e*W)}return i}flood(e,i,s){const a=Math.max(1,s),r=this.source.data,n=new Uint8Array(this.mask.length),l=e.slice(),[d,h,m]=i;for(;l.length;){const b=l.pop();if(n[b]||(n[b]=1,Z(r,b*4,d,h,m)>a))continue;this.mask[b]=F;const y=b%this.width,w=(b-y)/this.width;y>0&&l.push(b-1),y<this.width-1&&l.push(b+1),w>0&&l.push(b-this.width),w<this.height-1&&l.push(b+this.width)}}}function Z(t,e,i,s,a){const r=t[e]-i,n=t[e+1]-s,l=t[e+2]-a;return Math.sqrt(r*r+n*n+l*l)}function qt(t,e,i){return t*.2126+e*.7152+i*.0722}function Ht(t,e,i){const s=[0,(e-1)*4,(i-1)*e*4,((i-1)*e+(e-1))*4];let a=0,r=0,n=0;for(const l of s)a+=t[l],r+=t[l+1],n+=t[l+2];return[a/4,r/4,n/4]}function $t(t,e,i){return ct(Math.round(t+(t-e)*i),0,255)}function ct(t,e,i){return Math.min(i,Math.max(e,t))}function Ge(t){return new Promise((e,i)=>{const s=new Image;s.crossOrigin="anonymous",s.onload=()=>e(s),s.onerror=()=>i(new Error("Couldn't load that image.")),s.src=t})}function Vt(t){return new Promise((e,i)=>{t.toBlob(s=>s?e(s):i(new Error("Couldn't encode the PNG.")),"image/png")})}function ht(t,e,i=48){return t.normalize("NFKD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"").slice(0,i).replace(/-+$/g,"")||e}function We(t,e,i){return`${ht(t,"outfit")}-${ht(e,"calm",20)}-${ht(i,"neutral",24)}.png`}function qe(t){return`${ht(t,"outfit")}-wardrobe.zip`}const j=[{key:"head",label:"Head",hint:"Hats, glasses, etc.",prompt:"head item",noun:"headwear",icon:"face"},{key:"top",label:"Top",hint:"Shirt, dress, jacket…",prompt:"top",noun:"top",icon:"apparel"},{key:"bottoms",label:"Bottoms",hint:"Skirt, shorts, pants…",prompt:"bottoms",noun:"bottoms",icon:"styler"},{key:"shoes",label:"Shoes",hint:"Boots, heels, socks…",prompt:"footwear",noun:"footwear",icon:"steps"},{key:"panties",label:"Panties",hint:"Style and material",prompt:"panties",noun:"panties",icon:"apparel"},{key:"bra",label:"Bra",hint:"Style and material",prompt:"bra",noun:"bra",icon:"apparel"},{key:"hand1",label:"Hand 1",hint:"Held or worn item",prompt:"left-hand item",noun:"glove",icon:"front_hand"},{key:"hand2",label:"Hand 2",hint:"Held or worn item",prompt:"right-hand item",noun:"glove",icon:"back_hand"},{key:"extra1",label:"Extra 1",hint:"Accessory or layer",prompt:"extra accessory",noun:"accessory",icon:"diamond"},{key:"extra2",label:"Extra 2",hint:"Accessory or layer",prompt:"second extra accessory",noun:"accessory",icon:"diamond"}];function G(t){return!!t.item.trim()&&!t.off}const kt={head:{color:"",item:""},top:{color:"cream white",item:"fitted top"},bottoms:{color:"charcoal",item:"pleated skirt"},shoes:{color:"black",item:"ankle boots"},panties:{color:"black",item:"lace panties"},bra:{color:"black",item:"lace bra"},hand1:{color:"",item:""},hand2:{color:"",item:""},extra1:{color:"",item:""},extra2:{color:"",item:""}},de=Object.fromEntries(j.map(({key:t})=>[t,{color:"",item:""}])),pe=[{name:"red",words:["red","crimson","scarlet","ruby","burgundy","maroon","wine"]},{name:"pink",words:["pink","rose","blush","magenta","fuchsia","salmon"]},{name:"orange",words:["orange","peach","apricot","coral","amber","rust"]},{name:"yellow",words:["yellow","gold","golden","mustard","lemon","blonde"]},{name:"green",words:["green","emerald","olive","mint","jade","teal","sage"]},{name:"blue",words:["blue","navy","azure","cobalt","indigo","denim","cyan","turquoise"]},{name:"purple",words:["purple","violet","lavender","lilac","plum","mauve"]},{name:"brown",words:["brown","tan","beige","chocolate","caramel","khaki","bronze","copper"]},{name:"white",words:["white","cream","ivory","pearl","off-white"]},{name:"black",words:["black","charcoal","onyx","jet"]},{name:"grey",words:["grey","gray","silver","slate","ash","steel"]}];function He(t){const e=t.toLowerCase();return pe.filter(({words:i})=>i.some(s=>new RegExp(`\\b${s}\\b`).test(e))).map(({name:i})=>i)}function Ve(t,e,i){if(!t.trim())return"";const s=e.toFixed(2).replace(/0+$/,"").replace(/\.$/,"");return i==="a1111"?`(${t}:${s})`:i==="invokeai"?`(${t})${s}`:t}const Ye=1.25;function Yt(t,e,i,s){const a=e.item.trim();if(!a||e.off)return"";const r=_t(t,e),n=vt(t,e),l=e.color.trim();if(!l)return`${r}: ${a}`;const d=`${l} ${a}`;return s?`${r}: ${Ve(d,Ye,i)}, ${l} ${n}`:`${r}: ${d}`}function _t(t,e){var i;return((i=e.prompt)==null?void 0:i.trim())||t.prompt}function vt(t,e){var i,s;return((i=e.noun)==null?void 0:i.trim())||((s=e.prompt)==null?void 0:s.trim())||t.noun}function Xe(t,e){const i=e.color.trim();if(!G(e)||!i)return[];const s=new Set(He(i));if(!s.size)return[];const a=vt(t,e);return pe.filter(({name:r})=>!s.has(r)).map(({name:r})=>`${r} ${a}`)}const Bt=[{description:"Clothes on; bra and panties hidden.",clothes:[["on",100]],bra:[["hidden",100]],panties:[["hidden",100]]},{description:"Usually covered, with an occasional underwear glimpse.",clothes:[["on",88],["displaced",12]],bra:[["hidden",88],["showing",12]],panties:[["hidden",94],["showing",6]]},{description:"Mixed neat, slipped, and rare clothes-off results.",clothes:[["on",58],["displaced",34],["off",8]],bra:[["hidden",52],["showing",38],["off",10]],panties:[["hidden",60],["showing",33],["off",7]]},{description:"Strong variation: clothes and underwear may be on, showing, or off.",clothes:[["on",28],["displaced",44],["off",28]],bra:[["hidden",22],["showing",46],["off",32]],panties:[["hidden",30],["showing",45],["off",25]]},{description:"Maximum variation, weighted toward displaced or removed clothing.",clothes:[["on",14],["displaced",28],["off",58]],bra:[["hidden",10],["showing",27],["off",63]],panties:[["hidden",14],["showing",31],["off",55]]}];function St(t,e){const i=Math.max(0,Math.min(.999999,e()))*100;let s=0;for(const[a,r]of t)if(s+=r,i<s)return a;return t[t.length-1][0]}function Ke(t,e=Math.random){const i=Bt[Math.max(0,Math.min(Bt.length-1,Math.round(t)))],s=St(i.clothes,e);let a=St(i.bra,e),r=St(i.panties,e);return s==="off"&&(a==="hidden"&&(a="showing"),r==="hidden"&&(r="showing")),{clothes:s,bra:a,panties:r}}function Ze(t){if(!t||typeof t!="object"||Array.isArray(t))return!1;const e=t;return typeof e.color=="string"&&typeof e.item=="string"}function Xt(t){if(!t||typeof t!="object"||Array.isArray(t))return{...de};const e=t;return Object.fromEntries(j.map(({key:i})=>{var a,r;const s=e[i];return typeof s=="string"?[i,{color:"",item:s}]:Ze(s)?[i,{color:s.color,item:s.item,...s.off?{off:!0}:{},...(a=s.prompt)!=null&&a.trim()?{prompt:s.prompt.trim()}:{},...(r=s.noun)!=null&&r.trim()?{noun:s.noun.trim()}:{}}]:[i,{color:"",item:""}]}))}function Je(t){return JSON.stringify(Object.fromEntries(j.map(e=>{const i=t[e.key];return[e.key,G(i)?`${i.color.trim().toLowerCase()}|${i.item.trim().toLowerCase()}|${_t(e,i).toLowerCase()}|${vt(e,i).toLowerCase()}`:"|"]})))}var Qe=Object.defineProperty,ti=Object.getOwnPropertyDescriptor,E=(t,e,i,s)=>{for(var a=s>1?void 0:s?ti(e,i):e,r=t.length-1,n;r>=0;r--)(n=t[r])&&(a=(s?n(e,i,a):n(a))||a);return s&&a&&Qe(e,i,a),a};const Mt=[{id:"neutral",label:"Neutral",hint:"Login screen and error popups"},{id:"happy",label:"Happy",hint:"Chat · Sweet mode"},{id:"mischievous",label:"Mischievous",hint:"Chat · Playful mode"},{id:"surprised",label:"Surprised",hint:"Chat · Bold mode"},{id:"thinking",label:"Thinking",hint:"Chat · Roleplay mode"},{id:"shy",label:"Shy",hint:"Bashful, flustered, caught out",borrows:"Surprised"},{id:"smug",label:"Smug",hint:"Proud of herself, vindicated",borrows:"Mischievous"},{id:"sad",label:"Sad",hint:"Hurt, wistful, let down",borrows:"Thinking"},{id:"annoyed",label:"Annoyed",hint:"Irritated, pouty, impatient",borrows:"Thinking"},{id:"sleepy",label:"Sleepy",hint:"Tired, dozy, winding down",borrows:"Neutral"},{id:"loving",label:"Loving",hint:"Tender, adoring, soft on you",borrows:"Happy"},{id:"excited",label:"Excited",hint:"Thrilled, eager, buzzing",borrows:"Happy"}],ut=["Calm","Warm","Flirty","Heated","Peak"],ei=Mt.length*ut.length,J=(t,e)=>`${t}:${e}`;let I=class extends mt{constructor(){super(...arguments),this.outfits=[],this.activities=[],this.backgrounds=[],this.defaultBackground="",this.backgroundDraft=null,this.backgroundBusy=!1,this.backgroundVersion=0,this.wornOutfit=he(),this.outfitDraft=null,this.outfitBusy=!1,this.outfitError="",this.outfitCoverVersion=0}connectedCallback(){super.connectedCallback(),this.loadOutfits()}async refresh(){await this.loadOutfits()}async loadBackgrounds(){try{const t=await g.libbyBackgrounds();this.backgrounds=t.backgrounds,this.defaultBackground=t.default??""}catch{}}async setDefaultBackground(t){try{const e=await g.setLibbyDefaultBackground(t);this.defaultBackground=e.default,L(t?"That's where she'll be unless a conversation moves her.":"No default room — the plain stage until she moves.","success")}catch(e){L(e.message||"Couldn't set the default background.","error")}}async loadOutfits(){this.loadBackgrounds();try{const t=await g.libbyOutfits();this.outfits=t.outfits,this.activities=t.activities??[],this.outfitError="",this.wornOutfit&&!t.outfits.some(e=>e.id===this.wornOutfit)&&(this.wornOutfit="",At(""))}catch(t){this.outfitError=t.message||"Couldn't load your wardrobes."}}render(){return o`
      <div class="wardrobe-intro">
        An outfit swaps Libby's artwork: one sprite per expression, per heat tier —
        ${ei} in all for a complete wardrobe — plus one picture for each of the
      ...
      <div class="outfit-cards">
        ...
        >
          <img class="cover" src=${ue("happy",1)} alt="Default Libby" />
    ...
    `}renderBackgrounds(){const t=this.backgroundDraft;return o`
      ...
      <div class="scene-cards">
        ${this.backgrounds.map(e=>o`<button class="scene-card" title="Edit ${e.name}" @click=${()=>this.openBackgroundEditor(e)}>
          ${e.hasImage?o`<img class="cover" src=${g.libbyBackgroundURL(e.id,this.backgroundVersion)} alt=${e.name} loading="lazy" />`:o`<div class="cover-empty">No picture yet</div>`}
      ...
      ${t?o`<div class="scene-editor">
        <label class="drop"
          ...
          ${t.image?o`<img src=${t.image} alt="" />`:t.id&&t.hasImage?o`<img src=${g.libbyBackgroundURL(t.id,this.backgroundVersion)} alt="" />`:o`<span>Drop a picture here<br />or click to browse<br /><small>Landscape works best</small></span>`}
    ...
    `}openBackgroundEditor(t){this.backgroundDraft={id:t.id,name:t.name,tags:t.tags.join(", "),hasImage:t.hasImage}}stageBackground(t){if(!t||!this.backgroundDraft)return;const e=new FileReader;e.onload=()=>{this.backgroundDraft&&(this.backgroundDraft={...this.backgroundDraft,image:String(e.result)})},e.readAsDataURL(t)}async saveBackground(){const t=this.backgroundDraft;if(!(!t||!t.name.trim())){this.backgroundBusy=!0;try{const e=await g.saveLibbyBackground({id:t.id,name:t.name.trim(),tags:t.tags.split(",").map(i=>i.trim()).filter(Boolean)});t.image&&await g.setLibbyBackgroundImage(e.id,t.image),this.backgroundVersion++,this.backgroundDraft=null,await this.loadBackgrounds(),!t.image&&!t.hasImage&&L("Saved — add a picture and she can go there.","success")}catch(e){L(e.message||"Couldn't save that background.","error")}finally{this.backgroundBusy=!1}}}async deleteBackground(){const t=this.backgroundDraft;if(!(!(t!=null&&t.id)||!confirm(`Delete "${t.name}"?`))){this.backgroundBusy=!0;try{await g.deleteLibbyBackground(t.id),this.backgroundDraft=null,await this.loadBackgrounds()}catch(e){L(e.message||"Couldn't delete that background.","error")}finally{this.backgroundBusy=!1}}}wearOutfit(t){this.wornOutfit=t,At(t)}openOutfitEditor(t){const e=[];if(t.emotionLevels)for(const[i,s]of Object.entries(t.emotionLevels))for(const a of s)e.push(J(i,a));else for(const i of t.emotions)e.push(J(i,0));for(const[i,s]of Object.entries(t.activityLevels??{}))for(const a of s)e.push(J(i,a));this.outfitDraft={id:t.id,name:t.name,existing:e,staged:{},removed:[],level:0,hasCover:t.hasThumb!==!1}}isActivity(t){return this.activities.some(e=>e.id===t)}toggleRemove(t){const e=this.outfitDraft;if(!e)return;const i=e.removed.includes(t)?e.removed.filter(a=>a!==t):[...e.removed,t],s={...e.staged};e.removed.includes(t)||delete s[t],this.outfitDraft={...e,removed:i,staged:s}}renderSlot(t,e,i,s){const a=this.isActivity(e)?0:t.level,r=J(e,a),n=t.staged[r],l=t.removed.includes(r),d=!n&&t.id&&t.existing.includes(r)?g.libbyEmotionURL(t.id,e,a,this.outfitCoverVersion):"";return o`
      <label
        ...
        @drop=${h=>{var m,b;h.preventDefault(),h.currentTarget.classList.remove("dragover"),this.stageEmotion(e,(b=(m=h.dataTransfer)==null?void 0:m.files)==null?void 0:b[0])}}
      >
        ${n?o`<img src=${n} alt=${i} />`:d?o`<img src=${d} alt=${i} />`:o`<div class="drop-hint">Drop an image here<br />or click to browse</div>`}
        ${d||n?o`<span class="slot-actions">
          ${d&&t.id?o`<button type="button" class="slot-act" title="Edit this sprite in the studio — adjust the cutout, redo it, or replace it"
        ...
        <input
          ...
          accept="image/*"
          style="display:none;"
          @change=${h=>{var b;const m=h.target;this.stageEmotion(e,(b=m.files)==null?void 0:b[0]),m.value=""}}
        />
      </label>
    `}renderCoverPicker(t){const e=t.cover||(t.id&&t.hasCover?g.libbyOutfitThumbURL(t.id,this.outfitCoverVersion):"");return o`<div class="cover-picker">
...
This also deletes ${e} generated square${e===1?"":"s"} the outfit studio is holding for it.`:"";if(confirm(`Delete the “${t.name}” outfit?${i}`)){this.outfitBusy=!0;try{await g.deleteLibbyOutfit(t.id);const a=it("libraryDelete");L(a.message,"success",{emotion:a.emotion,intensity:a.intensity}),this.wornOutfit===t.id&&this.wearOutfit(""),this.outfitDraft=null,await this.loadOutfits()}catch(a){this.outfitError=a.message}finally{this.outfitBusy=!1}}}renderOutfitCard(t){const e=this.wornOutfit===t.id,i=t.slots??t.emotions.length;return o`<button
    ...
    >
      ${t.hasThumb===!1?o`<div class="cover-empty">No art yet</div>`:o`<img
            class="cover"
            src=${g.libbyOutfitThumbURL(t.id,this.outfitCoverVersion)}
            alt=${t.name}
            loading="lazy"
      ...
      <div class="card-body">
        ...
        <div class="card-meta">
          ${t.emotions.length}/${Mt.length} emotions${i>t.emotions.length?o` · ${i} images`:c}${t.activitySlots?o` · ${t.activitySlots} misc`:c}
  ...
  `];E([p()],I.prototype,"outfits",2);E([p()],I.prototype,"activities",2);E([p()],I.prototype,"backgrounds",2);E([p()],I.prototype,"defaultBackground",2);E([p()],I.prototype,"backgroundDraft",2);E([p()],I.prototype,"backgroundBusy",2);E([p()],I.prototype,"backgroundVersion",2);E([p()],I.prototype,"wornOutfit",2);E([p()],I.prototype,"outfitDraft",2);E([p()],I.prototype,"outfitBusy",2);E([p()],I.prototype,"outfitError",2);E([p()],I.prototype,"outfitCoverVersion",2);I=E([bt("oppai-outfit-wardrobe")],I);const ii=new TextEncoder;function T(t,e,i){t.setUint16(e,i,!0)}function M(t,e,i){t.setUint32(e,i>>>0,!0)}let nt;function si(t){if(!nt){nt=new Uint32Array(256);for(let i=0;i<256;i++){let s=i;for(let a=0;a<8;a++)s=s&1?3988292384^s>>>1:s>>>1;nt[i]=s>>>0}}let e=4294967295;for(const i of t)e=nt[(e^i)&255]^e>>>8;return(e^4294967295)>>>0}function ai(t){return{date:Math.min(2107,Math.max(1980,t.getFullYear()))-1980<<9|t.getMonth()+1<<5|t.getDate(),time:t.getHours()<<11|t.getMinutes()<<5|Math.floor(t.getSeconds()/2)}}function oi(t){return t.buffer instanceof ArrayBuffer?t.byteOffset===0&&t.byteLength===t.buffer.byteLength?t.buffer:t.buffer.slice(t.byteOffset,t.byteOffset+t.byteLength):t.slice().buffer}async function ri(t){return t instanceof Uint8Array?t:t instanceof ArrayBuffer?new Uint8Array(t):new Uint8Array(await t.arrayBuffer())}async function ni(t,e=new Date){if(t.length>65535)throw new Error("Too many files for one ZIP archive.");const i=ai(e),s=[],a=[];let r=0;for(const b of t){const y=b.name.replaceAll("\\","_").replaceAll("/","_")||"file",w=ii.encode(y),$=await ri(b.data);if(w.length>65535||$.length>4294967295)throw new Error(`File is too large for ZIP: ${y}`);const z=si($),S=new Uint8Array(30+w.length),C=new DataView(S.buffer);M(C,0,67324752),T(C,4,20),T(C,6,2048),T(C,8,0),T(C,10,i.time),T(C,12,i.date),M(C,14,z),M(C,18,$.length),M(C,22,$.length),T(C,26,w.length),T(C,28,0),S.set(w,30),s.push({header:S,data:$});const P=new Uint8Array(46+w.length),k=new DataView(P.buffer);M(k,0,33639248),T(k,4,20),T(k,6,20),T(k,8,2048),T(k,10,0),T(k,12,i.time),T(k,14,i.date),M(k,16,z),M(k,20,$.length),M(k,24,$.length),T(k,28,w.length),T(k,30,0),T(k,32,0),T(k,34,0),T(k,36,0),M(k,38,0),M(k,42,r),P.set(w,46),a.push(P),r+=S.length+$.length}const n=a.reduce((b,y)=>b+y.length,0),l=new Uint8Array(22),d=new DataView(l.buffer);M(d,0,101010256),T(d,4,0),T(d,6,0),T(d,8,t.length),T(d,10,t.length),M(d,12,n),M(d,16,r),T(d,20,0);const m=[...s.flatMap(b=>[b.header,b.data]),...a,l].map(oi);return new Blob(m,{type:"application/zip"})}var li=Object.defineProperty,di=Object.getOwnPropertyDescriptor,R=(t,e,i,s)=>{for(var a=s>1?void 0:s?di(e,i):e,r=t.length-1,n;r>=0;r--)(n=t[r])&&(a=(s?n(e,i,a):n(a))||a);return s&&a&&li(e,i,a),a};const pi=40;let D=class extends mt{constructor(){super(...arguments),this.boards=[],this.board="none",this.items=[],this.total=0,this.loading=!1,this.error="",this.expanded=null,this.busy=!1,this.newBoard="",this.savedNames=new Set,this.selecting=!1,this.selected=new Set,this.metadata=new Map}connectedCallback(){super.connectedCallback(),ge(this,"generation gallery"),this.refresh()}get selectedBoard(){return this.board}announceBoard(){this.dispatchEvent(new CustomEvent("board-changed",{detail:{board:this.board},bubbles:!0,composed:!0}))}async refresh(){this.error="";try{const t=await g.galleryBoards();this.boards=t.boards,!this.boards.some(e=>e.id===this.board)&&this.boards.length&&(this.board=this.boards[0].id),this.announceBoard()}catch(t){this.error=t.message;return}await this.loadPage(!0)}async loadPage(t){if(!this.loading){this.loading=!0;try{const e=t?0:this.items.length,i=await g.galleryImages(this.board,e,pi);this.items=t?i.items:[...this.items,...i.items],this.total=i.total}catch(e){this.error=e.message}finally{this.loading=!1}}}pickBoard(t){this.board!==t&&(this.board=t,this.items=[],this.announceBoard(),this.loadPage(!0))}async createBoard(){const t=this.newBoard.trim();if(!(!t||this.busy)){this.busy=!0,this.error="";try{const e=await g.createGalleryBoard(t);this.newBoard="",await this.refresh(),this.pickBoard(e.id),this.dispatchEvent(new CustomEvent("boards-changed",{bubbles:!0,composed:!0}))}catch(e){this.error=e.message}finally{this.busy=!1}}}async deleteBoard(){const t=this.boards.find(e=>e.id===this.board);if(!(!t||t.id==="none"||this.busy)&&confirm(`Delete the “${t.name}” gallery? Its images move back to Uncategorized.`)){this.busy=!0,this.error="";try{await g.deleteGalleryBoard(t.id);const e=it("galleryDelete");L(e.message,"success",{emotion:e.emotion,intensity:e.intensity}),this.board="none",this.items=[],await this.refresh(),this.dispatchEvent(new CustomEvent("boards-changed",{bubbles:!0,composed:!0}))}catch(e){this.error=e.message}finally{this.busy=!1}}}async deleteImage(t){var e;if(!this.busy){this.busy=!0;try{await g.deleteGalleryImage(t.name);const i=it("galleryDelete");L(i.message,"success",{emotion:i.emotion,intensity:i.intensity}),this.items=this.items.filter(s=>s.name!==t.name),this.total=Math.max(0,this.total-1),this.boards=this.boards.map(s=>s.id===this.board?{...s,count:Math.max(0,s.count-1)}:s),((e=this.expanded)==null?void 0:e.name)===t.name&&(this.expanded=null)}catch(i){this.error=i.message}finally{this.busy=!1}}}async saveToLibrary(t){if(!(this.busy||this.savedNames.has(t.name))){this.busy=!0;try{await g.saveGalleryImage({name:t.name}),this.savedNames=new Set(this.savedNames).add(t.name),this.dispatchEvent(new CustomEvent("imported",{detail:{count:1,kind:"image",title:t.name},bubbles:!0,composed:!0}))}catch(e){this.error=e.message}finally{this.busy=!1}}}async openShareMenu(t,e,i){let s=[];try{s=(await g.chatWorkspace()).characters??[]}catch(a){L(a.message||"Couldn't load your chat characters.","error");return}if(!s.length){L("No chat characters yet — add one in Chat first.","error");return}Ct({x:e,y:i,title:"Show this to",items:s.map(a=>({label:a.name,icon:"person",run:()=>void this.share(t,a)}))})}async imageInfo(t){const e=this.metadata.get(t.name);if(e)return e;const i=Se(await g.galleryImageMetadata(t.name));return this.metadata.set(t.name,i),i}openImageMenu(t,e){e.preventDefault(),Ct({x:e.clientX,y:e.clientY,title:t.name,items:[{label:"Copy generation metadata",icon:"content_copy",run:()=>void this.copyMetadata(t)},{label:"Use same generation parameters",icon:"replay",run:()=>void this.reuseMetadata(t)},{label:"Export PNG for Civitai",icon:"download",run:()=>void this.exportImage(t)},{label:"Send to chat",icon:"forum",run:()=>void this.openShareMenu(t,e.clientX,e.clientY)}]})}async copyMetadata(t){try{if(!await re(V(await this.imageInfo(t))))throw new Error("Clipboard permission was denied.");L("Generation metadata copied.","success")}catch(e){L(e.message||"Couldn't copy generation metadata.","error")}}async reuseMetadata(t){try{const e=await this.imageInfo(t);this.dispatchEvent(new CustomEvent("reuse-generation",{detail:e,bubbles:!0,composed:!0}))}catch(e){L(e.message||"Couldn't load generation metadata.","error")}}async exportImage(t){try{const e=await this.imageInfo(t),i=t.name.replace(/\.[a-z0-9]+$/i,"")||"generated-image";await ne(g.galleryFullURL(t.name),`${i}-civitai.png`,V(e),et(e)),L("PNG exported with Civitai metadata.","success")}catch(e){L(e.message||"Couldn't export that image.","error")}}async share(t,e){try{await fe(g.galleryFullURL(t.name),e.id,t.name),this.expanded=null,this.dispatchEvent(new CustomEvent("open-chat",{bubbles:!0,composed:!0}))}catch(i){L(i.message||`Couldn't share with ${e.name}.`,"error")}}toggleSelecting(){this.selecting=!this.selecting,this.selecting||(this.selected=new Set)}toggleSelected(t){const e=new Set(this.selected);e.has(t)?e.delete(t):e.add(t),this.selected=e}async deleteSelected(){const t=[...this.selected];if(!(!t.length||this.busy)){this.busy=!0;try{await g.deleteGalleryImages(t);const e=it("galleryDelete",{count:t.length});L(e.message,"success",{emotion:e.emotion,intensity:e.intensity});const i=this.selected;this.items=this.items.filter(s=>!i.has(s.name)),this.total=Math.max(0,this.total-t.length),this.boards=this.boards.map(s=>s.id===this.board?{...s,count:Math.max(0,s.count-t.length)}:s),this.selected=new Set,this.selecting=!1}catch(e){this.error=e.message}finally{this.busy=!1}}}async addSelectedToBoard(t){const e=[...this.selected];if(!(!e.length||!t||t===this.board||this.busy)){this.busy=!0;try{await g.addGalleryImagesToBoard(t,e);const i=this.selected;this.items=this.items.filter(s=>!i.has(s.name)),this.total=Math.max(0,this.total-e.length),this.selected=new Set,this.selecting=!1,await this.refresh()}catch(i){this.error=i.message}finally{this.busy=!1}}}render(){const t=this.boards.find(e=>e.id===this.board);return o`
      <div class="panel">
        <div class="head">
        ...
        ${this.items.length?o`<div class="grid">
              ${this.items.map(e=>{const i=this.selected.has(e.name);return o`
                  ...
                  >
                    <img src=${g.galleryThumbURL(e.name)} alt="Generated image" loading="lazy" />
    ...
    `}renderExpanded(t){const e=this.savedNames.has(t.name);return o`
      <div class="overlay" @click=${i=>{i.target===i.currentTarget&&(this.expanded=null)}}>
        <img src=${g.galleryFullURL(t.name)} alt="Generated image"
        ...
        <div class="overlay-actions">
          ...
          <button class="obtn" @click=${()=>this.dispatchEvent(new CustomEvent("cut-out",{detail:{url:g.galleryFullURL(t.name),name:t.name},bubbles:!0,composed:!0}))}>
    ...
    `];R([p()],D.prototype,"boards",2);R([p()],D.prototype,"board",2);R([p()],D.prototype,"items",2);R([p()],D.prototype,"total",2);R([p()],D.prototype,"loading",2);R([p()],D.prototype,"error",2);R([p()],D.prototype,"expanded",2);R([p()],D.prototype,"busy",2);R([p()],D.prototype,"newBoard",2);R([p()],D.prototype,"savedNames",2);R([p()],D.prototype,"selecting",2);R([p()],D.prototype,"selected",2);D=R([bt("oppai-invoke-gallery")],D);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Ot extends me{constructor(e){if(super(e),this.it=c,e.type!==be.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===c||e==null)return this._t=void 0,this.it=e;if(e===ve)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const i=[e];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}}Ot.directiveName="unsafeHTML",Ot.resultType=1;const Kt=xe(Ot),Q={"euler a":"euler_a",euler:"euler","euler karras":"euler_k",lms:"lms","lms karras":"lms_k",heun:"heun","heun karras":"heun_k",dpm2:"kdpm_2","dpm2 karras":"kdpm_2_k","dpm2 a":"kdpm_2_a","dpm2 a karras":"kdpm_2_a_k","dpm++ 2s a":"dpmpp_2s","dpm++ 2s a karras":"dpmpp_2s_k","dpm++ 2m":"dpmpp_2m","dpm++ 2m karras":"dpmpp_2m_k","dpm++ 2m sde":"dpmpp_2m_sde","dpm++ 2m sde karras":"dpmpp_2m_sde_k","dpm++ 3m sde":"dpmpp_3m","dpm++ 3m sde karras":"dpmpp_3m_k","dpm++ sde":"dpmpp_sde","dpm++ sde karras":"dpmpp_sde_k",ddim:"ddim",ddpm:"ddpm",deis:"deis",unipc:"unipc",lcm:"lcm",pndm:"pndm",tcd:"tcd"};function ci(t){if(!t)return"";const e=t.trim().toLowerCase().replace(/\s+/g," ");if(Q[e])return Q[e];if(Object.values(Q).includes(e))return e;const i=e.split(" ");for(let s=i.length-1;s>=1;s--){const a=i.slice(0,s).join(" ");if(Q[a])return Q[a]}return""}function hi(t){const e=/^\s*(\d{2,5})\s*[x×]\s*(\d{2,5})\s*$/i.exec(t??"");if(!e)return null;const i=Number(e[1]),s=Number(e[2]);return i>=64&&s>=64?[i,s]:null}function Zt(t){var r;const e=(t.prompt??"").trim();if(!e)return null;const i={prompt:e};(r=t.negativePrompt)!=null&&r.trim()&&(i.negativePrompt=t.negativePrompt.trim());const s=ci(t.sampler);s&&(i.sampler=s),t.steps&&t.steps>0&&t.steps<=150&&(i.steps=Math.round(t.steps)),t.cfgScale&&t.cfgScale>0&&t.cfgScale<=30&&(i.cfgScale=t.cfgScale),t.seed&&t.seed>0&&(i.seed=t.seed);const a=hi(t.size)??(t.width>=64&&t.height>=64?[t.width,t.height]:null);return a&&([i.width,i.height]=a),i}var ui=Object.defineProperty,gi=Object.getOwnPropertyDescriptor,x=(t,e,i,s)=>{for(var a=s>1?void 0:s?gi(e,i):e,r=t.length-1,n;r>=0;r--)(n=t[r])&&(a=(s?n(e,i,a):n(a))||a);return s&&a&&ui(e,i,a),a};const fi=[{id:"",label:"All"},{id:"checkpoint",label:"Checkpoints"},{id:"lora",label:"LoRAs"},{id:"embedding",label:"Embeddings"},{id:"vae",label:"VAEs"},{id:"controlnet",label:"ControlNet"},{id:"upscaler",label:"Upscalers"}],mi=[{id:"",label:"Most downloaded"},{id:"rated",label:"Highest rated"},{id:"liked",label:"Most liked"},{id:"newest",label:"Newest"},{id:"collected",label:"Most collected"},{id:"discussed",label:"Most discussed"},{id:"images",label:"Most images"}],bi=[{id:"",label:"All time"},{id:"year",label:"This year"},{id:"month",label:"This month"},{id:"week",label:"This week"},{id:"day",label:"Today"}],vi=["SD 1.5","SD 2.1","SDXL 1.0","Pony","Illustrious","NoobAI","Flux.1 D","Flux.1 S","SD 3.5","Kolors","Hunyuan 1","Wan Video"];let v=class extends mt{constructor(){super(...arguments),this.tab="browse",this.q="",this.type="",this.sort="",this.period="",this.base="",this.category="",this.creator="",this.nsfw=!0,this.categories=[],this.items=[],this.cursor="",this.loading=!1,this.error="",this.detail=null,this.detailLoading=!1,this.versionId=0,this.shownImage="",this.zoomed="",this.galleryOpen=!1,this.gallery=[],this.galleryCursor="",this.galleryLoading=!1,this.gallerySort="",this.picked=null,this.copied=!1,this.promptsNeedKey=!1,this.jobs=[],this.installing=!1,this.me=null,this.meError="",this.meLoading=!1,this.myImages=[],this.myImagesCursor="",this.installed=[],this.installedLoading=!1,this.installedError="",this.installedFilter="all",this.syncing="",this.syncNote="",this.pinning="",this.pinVersion=""}connectedCallback(){super.connectedCallback(),this.search(!0),this.loadCategories(),this.pollJobs(),this.jobTimer=window.setInterval(()=>void this.pollJobs(),5e3)}disconnectedCallback(){super.disconnectedCallback(),this.jobTimer&&clearInterval(this.jobTimer)}async loadCategories(){try{this.categories=(await g.civitaiCategories()).categories}catch{this.categories=[]}}async pollJobs(){try{const e=(await g.civitaiInstalls()).jobs.filter(s=>s.status!=="cancelled").slice(0,5),i=e.some(s=>s.status==="completed")&&!this.jobs.some(s=>s.status==="completed");this.jobs=e,i&&this.tab==="installed"&&this.loadInstalled(!1)}catch{}}async search(t){if(!this.loading){this.loading=!0,this.error="";try{const e=await g.civitaiSearch({q:this.q||void 0,type:this.type||void 0,category:this.category||void 0,sort:this.sort||void 0,period:this.period||void 0,base:this.base||void 0,creator:this.creator||void 0,nsfw:this.nsfw,cursor:t?void 0:this.cursor||void 0});this.items=t?e.items:[...this.items,...e.items],this.cursor=e.nextCursor??""}catch(e){this.error=e.message}finally{this.loading=!1}}}setAnd(t,e){switch(t){case"type":this.type=e;break;case"sort":this.sort=e;break;case"period":this.period=e;break;case"base":this.base=e;break;case"category":this.category=e;break;case"creator":this.creator=e;break}this.tab="browse",this.search(!0)}async openDetail(t){const e=typeof t=="number"?t:t.id;if(typeof t!="number"){this.detail=t;const i=t.versions[0];this.versionId=(i==null?void 0:i.id)??0,this.shownImage=(i==null?void 0:i.images[0])??""}else this.detail=null;this.galleryOpen=!1,this.gallery=[],this.galleryCursor="",this.detailLoading=!0;try{const i=await g.civitaiModel(e);this.detail=i;const s=i.versions.find(a=>a.id===this.versionId)??i.versions[0];this.versionId=(s==null?void 0:s.id)??0,this.shownImage=(s==null?void 0:s.images[0])??this.shownImage}catch(i){this.error=i.message,this.detail||(this.detail=null)}finally{this.detailLoading=!1}}closeDetail(){this.detail=null,this.galleryOpen=!1,this.picked=null}currentVersion(){var t;return(t=this.detail)==null?void 0:t.versions.find(e=>e.id===this.versionId)}pickVersion(t){this.versionId=t.id,this.shownImage=t.images[0]??"",this.galleryOpen&&(this.gallery=[],this.galleryCursor="",this.loadGallery(!0))}async install(t){if(!(this.installing||!t.downloadUrl||!this.detail)){this.installing=!0,this.error="";try{await g.civitaiInstall(t.downloadUrl,{modelId:this.detail.id,versionId:t.id}),await this.pollJobs()}catch(e){this.error=e.message}finally{this.installing=!1}}}async loadGallery(t,e){if(!this.galleryLoading){this.galleryLoading=!0;try{const i=await g.civitaiImages({versionId:e?void 0:this.versionId||void 0,username:e,sort:this.gallerySort||void 0,nsfw:this.nsfw,cursor:t?void 0:this.galleryCursor||void 0});e?(this.myImages=t?i.items:[...this.myImages,...i.items],this.myImagesCursor=i.nextCursor??""):(this.gallery=t?i.items:[...this.gallery,...i.items],this.galleryCursor=i.nextCursor??"",this.promptsNeedKey=i.items.length>0&&i.withPrompts===0&&!i.keySet)}catch(i){this.error=i.message}finally{this.galleryLoading=!1}}}toggleGallery(){this.galleryOpen=!this.galleryOpen,this.galleryOpen&&this.gallery.length===0&&this.loadGallery(!0)}usePrompt(t){const e=Zt(t);e&&(this.dispatchEvent(new CustomEvent("use-prompt",{detail:e,bubbles:!0,composed:!0})),this.picked=null,this.zoomed="")}async copyPrompt(t){try{await navigator.clipboard.writeText(t.prompt??""),this.copied=!0,setTimeout(()=>this.copied=!1,1500)}catch{}}async loadMe(){if(!(this.me||this.meLoading)){this.meLoading=!0,this.meError="";try{this.me=await g.civitaiMe(),this.myImages=[],this.myImagesCursor="",this.loadGallery(!0,this.me.username)}catch(t){this.meError=t.message}finally{this.meLoading=!1}}}async loadInstalled(t){if(!this.installedLoading){this.installedLoading=!0,this.installedError="";try{this.installed=(await g.civitaiInstalled(t)).models}catch(e){this.installedError=e.message}finally{this.installedLoading=!1}}}async sync(t,e){if(!this.syncing){this.syncing=t.key,this.syncNote="";try{const i=await g.civitaiSync(t.key,e),s="modelId"in i&&i.modelId;this.syncNote=s?`${t.name}: cover, description and trigger words set from “${i.modelName}”.`:`${t.name}: Civitai does not know this file. Paste a version id to link it by hand.`,this.pinning="",this.pinVersion="",await this.loadInstalled(!1)}catch(i){this.syncNote=`${t.name}: ${i.message}`}finally{this.syncing=""}}}selectTab(t){this.tab=t,this.closeDetail(),t==="account"&&this.loadMe(),t==="installed"&&this.installed.length===0&&this.loadInstalled(!1)}jobLabel(t){return t.status==="downloading"&&t.totalBytes?`downloading ${Math.round((t.bytes??0)/t.totalBytes*100)}%`:t.status}render(){return o`
      <div class="wrap">
        <div class="topbar">
      ...
      ${this.picked?this.renderPicked(this.picked):this.zoomed?o`<div class="zoom plain" @click=${()=>this.zoomed=""}>
            <img src=${g.civitaiImageURL(this.zoomed)} alt="Preview" />
          </div>`:c}
    `}renderBrowse(){return o`
      <div class="controls">
        <input
          type="search"
      ...
      <div class="controls">
        ${fi.map(t=>o`<button class="chip ${this.type===t.id?"on":""}" @click=${()=>this.setAnd("type",t.id)}>${t.label}</button>`)}
    ...
    `}renderCard(t){var i,s;const e=(i=t.versions[0])==null?void 0:i.images[0];return o`
      <button class="card" @click=${()=>this.openDetail(t)}>
        ${e?o`<img src=${g.civitaiImageURL(e)} alt=${t.name} loading="lazy" />`:o`<div class="noimg"><span class="material-symbols-rounded" style="font-size:34px;">image</span></div>`}
    ...
    `}renderDetail(t){var i;const e=this.currentVersion();return o`
      <div class="overlay" @click=${s=>{s.target===s.currentTarget&&this.closeDetail()}}>
        <div class="detail" role="dialog" aria-label=${t.name}>
          <div>
            ${this.shownImage?o`<img class="big" src=${g.civitaiImageURL(this.shownImage)} alt=${t.name}
            ...
            ${e&&e.images.length>1?o`<div class="thumbs">
                  ${e.images.map(s=>o`<img src=${g.civitaiImageURL(s)} class=${s===this.shownImage?"on":""}
          ...
          <div>
            ...
            <div class="sub">
              ...
              ${t.creator?o`<button class="creator" title="Show this creator's models" @click=${()=>{this.closeDetail(),this.setAnd("creator",t.creator??"")}}>
                    ${t.creatorImage?o`<img src=${g.civitaiImageURL(t.creatorImage)} alt="" />`:o`<span class="material-symbols-rounded" style="font-size:16px;">person</span>`}
                    ${t.creator}
                  </button>`:c}
              <span>⤓ ${lt(t.downloads)}</span>
            ...
            ${t.versions.length>1?o`<div class="vlabel">Version</div>
                  ...
                  </div>`:e?o`<div class="vlabel">Version ${e.name} · ${e.base}${e.publishedAt?` · ${xi(e.publishedAt)}`:""}</div>`:c}
            ...
            <div class="actions">
              ${e?e.installed?o`<button class="primary" disabled>
                      ...
                      Install to InvokeAI${e.sizeMB?` (${Qt(e.sizeMB)})`:""}
                    </button>`:c}
    ...
    `}renderGallery(){return o`
      ...
      ${this.gallery.length?o`<div class="gal-grid">
            ${this.gallery.map(t=>o`<button title=${t.prompt?"Has a prompt":"No prompt kept"} @click=${()=>this.picked=t}>
                <img src=${g.civitaiImageURL(t.url)} alt="" loading="lazy" />
    ...
    `}renderPicked(t){const e=Zt(t);return o`
      <div class="zoom ${e?"":"plain"}" @click=${i=>{i.target===i.currentTarget&&(this.picked=null)}}>
        <img src=${g.civitaiImageURL(t.url)} alt="" @click=${()=>this.picked=null} />
        ${e?o`<div class="pane">
    ...
    `}renderAccount(){return this.meLoading?o`<div class="note">Asking Civitai whose key this is…</div>`:this.me?o`
      <div class="who">
        ${this.me.image?o`<img src=${g.civitaiImageURL(this.me.image)} alt="" />`:o`<span class="material-symbols-rounded" style="font-size:44px; color:var(--oppai-text-muted);">account_circle</span>`}
        <div>
      ...
      <div class="controls">
        <button class="chip on" @click=${()=>{var t;return this.setAnd("creator",((t=this.me)==null?void 0:t.username)??"")}}>
      ...
      ${this.myImages.length?o`<div class="gal-grid">
            ${this.myImages.map(t=>o`<button @click=${()=>this.picked=t}>
                <img src=${g.civitaiImageURL(t.url)} alt="" loading="lazy" />
                ${t.prompt?o`<span class="has">prompt</span>`:c}
              </button>`)}
          </div>`:c}
      ${this.galleryLoading?o`<div class="note" style="padding:12px 0;">Loading pictures…</div>`:this.myImages.length?this.myImagesCursor?o`<button class="more" @click=${()=>{var t;return this.loadGallery(!1,(t=this.me)==null?void 0:t.username)}}>More pictures</button>`:c:o`<div class="note" style="padding:12px 0;">No posted pictures.</div>`}
    `:o`<div class="note">
    ...
    `}renderInstalledRow(t){const e=t.civitai,i=t.hasCover?t.type==="lora"?g.loraThumbURL(t.name):g.modelThumbURL(t.key):"";return o`
      <div class="row">
        ...
        <div style="min-width:0;">
          ...
          ${e!=null&&e.previews.length?o`<div class="previews">
                ${e.previews.slice(0,6).map(s=>o`<img src=${g.civitaiImageURL(s)} alt="" loading="lazy" @click=${()=>this.zoomed=s} />`)}
              </div>`:c}
          ${this.pinning===t.key?o`<div class="pin">
                <input type="text" placeholder="Civitai version id" .value=${this.pinVersion}
                  @input=${s=>this.pinVersion=s.target.value} />
        ...
        <div class="rb">
          ...
          ${e?c:o`<button class="ghost" title="Link by a version id from the site" @click=${()=>{this.pinning=t.key,this.pinVersion=""}}>
    ...
    `}renderStudioToolbar(){const t=this.currentOutfitShots(),e=t.filter(s=>{var a;return(((a=s.outfitSlot)==null?void 0:a.index)??0)<H}).length,i=t.length-e;return o`<div class="canvas-toolbar studio-toolbar">
      ...
      <div class="zoom-tabs" title="Square size">
        ${ie.map((s,a)=>o`<button class="zoom-tab ${this.sheetZoom===a?"on":""}"
      ...
      </div>`;const t=ie[this.sheetZoom],e=t?`--cell:${t}px`:"";return this.sheetTab==="misc"?this.renderMiscGrid(e):this.renderFaceMatrix(e,!t)}renderFaceMatrix(t,e){const i=_(this.outfitSlot().slot);return o`<div class="face-matrix ${e?"fit":""}" style=${t}>
      <div class="matrix-corner"></div>
      ${B.map(s=>o`<div class="matrix-col-head" title=${s.face}>${s.label}</div>`)}
      ${A.map((s,a)=>{const r=B.map((l,d)=>this.outfitSlot(a,d,"").slot),n=r.filter(l=>this.shotAt(l)).length;return o`
    ...
    </button>`}squareStatus(t){return t?this.shotMatchesCurrentOutfit(t)?t.cutoutReviewed?{label:"Reviewed and filed — she can wear it",tone:"ready"}:{label:"Generated — the cutout needs a look",tone:"needs"}:{label:"Generated with an older recipe",tone:"stale"}:{label:"Not generated yet",tone:"none"}}renderFocusPanel(){var h;const{slot:t}=this.outfitSlot(),e=this.shotAt(t),i=this.squareStatus(e),s=t.tierLabel==="Misc",a=s?O.find(m=>m.id===t.emotion):void 0,r=s?void 0:B[this.outfitFace],{prompt:n,negative:l}=this.assemblePrompts(),d=this.generating;return o`
      <div class="panel-heading">
      ...
      <div class="panel-scroll focus-scroll">
        <div class="focus-art">
          ${e?o`<img src=${this.previewURL(e)} alt=${t.emotionLabel} style="cursor:zoom-in" title="Expand"
                @click=${()=>this.expandedShot=e} @contextmenu=${m=>this.openShotMenu(e,m)} />`:o`<span class="focus-empty"><span class="material-symbols-rounded">add_photo_alternate</span>Nothing here yet</span>`}
        </div>
        ...
        <div class="focus-actions">
          ...
          <label class="btn ${d?"disabled":""}" title="Use a picture of your own for this square">
            ...
            <input type="file" accept="image/*" style="display:none;" ?disabled=${d}
              @change=${m=>{var y;const b=m.target;this.uploadSquare((y=b.files)==null?void 0:y[0]),b.value=""}} />
          </label>
    ...
    `}renderBatchBar(){const t=this.currentOutfitShots(),e=t.filter(h=>{var m;return(((m=h.outfitSlot)==null?void 0:m.index)??0)<H}).length,i=t.length-e,s=t.filter(h=>h.cutoutReviewed).length,a=this.staleShots().length,r=H+(this.outfitMiscBatch?tt:0),n=e+(this.outfitMiscBatch?i:0),l=Math.max(0,r-n),d=!this.generating&&this.outfitOn&&!!this.assemblePrompts().prompt.trim();return o`<div class="batch-bar">
      ...
      ${this.outfitBatchRunning?o`<button class="btn" @click=${()=>this.cancelOutfitBatch()}>
            ...
            Stop after this one
          </button>`:o`<button class="btn primary" ?disabled=${!d||!l} @click=${()=>void this.generateAllOutfit()}>
            <span class="material-symbols-rounded" style="font-size:17px;">auto_awesome</span>
            Generate ${l} missing
          </button>
          ${a?o`<button class="btn" ?disabled=${!d} @click=${()=>void this.regenerateStale()}>
    ...
    </div>`}async uploadSquare(t){if(!t||!t.type.startsWith("image/")||this.generating)return;const{slot:e,filename:i}=this.outfitSlot();try{const s=await new Promise((d,h)=>{const m=new FileReader;m.onload=()=>d(String(m.result)),m.onerror=()=>h(new Error("couldn't read that file")),m.readAsDataURL(t)}),a=await this.ensureWardrobe();await g.putLibbyOutfitWip(a,e.emotion,e.tier,{imageData:s,filename:i,seed:-1,reviewed:!1,config:this.outfitConfigKey()});const r=this.shotAt(e);r&&!r.id.startsWith("wip-")&&await g.deleteGenPreview(r.id).catch(()=>{});const n=_(e),l={id:`wip-${a}-${e.emotion}-${e.tier}`,seed:-1,saved:!1,outfitFilename:i,outfitSlot:e,outfitConfig:this.outfitConfigKey(),cutoutReviewed:!1,previewVersion:Date.now(),wipOutfitId:a};this.shots=[...this.shots.filter(d=>!d.outfitSlot||_(d.outfitSlot)!==n),l],this.persistDraft(),this.openCutout(this.previewURL(l),t.name,i,l.id)}catch(s){this.showToast(`Couldn't use that image: ${s.message}`)}}async editWardrobeSlot(t,e,i){const s=B.findIndex(d=>d.id===e),a=O.some(d=>d.id===e)?e:"";if(s<0&&!a)return;this.outfitWardrobeId!==t&&(this.outfitWardrobeId=t,this.persistDraft(),await this.loadWipBoard(t)),this.outfitOn=!0;const{slot:r,filename:n}=this.outfitSlot(a?0:i,Math.max(0,s),a);this.selectOutfitSlot(r.index),this.studioView="build";let l=this.shotAt(r);if(!l)try{const d=await fetch(g.libbyEmotionURL(t,e,i,Date.now()),{credentials:"same-origin"});if(!d.ok)throw new Error(`the sprite returned ${d.status}`);const h=await dt(await d.blob());await g.putLibbyOutfitWip(t,r.emotion,r.tier,{imageData:h,filename:n,seed:-1,reviewed:!0,config:this.outfitConfigKey()}),l={id:`wip-${t}-${r.emotion}-${r.tier}`,seed:-1,saved:!1,outfitFilename:n,outfitSlot:r,outfitConfig:this.outfitConfigKey(),cutoutReviewed:!0,previewVersion:Date.now(),wipOutfitId:t},this.shots=[...this.shots,l],this.persistDraft()}catch(d){this.showToast(`Couldn't open that sprite: ${d.message}`);return}this.openCutout(this.previewURL(l),e,l.outfitFilename,l.id)}renderDressSection(){const t=j.filter(({key:i})=>G(this.outfitGear[i])).length,e=o`
    ...
    `}renderModelSection(t){if(!t.length)return this.section("models","Models","0",o`<div class="sec-note">
      ...
      <div class="cards">
        ${t.map(i=>{const s=i.title===this.checkpoint,a=`${g.modelThumbURL(i.title)}&v=${this.thumbVersion}`;return o`
            <div class="card-wrap">
    ...
    `;return this.section("models","Models",String(t.length),e)}renderLoraSection(t,e){if(!t.length)return this.section("loras","LoRAs","0",o`<div class="sec-note">
      ...
      <div class="cards">
        ${a.map(n=>{const l=n.name in this.selectedLoras,d=`${g.loraThumbURL(n.name)}&v=${this.thumbVersion}`;return o`
            <div class="card-wrap">
              ...
              ${l?o`<input class="lora-weight" type="number" min="-2" max="2" step="0.05"
                ...
                @input=${h=>{const m=Number(h.target.value);this.selectedLoras={...this.selectedLoras,[n.name]:Number.isFinite(m)?Math.max(-2,Math.min(2,m)):1}}} />`:c}
            </div>
          `})}
      </div>
    ...
    `;return this.section("loras","LoRAs",String(Object.keys(this.selectedLoras).length||t.length),r)}renderVaeSection(t){const e=t.length?o`
      ...
      <div class="settings">
        <div class="full">
          ...
          >
            ${ki.map(r=>o`<option value=${r.id} ?selected=${r.id===this.scheduler}>${r.label}</option>`)}
          </select>
        </div>
        <div>
          <label class="field">Steps</label>
    ...
    `,r=t.find(n=>n.id===this.templateId);return this.section("templates","Invoke templates",r?r.name:"none",a)}renderCharacterSection(){const t=o`
      ${this.characters.length?o`<div class="cards">
            ${this.characters.map(i=>{const s=this.selectedChars.includes(i.id),a=`${g.characterThumbURL(i.id)}?v=${this.thumbVersion}`;return o`
                <div class="card-wrap">
    ...
    `,e=this.selectedChars.length;return this.section("characters","Characters",e?`${e} picked`:String(this.characters.length),t)}renderPoseSection(){const t=o`
      ...
      ${this.poses.length?o`<div class="cards">
            ${this.poses.map(i=>{const s=this.selectedPoses.includes(i.id),a=`${g.poseThumbURL(i.id)}?v=${this.thumbVersion}`;return o`
                <div class="card-wrap">
...
`).map(i=>i.trim()).filter(i=>i&&!i.startsWith("#")).length;return o`
    ...
    `}renderGearSlot(t){var d,h,m;const e=j.find(b=>b.key===t),i=this.outfitGear[t],s=!!i.item.trim(),a=G(i),r=b=>{this.outfitGear={...this.outfitGear,[t]:{...i,...b}}},n=!!((d=i.prompt)!=null&&d.trim())||!!((h=i.noun)!=null&&h.trim()),l=this.gearPromptOpen===t;return o`<div class="gear-slot ${a?"filled":""} ${i.off?"off":""}" title=${e.hint}>
      ...
      <button class="gear-slot-prompt ${n?"on":""} ${l?"open":""}"
        title=${`What the generator calls this slot — currently "${_t(e,i)}"`}
      ...
      ${l?o`<div class="gear-prompt-edit">
        ...
        <p class="gear-prompt-preview">
          ${a?o`Sends: <code>${Yt(e,i,((m=this.status)==null?void 0:m.backend)??"",this.outfitLockColors)}</code>`:o`Describe something in this slot to see the phrase it sends.`}
        </p>
        ${n?o`<button class="gear-prompt-reset" ?disabled=${this.outfitBatchRunning}
          @click=${()=>r({prompt:"",noun:""})}>Reset to "${e.prompt}"</button>`:c}
      </div>`:c}
    </div>`}clearOutfitLoadout(){this.outfitGear={...de}}renderLoadoutSection(){const t=this.loadouts.find(i=>i.id===this.outfitLoadoutId),e=o`
      <div class="sec-note">
      ...
      <div class="loadout-cards">
        ${this.loadouts.map(i=>o`<div
          ...
          <button class="card-hit" ?disabled=${this.outfitBatchRunning}
            ...
            ${i.hasThumb?o`<img class="cover" src=${g.libbyLoadoutThumbURL(i.id,this.loadoutCoverVersion)} alt="" />`:o`<span class="cover cover-empty material-symbols-rounded">checkroom</span>`}
    ...
    `}renderCharEditor(t){var i;const e=t.imageData??(t.id&&((i=this.characters.find(s=>s.id===t.id))!=null&&i.hasThumb)?`${g.characterThumbURL(t.id)}?v=${this.thumbVersion}`:void 0);return o`
    ...
    `}};u.styles=[gt,Et,ft`
      ...
      .face-matrix {
        display: grid;
        grid-template-columns: 92px repeat(${B.length}, var(--cell, 88px));
        gap: 6px;
        align-items: stretch;
        width: max-content;
        min-width: 100%;
      }
      .face-matrix.fit { grid-template-columns: 92px repeat(${B.length}, minmax(0, 1fr)); width: 100%; min-width: 0; }
    ...
    `];u.DRAFT_FIELDS=new Set(["prompt","negative","checkpoint","vae","templateId","scheduler","width","height","steps","cfg","cfgRescale","clipSkip","seamlessX","seamlessY","vaePrecision","cpuNoise","count","seed","board","selectedLoras","selectedTriggers","selectedChars","selectedPoses","outfitOn","outfitText","outfitGear","outfitFace","outfitMisc","outfitMiscBatch","outfitTier","outfitBackground","outfitLockColors","outfitLoadoutId","outfitWardrobeId","sheetZoom","outfitUnderwearColor","outfitPubicHair","outfitPubicHairColor","camera","detailerEnabled","detailerModel","detailerPrompt","detailerNegative","detailerConfidence","detailerDenoise","detailerMaskBlur","open","showOptions","shots"]);f([se({type:Boolean})],u.prototype,"studio",2);f([p()],u.prototype,"status",2);f([p()],u.prototype,"checkpoint",2);f([p()],u.prototype,"vae",2);f([p()],u.prototype,"templateId",2);f([p()],u.prototype,"showBuiltInTemplates",2);f([p()],u.prototype,"selectedLoras",2);f([p()],u.prototype,"selectedTriggers",2);f([p()],u.prototype,"loraPage",2);f([p()],u.prototype,"outfitOn",2);f([p()],u.prototype,"outfitText",2);f([p()],u.prototype,"outfitGear",2);f([p()],u.prototype,"outfitFace",2);f([p()],u.prototype,"outfitMisc",2);f([p()],u.prototype,"outfitMiscBatch",2);f([p()],u.prototype,"outfitTier",2);f([p()],u.prototype,"outfitBackground",2);f([p()],u.prototype,"outfitUnderwearColor",2);f([p()],u.prototype,"outfitPubicHair",2);f([p()],u.prototype,"outfitPubicHairColor",2);f([p()],u.prototype,"outfitLockColors",2);f([p()],u.prototype,"gearPromptOpen",2);f([p()],u.prototype,"outfitBatchRunning",2);f([p()],u.prototype,"outfitExporting",2);f([p()],u.prototype,"outfitProgress",2);f([p()],u.prototype,"loadouts",2);f([p()],u.prototype,"outfitLoadoutId",2);f([p()],u.prototype,"loadoutBusy",2);f([p()],u.prototype,"loadoutCoverVersion",2);f([p()],u.prototype,"wardrobes",2);f([p()],u.prototype,"outfitWardrobeId",2);f([p()],u.prototype,"studioView",2);f([p()],u.prototype,"sheetTab",2);f([p()],u.prototype,"sheetZoom",2);f([p()],u.prototype,"showSquarePrompt",2);f([p()],u.prototype,"camera",2);f([p()],u.prototype,"cutout",2);f([p()],u.prototype,"cutoutTolerance",2);f([p()],u.prototype,"cutoutBusy",2);f([p()],u.prototype,"cutoutError",2);f([ae(".cutout-canvas")],u.prototype,"cutoutHost",2);f([p()],u.prototype,"cutoutTool",2);f([p()],u.prototype,"cutoutFeather",2);f([p()],u.prototype,"cutoutSpill",2);f([p()],u.prototype,"cutoutZoom",2);f([p()],u.prototype,"cutoutContrast",2);f([p()],u.prototype,"contiguous",2);f([p()],u.prototype,"brushSize",2);f([p()],u.prototype,"showOriginal",2);f([p()],u.prototype,"canUndo",2);f([p()],u.prototype,"canRedo",2);f([p()],u.prototype,"cutFraction",2);f([p()],u.prototype,"characters",2);f([p()],u.prototype,"selectedChars",2);f([p()],u.prototype,"charDraft",2);f([p()],u.prototype,"charBusy",2);f([p()],u.prototype,"scanBusy",2);f([p()],u.prototype,"poses",2);f([p()],u.prototype,"selectedPoses",2);f([p()],u.prototype,"poseDraft",2);f([p()],u.prototype,"poseBusy",2);f([p()],u.prototype,"wildcards",2);f([p()],u.prototype,"wildcardDraft",2);f([p()],u.prototype,"wildcardBusy",2);f([se({type:Number})],u.prototype,"editMedia",2);f([p()],u.prototype,"editing",2);f([p()],u.prototype,"open",2);f([p()],u.prototype,"speech",2);f([p()],u.prototype,"listening",2);f([p()],u.prototype,"optimizing",2);f([p()],u.prototype,"prompt",2);f([p()],u.prototype,"tagSuggestions",2);f([p()],u.prototype,"tagCorrection",2);f([p()],u.prototype,"negative",2);f([p()],u.prototype,"showOptions",2);f([p()],u.prototype,"width",2);f([p()],u.prototype,"height",2);f([p()],u.prototype,"steps",2);f([p()],u.prototype,"cfg",2);f([p()],u.prototype,"cfgRescale",2);f([p()],u.prototype,"clipSkip",2);f([p()],u.prototype,"seamlessX",2);f([p()],u.prototype,"seamlessY",2);f([p()],u.prototype,"vaePrecision",2);f([p()],u.prototype,"cpuNoise",2);f([p()],u.prototype,"board",2);f([p()],u.prototype,"scheduler",2);f([p()],u.prototype,"count",2);f([p()],u.prototype,"seed",2);f([p()],u.prototype,"detailerEnabled",2);f([p()],u.prototype,"detailerModel",2);f([p()],u.prototype,"detailerPrompt",2);f([p()],u.prototype,"detailerNegative",2);f([p()],u.prototype,"detailerConfidence",2);f([p()],u.prototype,"detailerDenoise",2);f([p()],u.prototype,"detailerMaskBlur",2);f([p()],u.prototype,"generating",2);f([p()],u.prototype,"progress",2);f([p()],u.prototype,"shots",2);f([p()],u.prototype,"activeNodeId",2);f([p()],u.prototype,"restoredNotice",2);f([p()],u.prototype,"infoFor",2);f([p()],u.prototype,"error",2);f([p()],u.prototype,"toast",2);f([p()],u.prototype,"thumbVersion",2);f([p()],u.prototype,"failedThumbs",2);f([p()],u.prototype,"expandedShot",2);f([p()],u.prototype,"metaDraft",2);f([p()],u.prototype,"metaBusy",2);f([p()],u.prototype,"metaTriggerText",2);f([p()],u.prototype,"civitaiOpen",2);f([ae("oppai-invoke-gallery")],u.prototype,"galleryPanel",2);u=f([bt("oppai-imagegen")],u);function dt(t){return new Promise((e,i)=>{const s=new FileReader;s.onload=()=>e(String(s.result)),s.onerror=()=>i(new Error("couldn't read the image")),s.readAsDataURL(t)})}export{u as OppaiImageGen};
