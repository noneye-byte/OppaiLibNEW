import{a as Xe,Z as Ve,$ as fe,a0 as W,T as ye,a1 as ve,Q as X,B as Je,a2 as we,a3 as Qe,e as g,a4 as Ze,a5 as M,a6 as et,l as xe,n as N,a7 as tt,g as ae,a8 as ke,a9 as at,aa as st,ab as it,ac as ot,ad as nt,ae as rt,af as $e,ag as lt,b as n,h as V,ah as dt,f as ct,A as d,j as se,k as ie,ai as oe,aj as Ce,ak as J,al as pt,am as ce,R as ht,an as B,ao as ut,ap as gt,aq as mt,ar as Se,M as bt,q as ft,as as yt,at as vt,au as wt,r as xt,i as kt,N as $t,u,t as Ct}from"./index-D3VFtMgd.js";import{e as je}from"./query-__j_ZMY6.js";import{l as St,a as Te,b as Tt,s as Ie}from"./libby-backgrounds-DD5yG2qS.js";function It(e){var a;return(((a=/(?:https?:\/\/|www\.)[^\s<>"'`]{2,}/i.exec(e))==null?void 0:a[0])??"").replace(/[.,;:!?)\]}'"]+$/,"")}const Q=5,Lt=160,Dt=200;function Le(e){var s;const t=e.trim();if(!t)return[t];let a=t.split(/\n{2,}/).map(o=>o.trim()).filter(Boolean);if(a.length<2){if(t.length<Lt)return[t];const o=(s=t.match(/[^.!?…]+[.!?…]+["')\]]*\s*|[^.!?…]+$/g))==null?void 0:s.map(r=>r.trim()).filter(Boolean);if(!o||o.length<2)return[t];a=[];let i="";for(const r of o)i&&i.length+r.length>Dt&&a.length<Q-1?(a.push(i.trim()),i=r):i=i?`${i} ${r}`:r;i.trim()&&a.push(i.trim())}return a.length<=Q?a:[...a.slice(0,Q-1),a.slice(Q-1).join(`
