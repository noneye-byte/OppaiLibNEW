import{a as Xe,Z as Je,$ as fe,a0 as W,T as ye,a1 as ve,Q as X,B as Ve,a2 as we,a3 as Qe,e as g,a4 as Ze,a5 as M,a6 as et,l as xe,n as N,a7 as tt,g as ae,a8 as ke,a9 as at,aa as st,ab as it,ac as ot,ad as nt,ae as rt,af as $e,ag as lt,b as i,h as J,ah as ct,f as dt,A as c,j as se,k as ie,ai as oe,aj as Ce,ak as V,al as pt,am as de,R as ht,an as j,ao as ut,ap as gt,aq as mt,ar as Se,M as bt,q as ft,as as yt,at as vt,au as wt,r as xt,i as kt,N as $t,u as h,t as Ct}from"./index-XPJwO1lq.js";import{e as Be}from"./query-__j_ZMY6.js";import{l as St,a as Te,b as Tt,s as Ie}from"./libby-backgrounds-CXSMdwIV.js";function It(e){var a;return(((a=/(?:https?:\/\/|www\.)[^\s<>"'`]{2,}/i.exec(e))==null?void 0:a[0])??"").replace(/[.,;:!?)\]}'"]+$/,"")}const Q=5,Lt=160,Dt=200;function Le(e){var s;const t=e.trim();if(!t)return[t];let a=t.split(/\n{2,}/).map(n=>n.trim()).filter(Boolean);if(a.length<2){if(t.length<Lt)return[t];const n=(s=t.match(/[^.!?…]+[.!?…]+["')\]]*\s*|[^.!?…]+$/g))==null?void 0:s.map(r=>r.trim()).filter(Boolean);if(!n||n.length<2)return[t];a=[];let o="";for(const r of n)o&&o.length+r.length>Dt&&a.length<Q-1?(a.push(o.trim()),o=r):o=o?`${o} ${r}`:r;o.trim()&&a.push(o.trim())}return a.length<=Q?a:[...a.slice(0,Q-1),a.slice(Q-1).join(`

`)]}function Pt(e,t,a=Math.random){const s=o=>o*(.7+a()*.6);let n=s(700+e*28);return t>10*6e4&&(n+=s(1500)),Math.min(6500,n)}function De(e){return e.replace(/\*\*|~~|`|\*/g,"").replace(/\s+/g," ").trim()}function At(e){return e.replace(/\[[^\]\n]{0,200}\]/g," ").replace(/\*\*|__|~~|\*|`/g,"").replace(/\s+/g," ").trim()}function Pe(e,t=Date.now()){const a=Math.max(0,(t-e)/1e3);return a<90?"just now":a<5400?`${Math.round(a/60)} minutes ago`:a<172800?`${Math.round(a/3600)} hours ago`:`${Math.round(a/86400)} days ago`}function Ot(e){return e<.15?"Still getting to know each other":e<.5?"Comfortable with each other by now":e<.85?"Close — you know each other well":"Deeply close after all this time"}function ne(e,t=140){let a=e.trim();const s=a.indexOf(`
`);if(s>=0&&a.slice(0,s).trim()&&(a=a.slice(0,s).trim()),a.length<=t)return a;let n=a.slice(0,t);const o=n.lastIndexOf(" ");return o>t/2&&(n=n.slice(0,o)),n.trim()+"…"}function I(e,...t){for(const a of t){const s=e[a];if(typeof s=="string"&&s.trim()!=="")return s}return""}function Ae(e,...t){for(const a of t){const s=e[a];if(Array.isArray(s)){const n=s.filter(o=>typeof o=="string"&&o.trim()!=="");if(n.length)return n}}return[]}function Ue(e,t){if(!e||typeof e!="object"||Array.isArray(e))throw new Error("that file isn't a character card (expected a JSON object)");const a=e,s=typeof a.spec=="string"?a.spec.toLowerCase():"",n=a.data&&typeof a.data=="object"&&!Array.isArray(a.data)?a.data:null,o=n??a,r=s.includes("v3")?"v3":s.includes("v2")||n?"v2":"v1",l=I(o,"name","char_name","charName")||t,u=I(o,"description","char_persona","persona"),m=I(o,"personality","personalitySummary"),f=I(o,"scenario","world_scenario"),b=I(o,"first_mes","firstMessage","char_greeting","greeting"),$=I(o,"mes_example","exampleDialogue","example_dialogue"),y=I(o,"creator_notes","creatorNotes","creatorcomment","creator_comment"),k=[I(o,"system_prompt","systemPrompt"),I(o,"post_history_instructions","postHistoryInstructions")].filter(Boolean).join(`

`),x=Ae(o,"alternate_greetings","alternateGreetings"),T=Ae(o,"tags"),v=o.extensions&&typeof o.extensions=="object"?o.extensions:{},S=v.oppailib&&typeof v.oppailib=="object"?v.oppailib:{},O={name:l,description:u,personality:m,scenario:f,firstMessage:b,exampleDialogue:$,systemPrompt:k,creatorNotes:y,appearance:I(S,"appearance"),kinks:I(S,"kinks"),promptWeight:typeof S.promptWeight=="number"&&Number.isFinite(S.promptWeight)?S.promptWeight:1,defaultMode:I(S,"defaultMode")||"roleplay"};return x.length&&(O.altGreetings=x),{character:O,spec:r,leftovers:{alternateGreetings:x.length,characterBook:!!o.character_book||!!o.characterBook,tags:T,creator:I(o,"creator"),characterVersion:I(o,"character_version","characterVersion")}}}function _t(e){const t=atob(e.replace(/\s+/g,"")),a=Uint8Array.from(t,s=>s.charCodeAt(0));return new TextDecoder("utf-8").decode(a)}async function Oe(e){const t=new Blob([e]).stream().pipeThrough(new DecompressionStream("deflate"));return new Uint8Array(await new Response(t).arrayBuffer())}async function zt(e){const t=[137,80,78,71,13,10,26,10];if(e.length<8||t.some((l,u)=>e[u]!==l))return[];const a=new DataView(e.buffer,e.byteOffset,e.byteLength),s=new TextDecoder("latin1"),n=new TextDecoder("utf-8"),o=[];let r=8;for(;r+12<=e.length;){const l=a.getUint32(r),u=s.decode(e.subarray(r+4,r+8));if(u==="IEND")break;const m=r+8,f=m+l;if(f+4>e.length)break;const b=e.subarray(m,f);if(u==="tEXt"||u==="zTXt"||u==="iTXt"){const $=b.indexOf(0);if($>0){const y=s.decode(b.subarray(0,$));try{if(u==="tEXt")o.push({keyword:y,text:s.decode(b.subarray($+1))});else if(u==="zTXt")o.push({keyword:y,text:s.decode(await Oe(b.subarray($+2)))});else{let k=$+1;const x=b[k]===1;k+=2;const T=b.indexOf(0,k);if(T<0)throw new Error("bad iTXt");const v=b.indexOf(0,T+1);if(v<0)throw new Error("bad iTXt");const S=b.subarray(v+1);o.push({keyword:y,text:x?n.decode(await Oe(S)):n.decode(S)})}}catch{}}}r=f+4}return o}async function Mt(e,t){const a=await zt(e),s=l=>a.find(u=>u.keyword.toLowerCase()===l),n=s("ccv3")??s("chara");if(!n)return null;let o;try{o=_t(n.text)}catch{throw new Error("the card data inside that PNG is not valid base64")}let r;try{r=JSON.parse(o)}catch{throw new Error("the card data inside that PNG is not valid JSON")}return Ue(r,t)}async function Et(e){const t=e.name.replace(/\.[^.]+$/,"")||"New friend";if(e.name.toLowerCase().endsWith(".png")||e.type==="image/png")return Mt(new Uint8Array(await e.arrayBuffer()),t);if(e.type.startsWith("image/"))return null;let s;try{s=JSON.parse(await e.text())}catch{throw new Error("that file is neither a PNG card nor valid JSON")}return Ue(s,t)}function Rt(e){const t={name:e.name,description:e.description??"",personality:e.personality??"",scenario:e.scenario??"",first_mes:e.firstMessage??"",mes_example:e.exampleDialogue??"",system_prompt:e.systemPrompt??"",post_history_instructions:"",creator_notes:e.creatorNotes??"",alternate_greetings:e.altGreetings??[],tags:[],creator:"",character_version:"",extensions:{oppailib:{appearance:e.appearance??"",kinks:e.kinks??"",defaultMode:e.defaultMode,promptWeight:e.promptWeight}}};return{spec:"chara_card_v2",spec_version:"2.0",data:t,...t}}var Wt=Object.defineProperty,Nt=Object.getOwnPropertyDescriptor,p=(e,t,a,s)=>{for(var n=s>1?void 0:s?Nt(t,a):t,o=e.length-1,r;o>=0;o--)(r=e[o])&&(n=(s?r(t,a,n):r(n))||n);return s&&n&&Wt(t,a,n),n};const E=[{id:"sweet",label:"sweet",emotion:"happy",topic:"Soft, warm, and unhurried."},{id:"playful",label:"playful",emotion:"mischievous",topic:"Teasing and quick on their feet."},{id:"bold",label:"bold",emotion:"surprised",topic:"Blunt, uninhibited, and direct."},{id:"roleplay",label:"roleplay",emotion:"thinking",topic:"In character, in scene, in detail."},{id:"horny",label:"horny",emotion:"mischievous",topic:"Explicit, leading, and sending pictures."}],jt=[{id:"character",label:"Character card",icon:"badge",group:"Friend"},{id:"images",label:"Images",icon:"image",group:"Friend"},{id:"model",label:"Model & generation",icon:"memory",group:"Chat"},{id:"profile",label:"Your profile",icon:"person",group:"Chat"}],Bt=[{id:"character",label:"Libby",icon:"badge",group:"Libby"},{id:"world",label:"Her world",icon:"public",group:"Libby"},{id:"mind",label:"Her mind",icon:"psychology",group:"Libby"},{id:"images",label:"Her pictures",icon:"image",group:"Libby"},{id:"model",label:"Model & generation",icon:"memory",group:"Chat"},{id:"profile",label:"Your profile",icon:"person",group:"Chat"}],Ut=14e3,Z=8,qt=40,_e="oppai_chat_autopilot",re=21e4,Ft=4e4,Yt=["❤️","😂","😮","😢","🔥","👍","👀","😘"],ze=56,Ht=72,Me=e=>`avatar:${e}`,_=()=>typeof crypto.randomUUID=="function"?crypto.randomUUID().replaceAll("-",""):[...crypto.getRandomValues(new Uint8Array(16))].map(e=>e.toString(16).padStart(2,"0")).join(""),pe=e=>new Date(e).toLocaleTimeString([],{hour:"numeric",minute:"2-digit"});function Gt(e){return e?e<0?-1:de.map(a=>a.value).filter(a=>a>0).reduce((a,s)=>Math.abs(s-e)<Math.abs(a-e)?s:a,1):1}function te(e){const t=new Date(e),a=new Date,s=o=>new Date(o.getFullYear(),o.getMonth(),o.getDate()).getTime(),n=Math.round((s(a)-s(t))/864e5);return n===0?"Today":n===1?"Yesterday":n<7?t.toLocaleDateString([],{weekday:"long"}):t.toLocaleDateString([],{month:"short",day:"numeric",year:t.getFullYear()===a.getFullYear()?void 0:"numeric"})}function Kt(e){const t=te(e);return t==="Today"?pe(e):t==="Yesterday"?t:new Date(e).toLocaleDateString([],{month:"short",day:"numeric"})}const le=()=>({}),Ee="oppai_stage_width",Xt={label:"Loader",keys:["loader"],kind:"select"},A=["llama.cpp"],B=["ExLlamav3_HF","ExLlamav3","ExLlamav2_HF","ExLlamav2"],z=["Transformers","HQQ"],ce=[{label:"Context length",keys:["ctx_size","n_ctx","max_seq_len"],kind:"number",placeholder:"model default"},{label:"GPU layers",keys:["gpu_layers","n_gpu_layers"],kind:"number",hint:"0 = CPU only",loaders:A},{label:"Batch size",keys:["batch_size","n_batch"],kind:"number",loaders:A},{label:"Threads",keys:["threads"],kind:"number",loaders:A},{label:"Batch threads",keys:["threads_batch"],kind:"number",loaders:A},{label:"KV cache type",keys:["cache_type"],kind:"select",options:["fp16","q8_0","q4_0","q8","q6","q4"],hint:"q8_0/q4_0 for llama.cpp; q8/q6/q4 for ExLlama"},{label:"Tensor split",keys:["tensor_split"],kind:"text",placeholder:"e.g. 20,10",loaders:A},{label:"GPU split (GB)",keys:["gpu_split"],kind:"text",placeholder:"e.g. 20,7",loaders:B},{label:"RoPE base",keys:["rope_freq_base"],kind:"number",placeholder:"model default"},{label:"Positional compression",keys:["compress_pos_emb"],kind:"number",placeholder:"1"},{label:"Experts per token",keys:["num_experts_per_token"],kind:"number",placeholder:"model default",loaders:B},{label:"Compute dtype",keys:["compute_dtype"],kind:"select",options:["float16","bfloat16","float32"],loaders:z},{label:"Quant type",keys:["quant_type"],kind:"select",options:["nf4","fp4"],loaders:z},{label:"Flash attention",keys:["flash_attn"],kind:"check"},{label:"mlock",keys:["mlock"],kind:"check",hint:"keep in RAM",loaders:A},{label:"No mmap",keys:["no_mmap"],kind:"check",loaders:A},{label:"NUMA",keys:["numa"],kind:"check",loaders:A},{label:"CPU only",keys:["cpu"],kind:"check"},{label:"Load in 4-bit",keys:["load_in_4bit"],kind:"check",loaders:z},{label:"Load in 8-bit",keys:["load_in_8bit"],kind:"check",loaders:z},{label:"bf16",keys:["bf16"],kind:"check",loaders:z},{label:"Auto devices",keys:["auto_devices"],kind:"check",loaders:z},{label:"Disk offload",keys:["disk"],kind:"check",loaders:z},{label:"Trust remote code",keys:["trust_remote_code"],kind:"check",loaders:z},{label:"No flash attention",keys:["no_flash_attn"],kind:"check",loaders:B},{label:"CFG cache",keys:["cfg_cache"],kind:"check",loaders:B},{label:"Tensor parallel",keys:["enable_tp"],kind:"check",loaders:B},{label:"Streaming LLM",keys:["streaming_llm"],kind:"check",loaders:A}],Re={boundary:"boundary",relationship:"us",preference:"likes",user:"about you",libby:"who she is",emotional:"feelings",shared:"together"},Jt="two";function qe(){return{profile:{displayName:"",persona:""},characters:[],conversations:[],images:[]}}function Vt(){return{...qe(),characters:[{id:"libby",name:"Libby",builtIn:!0,promptWeight:1,defaultMode:"sweet",description:"OppaiLib's librarian and resident mascot."}]}}function We(e){return{...e,profile:e.profile??{displayName:"",persona:""},characters:(e.characters??[]).filter(t=>t&&t.id),images:(e.images??[]).map(t=>({...t,tags:t.tags??[]})),conversations:(e.conversations??[]).map(t=>({...t,messages:(t.messages??[]).filter(a=>a&&typeof a.content=="string")}))}}function Ne(e,t,a){const s=e==null?void 0:e[t];return typeof s=="number"&&Number.isFinite(s)?s:a}function je(e,t,a){const s=/(\*\*[^*\n]+\*\*|\*[^*\n]+\*|~~[^~\n]+~~|`[^`\n]+`|"[^"\n]+")/g,n=e.split(s);return i`${n.map(o=>o.startsWith("**")&&o.endsWith("**")?i`<strong class="action">${ee(o.slice(2,-2),t,a)}</strong>`:o.startsWith("*")&&o.endsWith("*")?i`<em>${ee(o.slice(1,-1),t,a)}</em>`:o.startsWith("~~")&&o.endsWith("~~")?i`<s>${o.slice(2,-2)}</s>`:o.startsWith("`")&&o.endsWith("`")?i`<code>${o.slice(1,-1)}</code>`:o.startsWith('"')&&o.endsWith('"')?i`<span class="speech">${ee(o,t,a)}</span>`:ee(o,t,a))}`}const Qt=e=>e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");function ee(e,t,a){if(!(t!=null&&t.length)||!a||!e)return e;const s=t.filter(r=>r.title.trim().length>=3);if(!s.length)return e;const n=new RegExp(`(${s.map(r=>Qt(r.title)).join("|")})`,"i"),o=e.split(n);return o.length===1?e:i`${o.map(r=>{const l=s.find(m=>m.title.toLowerCase()===r.toLowerCase());if(!l)return r;const u=m=>{m.stopPropagation(),a(l.id)};return i`<a class="inline-link" role="link" tabindex="0" title=${`Open ${l.title}`} @click=${u}
      @keydown=${m=>{(m.key==="Enter"||m.key===" ")&&(m.preventDefault(),u(m))}}>${r}</a>`})}`}let d=class extends Xe{constructor(){super(...arguments),this.status=null,this.workspace=qe(),this.characterID="libby",this.conversationID="",this.draft="",this.busy=!1,this.loading=!0,this.workspaceLoaded=!0,this.loadError="",this.settingsOpen=!1,this.speakOn=St(),this.editorTab="character",this.outfits=null,this.activities=[],this.outfitsLoading=!1,this.notice="",this.noticeError=!1,this.imageTags="",this.memories=null,this.memoryKinds=[],this.memoryLimit=0,this.memoryDraft="",this.editingMemory=null,this.memoryDraftEdit="",this.memoryKindEdit="",this.autoState=null,this.wants=null,this.journal=null,this.reflecting=!1,this.identity=void 0,this.pendingLink=null,this.pendingLinkURL="",this.discord=void 0,this.discordPlaces=null,this.discordToken="",this.discordUserDraft="",this.bond=null,this.openingBond=null,this.models=null,this.modelChoice="",this.modelBusy=!1,this.backend=null,this.loadArgs={},this.loadExtra="",this.loadSettings="",this.loraPicks=[],this.cardTokens=null,this.deleteTarget=null,this.deleteConfirm="",this.deletePermanent=!1,this.deleteError="",this.mobileNavOpen=!1,this.chatSearch="",this.pickerOpen=!1,this.captureTurns=!1,this.turnLog=new Map,this.cardDrop=!1,this.cardNote=null,this.autopilot=localStorage.getItem(_e)==="1",this.autoPaused=!1,this.autoTurns=0,this.stageOpen=!0,this.stageWidth=(()=>{try{return Number(localStorage.getItem(Ee))||0}catch{return 0}})(),this.stageDragging=!1,this.pendingPhoto=null,this.typingPhase="idle",this.callOpen=!1,this.callSeconds=0,this.incomingCall=!1,this.ringTimer=0,this.backgrounds=[],this.defaultBackground="",this.scenePickerOpen=!1,this.callCaptions=!0,this.replyTarget=null,this.reactionPicker=null,this.snapOpen=null,this.weightTagDraft="",this.readTimer=0,this.turnOptions={},this.pendingReply=!1,this.swipe=null,this.pendingItems=[],this.picker=null,this.pickerSeq=0,this.callTimer=0,this.autoTimer=0,this.facts=null,this.factsAt=0,this.saveTimer=0,this.editSeq=0,this.idleTimer=0,this.idleNudged=!1,this.noticeTimer=0,this.imageSubject="self",this.approvals=new Je(()=>this.requestUpdate(),()=>this.actContext()),this.onShared=()=>{this.claimShare()},this.onGlobalKey=e=>{e.key==="Escape"&&this.callOpen&&(e.stopPropagation(),this.endCall())},this.lastArrivalID="",this.memoriesLoading=!1,this.wantsLoading=!1,this.journalLoading=!1,this.bondLoading=!1,this.armIdle=()=>{window.clearTimeout(this.idleTimer),this.idleNudged=!1,this.characterID==="libby"&&(this.idleTimer=window.setTimeout(()=>void this.idleNudge(),re))},this.pendingAsked=0,this.stageDragStart=e=>{var o,r;e.preventDefault();const t=e.clientX,a=this.stageWidth||((r=(o=this.shadowRoot)==null?void 0:o.querySelector(".stage"))==null?void 0:r.offsetWidth)||300;this.stageDragging=!0;const s=l=>{const u=Math.round(Math.max(220,Math.min(window.innerWidth*.5,a+(t-l.clientX))));this.stageWidth=u},n=()=>{window.removeEventListener("pointermove",s),window.removeEventListener("pointerup",n),this.stageDragging=!1;try{localStorage.setItem(Ee,String(this.stageWidth))}catch{}};window.addEventListener("pointermove",s),window.addEventListener("pointerup",n)},this.cancelDeleteModel=()=>{this.deleteTarget=null,this.deleteConfirm="",this.deleteError=""},this.autoStateLoading=!1,this.discordLoading=!1,this.identityLoading=!1,this.chatMenu=e=>{if(fe(e))return;e.preventDefault();const t=this.activeCharacter,a=this.activeConversation,n=e.composedPath().find(l=>{var u,m;return(m=(u=l==null?void 0:l.classList)==null?void 0:u.contains)==null?void 0:m.call(u,"convo-wrap")}),o=n==null?void 0:n.dataset.id,r=o?[{label:"Open",icon:"forum",run:()=>this.activateConversation(o)},{label:"New conversation",icon:"add_comment",run:()=>this.newConversation()},{label:"Export conversation…",icon:"download",run:()=>this.exportConversation(o)},W,{label:"Delete conversation",icon:"delete",danger:!0,run:()=>this.deleteConversation(o)}]:[{label:"Re-respond",icon:"refresh",disabled:this.busy||!(a!=null&&a.messages.some(l=>l.role==="assistant")),run:()=>void this.regenerate()},{label:"Retry with a note…",icon:"edit_note",disabled:this.busy||!(a!=null&&a.messages.some(l=>l.role==="assistant")),run:()=>void this.regenerateWithNote()},{label:this.callOpen?"End video call":"Video call",icon:this.callOpen?"call_end":"videocam",run:()=>this.callOpen?this.endCall():this.startCall()},{label:"Share a photo",icon:"add_photo_alternate",disabled:this.busy,run:()=>this.pickPhoto()},{label:"Attach from the library",icon:"collections_bookmark",disabled:this.busy,run:()=>this.openPicker()},{label:this.autopilot?"Turn off autopilot":"Let the AI continue on its own",icon:"smart_toy",run:()=>this.toggleAutopilot()},{label:this.stageOpen?"Hide portrait":"Show portrait",icon:"wallpaper",run:()=>this.stageOpen=!this.stageOpen},{label:this.speakOn?"Stop reading aloud":"Read replies aloud",icon:this.speakOn?"volume_off":"volume_up",run:()=>this.toggleSpeak()},W,{label:"New conversation",icon:"add_comment",run:()=>this.newConversation()},{label:"Chat settings",icon:"tune",run:()=>{this.settingsOpen=!0,this.editorTab="character"}},{label:"Refresh model status",icon:"sync",run:()=>void this.refreshModels()},W,{label:this.captureTurns?"Stop capturing turns":"Capture turns (prompt + raw reply)",icon:this.captureTurns?"bug_report":"pest_control",run:()=>{this.captureTurns=!this.captureTurns,this.say(this.captureTurns?"Capturing every turn's prompt and raw reply. Export the conversation to read them.":"Stopped capturing turns.")}},{label:"Export conversation…",icon:"download",run:()=>this.exportConversation()},W,{label:"Clear messages",icon:"delete_sweep",danger:!0,run:()=>this.clearConversation()}];ye({x:e.clientX,y:e.clientY,title:t==null?void 0:t.name,items:r})}}get canManageModels(){var e;return!!((e=this.user)!=null&&e.isAdmin)}actContext(){const e=this.activeConversation;return!e||e.characterId!=="libby"?{}:{outfit:X()||void 0,activity:e.activity||void 0,intensity:e.intensity,recentMediaIds:ve(e.messages)}}connectedCallback(){super.connectedCallback(),Ve(this,"chat"),this.load().then(()=>void this.claimShare()),window.addEventListener("keydown",this.onGlobalKey),window.addEventListener(we,this.onShared)}disconnectedCallback(){var e;window.clearTimeout(this.ringTimer),super.disconnectedCallback(),window.clearTimeout(this.saveTimer),window.clearTimeout(this.idleTimer),window.clearTimeout(this.noticeTimer),window.clearTimeout(this.autoTimer),window.clearInterval(this.callTimer),window.clearTimeout(this.readTimer),window.removeEventListener("keydown",this.onGlobalKey),window.removeEventListener(we,this.onShared),(e=this.resize)==null||e.disconnect()}async claimShare(){const e=Qe();if(!e)return;const t=this.workspace.characters.find(a=>a.id===e.characterId);if(!t){this.say("That character no longer exists.",!0);return}this.characterID!==t.id&&this.activateCharacter(t.id);try{this.say(`Scanning ${e.name} locally…`);const a=await g.uploadChatImage({characterId:t.id,name:e.name,imageData:e.imageData,tags:[]});this.workspace.images.push(a),this.pendingPhoto={imageId:a.id,tags:a.tags??[],name:a.name},this.touchWorkspace(),this.say(`Ready to show ${t.name} — add a message and send.`),this.focusComposer()}catch(a){this.say(a.message,!0)}}firstUpdated(){this.resize=new ResizeObserver(()=>void this.scrollToEnd(!1)),this.log&&this.resize.observe(this.log),this.focusComposer()}focusComposer(){this.settingsOpen||this.updateComplete.then(()=>{const e=this.callOpen?this.renderRoot.querySelector(".call-input"):this.composer;!e||e.disabled||(e.focus({preventScroll:!0}),e.setSelectionRange(e.value.length,e.value.length))})}updated(e){e.has("busy")&&!this.busy&&this.focusComposer(),(e.has("conversationID")||e.has("characterID"))&&this.focusComposer(),e.has("settingsOpen")&&!this.settingsOpen&&this.focusComposer(),e.has("callOpen")&&this.focusComposer(),this.animateArrival()}animateArrival(){var s;const e=(s=this.activeConversation)==null?void 0:s.messages,t=e==null?void 0:e[e.length-1];if(!t){this.lastArrivalID="";return}if(t.id===this.lastArrivalID)return;const a=!this.lastArrivalID;this.lastArrivalID=t.id,!a&&Ze(this.renderRoot.querySelector(".log article.msg:last-of-type"))}get activeCharacter(){const e=this.visibleCharacters;return e.find(t=>t.id===this.characterID)??e[0]}get visibleCharacters(){return this.workspace.characters}get spoken(){var e;return((e=this.activeConversation)==null?void 0:e.messages.reduce((t,a)=>t+(a.role==="assistant"?1:0),0))??0}get activeConversation(){return this.workspace.conversations.find(e=>e.id===this.conversationID)}conversationsFor(e=this.characterID){return this.workspace.conversations.filter(t=>t.characterId===e).sort((t,a)=>a.updatedAt-t.updatedAt)}async load(){var s,n,o;const[e,t,a]=await Promise.allSettled([g.chatStatus(),g.chatWorkspace(),g.libbyBond(),this.loadBackgrounds()]);try{e.status==="fulfilled"&&(this.status=e.value),t.status==="fulfilled"?(this.workspace=We(t.value),this.workspaceLoaded=!0):(this.workspace=Vt(),this.workspaceLoaded=!1,this.loadError=((s=t.reason)==null?void 0:s.message)||"Couldn't load your chat workspace."),a.status==="fulfilled"&&a.value.lastSeenAt&&(this.openingBond=a.value,M(Math.min(Math.max(1,Math.round(a.value.heatNow||1)),et))),this.characterID=((n=this.workspace.characters[0])==null?void 0:n.id)??"libby";const r=this.conversationsFor(this.characterID)[0];r?this.activateConversation(r.id):this.newConversation(!1),(o=this.status)!=null&&o.modelBackend&&this.refreshModels(!0)}catch(r){this.loadError=r.message||"Chat failed to start."}finally{this.loading=!1}}async retryLoad(){this.loading||(this.loadError="",this.loading=!0,await this.load())}say(e,t=!1){this.notice=e,this.noticeError=t,window.clearTimeout(this.noticeTimer),this.noticeTimer=window.setTimeout(()=>this.notice="",4200)}async libraryFacts(){if(this.facts&&Date.now()-this.factsAt<6e4)return this.facts;try{this.facts=await g.libbyContext(),this.factsAt=Date.now()}catch{}return this.facts}async loadMemories(e=!1){if(!this.memoriesLoading){this.memoriesLoading=!0;try{const t=await g.libbyMemory();this.memories=t.memories,this.memoryKinds=t.kinds??[],this.memoryLimit=t.limit??0}catch{e||(this.memories=[])}finally{this.memoriesLoading=!1}}}async forgetMemory(e){try{await g.forgetLibbyMemory(e),this.memories=(this.memories??[]).filter(t=>t.id!==e)}catch(t){this.say(t instanceof Error?t.message:"Couldn't forget that.",!0)}}async addMemory(){const e=this.memoryDraft.trim();if(!(e.length<8))try{await g.addLibbyMemory({text:e}),this.memoryDraft="",await this.loadMemories(!0),this.say("She'll remember that.")}catch(t){this.say(t instanceof Error?t.message:"Couldn't save that.",!0)}}async togglePin(e){try{const t=await g.updateLibbyMemory(e.id,{pinned:!e.pinned});this.memories=(this.memories??[]).map(a=>a.id===e.id?t:a)}catch(t){this.say(t instanceof Error?t.message:"Couldn't pin that.",!0)}}async saveMemoryEdit(e){const t=this.memoryDraftEdit.trim();if(t.length<8){this.say("A memory needs to be a sentence, not a fragment.",!0);return}try{const a=await g.updateLibbyMemory(e.id,{text:t,kind:this.memoryKindEdit&&this.memoryKindEdit!==e.kind?this.memoryKindEdit:void 0});this.memories=(this.memories??[]).map(s=>s.id===e.id?a:s),this.editingMemory=null}catch(a){this.say(a instanceof Error?a.message:"Couldn't save that.",!0)}}async clearMemories(){if(confirm("Clear everything Libby remembers about you? This can't be undone."))try{await g.clearLibbyMemory(),this.memories=[]}catch(e){this.say(e instanceof Error?e.message:"Couldn't clear her memory.",!0)}}async loadWants(){if(!this.wantsLoading){this.wantsLoading=!0;try{this.wants=(await g.libbyWants()).wants}catch{this.wants=[]}finally{this.wantsLoading=!1}}}async forgetWant(e){try{await g.forgetLibbyWant(e),this.wants=(this.wants??[]).filter(t=>t.id!==e)}catch(t){this.say(t instanceof Error?t.message:"Couldn't drop that.",!0)}}async clearWants(){if(confirm("Clear everything Libby has been wanting? This can't be undone."))try{await g.clearLibbyWants(),this.wants=[]}catch(e){this.say(e instanceof Error?e.message:"Couldn't clear her wants.",!0)}}async loadJournal(){if(!this.journalLoading){this.journalLoading=!0;try{this.journal=(await g.libbyJournal()).entries}catch{this.journal=[]}finally{this.journalLoading=!1}}}async reflectNow(){this.reflecting=!0;try{const e=await g.reflectLibbyNow();e.entry?this.journal=[e.entry,...this.journal??[]]:this.say(e.message??"Nothing new to write about.")}catch(e){this.say(e instanceof Error?e.message:"She couldn't write just now.",!0)}finally{this.reflecting=!1}}async forgetJournalEntry(e){try{await g.forgetJournalEntry(e),this.journal=(this.journal??[]).filter(t=>t.id!==e)}catch(t){this.say(t instanceof Error?t.message:"Couldn't remove that.",!0)}}async clearJournal(){if(confirm("Clear Libby's journal? She'll forget what she wrote about your past conversations. This can't be undone."))try{await g.clearLibbyJournal(),this.journal=[]}catch(e){this.say(e instanceof Error?e.message:"Couldn't clear her journal.",!0)}}async loadBond(){if(!this.bondLoading){this.bondLoading=!0;try{this.bond=await g.libbyBond()}catch{this.bond=null}finally{this.bondLoading=!1}}}async resetBond(){if(confirm("Start fresh with Libby? She'll forget where you left off — the time, the mood, how close you've grown. Your memories and her wants are kept."))try{await g.resetLibbyBond(),this.bond=null,this.openingBond=null,M(1),this.say("Reset. Your next chat with Libby starts fresh.")}catch(e){this.say(e instanceof Error?e.message:"Couldn't reset that.",!0)}}async refreshModels(e=!1){try{const[t,a]=await Promise.all([g.chatModels(),g.chatStatus()]);this.models=t,this.status=a,e||this.say(a.enabled?`Connected to ${a.model||"the loaded model"}.`:a.message||"No model is loaded.",!a.enabled),t.supported?this.refreshBackend():this.backend=null}catch(t){e||this.say(t.message,!0)}}async refreshBackend(){var e,t,a;try{this.backend=await g.chatBackendInfo(),this.loraPicks=[...((e=this.backend.loras)==null?void 0:e.loaded)??[]],this.seedLoadArgs(this.modelChoice||((t=this.models)==null?void 0:t.loaded)||((a=this.models)==null?void 0:a.models[0])||"")}catch{this.backend=null}}seedLoadArgs(e){var o,r;const t=(r=(o=this.backend)==null?void 0:o.loads)==null?void 0:r[e],a={...(t==null?void 0:t.args)??{}},s=new Set(ce.flatMap(l=>l.keys)),n={};for(const[l,u]of Object.entries(a))s.has(l)||(n[l]=u);for(const l of Object.keys(n))delete a[l];this.loadArgs=a,this.loadExtra=Object.keys(n).length?JSON.stringify(n,null,2):"",this.loadSettings=t!=null&&t.settings&&Object.keys(t.settings).length?JSON.stringify(t.settings,null,2):""}composeLoadArgs(){const e={};for(const a of ce){const s=this.loadArgs[a.keys[0]];if(!(s===void 0||s===""||s===null)&&!(a.kind==="check"&&!s))for(const n of a.keys)e[n]=s}this.loadExtra.trim()&&Object.assign(e,JSON.parse(this.loadExtra));const t=this.loadSettings.trim()?JSON.parse(this.loadSettings):{};return{args:e,settings:t}}setLoadArg(e,t){const a={...this.loadArgs},s=e.keys[0];if(e.kind==="check")t?a[s]=!0:delete a[s];else if(e.kind==="number"){const n=Number(t);t===""||Number.isNaN(n)?delete a[s]:a[s]=n}else t===""?delete a[s]:a[s]=t;this.loadArgs=a}async applyLoras(){if(!this.modelBusy){this.modelBusy=!0;try{const e=await g.setChatLoras(this.loraPicks);this.backend&&(this.backend={...this.backend,loras:e}),this.loraPicks=[...e.loaded],this.say(e.loaded.length?`Applied ${e.loaded.join(", ")}.`:"LoRAs cleared.")}catch(e){this.say(e.message,!0)}finally{this.modelBusy=!1}}}async stopGeneration(){try{await g.stopChat(),this.say("Stopping…")}catch(e){this.say(e.message,!0)}}async measureCard(e){const t=[e.description,e.personality,e.scenario,e.kinks,e.systemPrompt,e.exampleDialogue,e.firstMessage].filter(Boolean).join(`

`);try{this.cardTokens=await g.countChatTokens(t)}catch(a){this.say(a.message,!0)}}touchWorkspace(){this.workspace={...this.workspace,profile:{...this.workspace.profile},characters:[...this.workspace.characters],conversations:[...this.workspace.conversations],images:[...this.workspace.images]},this.editSeq++,window.clearTimeout(this.saveTimer),this.saveTimer=window.setTimeout(()=>void this.saveWorkspace(),450)}async saveWorkspace(){if(window.clearTimeout(this.saveTimer),!this.workspaceLoaded)return;const e=this.editSeq;try{const t=await g.saveChatWorkspace(this.workspace);e===this.editSeq&&(this.workspace=We(t))}catch(t){this.say(`Couldn't save chat: ${t.message}`,!0)}}liveConversation(e){return this.workspace.conversations.find(t=>t.id===e)}liveCharacter(e){return this.workspace.characters.find(t=>t.id===e)}async scrollToEnd(e=!0){await this.updateComplete,requestAnimationFrame(()=>{this.log&&this.log.scrollTo({top:this.log.scrollHeight,behavior:e?"smooth":"auto"})})}async idleNudge(){var o;if(this.busy||document.visibilityState!=="visible"||this.autoRunning){window.clearTimeout(this.idleTimer),this.idleTimer=window.setTimeout(()=>void this.idleNudge(),re);return}if(this.idleNudged)return;const e=this.activeConversation;if(!e||e.characterId!=="libby")return;const t=e.messages[e.messages.length-1];if(!t||t.role!=="assistant")return;const a=await this.mayLibbySpeak("idle");if(!(a!=null&&a.allow)){window.clearTimeout(this.idleTimer);const r=a!=null&&a.retryAfterSec?Math.min(a.retryAfterSec*1e3,30*6e4):re;this.idleTimer=window.setTimeout(()=>void this.idleNudge(),r);return}if(this.idleNudged=!0,(o=this.status)!=null&&o.enabled){await this.generateReply(e.id,"",{continuation:!0})&&this.recordLibbySpoke("idle","the conversation went quiet after her message");return}const s=xe("idle",{intensity:e.intensity}),n=this.liveConversation(e.id);n&&(n.emotion=s.emotion,await this.typeAndPushBubbles(n.id,[s.message],0),this.recordLibbySpoke("idle","the conversation went quiet (no model loaded)"))}async mayLibbySpeak(e){try{return await g.libbyAutoCheck({trigger:e})}catch{return}}async recordLibbySpoke(e,t){try{await g.libbyAutoSent({trigger:e,detail:t})}catch{}}activateCharacter(e){this.characterID=e,this.mobileNavOpen=!1;const t=this.conversationsFor(e)[0];t?this.activateConversation(t.id):this.newConversation()}activateConversation(e){const t=this.workspace.conversations.find(a=>a.id===e);t&&(this.conversationID=e,this.characterID=t.characterId,this.mobileNavOpen=!1,this.autoTurns=Z,M(t.intensity),this.armIdle(),this.scheduleAuto(),this.scrollToEnd(!1),this.sayWhatIsPending())}async sayWhatIsPending(){var n;const e=this.activeConversation;if(!e||e.characterId!=="libby"||!((n=this.status)!=null&&n.enabled)||Date.now()-this.pendingAsked<6e4)return;this.pendingAsked=Date.now();let t;try{t=(await g.libbyAutoPending()).pending}catch{return}const a=t.find(o=>o.decision.allow);if(!a||this.busy||this.conversationID!==e.id)return;await this.generateReply(e.id,"",{continuation:!0,task:a.trigger})&&this.recordLibbySpoke(a.trigger,a.detail)}newConversation(e=!0){var r,l,u;const t=this.activeCharacter;if(!t)return;const a=Date.now();let s=((r=t.firstMessage)==null?void 0:r.trim())??"",n=N((l=E.find(m=>m.id===t.defaultMode))==null?void 0:l.emotion);if(t.id==="libby"&&((u=this.openingBond)!=null&&u.mood&&(n=N(this.openingBond.mood)),!s)){const m=tt(t.defaultMode,ae());s=m.message,n=m.emotion}const o={id:_(),characterId:t.id,title:"New conversation",mode:t.defaultMode||"sweet",emotion:n,intensity:t.id==="libby"?ae():1,progress:t.id==="libby"?ae():1,options:{...this.workspace.defaults??le()},messages:s?[{id:_(),role:"assistant",content:s,at:a}]:[],createdAt:a,updatedAt:a};this.workspace.conversations.push(o),this.conversationID=o.id,this.mobileNavOpen=!1,this.touchWorkspace(),e&&this.say(`Started a new chat with ${t.name}.`),this.armIdle(),this.scrollToEnd(!1)}clearConversation(){const e=this.activeConversation;!e||!confirm("Clear every message in this conversation?")||(e.messages=[],e.title="New conversation",e.updatedAt=Date.now(),this.touchWorkspace(),this.say("Conversation cleared."))}deleteConversation(e){if(!confirm("Delete this conversation?"))return;this.workspace.conversations=this.workspace.conversations.filter(a=>a.id!==e);const t=this.conversationsFor()[0];t?this.conversationID=t.id:this.newConversation(!1),this.touchWorkspace()}updateConversation(e){const t=this.activeConversation;t&&(Object.assign(t,e,{updatedAt:Date.now()}),e.intensity!=null&&(t.progress=e.intensity,M(e.intensity)),this.touchWorkspace())}updateOption(e,t){this.updateOptionValue(e,t)}updateOptionValue(e,t){const a=this.activeConversation;if(!a)return;const s={...a.options??{}};t===void 0?delete s[e]:s[e]=t,a.options=s,a.updatedAt=Date.now(),this.touchWorkspace()}onKey(e){e.key==="Enter"&&!e.shiftKey&&(e.preventDefault(),this.send())}noticeLink(){const e=It(this.draft);e!==this.pendingLinkURL&&(this.pendingLinkURL=e,this.pendingLink=null,e&&(async()=>{try{const t=await g.libbyLink(e);this.pendingLinkURL===e&&(this.pendingLink=t)}catch{this.pendingLinkURL===e&&(this.pendingLinkURL="")}})())}dropLink(){this.pendingLink=null,this.pendingLinkURL=""}async send(){const e=this.pendingPhoto,t=this.pendingItems,a=this.activeConversation,s=this.draft.trim()||(e?"*shares a photo with you*":"")||(t.length?`*shares ${t.length===1?t[0].title:`${t.length} things`} from the library*`:"");if(!s||!a)return;const n=a.id,o=this.replyTarget,r={id:_(),role:"user",content:s,at:Date.now(),imageId:e==null?void 0:e.imageId,attachments:t.length?t:void 0,replyTo:o?{id:o.id,role:o.role,excerpt:ne(o.content)}:void 0};a.messages.push(r),a.updatedAt=Date.now(),a.title==="New conversation"&&(a.title=s.slice(0,42));const l=this.pendingLink&&!this.pendingLink.failed&&this.pendingLinkURL?this.pendingLinkURL:"";this.draft="",this.pendingPhoto=null,this.pendingItems=[],this.replyTarget=null,this.dropLink(),this.notice="";const u=this.renderRoot.querySelector("textarea");u&&(u.value=""),this.touchWorkspace(),this.armIdle(),this.scrollToEnd(),this.autoTurns=Z,a.characterId==="libby"&&g.libbyAutoAnswered().catch(()=>{});const m=this.turnOptions;this.turnOptions={photoTags:e?e.tags:m.photoTags,photoImageID:e?e.imageId:m.photoImageID,link:l||m.link,sharedMediaIds:[...m.sharedMediaIds??[],...t.map(f=>f.id)]},this.scheduleReply(n,s.length)}scheduleReply(e,t){window.clearTimeout(this.readTimer);const a=this.liveConversation(e),s=a?[...a.messages].reverse().find(o=>o.role==="assistant"):void 0,n=s?Date.now()-s.at:0;if(this.busy){this.pendingReply=!0;return}this.readTimer=window.setTimeout(()=>void this.runTurn(e),Pt(t,n))}async runTurn(e){if(this.busy){this.pendingReply=!0;return}const t=this.liveConversation(e);if(!t)return;const a=Date.now();let s="";for(const l of t.messages)l.role==="user"&&!l.readAt&&(l.readAt=a,s=l.content);if(!s)return;this.touchWorkspace(),await this.pause(250+Math.random()*500);const n=this.turnOptions;this.turnOptions={},await this.generateReply(e,s,{photoTags:n.photoTags??[],photoImageID:n.photoImageID??"",link:n.link??"",sharedMediaIds:n.sharedMediaIds??[]}),this.scheduleAuto();const o=this.liveConversation(e),r=(o==null?void 0:o.messages.some(l=>l.role==="user"&&!l.readAt))??!1;(this.pendingReply||r)&&(this.pendingReply=!1,r&&this.scheduleReply(e,40))}receiptFor(e,t){if(e.role!=="user")return"";const a=t.messages.filter(n=>n.role==="user");if(a[a.length-1]!==e)return"";if(e.readAt)return`Read ${pe(e.readAt)}`;const s=t.messages.indexOf(e);return t.messages.slice(s+1).some(n=>n.role==="assistant"&&!n.thought)?"Read":"Sent"}react(e,t){const a=this.activeConversation;if(!a)return;const s=(e.reactions??[]).find(o=>o.by==="user"),n=(e.reactions??[]).filter(o=>o.by!=="user");e.reactions=(s==null?void 0:s.emoji)===t?n:[...n,{emoji:t,by:"user"}],e.reactions.length||delete e.reactions,this.reactionPicker=null,a.updatedAt=Date.now(),this.touchWorkspace()}applyReaction(e,t,a){const s=a&&e.messages.find(o=>o.id===a)||[...e.messages].reverse().find(o=>o.role==="user");if(!s)return;const n=(s.reactions??[]).filter(o=>o.by!=="assistant");s.reactions=[...n,{emoji:t,by:"assistant"}]}openSnap(e){e.opened||(this.snapOpen=e)}closeSnap(){const e=this.snapOpen;if(this.snapOpen=null,!e)return;e.opened=!0;const t=this.activeConversation;t&&(t.updatedAt=Date.now(),this.touchWorkspace())}swipeStart(e,t){if(t.pointerType==="mouse"||e.thought)return;const a=t.currentTarget.querySelector(".bubble-wrap");a&&(this.swipe={id:e.id,startX:t.clientX,startY:t.clientY,dx:0,live:!1,el:a})}swipeMove(e){const t=this.swipe;if(!t)return;const a=e.clientX-t.startX,s=e.clientY-t.startY;if(!t.live){if(Math.abs(s)>8&&Math.abs(s)>Math.abs(a)){this.swipe=null;return}if(a<10)return;t.live=!0,t.el.classList.add("swiping");try{e.currentTarget.setPointerCapture(e.pointerId)}catch{}}t.dx=Math.max(0,Math.min(Ht,a)),t.el.style.transform=`translateX(${t.dx}px)`,t.el.classList.toggle("will-reply",t.dx>=ze),e.preventDefault()}swipeEnd(e){const t=this.swipe;this.swipe=null,t&&(t.el.classList.remove("swiping","will-reply"),t.el.style.transform="",t.live&&t.dx>=ze&&this.replyTo(e))}replyTo(e){e.thought||(this.replyTarget=e,this.focusComposer())}jumpTo(e){if(!(e!=null&&e.id))return;const t=this.renderRoot.querySelector(`[data-message-id="${e.id}"]`);if(!t){this.say("That message isn't in this conversation any more.");return}t.scrollIntoView({block:"center",behavior:"smooth"}),t.classList.remove("flash"),t.offsetWidth,t.classList.add("flash")}openPicker(){this.picker={query:"",items:[],loading:!0},this.searchLibrary(""),window.setTimeout(()=>{var e;return(e=this.renderRoot.querySelector(".picker-head input"))==null?void 0:e.focus()},30)}closePicker(){this.picker=null,this.focusComposer()}async searchLibrary(e){var s;if(!this.picker)return;const t=++this.pickerSeq;(s=this.pickerAbort)==null||s.abort();const a=new AbortController;this.pickerAbort=a,this.picker={...this.picker,query:e,loading:!0};try{const{items:n}=await g.listMedia({q:e,limit:120,signal:a.signal});if(t!==this.pickerSeq||!this.picker)return;this.picker={query:e,items:n,loading:!1}}catch(n){if(a.signal.aborted||t!==this.pickerSeq||!this.picker)return;this.picker={...this.picker,loading:!1},this.say(n.message,!0)}}toggleItem(e){this.pendingItems.some(a=>a.id===e.id)?this.pendingItems=this.pendingItems.filter(a=>a.id!==e.id):this.pendingItems.length<6?this.pendingItems=[...this.pendingItems,{id:e.id,title:e.title||`Item ${e.id}`,kind:e.kind,hasThumb:e.hasThumb===!0}]:this.say("Six at a time is plenty.")}removeItem(e){this.pendingItems=this.pendingItems.filter(t=>t.id!==e)}async attachPhoto(e){var n,o;const t=e.target,a=(n=t.files)==null?void 0:n[0],s=this.activeCharacter;if(!(!a||!s))try{this.say("Scanning photo locally…");const r=await g.uploadChatImage({characterId:s.id,name:a.name,imageData:await this.readDataURL(a),tags:[]});this.workspace.images.push(r),this.pendingPhoto={imageId:r.id,tags:r.tags??[],name:r.name},this.touchWorkspace(),this.say((o=r.tags)!=null&&o.length?`Photo ready: ${r.tags.slice(0,6).join(", ")}.`:"Photo ready to send."),this.focusComposer()}catch(r){this.say(r.message,!0)}finally{t.value=""}}pickPhoto(){var e;(e=this.renderRoot.querySelector(".attach-btn input"))==null||e.click()}async discardPhoto(){const e=this.pendingPhoto;if(e){this.pendingPhoto=null,this.workspace.images=this.workspace.images.filter(t=>t.id!==e.imageId),this.touchWorkspace(),this.focusComposer();try{await g.deleteChatImage(e.imageId)}catch{}}}pause(e){return new Promise(t=>setTimeout(t,e))}async typeLikeAPerson(e,t){const a=r=>r*(.7+Math.random()*.6),s=Math.min(7e3,a(420+e.length*45));let n=Math.max(0,s-t);if(n<120)return;this.typingPhase="thinking";const o=Math.min(n,a(500));if(await this.pause(o),n-=o,e.length>90&&n>900&&Math.random()<.35){const r=n*(.3+Math.random()*.3);this.typingPhase="typing",await this.pause(r),this.typingPhase="thinking";const l=a(650);await this.pause(l),n-=r+l}n>0&&(this.typingPhase="typing",await this.pause(n)),this.typingPhase="idle"}async typeAndPushBubbles(e,t,a,s={},n={}){for(let o=0;o<t.length;o++){await this.typeLikeAPerson(t[o],o===0?a:0);const r=this.liveConversation(e);if(!r)return!1;const l=o===t.length-1;r.messages.push({id:_(),role:"assistant",content:t[o],at:Date.now(),...o===0?n:{},...l?s:{}}),r.updatedAt=Date.now(),this.touchWorkspace(),this.scrollToEnd(),this.speakOn&&e===this.conversationID&&Te(t[o],r.intensity)}return!0}toggleSpeak(){this.speakOn=!this.speakOn,Tt(this.speakOn),this.say(this.speakOn?"She'll read her replies aloud on this device.":"Voice off.")}pushThoughts(e,t){if(!(t!=null&&t.length))return!0;const a=this.liveConversation(e);if(!a)return!1;for(const{kind:s,text:n}of t)n.trim()&&a.messages.push({id:_(),role:"assistant",content:n,at:Date.now(),thought:s});return a.updatedAt=Date.now(),this.touchWorkspace(),this.scrollToEnd(),!0}async generateReply(e,t,a={}){var $,y,k,x,T,v,S,O,U,R,q,he,ue,ge,me,be;const{continuation:s=!1,photoTags:n=[],photoImageID:o="",link:r="",sharedMediaIds:l=[],nudge:u="",task:m=""}=a,f=this.liveConversation(e),b=f&&this.liveCharacter(f.characterId);if(!f||!b||this.busy)return!1;if(this.busy=!0,!(($=this.status)!=null&&$.enabled)&&((y=this.status)!=null&&y.configured||(k=this.status)!=null&&k.modelBackend))try{this.status=await g.chatStatus()}catch{}if(!((x=this.status)!=null&&x.enabled)){if(b.id!=="libby")return this.busy=!1,this.say(((T=this.status)==null?void 0:T.message)||"Load a model in text-generation-webui, then refresh backend status.",!0),!1;const L=ke(f.progress??f.intensity,s?0:at(t,f.mode)),F=f.mode,w=N(f.emotion);let C;if(s)C=xe("idle",{intensity:L.intensity});else{const H=await this.libraryFacts();C=(H&&st(t,H,{intensity:L.intensity}))??it(t,F,w,L.intensity,!1)}const D=this.liveConversation(e);if(!D)return this.busy=!1,this.typingPhase="idle",!1;D.emotion=C.emotion,D.progress=L.progress,D.intensity=M(L.intensity),D.updatedAt=Date.now(),this.touchWorkspace();const Y=await this.typeAndPushBubbles(e,Le(C.message),0);return this.busy=!1,this.typingPhase="idle",Y}try{const L=f.messages.filter(P=>!P.thought).map(({id:P,role:Fe,content:Ye,replyTo:He,imageId:Ge,attachments:G,reactions:K})=>({id:P,role:Fe,content:Ye,replyTo:He,imageId:Ge||void 0,mediaIds:G!=null&&G.length?G.map(Ke=>Ke.id):void 0,reactions:K!=null&&K.length?K:void 0}));s?L.push({role:"user",content:"(Continue the scene on your own. Speak or act again without waiting for a reply, and do not answer for me.)"}):u&&L.push({role:"user",content:`(Try that reply again. ${u} Do not mention this note.)`});const F=Date.now();this.typingPhase="typing";const w=await g.chat({mode:f.mode,messages:L,emotion:f.emotion,intensity:f.intensity,options:f.options,characterId:b.id,conversationId:f.id,photoTags:n,photoImageId:o,recentImageIds:rt(f.messages),recentMediaIds:ve(f.messages),recentMoods:nt(f.messages),recentHeat:ot(f.messages),activity:f.activity||void 0,background:f.background||void 0,sharedMediaIds:l.length?l:void 0,call:this.callOpen||void 0,outfit:b.id==="libby"?X():"",link:r||void 0,task:m||(s?"autonomous":void 0),debug:this.captureTurns||void 0});if(w.debug){const P=this.turnLog.get(e)??[];P.push({at:F,request:{photoTags:n,photoImageId:o,task:s?"autonomous":""},debug:w.debug}),this.turnLog.set(e,P.slice(-qt))}this.lastSampling=w.sampling,this.lastPhoto=w.photo,(v=w.context)!=null&&v.note&&this.say(w.context.note);const C=this.liveConversation(e);if(!C)return!1;C.emotion=N(w.emotion??C.emotion),w.activity!==void 0&&(C.activity=w.activity),w.background!==void 0&&(C.background=w.background);const D=$e(w.intensity??C.intensity);if(w.declared)C.progress=D,C.intensity=M(D);else{const P=ke(C.progress??C.intensity,D-C.intensity);C.progress=P.progress,C.intensity=M(P.intensity)}if(C.updatedAt=Date.now(),this.touchWorkspace(),w.callRequest&&!this.callOpen&&this.ring(),w.callEnd&&this.callOpen&&(this.endCall(),this.say(`${b.name} ended the call.`)),!this.pushThoughts(e,w.thoughts))return!1;(S=w.reaction)!=null&&S.emoji&&(this.applyReaction(C,w.reaction.emoji,w.reaction.to),this.touchWorkspace());const Y=!!(w.imageId||(O=w.attachments)!=null&&O.length);if(!w.message.trim()&&!Y)return(((U=w.thoughts)==null?void 0:U.length)??0)>0||!!w.reaction;const H=w.message.trim()||(w.snap?"*sends a snap*":"*sends a picture*");return await this.typeAndPushBubbles(e,Le(H),Date.now()-F,{mood:C.emotion,heat:C.intensity,imageId:w.imageId||void 0,snap:w.snap&&Y?!0:void 0,links:(R=w.links)!=null&&R.length?w.links:void 0,attachments:(q=w.attachments)!=null&&q.length?w.attachments:void 0,actions:(he=w.actions)!=null&&he.length?w.actions:void 0},{replyTo:w.replyTo??void 0})}catch(L){if((ue=this.status)!=null&&ue.configured||(ge=this.status)!=null&&ge.modelBackend)try{this.status=await g.chatStatus()}catch{}return this.typingPhase="idle",this.say(!((me=this.status)!=null&&me.enabled)&&((be=this.status)!=null&&be.message)?this.status.message:L.message,!0),!1}finally{this.busy=!1,this.typingPhase="idle"}}async regenerate(e=""){const t=this.activeConversation;if(!t||this.busy)return;const a=t.messages;let s=a.length;for(;s>0&&a[s-1].role==="assistant";)s--;if(s===a.length){this.say("There is no reply to redo yet.",!0);return}const n=t.id,o=s>0?a[s-1].content:"";t.messages=a.slice(0,s),t.updatedAt=Date.now(),this.touchWorkspace(),this.scrollToEnd();const r=s>0?a[s-1]:void 0;await this.generateReply(n,o,{continuation:s===0,nudge:e,sharedMediaIds:(r==null?void 0:r.role)==="user"?(r.attachments??[]).map(l=>l.id):[]})}async regenerateWithNote(){var t;const e=(t=prompt("Ask her to try again — what should be different?",""))==null?void 0:t.trim();e!==void 0&&await this.regenerate(e?e.endsWith(".")?e:e+".":"")}async retryFrom(e){const t=this.activeConversation;if(!t||this.busy||e.role!=="user")return;const a=t.messages.indexOf(e);if(a<0)return;const s=t.id;t.messages=t.messages.slice(0,a+1),t.updatedAt=Date.now(),this.touchWorkspace(),this.scrollToEnd(),await this.generateReply(s,e.content,{sharedMediaIds:(e.attachments??[]).map(n=>n.id)})}toggleAutopilot(){var e;this.autopilot=!this.autopilot,this.autoPaused=!1,this.autoTurns=Z;try{localStorage.setItem(_e,this.autopilot?"1":"0")}catch{}this.autopilot&&!((e=this.status)!=null&&e.enabled)&&this.say("Autopilot needs a connected model — it stays off until one is loaded.",!0),this.scheduleAuto()}pauseAutopilot(e){this.autoPaused=e,e?window.clearTimeout(this.autoTimer):(this.autoTurns=Math.max(this.autoTurns,1),this.scheduleAuto())}refillAutopilot(){this.autoTurns=Z,this.pauseAutopilot(!1)}get autoRunning(){var e;return this.autopilot&&!this.autoPaused&&!!((e=this.status)!=null&&e.enabled)&&this.autoTurns>0}scheduleAuto(){window.clearTimeout(this.autoTimer),this.autoRunning&&(this.autoTimer=window.setTimeout(()=>void this.autoTick(),Ut))}async autoTick(){if(this.busy||document.visibilityState!=="visible"){this.scheduleAuto();return}const e=this.activeConversation;if(!e||!this.autoRunning)return;this.autoTurns--,await this.generateReply(e.id,"",{continuation:!0})?this.scheduleAuto():this.autoPaused=!0}editMessage(e){var s;const t=(s=prompt("Edit message",e.content))==null?void 0:s.trim();if(!t||t===e.content)return;e.content=t;const a=this.activeConversation;a&&(a.updatedAt=Date.now()),this.touchWorkspace()}deleteMessage(e){const t=this.activeConversation;t&&(t.messages=t.messages.filter(a=>a.id!==e),t.updatedAt=Date.now(),this.touchWorkspace())}updateCharacter(e,t){const a=this.activeCharacter;a&&(a[e]=t,this.touchWorkspace())}addCharacter(){const e={id:_(),name:"New friend",promptWeight:1,defaultMode:"sweet",firstMessage:"Hey! It's nice to meet you."};this.workspace.characters.push(e),this.characterID=e.id,this.touchWorkspace(),this.newConversation(!1),this.settingsOpen=!0,this.editorTab="character"}deleteCharacter(){var a;const e=this.activeCharacter;if(!e||e.builtIn||!confirm(`Remove ${e.name} and all of their conversations?`))return;this.workspace.characters=this.workspace.characters.filter(s=>s.id!==e.id),this.workspace.conversations=this.workspace.conversations.filter(s=>s.characterId!==e.id),this.characterID=((a=this.workspace.characters[0])==null?void 0:a.id)??"libby";const t=this.conversationsFor()[0];t?this.conversationID=t.id:this.newConversation(!1),this.touchWorkspace()}async importCard(e){const t=e.target,a=Array.from(t.files??[]);a.length&&await this.ingestCards(a),t.value=""}async ingestCards(e){const t=[],a=[],s=[];for(const o of e)try{const r=await Et(o),l=o.name.toLowerCase().endsWith(".png")||o.type==="image/png";if(!r){if(!l&&!o.type.startsWith("image/")){s.push(`${o.name}: no character card inside`);continue}s.push(`${o.name}: no card data in that image — add a friend first, then set their picture`);continue}if(this.workspace.characters.length>=40){s.push(`${o.name}: workspace is full`);break}const u={...r.character,id:_()};if(this.workspace.characters.push(u),this.characterID=u.id,t.push(u.name),r.leftovers.alternateGreetings>0&&a.push(`${u.name}: kept ${r.leftovers.alternateGreetings} alternate greeting${r.leftovers.alternateGreetings===1?"":"s"}`),r.leftovers.characterBook&&a.push(`${u.name}: the card's lorebook was dropped — this app has nowhere to put one`),l){await this.saveWorkspace();try{const m=await g.uploadChatImage({characterId:u.id,name:`${u.name} avatar`,imageData:await this.readDataURL(o),tags:["portrait"]});this.workspace.images.push(m);const f=this.liveCharacter(u.id);f&&(f.avatarImageId=m.id)}catch(m){a.push(`${u.name}: card imported, but the portrait didn't upload (${m.message})`)}}}catch(r){s.push(`${o.name}: ${r.message}`)}t.length&&(this.touchWorkspace(),this.newConversation(!1));const n=[t.length?`Imported ${t.join(", ")}.`:"",...a,...s.map(o=>`Couldn't import ${o}.`)].filter(Boolean).join(" ");this.cardNote=n?{text:n,bad:!t.length}:null,n&&this.say(n,!t.length)}readDataURL(e){return new Promise((t,a)=>{const s=new FileReader;s.onload=()=>t(String(s.result)),s.onerror=()=>a(s.error),s.readAsDataURL(e)})}async uploadImage(e){var s;const t=(s=e.target.files)==null?void 0:s[0],a=this.activeCharacter;if(!(!t||!a))try{this.say("Scanning image locally…");const n=this.imageTags.split(",").map(l=>l.trim()).filter(Boolean),o=await g.uploadChatImage({characterId:a.id,name:t.name,imageData:await this.readDataURL(t),tags:n,subject:this.imageSubject||void 0});this.workspace.images.push(o);const r=this.liveCharacter(a.id);r&&!r.avatarImageId&&(r.avatarImageId=o.id),this.imageTags="",this.touchWorkspace(),this.say(`Image scanned: ${o.tags.join(", ")||"no content tags found"}.`)}catch(n){this.say(n.message,!0)}finally{e.target.value=""}}async uploadProfilePicture(e){var s;const t=(s=e.target.files)==null?void 0:s[0];if(!t)return;const a=this.workspace.profile.avatarImageId;try{this.say("Uploading profile picture…");const n=await g.uploadChatImage({characterId:lt,name:t.name,imageData:await this.readDataURL(t),tags:[]});this.workspace.images.push(n),this.editProfile({avatarImageId:n.id}),await this.saveWorkspace(),a&&await this.discardProfileImage(a),this.say("Profile picture updated.")}catch(n){this.say(n.message,!0)}finally{e.target.value=""}}async removeProfilePicture(){const e=this.workspace.profile.avatarImageId;e&&(this.editProfile({avatarImageId:""}),await this.saveWorkspace(),await this.discardProfileImage(e),this.say("Profile picture removed."))}async uploadCharacterPicture(e){var o;const t=(o=e.target.files)==null?void 0:o[0],a=this.activeCharacter;if(!t||!a)return;const s=a.id,n=a.avatarImageId;try{this.say("Uploading picture…");const r=await g.uploadChatImage({characterId:Me(s),name:`${a.name} avatar`,imageData:await this.readDataURL(t),tags:[]});this.workspace.images.push(r);const l=this.liveCharacter(s);l&&(l.avatarImageId=r.id),this.touchWorkspace(),await this.saveWorkspace(),n&&this.isAvatarUpload(n,s)&&await this.discardProfileImage(n),this.say("Picture updated.")}catch(r){this.say(r.message,!0)}finally{e.target.value=""}}async removeCharacterPicture(){const e=this.activeCharacter,t=e==null?void 0:e.avatarImageId;if(!e||!t)return;const a=e.id;e.avatarImageId="",this.touchWorkspace(),await this.saveWorkspace(),this.isAvatarUpload(t,a)&&await this.discardProfileImage(t),this.say("Picture removed.")}isAvatarUpload(e,t){var a;return((a=this.workspace.images.find(s=>s.id===e))==null?void 0:a.characterId)===Me(t)}async discardProfileImage(e){try{await g.deleteChatImage(e),this.workspace.images=this.workspace.images.filter(t=>t.id!==e),this.touchWorkspace()}catch{}}async deleteImage(e){if(confirm(`Delete ${e.name}?`))try{await g.deleteChatImage(e.id),this.workspace.images=this.workspace.images.filter(a=>a.id!==e.id);const t=this.activeCharacter;(t==null?void 0:t.avatarImageId)===e.id&&(t.avatarImageId=""),this.touchWorkspace()}catch(t){this.say(t.message,!0)}}avatar(e,t){return e.avatarImageId?i`<span class=${t}><img src=${g.chatImageURL(e.avatarImageId)} alt="" /></span>`:e.id==="libby"&&!J()?i`<span class=${t}><img src=${ct} alt="Libby" /></span>`:i`<span class="${t} initial">${e.name.slice(0,2).toUpperCase()}</span>`}profileAvatar(e,t){const a=this.workspace.profile.avatarImageId;return a?i`<span class=${t}><img src=${g.chatImageURL(a)} alt="" /></span>`:i`<span class="${t} initial">${e.slice(0,2).toUpperCase()}</span>`}spriteFor(e,t,a,s){return e.id==="libby"?dt(t,a,X(),s):[]}startCall(){const e=this.activeCharacter;if(e){if(!this.spriteFor(e,"neutral",1).length){this.say(`${e.name} has no picture to show — set one on their character card first.`,!0);return}this.stopRinging(),this.callOpen=!0,this.callSeconds=0,this.settingsOpen=!1,this.scenePickerOpen=!1,window.clearInterval(this.callTimer),this.callTimer=window.setInterval(()=>this.callSeconds+=1,1e3),this.loadBackgrounds(),this.focusComposer()}}endCall(){Ie(),this.callOpen=!1,this.scenePickerOpen=!1,window.clearInterval(this.callTimer),this.focusComposer()}ring(){var e;if(!(this.callOpen||J())){this.incomingCall=!0,window.clearTimeout(this.ringTimer),this.ringTimer=window.setTimeout(()=>this.declineCall(!0),Ft);try{(e=navigator.vibrate)==null||e.call(navigator,[220,120,220])}catch{}}}stopRinging(){this.incomingCall=!1,window.clearTimeout(this.ringTimer)}acceptCall(){this.stopRinging(),this.startCall()}declineCall(e=!1){var t;this.incomingCall&&(this.stopRinging(),e&&this.say("Missed a call from "+(((t=this.activeCharacter)==null?void 0:t.name)??"her")+"."))}async loadBackgrounds(){try{const e=await g.libbyBackgrounds();this.backgrounds=e.backgrounds,this.defaultBackground=e.default??""}catch{this.backgrounds=[]}}setBackground(e){const t=this.activeConversation;t&&(t.background=e,t.updatedAt=Date.now(),this.touchWorkspace(),this.scenePickerOpen=!1)}toggleScenePicker(){this.scenePickerOpen=!this.scenePickerOpen,this.scenePickerOpen&&this.loadBackgrounds()}renderCall(e,t){if(!this.callOpen)return c;const a=this.poseOf(e,t);if(!a)return c;const{emotion:s,intensity:n,typing:o,activity:r,assets:l}=a,u=this.backgrounds.find(b=>b.id===(t.background||this.defaultBackground)&&b.hasImage),m=t.messages.filter(b=>!b.thought).slice(-3),f=`${Math.floor(this.callSeconds/60)}:${String(this.callSeconds%60).padStart(2,"0")}`;return i`<div class="call" role="dialog" aria-modal="true" aria-label=${`Video call with ${e.name}`}>
      <div class="call-scene" @click=${()=>{this.scenePickerOpen&&(this.scenePickerOpen=!1)}}>
        <div class="call-bg ${u?"":"plain"}" style=${u?`background-image:url("${g.libbyBackgroundURL(u.id)}")`:""}></div>
        ...
        <span class="call-hold libby-breathe">${se(`${s}-${n}-${r}-${this.spoken}`,i`<img
          class="call-sprite" src=${l[0]} data-fallback-index="0"
          alt=${`${e.name} looking ${s}`}
          @error=${b=>ie(b.target,l)} />`)}</span>
        <div class="call-top">
          <span class="call-who">${this.avatar(e,"avatar")}<span><strong>${e.name}</strong><span><i class="call-live"></i>${o?"typing…":this.busy?"thinking…":f}</span></span></span>
          <span class="call-mood" title=${`Feeling ${s}`}>
            <span class="material-symbols-rounded">mood</span>${s}
            ${t.activity?i`<span class="call-doing" title=${`She is ${t.activity}`}>${oe(t.activity)}</span>`:c}
            ${u?i`<span class="call-place" title="Where she is">${u.name}</span>`:c}
          </span>
        </div>
        ${this.callCaptions?i`<div class="call-captions" aria-live="polite">
          ${m.map((b,$)=>i`<p class="call-caption ${b.role==="user"?"mine":""} ${$<m.length-1?"older":""}">${je(b.content,b.links,y=>j(this,y))}</p>`)}
          ${o?i`<p class="call-caption typing" aria-label="${e.name} is typing"><span class="dots"><i></i><i></i><i></i></span></p>`:c}
        </div>`:c}
        ${this.scenePickerOpen?this.renderScenePicker(t):c}
      </div>
      <div class="call-bar">
    ...
    </div>`}renderScenePicker(e){const t=this.backgrounds.filter(a=>a.hasImage);return i`<div class="call-tray" @click=${a=>a.stopPropagation()}>
      <h4>Where she is</h4>
      <div class="call-scenes">
        ${this.defaultBackground?c:i`<button class="call-scene-btn ${e.background?"":"on"}" title="No background" @click=${()=>this.setBackground("")}>
          <span class="scene-icon material-symbols-rounded">blur_on</span><span class="scene-name">Plain</span>
        </button>`}
        ${t.map(a=>i`<button class="call-scene-btn ${(e.background||this.defaultBackground)===a.id?"on":""}" title=${a.tags.join(", ")||a.name} @click=${()=>this.setBackground(a.id)}>
    ...
    </div>`}poseOf(e,t){if(e.id==="libby"&&J())return null;const a=N(t.emotion),s=$e(t.intensity),n=this.busy&&this.typingPhase==="typing",o=t.activity||(n?"typing":""),r=this.spriteFor(e,a,s,o);return r.length?{emotion:a,intensity:s,typing:n,activity:o,assets:r,key:`${a}-${s}-${o}-${this.spoken}`}:null}renderHero(e,t){var m;const a=this.poseOf(e,t);if(!a)return c;const{emotion:s,typing:n,activity:o,assets:r,key:l}=a,u=this.busy?"Typing…":this.autoRunning?"Talking on their own":(m=this.status)!=null&&m.enabled?this.status.model:"Local replies";return i`<div class="hero" role="button" tabindex="0" aria-label=${`${e.name} — open the call`} title="Open the call"
      @click=${()=>this.startCall()} @keydown=${f=>{(f.key==="Enter"||f.key===" ")&&(f.preventDefault(),this.startCall())}}>
      <span class="hero-hold libby-breathe">${se(l,i`<img
        class="hero-sprite ${this.busy?"":"libby-speak"}" src=${r[0]} data-fallback-index="0"
        alt=${o?`${e.name} ${o}, looking ${s}`:`${e.name} looking ${s}`}
        @error=${f=>ie(f.target,r)} />`)}</span>
      ${n?i`<div class="hero-bubble" aria-hidden="true"><span class="dots"><i></i><i></i><i></i></span></div>`:c}
      <div class="hero-copy">
        <span class="hero-name">${e.name}</span>
        <span class="hero-status">${u}${e.id==="libby"?` · ${s}`:""}</span>
        ${t.activity?i`<div class="stage-doing" role="status">${oe(t.activity)}</div>`:c}
      </div>
      <span class="hero-open"><span class="material-symbols-rounded">videocam</span>Call</span>
    </div>`}renderStage(e,t){var y,k;const a=this.poseOf(e,t);if(!a)return c;const{emotion:s,intensity:n,typing:o,activity:r,assets:l}=a,u=this.busy?"Typing…":this.autoRunning?"Talking on their own":(y=this.status)!=null&&y.enabled?this.status.model:"Local replies",m=this.backgrounds.find(x=>x.id===(t.background||this.defaultBackground)&&x.hasImage),f=o?void 0:[...t.messages].reverse().find(x=>x.role==="assistant"&&!x.thought&&x.content.trim()),b=f?ne(At(f.content),110):"",$=!!((k=this.status)!=null&&k.enabled);return i`<aside class="stage" aria-label="${e.name} portrait">
      ...
      <div class="stage-scene" @click=${()=>{this.scenePickerOpen&&(this.scenePickerOpen=!1)}}>
        ...
        <div class="stage-art">
          ...
          <span class="sprite-hold libby-breathe">${se(`${s}-${n}-${r}-${this.spoken}`,i`<img
        ...
        ${o?i`<div class="stage-bubble" aria-hidden="true"><span class="dots"><i></i><i></i><i></i></span></div>`:b?i`<div class="stage-bubble quote" aria-hidden="true">${b}</div>`:c}
        <div class="stage-tools">
          ${e.id==="libby"?i`<button class="icon-btn" title="Video call" aria-label="Start a video call" @click=${()=>this.startCall()}><span class="material-symbols-rounded">videocam</span></button>
          <button class="icon-btn ${this.scenePickerOpen?"on":""}" title="Change where she is" aria-label="Change the background" @click=${x=>{x.stopPropagation(),this.toggleScenePicker()}}><span class="material-symbols-rounded">wallpaper</span></button>`:c}
        ...
        ${this.scenePickerOpen&&!this.callOpen?this.renderScenePicker(t):c}
        <div class="stage-glass">
          <div class="stage-who">
            <span class="stage-name">${e.name}</span>
            <span class="stage-status"><span class="status-dot ${$?"online":""}"></span> ${u}</span>
          </div>
          <div class="stage-chips">
            <span class="stage-chip" title="How she feels"><span class="material-symbols-rounded">mood</span>${Ce[s]??s}</span>
            ${t.activity?i`<span class="stage-chip doing" role="status" title=${`She is ${t.activity}`}><span class="material-symbols-rounded">directions_walk</span>${oe(t.activity)}</span>`:c}
            ${m?i`<span class="stage-chip" title="Where she is"><span class="material-symbols-rounded">location_on</span>${m.name}</span>`:c}
          </div>
          ${e.id==="libby"?i`<div class="stage-heat h${n}" title=${`Heat ${n} of 5`}>
            <span>Heat</span><span class="segs">${[1,2,3,4,5].map(x=>i`<i class=${x<=n?"on":""}></i>`)}</span>
          </div>`:c}
        </div>
      </div>
    </aside>`}renderAutopilotBar(e){var s,n,o;if(!this.autopilot)return c;const t=this.autoTurns<=0,a=(s=this.status)!=null&&s.enabled?this.autoPaused?"Autopilot paused.":t?`${e.name} is waiting for you to say something.`:`${e.name} keeps the conversation going · ${this.autoTurns} turn${this.autoTurns===1?"":"s"} left`:"Autopilot is waiting for a model.";return i`<div class="autobar ${this.autoPaused||t||!((n=this.status)!=null&&n.enabled)?"idle":""}" role="status">
      <span class="material-symbols-rounded">${this.autoPaused?"pause_circle":"smart_toy"}</span>
      <span class="autobar-copy">${a}</span>
      ${(o=this.status)!=null&&o.enabled?i`<button class="autobar-btn" @click=${()=>t?this.refillAutopilot():this.pauseAutopilot(!this.autoPaused)}>
        ${t?"Continue":this.autoPaused?"Resume":"Pause"}
      </button>`:c}
      <button class="autobar-btn" @click=${()=>this.toggleAutopilot()}>Turn off</button>
    </div>`}renderSidebar(){var t;const e=this.workspace.profile.displayName||((t=this.user)==null?void 0:t.username)||"You";return i`<aside class="side">
      <div class="side-head">
        <h1>${this.pickerOpen?"New chat":"Chats"}</h1>
        ${this.pickerOpen?i`<button class="icon-btn" title="Back to chats" aria-label="Back to chats" @click=${()=>this.pickerOpen=!1}><span class="material-symbols-rounded">close</span></button>`:i`<button class="icon-btn" title="New chat" aria-label="New chat" @click=${()=>this.pickerOpen=!0}><span class="material-symbols-rounded">edit_square</span></button>
      ...
      ${this.pickerOpen?this.renderFriends():i`
    ...
    </aside>`}renderChatRows(){const e=this.chatSearch.trim().toLowerCase(),t=new Map;for(const s of this.workspace.conversations)t.set(s.characterId,(t.get(s.characterId)??0)+1);const a=[...this.workspace.conversations].map(s=>({conversation:s,character:this.visibleCharacters.find(n=>n.id===s.characterId)})).filter(s=>!!s.character).sort((s,n)=>n.conversation.updatedAt-s.conversation.updatedAt).filter(({conversation:s,character:n})=>!e||n.name.toLowerCase().includes(e)||s.title.toLowerCase().includes(e)||De(this.lastLine(s)).toLowerCase().includes(e));return a.length?a.map(({conversation:s,character:n})=>{var l;const o=[...s.messages].reverse().find(u=>!u.thought),r=(t.get(n.id)??0)>1;return i`<div class="chat-wrap ${s.id===this.conversationID?"on":""}" data-id=${s.id}>
        <button class="chat-row" @click=${()=>this.activateConversation(s.id)} aria-current=${s.id===this.conversationID?"page":"false"}>
          ${this.avatar(n,"chat-avatar")}
          <span class="chat-name">${n.name}${r?i` <small>· ${s.title}</small>`:c}</span>
          <span class="chat-time">${Kt(s.updatedAt)}</span>
          <span class="chat-preview">${o?i`${o.role==="user"?"You: ":""}${o.imageId&&!o.content.trim()?i`<span class="material-symbols-rounded">photo_camera</span>Photo`:De(o.content)}`:i`<em>${(l=n.firstMessage)!=null&&l.trim()?"Say hello":"No messages yet"}</em>`}</span>
        </button>
        <button class="chat-delete" title="Delete chat" aria-label="Delete chat with ${n.name}" @click=${()=>this.deleteConversation(s.id)}><span class="material-symbols-rounded" style="font-size:16px">delete</span></button>
      </div>`}):i`<div class="chats-empty">${e?"No chats match that.":"No chats yet — start one."}</div>`}lastLine(e){var t;return((t=[...e.messages].reverse().find(a=>!a.thought))==null?void 0:t.content)??""}renderFriends(){const e=this.visibleCharacters;return i`<div class="friends"
      @dragover=${t=>{t.preventDefault(),this.cardDrop=!0}}
      @dragleave=${()=>this.cardDrop=!1}
      @drop=${this.dropCard}>
      <div class="pick-cat">Friends</div>
      ${e.map(t=>{var a;return i`
        <div class="pick-wrap">
          ...
          <div class="pick-acts">
            ...
            ${t.builtIn?c:i`<button class="pick-act danger" title="Remove ${t.name}" aria-label="Remove ${t.name}"
      ...
      ${this.cardNote?i`<div class="card-note ${this.cardNote.bad?"bad":""}">${this.cardNote.text}</div>`:c}
    </div>`}exportConversation(e){const t=e?this.workspace.conversations.find(m=>m.id===e):this.activeConversation;if(!t)return;const a=this.workspace.characters.find(m=>m.id===t.characterId),s=this.turnLog.get(t.id)??[],n={exportedAt:new Date().toISOString(),app:"oppailib",format:1,conversation:{id:t.id,title:t.title,characterId:t.characterId,mode:t.mode,emotion:t.emotion,intensity:t.intensity,activity:t.activity??"",background:t.background??"",options:t.options??{},updatedAt:t.updatedAt,messages:t.messages},character:a??null,images:this.workspace.images.filter(m=>t.messages.some(f=>f.imageId===m.id)),profile:this.workspace.profile,turns:s,capture:s.length?`${s.length} turn(s) captured with full prompts`:"No turns captured — switch on 'Capture turns' in the chat menu and send a message first"},o=new Blob([JSON.stringify(n,null,2)],{type:"application/json"}),r=URL.createObjectURL(o),l=document.createElement("a"),u=new Date().toISOString().replace(/[:.]/g,"-").slice(0,19);l.href=r,l.download=`oppailib-chat-${((a==null?void 0:a.name)??"chat").replace(/[^\w.-]+/g,"-").toLowerCase()}-${u}.json`,l.click(),setTimeout(()=>URL.revokeObjectURL(r),1e3),this.say(s.length?`Exported ${t.messages.length} messages and ${s.length} captured turn(s).`:`Exported ${t.messages.length} messages. Turn capture was off, so no prompts are included.`)}dropCard(e){var a;e.preventDefault(),this.cardDrop=!1;const t=Array.from(((a=e.dataTransfer)==null?void 0:a.files)??[]);t.length&&this.ingestCards(t)}duplicateCharacter(e){const t=this.workspace.characters.find(s=>s.id===e);if(!t)return;if(this.workspace.characters.length>=40){this.say("That's as many friends as a workspace holds.",!0);return}const a={...t,id:_(),name:`${t.name} (copy)`,builtIn:!1};this.workspace.characters.push(a),this.touchWorkspace(),this.say(`${a.name} added.`)}exportCharacter(e){const t=this.workspace.characters.find(r=>r.id===e);if(!t)return;const a=Rt(t),s=new Blob([JSON.stringify(a,null,2)],{type:"application/json"}),n=URL.createObjectURL(s),o=document.createElement("a");o.href=n,o.download=`${t.name.replace(/[^\w.-]+/g,"-").toLowerCase()||"character"}.card.json`,o.click(),setTimeout(()=>URL.revokeObjectURL(n),1e3),this.say(`Exported ${t.name}.`)}removeCharacter(e){var s;const t=this.workspace.characters.find(n=>n.id===e);if(!t||t.builtIn||!confirm(`Remove ${t.name} and every chat with them?`))return;this.workspace.characters=this.workspace.characters.filter(n=>n.id!==e),this.workspace.conversations=this.workspace.conversations.filter(n=>n.characterId!==e),this.characterID===e&&(this.characterID=((s=this.workspace.characters[0])==null?void 0:s.id)??"libby");const a=this.conversationsFor()[0];a?this.conversationID=a.id:this.newConversation(!1),this.touchWorkspace(),this.say(`${t.name} removed.`)}startChatWith(e){this.pickerOpen=!1,this.characterID=e,this.newConversation()}renderSettings(){const e=this.activeCharacter,t=this.activeConversation;if(!e||!t)return c;const a=e.id==="libby"?Bt:jt,s=a.find(o=>o.id===this.editorTab)??a[0];let n="";return i`<section class="settings">
      <nav class="settings-nav" aria-label="Chat settings">
        ${a.map(o=>{const r=o.group===n?c:i`<div class="nav-cat">${o.group}</div>`;return n=o.group,i`${r}
            <button class="nav-row ${o.id===s.id?"on":""}" aria-current=${o.id===s.id?"page":"false"} @click=${()=>this.editorTab=o.id}>
      ...
      <div class="settings-body">
        ...
        ${s.id==="character"?this.renderCharacterPanel(e):c}
        ${s.id==="world"?this.renderWorldPanel():c}
        ${s.id==="mind"?this.renderMindPanel():c}
        ${s.id==="model"?this.renderModelPanel(t,e):c}
        ${s.id==="images"?this.renderImagesPanel(e):c}
        ${s.id==="profile"?this.renderProfilePanel():c}
      </div>
    </section>`}field(e,t,a,s=1){return i`<label>${e}${s>1?i`<textarea class="field" rows=${s} .value=${a} @change=${n=>this.updateCharacter(t,n.target.value)}></textarea>`:i`<input class="field" .value=${a} @change=${n=>this.updateCharacter(t,n.target.value)} />`}</label>`}renderCharacterPanel(e){const t=e.id==="libby"&&!J();return i`<div class="panel">
      <section class="group">
        ...
        <div class="pfp-row">
          ...
          <div class="pfp-actions">
            ...
            <div class="panel-actions">
              ...
              ${e.avatarImageId?i`<button class="secondary" @click=${()=>void this.removeCharacterPicture()}>Remove</button>`:c}
            </div>
          </div>
        </div>
      </section>
      <div class="grid">${this.field("Name","name",e.name)}${e.id==="libby"?c:i`<label>Default mode<select .value=${e.defaultMode} @change=${a=>this.updateCharacter("defaultMode",a.target.value)}>${E.map(a=>i`<option value=${a.id}>${a.label}</option>`)}</select></label>`}</div>
      ...
      <div class="panel-actions"><button class="primary" @click=${()=>void this.saveWorkspace()}>Save card</button><span class="file-btn">Import a card<input type="file" accept=".json,.png,application/json,image/png" multiple @change=${this.importCard}/></span><button @click=${()=>this.exportCharacter(e.id)}>Export card</button>${e.builtIn?i`<span class="empty">Libby's built-in card is editable.</span>`:i`<button class="danger" @click=${this.deleteCharacter}>Remove friend</button>`}</div>
    </div>`}async loadModel(){var a,s;const e=this.modelChoice||((a=this.models)==null?void 0:a.models[0]);if(!e||this.modelBusy)return;let t;try{t=this.composeLoadArgs()}catch{this.say("Extra loader arguments and settings must be valid JSON.",!0);return}this.modelBusy=!0,this.say(`Loading ${e}… this can take a few minutes.`);try{await g.loadChatModel(e,t.args,t.settings,!0),await this.refreshModels(!0),this.say(`Loaded ${((s=this.models)==null?void 0:s.loaded)||e}.`)}catch(n){this.say(n.message,!0)}finally{this.modelBusy=!1}}async unloadModel(){if(!(this.modelBusy||!confirm("Unload the current model? Chat stops working until a model is loaded again."))){this.modelBusy=!0,this.say("Unloading…");try{await g.unloadChatModel(),await this.refreshModels(!0),this.say("Model unloaded.")}catch(e){this.say(e.message,!0)}finally{this.modelBusy=!1}}}renderModelControls(){var a,s,n,o,r;const e=((a=this.models)==null?void 0:a.models)??[],t=((s=this.models)==null?void 0:s.loaded)||((n=this.status)==null?void 0:n.model)||"";return i`<label>Text-generation backend
      <div class="model-row">
        <strong>${t||"No model loaded"}${(o=this.status)!=null&&o.contextLimit?` · ${this.status.contextLimit.toLocaleString()} token context`:""}</strong>
        <button class="secondary" ?disabled=${this.modelBusy} @click=${()=>void this.refreshModels()}>Refresh</button>
      </div>
    </label>
    ${((r=this.models)==null?void 0:r.supported)===!1?i`<div class="empty">This backend serves an OpenAI-compatible API but does not expose model load/unload. Manage the model where it runs.</div>`:i`
        <label>Model
          <select class="field" ?disabled=${this.modelBusy||!e.length}
            ...
            ${e.length?c:i`<option value="">No models found</option>`}
            ${e.map(l=>i`<option value=${l} ?selected=${l===(this.modelChoice||t)}>${l}</option>`)}
          </select>
        </label>
        ...
        <div class="panel-actions">
          ...
          ${this.canManageModels?i`<button class="secondary" ?disabled=${this.modelBusy||!e.length}
                title="See what deleting the selected model would remove"
                @click=${()=>void this.inspectModel()}>Delete…</button>`:c}
        </div>
        ${this.modelBusy?i`<div class="empty">Loading a large model can take several minutes. Leaving this page will not cancel it.</div>`:c}
        ${this.deleteTarget?this.renderDeleteModel(this.deleteTarget):c}
        ${this.deleteError?i`<div class="empty error">${this.deleteError}</div>`:c}
        ${this.renderLoras()}`}`}renderLoaderForm(){var a;if(!((a=this.backend)!=null&&a.supported))return c;const e=String(this.loadArgs.loader??""),t=ce.filter(s=>!s.loaders||!e||s.loaders.includes(e));return i`<details class="loader" open>
      ...
      <div class="grid loader-grid">
        <label>Loader<select class="field" .value=${e} ?disabled=${this.modelBusy}
          ...
          ${(this.backend.loaders??[]).map(s=>i`<option value=${s} ?selected=${s===e}>${s}</option>`)}
        </select></label>
        ${t.map(s=>s.kind==="check"?i`<label class="inline-check loader-check"><input type="checkbox" .checked=${!!this.loadArgs[s.keys[0]]} ?disabled=${this.modelBusy}
              @change=${n=>this.setLoadArg(s,n.target.checked)}/>${s.label}${s.hint?i`<span class="hint">${s.hint}</span>`:c}</label>`:s.kind==="select"?i`<label>${s.label}<select class="field" .value=${String(this.loadArgs[s.keys[0]]??"")} ?disabled=${this.modelBusy}
              @change=${n=>this.setLoadArg(s,n.target.value)}>
              <option value="">Default</option>${(s.options??[]).map(n=>i`<option value=${n} ?selected=${n===String(this.loadArgs[s.keys[0]]??"")}>${n}</option>`)}
            </select></label>`:i`<label>${s.label}${s.hint?i`<span class="hint">${s.hint}</span>`:c}<input class="field" type=${s.kind==="number"?"number":"text"} placeholder=${s.placeholder??"default"}
              .value=${String(this.loadArgs[s.keys[0]]??"")} ?disabled=${this.modelBusy}
              @change=${n=>this.setLoadArg(s,n.target.value)}/></label>`)}
      </div>
      <details>
    ...
    </details>`}renderLoras(){var n;if(!((n=this.backend)!=null&&n.supported))return c;if(this.backend.lorasError)return i`<div class="empty">LoRAs: ${this.backend.lorasError}</div>`;const e=this.backend.loras;if(!e||!e.available.length)return c;const t=new Set(e.loaded),a=new Set(this.loraPicks),s=e.available.some(o=>t.has(o)!==a.has(o));return i`<label>LoRAs<span class="hint">${e.loaded.length?`${e.loaded.length} applied`:"none applied"}</span>
      <div class="lora-list">${e.available.map(o=>i`<label class="inline-check"><input type="checkbox" .checked=${a.has(o)} ?disabled=${this.modelBusy}
        @change=${r=>{const l=r.target.checked;this.loraPicks=l?[...new Set([...this.loraPicks,o])]:this.loraPicks.filter(u=>u!==o)}}/>${o}${t.has(o)?i`<span class="hint">applied</span>`:c}</label>`)}</div>
    </label>
    <div class="panel-actions">
    ...
    </div>`}renderDeleteModel(e){const t=this.deleteConfirm.trim()===e.name;return i`
      <div class="model-delete">
        <strong>Delete ${e.name}?</strong>
        ${e.loaded?i`<div class="empty error">
        ...
        <div class="model-delete-facts">
          ...
          <div><span>Frees</span>${V(e.bytes)}${e.freeBytes?` · ${V(e.freeBytes)} free now`:""}</div>
        ...
        <details>
          ...
          <ul class="model-delete-files">${e.files.map(a=>i`<li>${a}</li>`)}</ul>
        </details>
    ...
    `}async inspectModel(){var t;const e=this.modelChoice||((t=this.models)==null?void 0:t.models[0]);if(e){this.deleteError="",this.deleteConfirm="",this.deletePermanent=!1;try{this.deleteTarget=await g.inspectChatModel(e)}catch(a){this.deleteError=a.message}}}async confirmDeleteModel(){const e=this.deleteTarget;if(!(!e||this.modelBusy)){this.modelBusy=!0,this.deleteError="";try{const t=await g.deleteChatModel(e.name,this.deleteConfirm.trim(),this.deletePermanent);this.models&&(this.models={...this.models,models:t.models}),this.modelChoice="",this.deleteTarget=null,this.deleteConfirm="",this.say(t.movedTo?`${t.name} moved to the trash — ${V(t.bytes)} recoverable at ${t.movedTo}.`:`${t.name} deleted permanently — ${V(t.bytes)} freed.`)}catch(t){this.deleteError=t.message}finally{this.modelBusy=!1}}}async copySampling(){var t;const e=(t=this.lastSampling)==null?void 0:t.summary;if(e)try{await navigator.clipboard.writeText(e),this.say("Generation settings copied.")}catch{this.say(e,!0)}}saveOptionsGlobally(e){this.workspace.defaults={...e.options??le()},this.touchWorkspace(),this.saveWorkspace(),this.say("Saved as the default for new conversations.")}renderModelPanel(e,t){var o,r,l,u,m,f,b,$;const a=(y,k)=>{var x;return Ne((x=this.lastSampling)==null?void 0:x.values,y,k)},s=(y,k,x,T,v,S)=>{var R;const O=Ne(e.options,k,a(k,S)),U=((R=e.options)==null?void 0:R[k])!=null;return i`<label>${y}${U?c:i`<span class="hint">auto</span>`}<span class="range"><input type="range" min=${x} max=${T} step=${v} .value=${String(O)} @input=${q=>this.updateOption(k,Number(q.target.value))}/><output>${O}</output></span></label>`},n=!!this.workspace.defaults;return i`<div class="panel">
      <section class="group">
        <h3>Backend</h3>
      ...
      <section class="group">
        ...
        ${(o=this.status)!=null&&o.modelManagement?i`<details class="samplers">
          ...
          <div class="grid">
            ${["dynamic_temperature","temperature_last","do_sample","ban_eos_token","add_bos_token","skip_special_tokens","auto_max_new_tokens"].map(y=>{var k,x,T;return i`<label class="inline-check">
              <input type="checkbox" .checked=${((k=e.options)==null?void 0:k[y])===!0} .indeterminate=${((x=e.options)==null?void 0:x[y])==null}
                @change=${v=>this.updateOptionValue(y,v.target.checked)}/>${y.replace(/_/g," ")}${((T=e.options)==null?void 0:T[y])==null?i`<span class="hint">auto</span>`:c}</label>`})}
          </div>
...
`).map(x=>x.trim()).filter(Boolean);this.updateOptionValue("stop",k.length?k:void 0)}}></textarea></label>
          <div class="panel-actions">
            <button class="secondary" ?disabled=${!((u=this.status)!=null&&u.enabled)} @click=${()=>void this.stopGeneration()}>Stop generating now</button>
            <button class="secondary" @click=${()=>void this.measureCard(t)}>Measure the card</button>
            ${this.cardTokens?i`<span class="empty">Card: ${this.cardTokens.tokens.toLocaleString()} tokens${this.cardTokens.exact?"":" (estimated)"}${(m=this.status)!=null&&m.contextLimit?` of ${this.status.contextLimit.toLocaleString()}`:""}</span>`:c}
          </div>
        </details>`:c}
        ${this.lastSampling?i`<div class="sampling">
          <span>Last reply sampled as <strong>${this.lastSampling.task}</strong>${(f=this.lastSampling.overridden)!=null&&f.length?i` — you overrode ${this.lastSampling.overridden.join(", ")}`:c}</span>
          <button class="secondary" @click=${()=>void this.copySampling()}>Copy settings</button>
        </div>`:c}
        ${(b=this.lastPhoto)!=null&&b.source?i`<div class="sampling">
          <span>Last picture chosen <strong>${Zt(this.lastPhoto.source)}</strong> — fit ${this.lastPhoto.fit} of ${this.lastPhoto.candidates} candidate${this.lastPhoto.candidates===1?"":"s"}${($=this.lastPhoto.tags)!=null&&$.length?i`; it shows ${this.lastPhoto.tags.slice(0,6).join(", ")}`:c}</span>
        </div>`:c}
        <details>
        ...
        <div class="panel-actions">
          ...
          <button class="secondary" @click=${()=>{e.options={...this.workspace.defaults??le()},this.touchWorkspace()}}>Reset${n?" to global":""}</button>
        </div>
      </section>

      ${t.id==="libby"?i`<section class="group">
        <h3>Her mood<span>Libby chooses her own tone, emotion, and intensity from the conversation. There is no user preset.</span></h3>
      </section>`:i`<section class="group">
        <h3>This conversation<span>Mood and pacing for the current chat only.</span></h3>
        <div class="grid">
          <label>Conversation mode<select .value=${e.mode} @change=${y=>this.updateConversation({mode:y.target.value})}>${E.map(y=>i`<option value=${y.id}>${y.label}</option>`)}</select></label>
          <label>Displayed emotion<select .value=${e.emotion} @change=${y=>this.updateConversation({emotion:y.target.value})}>${pt.map(y=>i`<option value=${y}>${Ce[y]}</option>`)}</select></label>
        </div>
    ...
    </div>`}renderImagesPanel(e){const t=this.workspace.images.filter(n=>n.characterId===e.id),a=t.filter(n=>n.subject!=="other"),s=t.filter(n=>n.subject==="other");return i`<div class="panel">
      ...
      <div class="upload-row">
        <label>Extra matching tags<input class="field" placeholder="beach, happy, bedroom" .value=${this.imageTags} @input=${n=>this.imageTags=n.target.value}/></label>
        <label>Who it shows<select class="field" aria-label="Who the uploaded picture shows" .value=${this.imageSubject} @change=${n=>this.imageSubject=n.target.value}>
      ...
      <div class="image-grid">${a.map(n=>this.renderImageCard(e,n))}</div>
      ${a.length?c:i`<div class="empty">No pictures of ${e.name} yet.</div>`}
      ${s.length?i`
        ...
        <div class="image-grid">${s.map(n=>this.renderImageCard(e,n))}</div>`:c}
      ${e.id==="libby"?this.renderWeightsPanel(a):c}
    </div>`}renderImageCard(e,t){const a=t.subject!=="other";return i`<article class="image-card">
      ...
      <div class="card-body">
        ...
        ${a?i`<label class="weight">Sends<select aria-label=${`How often to send ${t.name}`} .value=${String(t.weight||1)} @change=${s=>this.setImageWeight(t,Number(s.target.value))}>
          ${de.map(s=>i`<option value=${String(s.value)} ?selected=${(t.weight||1)===s.value}>${s.label}</option>`)}
        </select></label>`:c}
        ...
        ${a?e.avatarImageId===t.id?i`<span class="badge">Avatar</span>`:i`<button @click=${()=>this.updateCharacter("avatarImageId",t.id)}>Use as avatar</button>`:c}
      </div>
    </article>`}setImageSubject(e,t){const a=this.workspace.images.find(s=>s.id===e.id);a&&(a.subject=t,this.touchWorkspace())}setImageWeight(e,t){const a=this.workspace.images.find(s=>s.id===e.id);a&&(t===1?delete a.weight:a.weight=t,this.touchWorkspace())}renderWeightsPanel(e){const t=this.workspace.sendWeights??{},a=Object.keys(t).sort(),s=new Map;for(const o of e)for(const r of o.tags)s.set(r.toLowerCase(),(s.get(r.toLowerCase())??0)+1);const n=[...s.entries()].filter(([o])=>!(o in t)).sort((o,r)=>r[1]-o[1]).slice(0,14).map(([o])=>o);return i`<section class="group weights">
      ...
      ${a.length?i`<div class="weight-rows">${a.map(o=>i`<div class="weight-row">
        <span class="weight-tag">${o}</span>
        <select aria-label=${`Weight for ${o}`} @change=${r=>this.setTagWeight(o,Number(r.target.value))}>
          ${de.map(r=>i`<option value=${String(r.value)} ?selected=${Gt(t[o])===r.value}>${r.label}</option>`)}
        </select>
        <button type="button" class="icon-btn" title=${`Forget the weight for ${o}`} aria-label=${`Forget the weight for ${o}`} @click=${()=>this.setTagWeight(o,1)}><span class="material-symbols-rounded" style="font-size:18px">close</span></button>
      </div>`)}</div>`:i`<div class="empty">No tag weights yet. Everything is at normal odds.</div>`}
      <form class="weight-add" @submit=${o=>{o.preventDefault(),this.addTagWeight(this.weightTagDraft,2.5)}}>
        <input class="field" placeholder="tag, e.g. lingerie" .value=${this.weightTagDraft} @input=${o=>this.weightTagDraft=o.target.value}/>
      ...
      ${n.length?i`<div class="weight-suggest">${n.map(o=>i`<button type="button" class="chip" title=${`Weight ${o}`} @click=${()=>{this.weightTagDraft=o}}>${o}</button>`)}</div>`:c}
    </section>`}addTagWeight(e,t){const a=e.trim().toLowerCase().replace(/\s+/g," ");a&&(this.setTagWeight(a,t),this.weightTagDraft="")}setTagWeight(e,t){const a={...this.workspace.sendWeights??{}};t===1?delete a[e]:a[e]=t,this.workspace.sendWeights=Object.keys(a).length?a:void 0,this.touchWorkspace()}renderProfilePanel(){var a;const e=this.workspace.profile,t=e.displayName||((a=this.user)==null?void 0:a.username)||"You";return i`<div class="panel"><p class="empty">This profile is shared by WebUI and APK and is included in character context.</p>
      <div class="pfp-row">
        <span class="pfp">${e.avatarImageId?i`<img src=${g.chatImageURL(e.avatarImageId)} alt="Your profile picture"/>`:i`<span class="pfp-initial">${t.slice(0,2).toUpperCase()}</span>`}</span>
        <div class="pfp-actions">
          ...
          <div class="panel-actions">
            ...
            ${e.avatarImageId?i`<button class="danger" @click=${()=>void this.removeProfilePicture()}>Remove</button>`:c}
          </div>
        </div>
      </div>
      ...
      </p></div>`}renderMindPanel(){return i`<div class="panel">
      ...
      ${this.renderDiscordPanel()}</div>`}async loadOutfits(){if(!this.outfitsLoading){this.outfitsLoading=!0;try{const e=await g.libbyOutfits();this.outfits=e.outfits??[],this.activities=e.activities??[]}catch{this.outfits=[]}finally{this.outfitsLoading=!1}}}wearOutfit(e){ht(e),this.requestUpdate()}openSection(e){this.dispatchEvent(new CustomEvent("open-section",{detail:{section:e},bubbles:!0,composed:!0}))}renderWorldPanel(){var r;this.outfits===null&&!this.outfitsLoading&&this.loadOutfits();const e=X(),t=(r=this.outfits)==null?void 0:r.find(l=>l.id===e),a=this.activities.filter(l=>l.group==="idle"),s=this.activities.filter(l=>l.group!=="idle"),n=l=>{var u,m;return!t||!!((m=(u=t.activityLevels)==null?void 0:u[l.id])!=null&&m.length)},o=l=>i`<span class="state-chip ${n(l)?"":"default-art"}" title=${`${l.says}${l.minIntensity>1?` — from heat ${l.minIntensity}`:""}${n(l)?"":" · default art in this outfit"}`}>
      ${l.label}${l.minIntensity>1?i`<i>${l.minIntensity}</i>`:c}</span>`;return i`<div class="panel">
      <section class="group">
        ...
        <div class="grid">
          <label>Outfit
            <select .value=${e} @change=${l=>this.wearOutfit(l.target.value)}>
              ...
              ${(this.outfits??[]).map(l=>i`<option value=${l.id} ?selected=${l.id===e}>${l.name}${l.slots?` · ${l.slots} squares`:""}</option>`)}
            </select></label>
        ...
        ${this.outfits===null?i`<p class="empty">Loading her wardrobes…</p>`:c}
      </section>
      <section class="group">
      ...
      <section class="group">
        ...
        ${this.activities.length?i`
          <div class="state-row">${a.filter(l=>!l.auto).map(o)}</div>
          <div class="state-row intimate">${s.map(o)}</div>
          ${t&&s.concat(a).some(l=>!n(l))?i`<p class="empty">Greyed states have no picture in ${t.name} yet, so she wears the default art for them. Draw them in the studio.</p>`:c}`:i`<p class="empty">${this.outfits===null?"Loading…":"This server has no state vocabulary yet."}</p>`}
      </section>
      <section class="group">
    ...
    </div>`}editProfile(e){this.workspace={...this.workspace,profile:{...this.workspace.profile,...e}},this.touchWorkspace()}async loadAutoState(){if(!this.autoStateLoading){this.autoStateLoading=!0;try{this.autoState=await g.libbyAuto()}catch{this.autoState=void 0}finally{this.autoStateLoading=!1}}}async saveAutoSettings(e){var a;const t=(a=this.autoState)==null?void 0:a.settings;if(t)try{await g.saveLibbyAuto({...t,...e}),await this.loadAutoState()}catch(s){this.say(s instanceof Error?s.message:"Couldn't save that.",!0)}}renderAutoPanel(){this.autoState===null&&this.loadAutoState();const e=this.autoState;if(!e)return i`<div class="mem-panel"><strong>When Libby messages first</strong>
        <p class="empty">${this.autoState===null?"Loading…":"This server doesn't support messaging controls yet."}</p></div>`;const t=e.settings,a=Array.from({length:24},(s,n)=>n);return i`<div class="mem-panel">
      <strong>When Libby messages first</strong>
      <p class="empty">She'll start a conversation on her own now and then. These are the limits on that: she stops after ${Jt} unanswered messages, waits out your quiet hours, and never replies to herself.</p>
        ...
        <div class="grid">
          <label>Quiet from
            <select class="field" .value=${String(t.quietFrom)} @change=${s=>void this.saveAutoSettings({quietFrom:Number(s.target.value)})}>
              ${a.map(s=>i`<option value=${s} ?selected=${s===t.quietFrom}>${String(s).padStart(2,"0")}:00</option>`)}
            </select>
          </label>
          <label>Quiet until
            <select class="field" .value=${String(t.quietTo)} @change=${s=>void this.saveAutoSettings({quietTo:Number(s.target.value)})}>
              ${a.map(s=>i`<option value=${s} ?selected=${s===t.quietTo}>${String(s).padStart(2,"0")}:00</option>`)}
            </select>
          </label>
          <label>At least this far apart
            <select class="field" .value=${String(t.minGapMinutes)} @change=${s=>void this.saveAutoSettings({minGapMinutes:Number(s.target.value)})}>
              ${[20,30,60,120,240,480].map(s=>i`<option value=${s} ?selected=${s===t.minGapMinutes}>${s<60?`${s} minutes`:`${s/60} hour${s===60?"":"s"}`}</option>`)}
            </select>
          </label>
          <label>Most per day
            <select class="field" .value=${String(t.maxPerDay)} @change=${s=>void this.saveAutoSettings({maxPerDay:Number(s.target.value)})}>
              ${[0,2,4,6,10,20].map(s=>i`<option value=${s} ?selected=${s===t.maxPerDay}>${s===0?"No limit":s}</option>`)}
            </select>
          </label>
        </div>
        <label class="mem-toggle">
      ...
      ${e.log.length?i`
        <details>
          ...
          <ul class="mem-list">${[...e.log].reverse().map(s=>i`
            <li><span>
              ${s.detail||s.trigger}
              <span class="mem-tags">
                <em class="mem-kind">${s.trigger}</em>
                ${s.importance>=2?i`<em class="mem-kind mine">important</em>`:c}
                ${s.answered?c:i`<em class="mem-kind unsure">no reply</em>`}
              </span>
            </span><span class="empty">${Pe(s.at)}</span></li>`)}</ul>
        </details>`:c}
    </div>`}renderBondPanel(){this.bond===null&&!this.bondLoading&&this.loadBond();const e=this.bond,t=!!e&&e.lastSeenAt>0;return i`<div class="mem-panel">
      ...
      ${this.bond===null&&this.bondLoading?i`<p class="empty">Loading…</p>`:t?i`<ul class="mem-list">
              <li><span>Last talked ${Pe(e.lastSeenAt)}</span></li>
              ${e.mood?i`<li><span>She left off feeling ${e.mood}</span></li>`:c}
              <li><span>${Ot(e.warmth)}</span></li>
              ${e.petname?i`<li><span>She calls you “${e.petname}”</span></li>`:c}
            </ul>`:i`<p class="empty">Nothing yet. This fills in as you talk.</p>`}
      ${t?i`<div class="panel-actions"><button class="danger" @click=${()=>void this.resetBond()}>Start fresh</button></div>`:c}
    </div>`}renderMemoryPanel(){this.memories===null&&this.loadMemories();const e=this.memories??[];return i`<div class="mem-panel">
      <strong>What Libby remembers</strong>
      <p class="empty">Libby quietly keeps things you tell her and carries them into later chats. Correct anything she got wrong, pin what she must never forget, or add something she hasn't picked up on.${this.memoryLimit?i` She holds up to ${this.memoryLimit}; past that the least important fade, but pinned notes and boundaries never do.`:c}</p>
      ${this.memories===null?i`<p class="empty">Loading…</p>`:e.length===0?i`<p class="empty">Nothing yet. She'll start remembering as you talk.</p>`:i`<ul class="mem-list">${e.map(t=>this.renderMemory(t))}</ul>`}
      <div class="mem-add">
      ...
      ${e.length>0?i`<div class="panel-actions"><button class="danger" @click=${()=>void this.clearMemories()}>Clear all memories</button></div>`:c}
    </div>`}renderMemory(e){return this.editingMemory===e.id?i`<li class="mem-editing">
        ...
        <select class="field" .value=${e.kind??"user"}
          ...
          ${(this.memoryKinds.length?this.memoryKinds:[e.kind??"user"]).map(a=>i`<option value=${a} ?selected=${a===(e.kind??"user")}>${Re[a]??a}</option>`)}
        </select>
        <div class="panel-actions">
      ...
      <span>
        ${e.text}
        <span class="mem-tags">
          ${e.kind?i`<em class="mem-kind ${e.kind}">${Re[e.kind]??e.kind}</em>`:c}
          ${e.uncertain?i`<em class="mem-kind unsure" title="She wrote this as a guess, so she'll offer it rather than assert it">unsure</em>`:c}
          ${e.source==="user"?i`<em class="mem-kind mine" title="You told her this, so she treats it as certain">yours</em>`:c}
          ${(e.recalls??0)>0?i`<em class="mem-kind" title="She has learned this ${(e.recalls??0)+1} times">×${(e.recalls??0)+1}</em>`:c}
        </span>
      </span>
    ...
    </li>`}renderWantsPanel(){this.wants===null&&this.loadWants();const e=this.wants??[];return i`<div class="mem-panel">
      ...
      ${this.wants===null?i`<p class="empty">Loading…</p>`:e.length===0?i`<p class="empty">Nothing yet. She'll let you know when she's wanting something.</p>`:i`<ul class="mem-list">${e.map(t=>i`
              <li><span>${t.text}</span>
      ...
      ${e.length>0?i`<div class="panel-actions"><button class="danger" @click=${()=>void this.clearWants()}>Clear all wants</button></div>`:c}
    </div>`}renderJournalPanel(){this.journal===null&&this.loadJournal();const e=this.journal??[];return i`<div class="mem-panel">
      ...
      ${this.journal===null?i`<p class="empty">Loading…</p>`:e.length===0?i`<p class="empty">Nothing yet. She writes once a conversation has been quiet for twenty minutes.</p>`:i`<ul class="mem-list">${e.map(t=>i`
              <li><span><em class="mem-kind">${new Date(t.at).toLocaleDateString()}${t.mood?` · ${t.mood}`:""}</em> ${t.text}</span>
                <button class="mem-forget" title="Remove this entry" aria-label="Remove journal entry" @click=${()=>void this.forgetJournalEntry(t.id)}><span class="material-symbols-rounded" style="font-size:16px">close</span></button>
              </li>`)}</ul>`}
      <div class="panel-actions">
      ...
      ${e===void 0?i`<p class="empty">Loading…</p>`:i`
        ...
        ${e.hasToken?i`
          ...
          ${e.users.length===0?i`<p class="empty">Nobody yet.</p>`:i`<ul class="mem-list">${e.users.map(t=>i`
            <li><span>${t}</span>
          ...
          ${this.discordPlaces===null?i`<div class="panel-actions"><button class="secondary" @click=${()=>void this.loadDiscordPlaces()}>Show her servers and channels</button></div>`:i`${this.discordPlaces.map(t=>i`
                <p class="empty"><strong>${t.name}</strong></p>
                ${t.channels.length===0?i`<p class="empty">No channels it can see here — check the bot's permissions in that server.</p>`:i`
                  <ul class="mem-list">${t.channels.map(a=>{const s=e.channels.find(n=>n.channelId===a.channelId);return i`<li><span>#${a.name}</span>
                      <label class="mem-toggle"><input type="checkbox" .checked=${!!(s!=null&&s.read)} @change=${n=>this.setDiscordChannel(t,a.channelId,a.name,{read:n.target.checked})}/><span>read</span></label>
                      <label class="mem-toggle"><input type="checkbox" .checked=${!!(s!=null&&s.write)} @change=${n=>this.setDiscordChannel(t,a.channelId,a.name,{write:n.target.checked})}/><span>post</span></label>
                    </li>`})}</ul>`}`)}`}

          ${e.log.length===0?c:i`
            <p class="empty">What she's done on Discord, and what was refused and why.</p>
            <ul class="mem-list">${[...e.log].reverse().slice(0,25).map(t=>i`
              <li><span><strong>${t.kind}</strong>${t.channel?` · ${t.channel}`:""}${t.user?` · ${t.user}`:""} — ${t.detail??""}</span></li>`)}</ul>`}

          <div class="panel-actions"><button class="danger" @click=${()=>void this.disconnectDiscord()}>Disconnect and delete the token</button></div>`:i`
      ...
      ${e===void 0?i`<p class="empty">Loading…</p>`:i`
          ...
          ${e.references.length?i`<p class="empty">Reference pictures — what she looks like across outfits, poses and expressions. Open one to see it, drop it from the references, or say it isn't her after all:</p>
              <ul class="mem-list">${e.references.map(t=>i`<li>
                <button class="link-btn" title="Open ${t.title}" @click=${()=>j(this,t.id)}>${t.title}</button>
                <span class="mem-acts">
              ...
              </li>`)}</ul>`:i`<p class="empty">No reference pictures yet. Mark a few from the library and she has more than one angle to go on.</p>`}
          <div class="panel-actions"><button class="secondary" @click=${()=>void this.scanForHerself()}>Look through the library now</button></div>`}
    </div>`}renderLinkPreview(){if(!this.pendingLinkURL)return c;const e=this.pendingLink;return i`<div class="attachment link-preview">
      ...
      <span class="attachment-copy">
        ...
        ${e&&!e.failed&&!e.internal?i`<span class="link-host">${e.host}${e.media?` · ${e.media} file${e.media===1?"":"s"}`:""}</span>`:c}
      </span>
      ...
      <div>${e.content}</div>
    </div>`}sameRun(e,t){return!!e&&!!t&&!e.thought&&!t.thought&&e.role===t.role&&Math.abs(t.at-e.at)<5*6e4}renderEntry(e,t,a){var k,x,T;const s=this.activeCharacter,n=this.activeConversation;if(!s||!n)return c;const o=!t||te(t.at)!==te(e.at)?i`<div class="day">${te(e.at)}</div>`:c;if(e.thought)return i`${o}${this.renderThought(e,s)}`;const r=!this.sameRun(t,e)||o!==c,l=!this.sameRun(e,a),u=e.role==="assistant",m=u?s.name:this.workspace.profile.displayName||((k=this.user)==null?void 0:k.username)||"You",f=l?this.receiptFor(e,n):"",b=e.reactions??[],$=this.reactionPicker===e.id,y=(x=b.find(v=>v.by==="user"))==null?void 0:x.emoji;return i`${o}<article class="msg ${u?"theirs":"mine"} ${r?"first":""} ${l?"last":""}" data-message-id=${e.id}
      ...
      ${u?this.avatar(s,"avatar"):c}
      <div class="bubble-wrap">
        <span class="swipe-hint material-symbols-rounded" aria-hidden="true">reply</span>
        ${$?i`<div class="react-row" role="menu" aria-label="React">${Yt.map(v=>i`<button type="button" class=${y===v?"on":""} @click=${()=>this.react(e,v)}>${v}</button>`)}<button type="button" class="close" title="Close" aria-label="Close" @click=${()=>this.reactionPicker=null}><span class="material-symbols-rounded" style="font-size:16px">close</span></button></div>`:c}
        <div class="bubble ${e.snap?"has-snap":""}">
          ${e.replyTo?i`<button type="button" class="quote" title="Go to that message" @click=${()=>this.jumpTo(e.replyTo)}>
            <strong>${e.replyTo.role==="assistant"?s.name:this.workspace.profile.displayName||((T=this.user)==null?void 0:T.username)||"You"}</strong>
            <span>${e.replyTo.excerpt}</span></button>`:c}
          ${e.content.trim()?i`<div class="text">${je(e.content,e.links,v=>j(this,v))}</div>`:c}
          ${e.snap?this.renderSnapTile(e,m):i`
            ${e.imageId?i`<img class="sent-image" src=${g.chatImageURL(e.imageId)} alt="Image sent by ${m}"/>`:c}
            ${ut(e.attachments,(v,S)=>j(this,v,S),m)}`}
          ${gt(e.links,v=>j(this,v))}
          ${mt(e.actions,this.approvals.stateOf,this.approvals.decide)}
          <div class="meta"><span>${pe(e.at)}</span></div>
          ${b.length?i`<div class="reactions">${b.map(v=>i`<button type="button" class="reaction ${v.by}" title=${v.by==="assistant"?`${s.name} reacted ${v.emoji}`:`You reacted ${v.emoji}`}
            @click=${()=>u&&v.by==="user"?this.react(e,v.emoji):void 0}>${v.emoji}</button>`)}</div>`:c}
        </div>
        ${f?i`<span class="receipt ${e.readAt?"read":""}">${f}</span>`:c}
        <span class="msg-actions"><button title="Reply" aria-label="Reply to this message" @click=${()=>this.replyTo(e)}><span class="material-symbols-rounded" style="font-size:16px">reply</span></button>${u?i`<button title="React" aria-label="React to this message" @click=${()=>this.reactionPicker=$?null:e.id}><span class="material-symbols-rounded" style="font-size:16px">add_reaction</span></button><button title="Read aloud" aria-label="Read this message aloud" @click=${()=>{Ie(),Te(e.content)}}><span class="material-symbols-rounded" style="font-size:16px">volume_up</span></button>`:c}${this.canRedo(e)?i`<button title="Retry" aria-label="Ask for a different reply" ?disabled=${this.busy} @click=${()=>void this.regenerate()}><span class="material-symbols-rounded" style="font-size:16px">refresh</span></button>`:c}${e.role==="user"?i`<button title="Retry from here" aria-label="Retry from this message" ?disabled=${this.busy} @click=${()=>void this.retryFrom(e)}><span class="material-symbols-rounded" style="font-size:16px">replay</span></button>`:c}<button title="Copy" @click=${()=>void navigator.clipboard.writeText(e.content)}><span class="material-symbols-rounded" style="font-size:16px">content_copy</span></button><button title="Edit" @click=${()=>this.editMessage(e)}><span class="material-symbols-rounded" style="font-size:16px">edit</span></button><button title="Delete" @click=${()=>this.deleteMessage(e.id)}><span class="material-symbols-rounded" style="font-size:16px">delete</span></button></span>
      </div>
    </article>`}renderSnapTile(e,t){return e.opened?i`<div class="snap opened" aria-label="Snap from ${t}, opened"><span class="material-symbols-rounded">check_box_outline_blank</span><span>Opened</span></div>`:i`<button type="button" class="snap" title="Tap to view — you only get to see it once" @click=${()=>this.openSnap(e)}>
      <span class="material-symbols-rounded">photo_camera</span><span>Tap to view</span><em>Snap from ${t}</em>
    </button>`}renderSnapViewer(){var a;const e=this.snapOpen;if(!e)return c;const t=e.imageId?g.chatImageURL(e.imageId):(a=e.attachments)!=null&&a[0]?g.streamURL(e.attachments[0].id):"";return i`<div class="snap-viewer" role="dialog" aria-modal="true" aria-label="Snap" @click=${()=>this.closeSnap()}>
      ${t?i`<img src=${t} alt="Snap"/>`:i`<p>This snap is gone.</p>`}
      <span class="snap-close">Tap anywhere to close — it won't open again</span>
    </div>`}render(){try{return this.renderClient()}catch(e){return console.error("chat render failed",e),i`<div class="client"><section class="main load-failed">
      ...
      </section></div>`}}renderClient(){var u,m,f;const e=this.activeCharacter,t=this.activeConversation;if(this.loading)return i`<div class="client"><section class="main" style="grid-column:1/-1;place-items:center;display:grid"><md-circular-progress indeterminate></md-circular-progress></section></div>`;if(!e||!t)return i`<div class="client"><section class="main" style="grid-column:1/-1;padding:24px">Chat workspace is unavailable.</section></div>`;const a=E.find(b=>b.id===t.mode)??E[0],s=this.stageOpen?this.renderStage(e,t):c,n=!!((u=this.status)!=null&&u.enabled),o=n?this.status.model:e.id==="libby"?"Local replies":"Model offline",r=t.messages,l=this.stageOpen?this.renderHero(e,t):c;return i`<div class="client ${this.mobileNavOpen?"nav-open":""} ${s!==c?"with-stage":""} ${this.callOpen?"in-call":""}" style=${this.stageWidth?`--stage-w:${this.stageWidth}px`:""} @pointerdown=${this.armIdle} @contextmenu=${this.chatMenu}>${this.renderSidebar()}
      <main class="main"><header class="top">
        ...
        <span class="top-title"><span class="name">${e.name}</span><span class="presence"><span class="status-dot ${n?"online":""}"></span>${o}${e.id==="libby"?` · ${t.emotion}${t.activity?`, ${t.activity}`:""}`:` · ${a.topic}`}</span></span>
        ${e.id==="libby"?c:i`<select class="quick-mode" aria-label="Conversation mode" title="Conversation mode" .value=${t.mode} @change=${b=>this.updateConversation({mode:b.target.value})}>${E.map(b=>i`<option value=${b.id}>${b.label}</option>`)}</select>`}
        ...
        ${this.settingsOpen?this.renderSettings():c}
        ${this.loadError?i`<div class="backend-state load-error" role="alert"><strong>Chat didn't load.</strong> ${this.loadError}
          ${this.workspaceLoaded?c:i` Your saved characters and conversations aren't shown, and nothing is being saved until this succeeds.`}
          <button class="autobar-btn" @click=${()=>void this.retryLoad()}>Retry</button></div>`:c}
        ${(m=this.status)!=null&&m.modelBackend&&!this.status.enabled?i`<div class="backend-state" role="status"><strong>Text generation offline.</strong> ${this.status.message||"Load a model in text-generation-webui, then refresh status."}</div>`:c}
        ${l}
        ${this.renderAutopilotBar(e)}
        <section class="log">${r.length?c:i`<div class="intro">${this.avatar(e,"intro-avatar")}<h2>${e.name}</h2><p>${e.description||`This is the beginning of your conversation with ${e.name}.`}</p><p>${n?`Running on ${this.status.model}.`:e.id==="libby"?"Libby is using built-in local replies.":"Connect a local model to start chatting."}</p></div>`}
          ${r.map((b,$)=>this.renderEntry(b,r[$-1],r[$+1]))}${this.busy&&this.typingPhase==="typing"?i`<div class="msg theirs last typing-row">${this.avatar(e,"avatar")}<div class="bubble-wrap"><div class="bubble" aria-label="${e.name} is typing"><span class="dots"><i></i><i></i><i></i></span></div></div></div>`:c}
        </section>${this.notice?i`<div class="notice ${this.noticeError?"error":""}" role=${this.noticeError?"alert":"status"}>${this.notice}</div>`:c}
        <form class="composer-form" @submit=${b=>{b.preventDefault(),this.send()}}>
          ${this.pendingPhoto?i`<div class="attachment"><img src=${g.chatImageURL(this.pendingPhoto.imageId)} alt=${`Attached photo: ${this.pendingPhoto.name}`}/>
            ...
            <button type="button" class="icon-btn" title="Remove photo" aria-label="Remove photo" @click=${()=>void this.discardPhoto()}><span class="material-symbols-rounded">close</span></button></div>`:c}
          ${this.renderLinkPreview()}
          ${this.replyTarget?i`<div class="attachment reply-preview">
            ...
            <button type="button" class="icon-btn" title="Cancel reply" aria-label="Cancel reply" @click=${()=>this.replyTarget=null}><span class="material-symbols-rounded">close</span></button></div>`:c}
          ${this.pendingItems.length?i`<div class="items-preview">${this.pendingItems.map(b=>i`<span class="item-chip">
            ${b.hasThumb?i`<img src=${g.thumbURL(b.id)} alt=""/>`:i`<span class="chip-icon"><span class="material-symbols-rounded">${Se[b.kind]??"folder"}</span></span>`}
          ...
          <div class="composer">
            ...
            ${this.busy&&((f=this.status)!=null&&f.modelManagement)?i`<button class="send stop" type="button" title="Stop the reply" aria-label="Stop the reply" @click=${()=>void this.stopGeneration()}><span class="material-symbols-rounded">stop</span></button>`:c}
    ...
    </div>`}renderPicker2(){const e=this.picker;if(!e)return c;const t=new Set(this.pendingItems.map(a=>a.id));return i`<div class="picker" @click=${()=>this.closePicker()}>
      <div class="picker-card" role="dialog" aria-modal="true" aria-label="Attach from the library" @click=${a=>a.stopPropagation()}>
        ...
        <div class="picker-grid">
          ${e.loading&&!e.items.length?i`<div class="picker-empty">Looking…</div>`:c}
          ${!e.loading&&!e.items.length?i`<div class="picker-empty">Nothing matches.</div>`:c}
          ${e.items.map(a=>i`<button type="button" class="picker-tile ${t.has(a.id)?"on":""}" title=${a.title} @click=${()=>this.toggleItem(a)}>
            ${a.hasThumb||a.kind==="image"||a.kind==="gif"?i`<img src=${g.thumbURL(a.id)} alt="" loading="lazy"/>`:i`<span class="tile-kind material-symbols-rounded">${Se[a.kind]??"folder"}</span>`}
    ...
    </div>`}renderIncomingCall(e){return this.incomingCall?i`<div class="incoming" role="alertdialog" aria-label=${`${e.name} is calling`}>
    ...
    </div>`:c}};d.styles=[bt,ft,yt,vt,wt,xt,kt`
  ...
  `];p([$t({attribute:!1})],d.prototype,"user",2);p([h()],d.prototype,"status",2);p([h()],d.prototype,"workspace",2);p([h()],d.prototype,"characterID",2);p([h()],d.prototype,"conversationID",2);p([h()],d.prototype,"draft",2);p([h()],d.prototype,"busy",2);p([h()],d.prototype,"loading",2);p([h()],d.prototype,"workspaceLoaded",2);p([h()],d.prototype,"loadError",2);p([h()],d.prototype,"settingsOpen",2);p([h()],d.prototype,"speakOn",2);p([h()],d.prototype,"editorTab",2);p([h()],d.prototype,"outfits",2);p([h()],d.prototype,"activities",2);p([h()],d.prototype,"notice",2);p([h()],d.prototype,"noticeError",2);p([h()],d.prototype,"imageTags",2);p([h()],d.prototype,"memories",2);p([h()],d.prototype,"memoryKinds",2);p([h()],d.prototype,"memoryLimit",2);p([h()],d.prototype,"memoryDraft",2);p([h()],d.prototype,"editingMemory",2);p([h()],d.prototype,"memoryDraftEdit",2);p([h()],d.prototype,"memoryKindEdit",2);p([h()],d.prototype,"autoState",2);p([h()],d.prototype,"wants",2);p([h()],d.prototype,"journal",2);p([h()],d.prototype,"reflecting",2);p([h()],d.prototype,"identity",2);p([h()],d.prototype,"pendingLink",2);p([h()],d.prototype,"discord",2);p([h()],d.prototype,"discordPlaces",2);p([h()],d.prototype,"discordToken",2);p([h()],d.prototype,"discordUserDraft",2);p([h()],d.prototype,"bond",2);p([h()],d.prototype,"models",2);p([h()],d.prototype,"modelChoice",2);p([h()],d.prototype,"modelBusy",2);p([h()],d.prototype,"backend",2);p([h()],d.prototype,"loadArgs",2);p([h()],d.prototype,"loadExtra",2);p([h()],d.prototype,"loadSettings",2);p([h()],d.prototype,"loraPicks",2);p([h()],d.prototype,"cardTokens",2);p([h()],d.prototype,"deleteTarget",2);p([h()],d.prototype,"deleteConfirm",2);p([h()],d.prototype,"deletePermanent",2);p([h()],d.prototype,"deleteError",2);p([h()],d.prototype,"mobileNavOpen",2);p([h()],d.prototype,"chatSearch",2);p([h()],d.prototype,"pickerOpen",2);p([h()],d.prototype,"captureTurns",2);p([h()],d.prototype,"cardDrop",2);p([h()],d.prototype,"cardNote",2);p([h()],d.prototype,"autopilot",2);p([h()],d.prototype,"autoPaused",2);p([h()],d.prototype,"autoTurns",2);p([h()],d.prototype,"stageOpen",2);p([h()],d.prototype,"stageWidth",2);p([h()],d.prototype,"stageDragging",2);p([h()],d.prototype,"pendingPhoto",2);p([h()],d.prototype,"typingPhase",2);p([h()],d.prototype,"callOpen",2);p([h()],d.prototype,"callSeconds",2);p([h()],d.prototype,"incomingCall",2);p([h()],d.prototype,"backgrounds",2);p([h()],d.prototype,"defaultBackground",2);p([h()],d.prototype,"scenePickerOpen",2);p([h()],d.prototype,"callCaptions",2);p([h()],d.prototype,"replyTarget",2);p([h()],d.prototype,"reactionPicker",2);p([h()],d.prototype,"snapOpen",2);p([h()],d.prototype,"weightTagDraft",2);p([h()],d.prototype,"pendingItems",2);p([h()],d.prototype,"picker",2);p([Be(".log")],d.prototype,"log",2);p([Be(".composer textarea")],d.prototype,"composer",2);p([h()],d.prototype,"lastSampling",2);p([h()],d.prototype,"lastPhoto",2);p([h()],d.prototype,"imageSubject",2);d=p([Ct("oppai-chat")],d);function Zt(e){switch(e){case"ready":return"from your words, before she wrote";case"model":return"from the tags she wrote";case"rescue":return"as a rescue: she said she was sending one and nothing fitted";case"inferred":return"unprompted, because her words matched it";default:return e}}export{d as OppaiChat};
