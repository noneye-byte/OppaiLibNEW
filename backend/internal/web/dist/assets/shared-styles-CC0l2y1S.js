import{a as $,b as p,i as x,_ as a,t as k,N as l,u as _,aF as S,aE as ct,A as d,aG as wt,Y as ht,V as pt,W as C,aH as Ct,X as I,aI as $t}from"./index-D3VFtMgd.js";import{a as Tt,e as T}from"./query-__j_ZMY6.js";/**
 * @license
 ...
 * SPDX-License-Identifier: Apache-2.0
 */const ut=Symbol("attachableController");let M;M=new MutationObserver(i=>{var t;for(const e of i)(t=e.target[ut])==null||t.hostConnected()});class ft{get htmlFor(){return this.host.getAttribute("for")}set htmlFor(t){t===null?this.host.removeAttribute("for"):this.host.setAttribute("for",t)}get control(){return this.host.hasAttribute("for")?!this.htmlFor||!this.host.isConnected?null:this.host.getRootNode().querySelector(`#${this.htmlFor}`):this.currentControl||this.host.parentElement}set control(t){t?this.attach(t):this.detach()}constructor(t,e){this.host=t,this.onControlChange=e,this.currentControl=null,t.addController(this),t[ut]=this,M==null||M.observe(t,{attributeFilter:["for"]})}attach(t){t!==this.currentControl&&(this.setCurrentControl(t),this.host.removeAttribute("for"))}detach(){this.setCurrentControl(null),this.host.setAttribute("for","")}hostConnected(){this.setCurrentControl(this.control)}hostDisconnected(){this.setCurrentControl(null)}setCurrentControl(t){this.onControlChange(this.currentControl,t),this.currentControl=t}}/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2024 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const Xt=x`:host{--_container-height: var(--md-text-button-container-height, 40px);--_disabled-label-text-color: var(--md-text-button-disabled-label-text-color, var(--md-sys-color-on-surface, #1d1b20));--_disabled-label-text-opacity: var(--md-text-button-disabled-label-text-opacity, 0.38);--_focus-label-text-color: var(--md-text-button-focus-label-text-color, var(--md-sys-color-primary, #6750a4));--_hover-label-text-color: var(--md-text-button-hover-label-text-color, var(--md-sys-color-primary, #6750a4));--_hover-state-layer-color: var(--md-text-button-hover-state-layer-color, var(--md-sys-color-primary, #6750a4));--_hover-state-layer-opacity: var(--md-text-button-hover-state-layer-opacity, 0.08);--_label-text-color: var(--md-text-button-label-text-color, var(--md-sys-color-primary, #6750a4));--_label-text-font: var(--md-text-button-label-text-font, var(--md-sys-typescale-label-large-font, var(--md-ref-typeface-plain, Roboto)));--_label-text-line-height: var(--md-text-button-label-text-line-height, var(--md-sys-typescale-label-large-line-height, 1.25rem));--_label-text-size: var(--md-text-button-label-text-size, var(--md-sys-typescale-label-large-size, 0.875rem));--_label-text-weight: var(--md-text-button-label-text-weight, var(--md-sys-typescale-label-large-weight, var(--md-ref-typeface-weight-medium, 500)));--_pressed-label-text-color: var(--md-text-button-pressed-label-text-color, var(--md-sys-color-primary, #6750a4));--_pressed-state-layer-color: var(--md-text-button-pressed-state-layer-color, var(--md-sys-color-primary, #6750a4));--_pressed-state-layer-opacity: var(--md-text-button-pressed-state-layer-opacity, 0.12);--_disabled-icon-color: var(--md-text-button-disabled-icon-color, var(--md-sys-color-on-surface, #1d1b20));--_disabled-icon-opacity: var(--md-text-button-disabled-icon-opacity, 0.38);--_focus-icon-color: var(--md-text-button-focus-icon-color, var(--md-sys-color-primary, #6750a4));--_hover-icon-color: var(--md-text-button-hover-icon-color, var(--md-sys-color-primary, #6750a4));--_icon-color: var(--md-text-button-icon-color, var(--md-sys-color-primary, #6750a4));--_icon-size: var(--md-text-button-icon-size, 18px);--_pressed-icon-color: var(--md-text-button-pressed-icon-color, var(--md-sys-color-primary, #6750a4));--_container-shape-start-start: var(--md-text-button-container-shape-start-start, var(--md-text-button-container-shape, var(--md-sys-shape-corner-full, 9999px)));--_container-shape-start-end: var(--md-text-button-container-shape-start-end, var(--md-text-button-container-shape, var(--md-sys-shape-corner-full, 9999px)));--_container-shape-end-end: var(--md-text-button-container-shape-end-end, var(--md-text-button-container-shape, var(--md-sys-shape-corner-full, 9999px)));--_container-shape-end-start: var(--md-text-button-container-shape-end-start, var(--md-text-button-container-shape, var(--md-sys-shape-corner-full, 9999px)));--_leading-space: var(--md-text-button-leading-space, 12px);--_trailing-space: var(--md-text-button-trailing-space, 12px);--_with-leading-icon-leading-space: var(--md-text-button-with-leading-icon-leading-space, 12px);--_with-leading-icon-trailing-space: var(--md-text-button-with-leading-icon-trailing-space, 16px);--_with-trailing-icon-leading-space: var(--md-text-button-with-trailing-icon-leading-space, 16px);--_with-trailing-icon-trailing-space: var(--md-text-button-with-trailing-icon-trailing-space, 12px);--_container-color: none;--_disabled-container-color: none;--_disabled-container-opacity: 0}
`;/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */let X=class extends jt{};X.styles=[mt,Xt];X=a([k("md-text-button")],X);/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const gt=Symbol.for(""),Zt=i=>{if((i==null?void 0:i.r)===gt)return i==null?void 0:i._$litStatic$},_e=(i,...t)=>({_$litStatic$:t.reduce((e,r,o)=>e+(n=>{if(n._$litStatic$!==void 0)return n._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${n}. Use 'unsafeStatic' to pass non-literal values, but
            take care to ensure page security.`)})(r)+i[o+1],i[0]),r:gt}),st=new Map,Jt=i=>(t,...e)=>{const r=e.length;let o,n;const s=[],h=[];let f,v=0,w=!1;for(;v<r;){for(f=t[v];v<r&&(n=e[v],(o=Zt(n))!==void 0);)f+=o+t[++v],w=!0;v!==r&&h.push(n),s.push(f),v++}if(v===r&&s.push(t[r]),w){const A=s.join("$$lit$$");(t=st.get(A))===void 0&&(s.raw=s,st.set(A,t=s)),e=h}return i(t,...e)},Qt=Jt(p);/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const Z=Symbol("createValidator"),J=Symbol("getValidityAnchor"),U=Symbol("privateValidator"),y=Symbol("privateSyncValidity"),O=Symbol("privateCustomValidationMessage");function ie(i){var t;class e extends i{constructor(){super(...arguments),this[t]=""}get validity(){return this[y](),this[g].validity}get validationMessage(){return this[y](),this[g].validationMessage}get willValidate(){return this[y](),this[g].willValidate}checkValidity(){return this[y](),this[g].checkValidity()}reportValidity(){return this[y](),this[g].reportValidity()}setCustomValidity(o){this[O]=o,this[y]()}requestUpdate(o,n,s){super.requestUpdate(o,n,s),this[y]()}firstUpdated(o){super.firstUpdated(o),this[y]()}[(t=O,y)](){this[U]||(this[U]=this[Z]());const{validity:o,validationMessage:n}=this[U].getValidity(),s=!!this[O],h=this[O]||n;this[g].setValidity({...o,customError:s},h,this[J]()??void 0)}[Z](){throw new Error("Implement [createValidator]")}[J](){throw new Error("Implement [getValidityAnchor]")}}return e}/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const P=Symbol("getFormValue"),dt=Symbol("getFormState");function oe(i){class t extends i{get form(){return this[g].form}get labels(){return this[g].labels}get name(){return this.getAttribute("name")??""}set name(r){this.setAttribute("name",r)}get disabled(){return this.hasAttribute("disabled")}set disabled(r){this.toggleAttribute("disabled",r)}attributeChangedCallback(r,o,n){if(r==="name"||r==="disabled"){const s=r==="disabled"?o!==null:o;this.requestUpdate(r,s);return}super.attributeChangedCallback(r,o,n)}requestUpdate(r,o,n){super.requestUpdate(r,o,n),this[g].setFormValue(this[P](),this[dt]())}[P](){throw new Error("Implement [getFormValue]")}[dt](){return this[P]()}formDisabledCallback(r){this.disabled=r}}return t.formAssociated=!0,a([l({noAccessor:!0})],t.prototype,"name",null),a([l({type:Boolean,noAccessor:!0})],t.prototype,"disabled",null),t}/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */const Q=Symbol("onReportValidity"),R=Symbol("privateCleanupFormListeners"),D=Symbol("privateDoNotReportInvalid"),F=Symbol("privateIsSelfReportingValidity"),V=Symbol("privateCallOnReportValidity");function ae(i){var t,e,r;class o extends i{constructor(...s){super(...s),this[t]=new AbortController,this[e]=!1,this[r]=!1,this.addEventListener("invalid",h=>{this[D]||!h.isTrusted||this.addEventListener("invalid",()=>{this[V](h)},{once:!0})},{capture:!0})}checkValidity(){this[D]=!0;const s=super.checkValidity();return this[D]=!1,s}reportValidity(){this[F]=!0;const s=super.reportValidity();return s&&this[V](null),this[F]=!1,s}[(t=R,e=D,r=F,V)](s){const h=s==null?void 0:s.defaultPrevented;h||(this[Q](s),!(!h&&(s==null?void 0:s.defaultPrevented)))||(this[F]||le(this[g].form,this))&&this.focus()}[Q](s){throw new Error("Implement [onReportValidity]")}formAssociatedCallback(s){super.formAssociatedCallback&&super.formAssociatedCallback(s),this[R].abort(),s&&(this[R]=new AbortController,se(this,s,()=>{this[V](null)},this[R].signal))}}return o}function se(i,t,e,r){const o=ne(t);let n=!1,s,h=!1;o.addEventListener("before",()=>{h=!0,s=new AbortController,n=!1,i.addEventListener("invalid",()=>{n=!0},{signal:s.signal})},{signal:r}),o.addEventListener("after",()=>{h=!1,s==null||s.abort(),!n&&e()},{signal:r}),t.addEventListener("submit",()=>{h||e()},{signal:r})}const G=new WeakMap;function ne(i){if(!G.has(i)){const t=new EventTarget;G.set(i,t);for(const e of["reportValidity","requestSubmit"]){const r=i[e];i[e]=function(){t.dispatchEvent(new Event("before"));const o=Reflect.apply(r,this,arguments);return t.dispatchEvent(new Event("after")),o}}}return G.get(i)}function le(i,t){if(!i)return!0;let e;for(const r of i.elements)if(r.matches(":invalid")){e=r;break}return e===t}/**
 * @license
 * Copyright 2023 Google LLC
 * SPDX-License-Identifier: Apache-2.0
